...
public final class TabKt {
    ...
    private static final float SmallTabHeight = PrimaryNavigationTabTokens.INSTANCE.m2109getContainerHeightD9Ej5fM();
    ...
    public static final void m1587TabwqdebIU(final boolean selected, final Function0<Unit> onClick, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, long selectedContentColor, long unselectedContentColor, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(Tab)P(5,4,3!1,7!1,6:c#ui.graphics.Color,8:c#ui.graphics.Color)98@4343L7,100@4460L39,110@4827L234:Tab.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        ...
        if (($dirty2 & 191739611) == 38347922 && $composer3.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-350627181, $dirty, -1, "androidx.compose.material3.Tab (Tab.kt:91)");
            }
            final Function2 styledText = text != null ? ComposableLambdaKt.composableLambda($composer3, 708874428, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$styledText$1$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ComposerKt.sourceInformation($composer4, "C105@4640L10,107@4767L39:Tab.kt#uh7d8r");
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(708874428, $changed2, -1, "androidx.compose.material3.Tab.<anonymous>.<anonymous> (Tab.kt:103)");
                        }
                        TextStyle style = TextStyle.m4646copyHL5avdY$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer4, 6), PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont()), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m4987boximpl(TextAlign.Companion.m4994getCentere0LSkKk()), null, 0L, null, 245759, null);
            ...
            text2 = text;
            $composer2 = $composer3;
            m1586TabbogVsAg(selected, onClick, modifier3, enabled2, selectedContentColor3, unselectedContentColor3, interactionSource2, ComposableLambdaKt.composableLambda($composer3, 1540996038, true, new Function3<ColumnScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(ColumnScope Tab, Composer $composer4, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer4, "C119@5006L49:Tab.kt#uh7d8r");
                    if (($changed2 & 81) != 16 || !$composer4.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(1540996038, $changed2, -1, "androidx.compose.material3.Tab.<anonymous> (Tab.kt:118)");
                        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$3
            ...
            public final void invoke(Composer composer, int i9) {
                TabKt.m1587TabwqdebIU(selected, onClick, modifier5, z, function25, function26, j, j2, mutableInteractionSource, composer, $changed | 1, i);
            }
        });
    }

    /* renamed from: LeadingIconTab-wqdebIU  reason: not valid java name */
    public static final void m1585LeadingIconTabwqdebIU(final boolean selected, final Function0<Unit> onClick, final Function2<? super Composer, ? super Integer, Unit> text, final Function2<? super Composer, ? super Integer, Unit> icon, Modifier modifier, boolean enabled, long selectedContentColor, long unselectedContentColor, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        boolean enabled2;
        long selectedContentColor2;
        int $dirty;
        ...
        ComposerKt.sourceInformation($composer2, "C(LeadingIconTab)P(5,4,7,1,3!1,6:c#ui.graphics.Color,8:c#ui.graphics.Color)161@6803L7,163@6920L39,168@7200L60,170@7266L991:Tab.kt#uh7d8r");
        int $dirty4 = $changed;
        if ((i & 1) != 0) {
            $dirty4 |= 6;
        } else if (($changed & 14) == 0) {
        ...
        if (($dirty & 191739611) == 38347922 && $composer2.getSkipping()) {
            ...
            final Indication ripple = RippleKt.m1217rememberRipple9IZ8Weo(true, 0.0f, selectedContentColor3, $composer2, (($dirty2 >> 12) & 896) | 6, 2);
            final Modifier modifier4 = modifier3;
            final MutableInteractionSource mutableInteractionSource = interactionSource2;
            final boolean z = enabled3;
            int $dirty5 = $dirty2;
            m1588TabTransitionKlgxPg(selectedContentColor3, unselectedContentColor3, selected, ComposableLambdaKt.composableLambda($composer2, -429037564, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$LeadingIconTab$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        if (($changed$iv & 11) == 2 && $composer3.getSkipping()) {
                            ...
                            if (((((432 >> 6) & 112) | 6) & 81) != 16 || !$composer3.getSkipping()) {
                                ...
                                TextStyle style = TextStyle.m4646copyHL5avdY$default(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, 6), PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont()), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, TextAlign.m4987boximpl(TextAlign.Companion.m4994getCentere0LSkKk()), null, 0L, null, 245759, null);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$LeadingIconTab$3
            ...
            public final void invoke(Composer composer, int i7) {
                TabKt.m1585LeadingIconTabwqdebIU(selected, onClick, text, icon, modifier5, z2, j, j2, mutableInteractionSource2, composer, $changed | 1, i);
            }
        });
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1588TabTransitionKlgxPg(final long r30, final long r32, final boolean r34, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, androidx.compose.runtime.Composer r36, final int r37) {
        /*
            Method dump skipped, instructions count: 591
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m1588TabTransitionKlgxPg(long, long, boolean, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int):void");
    }

    /* renamed from: TabTransition_Klgx_Pg$lambda-5  reason: not valid java name */
    private static final long m1589TabTransition_Klgx_Pg$lambda5(State<Color> state) {
    ...
    public static final void TabBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer3, "C(TabBaselineLayout)P(1)306@12539L2151:Tab.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty & 91) != 18 || !$composer3.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(514131524, $dirty, -1, "androidx.compose.material3.TabBaselineLayout (Tab.kt:302)");
            }
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2
                ...
                public final MeasureResult mo11measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long constraints) {
                    ...
                    int specHeight = Layout.mo295roundToPx0680j_4((textPlaceable == null || iconPlaceable == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight);
                    ...
                    final int tabHeight = Math.max(specHeight, height + height2 + Layout.mo294roundToPxR2X_6o(j));
            ...
            $composer3.startReplaceableGroup(2058660585);
            $composer3.startReplaceableGroup(1480471867);
            ComposerKt.sourceInformation($composer3, "C316@12841L41:Tab.kt#uh7d8r");
            if ((($changed$iv$iv >> 9) & 14 & 11) != 2 || !$composer3.getSkipping()) {
                $composer3.startReplaceableGroup(720850841);
                ComposerKt.sourceInformation($composer3, "309@12605L173");
                if (function2 == null) {
                    $composer2 = $composer3;
                } else {
                    ...
                    if (($changed$iv & 11) == 2 && $composer3.getSkipping()) {
                        ...
                        $composer3.startReplaceableGroup(-947514212);
                        ComposerKt.sourceInformation($composer3, "C313@12770L6:Tab.kt#uh7d8r");
                ...
                if (function22 != null) {
                    ...
                    if (($changed$iv2 & 11) == 2 && $composer3.getSkipping()) {
                        ...
                        $composer3.startReplaceableGroup(-1983967725);
                        ComposerKt.sourceInformation($composer3, "C316@12874L6:Tab.kt#uh7d8r");
                        if (((((6 >> 6) & 112) | 6) & 81) == 16 && $composer3.getSkipping()) {
                            $composer3.skipToGroupEnd();
                        } else {
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope $this$placeTextAndIcon, Density density, Placeable textPlaceable, Placeable iconPlaceable, int tabWidth, int tabHeight, int firstBaseline, int lastBaseline) {
        ...
        int textOffset = density.mo295roundToPx0680j_4(baselineOffset) + density.mo295roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m2107getActiveIndicatorHeightD9Ej5fM());
