    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (!this.$enabled) {
                    this.label = 2;
                    if (this.$animatable.snapTo(Dp.m5120boximpl(this.$target), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
                } else {
                    float m5136unboximpl = this.$animatable.getTargetValue().m5136unboximpl();
                    f = this.this$0.pressedElevation;
                    DragInteraction.Start start = null;
                    if (Dp.m5127equalsimpl0(m5136unboximpl, f)) {
                        start = new PressInteraction.Press(Offset.Companion.m2384getZeroF1C5BW0(), null);
                    } else {
                        f2 = this.this$0.hoveredElevation;
                        if (Dp.m5127equalsimpl0(m5136unboximpl, f2)) {
                            start = new HoverInteraction.Enter();
                        } else {
                            f3 = this.this$0.focusedElevation;
                            if (Dp.m5127equalsimpl0(m5136unboximpl, f3)) {
                                start = new FocusInteraction.Focus();
                            } else {
                                f4 = this.this$0.draggedElevation;
                                if (Dp.m5127equalsimpl0(m5136unboximpl, f4)) {
                    ...
                    this.label = 1;
                    if (ElevationKt.m1387animateElevationrAjV9yQ(this.$animatable, this.$target, interaction, this.$interaction, this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
