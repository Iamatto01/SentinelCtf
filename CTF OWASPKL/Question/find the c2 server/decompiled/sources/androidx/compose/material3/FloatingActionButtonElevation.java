...
public class FloatingActionButtonElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-424810125, $changed, -1, "androidx.compose.material3.FloatingActionButtonElevation.shadowElevation (FloatingActionButton.kt:493)");
        }
    ...
    public final State<Dp> tonalElevation$material3_release(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-550096911, $changed, -1, "androidx.compose.material3.FloatingActionButtonElevation.tonalElevation (FloatingActionButton.kt:498)");
        }
        State<Dp> animateElevation = animateElevation(interactionSource, $composer, ($changed & 14) | ($changed & 112));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1845106002, $changed, -1, "androidx.compose.material3.FloatingActionButtonElevation.animateElevation (FloatingActionButton.kt:503)");
        }
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv3 = (Function2) new FloatingActionButtonElevation$animateElevation$1$1(interactionSource, interactions, null);
        ...
        $composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect(interactionSource, (Function2) value$iv$iv2, $composer, ($changed & 14) | 64);
        ...
        EffectsKt.LaunchedEffect(Dp.m5120boximpl(target), new FloatingActionButtonElevation$animateElevation$2(animatable, this, target, interaction, null), $composer, 64);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof FloatingActionButtonElevation) && Dp.m5127equalsimpl0(this.defaultElevation, ((FloatingActionButtonElevation) other).defaultElevation) && Dp.m5127equalsimpl0(this.pressedElevation, ((FloatingActionButtonElevation) other).pressedElevation) && Dp.m5127equalsimpl0(this.focusedElevation, ((FloatingActionButtonElevation) other).focusedElevation) && Dp.m5127equalsimpl0(this.hoveredElevation, ((FloatingActionButtonElevation) other).hoveredElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Dp.m5128hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5128hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5128hashCodeimpl(this.hoveredElevation);
    }
}
