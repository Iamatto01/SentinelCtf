...
public final class TabRowKt {
    private static final float ScrollableTabRowMinimumTabWidth = Dp.m5122constructorimpl(90);
    private static final float ScrollableTabRowPadding = Dp.m5122constructorimpl(52);
    ...
    */
    public static final void m1598TabRowpAZo6Ak(final int r28, androidx.compose.ui.Modifier r29, long r30, long r32, kotlin.jvm.functions.Function3<? super java.util.List<androidx.compose.material3.TabPosition>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instructions count: 492
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabRowKt.m1598TabRowpAZo6Ak(int, androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: ScrollableTabRow-sKfQg0A  reason: not valid java name */
    public static final void m1597ScrollableTabRowsKfQg0A(final int selectedTabIndex, Modifier modifier, long containerColor, long contentColor, float edgePadding, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> tabs, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(ScrollableTabRow)P(6,5,0:c#ui.graphics.Color,1:c#ui.graphics.Color,3:c#ui.unit.Dp,4)224@10825L14,225@10882L12,237@11285L3200:TabRow.kt#uh7d8r");
        int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        ...
        if ((i & 128) != 0) {
            ...
            $dirty |= $composer2.changed(tabs) ? 8388608 : 4194304;
        }
        if ((23967451 & $dirty) == 4793490 && $composer2.getSkipping()) {
                ...
                indicator = i6 != 0 ? ComposableLambdaKt.composableLambda($composer2, -913748678, true, new Function3<List<? extends TabPosition>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$1
                    ...
                    public final void invoke(List<TabPosition> tabPositions, Composer $composer3, int $changed2) {
                        ...
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-913748678, $changed2, -1, "androidx.compose.material3.ScrollableTabRow.<anonymous> (TabRow.kt:227)");
                        }
                        TabRowDefaults.INSTANCE.m1594Indicator9IZ8Weo(TabRowDefaults.INSTANCE.tabIndicatorOffset(Modifier.Companion, tabPositions.get(selectedTabIndex)), 0.0f, 0L, $composer3, 3072, 6);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
                }) : function3;
                divider = i7 != 0 ? ComposableSingletons$TabRowKt.INSTANCE.m1363getLambda2$material3_release() : function2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-497821003, $dirty, -1, "androidx.compose.material3.ScrollableTabRow (TabRow.kt:221)");
            }
            final float f = edgePadding2;
            final Function2 function22 = divider;
            final Function3 function32 = indicator;
            final int i8 = $dirty;
            SurfaceKt.m1565SurfaceT9BRK9s(modifier2, null, containerColor2, contentColor2, 0.0f, 0.0f, null, ComposableLambdaKt.composableLambda($composer2, 286469328, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(286469328, $changed2, -1, "androidx.compose.material3.ScrollableTabRow.<anonymous> (TabRow.kt:241)");
                        }
                        ...
                        if (it$iv$iv$iv == Composer.Companion.getEmpty()) {
                            Object value$iv$iv$iv = new CompositionScopedCoroutineScopeCanceller(EffectsKt.createCompositionCoroutineScope(EmptyCoroutineContext.INSTANCE, $composer3));
                        ...
                        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                            Object value$iv$iv2 = new ScrollableTabData(scrollState, coroutineScope);
                        ...
                        Modifier clipToBounds = ClipKt.clipToBounds(SelectableGroupKt.selectableGroup(ScrollKt.horizontalScroll$default(SizeKt.wrapContentSize$default(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), Alignment.Companion.getCenterStart(), false, 2, null), scrollState, false, null, false, 14, null)));
                        final float f2 = f;
                        ...
                        SubcomposeLayoutKt.SubcomposeLayout(clipToBounds, new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$2.1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                return m1599invoke0kLqBqw(subcomposeMeasureScope, constraints.m5084unboximpl());
                            }

                            /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                            public final MeasureResult m1599invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, final long constraints) {
                                float f3;
                                long tabConstraints;
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                f3 = TabRowKt.ScrollableTabRowMinimumTabWidth;
                                int minTabWidth = SubcomposeLayout.mo295roundToPx0680j_4(f3);
                                final int padding = SubcomposeLayout.mo295roundToPx0680j_4(f2);
                                ...
                                tabConstraints = Constraints.m5068copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(constraints) : minTabWidth, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(constraints) : accumulator$iv, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(constraints) : 0);
                                Iterable $this$map$iv = tabMeasurables;
                                Collection destination$iv$iv = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10));
                                for (Object item$iv$iv : $this$map$iv) {
                                    Measurable it = (Measurable) item$iv$iv;
                                    destination$iv$iv.add(it.mo4125measureBRTryo0(tabConstraints));
                                }
                                ...
                                return MeasureScope.layout$default(SubcomposeLayout, accumulator$iv2, accumulator$iv, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabRowKt.ScrollableTabRow.2.1.1
                                    ...
                                    public final void invoke2(Placeable.PlacementScope layout) {
                                        ...
                                        for (Object element$iv3 : $this$forEach$iv) {
                                            ...
                                            tabPositions.add(new TabPosition(subcomposeMeasureScope.mo298toDpu2uoSUM(left2), subcomposeMeasureScope.mo298toDpu2uoSUM(it2.getWidth()), null));
                                            left2 += it2.getWidth();
                                        }
                                        ...
                                        for (Object element$iv4 : $this$forEach$iv2) {
                                            ...
                                            m5068copyZbe2FdA = Constraints.m5068copyZbe2FdA(j, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(j) : i14, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(j) : i14, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(j) : 0, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(j) : 0);
                                            Placeable placeable = it3.mo4125measureBRTryo0(m5068copyZbe2FdA);
                                        ...
                                        Iterable $this$forEach$iv3 = subcomposeMeasureScope2.subcompose(tabSlots, ComposableLambdaKt.composableLambdaInstance(963343607, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt.ScrollableTabRow.2.1.1.3
                                            ...
                                            public final void invoke(Composer $composer4, int $changed3) {
                                                ...
                                                if (ComposerKt.isTraceInProgress()) {
                                                    ComposerKt.traceEventStart(963343607, $changed3, -1, "androidx.compose.material3.ScrollableTabRow.<anonymous>.<anonymous>.<anonymous>.<anonymous> (TabRow.kt:301)");
                                                }
                                        ...
                                        for (Object element$iv5 : $this$forEach$iv3) {
                                            ...
                                            Placeable.PlacementScope.placeRelative$default(layout, it4.mo4125measureBRTryo0(Constraints.Companion.m5086fixedJhjzzOo(i17, i18)), 0, 0, 0.0f, 4, null);
                                        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRow$3
            ...
            public final void invoke(Composer composer, int i9) {
                TabRowKt.m1597ScrollableTabRowsKfQg0A(selectedTabIndex, modifier4, j, j2, f2, function33, function23, tabs, composer, $changed | 1, i);
            }
        });
    }
}
