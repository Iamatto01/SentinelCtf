...
public final class FilterChipDefaults {
    ...
    public final SelectableChipColors m1411filterChipColorsXqyqHi0(long containerColor, long labelColor, long iconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        ...
        if ((i & 16) != 0) {
            m2604copywmQWz5c3 = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.38f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), $composer, 6)) : 0.0f);
            disabledLabelColor2 = m2604copywmQWz5c3;
        } else {
            disabledLabelColor2 = disabledLabelColor;
        }
        if ((i & 32) != 0) {
            m2604copywmQWz5c2 = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.38f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledIconColor(), $composer, 6)) : 0.0f);
            disabledLeadingIconColor2 = m2604copywmQWz5c2;
        } else {
        ...
        if ((i & 256) != 0) {
            m2604copywmQWz5c = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.12f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledSelectedContainerColor(), $composer, 6)) : 0.0f);
            disabledSelectedContainerColor2 = m2604copywmQWz5c;
        } else {
    ...
    public final SelectableChipElevation m1412filterChipElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? FilterChipTokens.INSTANCE.m1941getFlatContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) == 0) {
            pressedElevation2 = pressedElevation;
        } else {
            pressedElevation2 = FilterChipTokens.INSTANCE.m1945getFlatSelectedPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) == 0) {
            focusedElevation2 = focusedElevation;
        } else {
            focusedElevation2 = FilterChipTokens.INSTANCE.m1942getFlatSelectedFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) == 0) {
            hoveredElevation2 = hoveredElevation;
        } else {
            hoveredElevation2 = FilterChipTokens.INSTANCE.m1943getFlatSelectedHoverContainerElevationD9Ej5fM();
        }
        if ((i & 16) == 0) {
            draggedElevation2 = draggedElevation;
        } else {
            draggedElevation2 = FilterChipTokens.INSTANCE.m1935getDraggedContainerElevationD9Ej5fM();
        }
        if ((i & 32) == 0) {
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(defaultElevation2, pressedElevation2, focusedElevation2, hoveredElevation2, draggedElevation2, disabledElevation2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final SelectableChipBorder m1410filterChipBordergHcDVlo(long borderColor, long selectedBorderColor, long disabledBorderColor, long disabledSelectedBorderColor, float borderWidth, float selectedBorderWidth, Composer $composer, int $changed, int i) {
        ...
        if ((i & 2) == 0) {
            ...
            selectedBorderColor2 = Color.Companion.m2641getTransparent0d7_KjU();
        }
        if ((i & 4) != 0) {
            disabledBorderColor2 = Color.m2604copywmQWz5c(r6, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r6) : 0.12f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r6) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r6) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineColor(), $composer, 6)) : 0.0f);
        } else {
        ...
        if ((i & 8) == 0) {
            ...
            disabledSelectedBorderColor2 = Color.Companion.m2641getTransparent0d7_KjU();
        }
        if ((i & 16) == 0) {
            borderWidth2 = borderWidth;
        } else {
            borderWidth2 = FilterChipTokens.INSTANCE.m1948getFlatUnselectedOutlineWidthD9Ej5fM();
        }
        if ((i & 32) == 0) {
            selectedBorderWidth2 = selectedBorderWidth;
        } else {
            selectedBorderWidth2 = FilterChipTokens.INSTANCE.m1944getFlatSelectedOutlineWidthD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final SelectableChipColors m1408elevatedFilterChipColorsXqyqHi0(long containerColor, long labelColor, long iconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor, Composer $composer, int $changed, int $changed1, int i) {
        long labelColor2;
        long iconColor2;
        long disabledContainerColor2;
        long disabledLabelColor2;
        ...
        if ((i & 8) != 0) {
            m2604copywmQWz5c3 = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.12f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getElevatedDisabledContainerColor(), $composer, 6)) : 0.0f);
            disabledContainerColor2 = m2604copywmQWz5c3;
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 16) != 0) {
            m2604copywmQWz5c2 = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.38f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledLabelTextColor(), $composer, 6)) : 0.0f);
            disabledLabelColor2 = m2604copywmQWz5c2;
        } else {
            disabledLabelColor2 = disabledLabelColor;
        }
        if ((i & 32) != 0) {
            m2604copywmQWz5c = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.38f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(FilterChipTokens.INSTANCE.getDisabledIconColor(), $composer, 6)) : 0.0f);
            disabledLeadingIconColor2 = m2604copywmQWz5c;
        } else {
            disabledLeadingIconColor2 = disabledLeadingIconColor;
        }
        if ((i & 64) == 0) {
    ...
    public final SelectableChipElevation m1409elevatedFilterChipElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float defaultElevation2 = (i & 1) != 0 ? FilterChipTokens.INSTANCE.m1936getElevatedContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) == 0) {
            pressedElevation2 = pressedElevation;
        } else {
            pressedElevation2 = FilterChipTokens.INSTANCE.m1940getElevatedPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) == 0) {
            focusedElevation2 = focusedElevation;
        } else {
            focusedElevation2 = FilterChipTokens.INSTANCE.m1938getElevatedFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) == 0) {
            hoveredElevation2 = hoveredElevation;
        } else {
            hoveredElevation2 = FilterChipTokens.INSTANCE.m1939getElevatedHoverContainerElevationD9Ej5fM();
        }
        if ((i & 16) == 0) {
            draggedElevation2 = draggedElevation;
        } else {
        ...
        if ((i & 32) == 0) {
            ...
            disabledElevation2 = FilterChipTokens.INSTANCE.m1937getElevatedDisabledContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
