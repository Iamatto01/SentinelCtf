...
public final class CardDefaults {
    ...
    public final CardElevation m1259cardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? FilledCardTokens.INSTANCE.m1909getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) == 0) {
            pressedElevation2 = pressedElevation;
        } else {
            pressedElevation2 = FilledCardTokens.INSTANCE.m1915getPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) == 0) {
            focusedElevation2 = focusedElevation;
        } else {
            focusedElevation2 = FilledCardTokens.INSTANCE.m1912getFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) == 0) {
            hoveredElevation2 = hoveredElevation;
        } else {
            hoveredElevation2 = FilledCardTokens.INSTANCE.m1913getHoverContainerElevationD9Ej5fM();
        }
        if ((i & 16) == 0) {
            draggedElevation2 = draggedElevation;
        } else {
            draggedElevation2 = FilledCardTokens.INSTANCE.m1911getDraggedContainerElevationD9Ej5fM();
        }
        if ((i & 32) == 0) {
            disabledElevation2 = disabledElevation;
        } else {
            disabledElevation2 = FilledCardTokens.INSTANCE.m1910getDisabledContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardElevation m1261elevatedCardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float defaultElevation2 = (i & 1) != 0 ? ElevatedCardTokens.INSTANCE.m1825getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) == 0) {
            pressedElevation2 = pressedElevation;
        } else {
            pressedElevation2 = ElevatedCardTokens.INSTANCE.m1831getPressedContainerElevationD9Ej5fM();
        }
        if ((i & 4) == 0) {
            focusedElevation2 = focusedElevation;
        } else {
            focusedElevation2 = ElevatedCardTokens.INSTANCE.m1828getFocusContainerElevationD9Ej5fM();
        }
        if ((i & 8) == 0) {
            hoveredElevation2 = hoveredElevation;
        } else {
            hoveredElevation2 = ElevatedCardTokens.INSTANCE.m1829getHoverContainerElevationD9Ej5fM();
        }
        if ((i & 16) == 0) {
            draggedElevation2 = draggedElevation;
        } else {
            draggedElevation2 = ElevatedCardTokens.INSTANCE.m1827getDraggedContainerElevationD9Ej5fM();
        }
        if ((i & 32) == 0) {
            disabledElevation2 = disabledElevation;
        } else {
            disabledElevation2 = ElevatedCardTokens.INSTANCE.m1826getDisabledContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardElevation m1263outlinedCardElevationaqJV_2Y(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float focusedElevation2;
        float hoveredElevation2;
        float draggedElevation2;
        ...
        float defaultElevation2 = (i & 1) != 0 ? OutlinedCardTokens.INSTANCE.m2009getContainerElevationD9Ej5fM() : defaultElevation;
        if ((i & 2) == 0) {
            pressedElevation2 = pressedElevation;
        } else {
        ...
        if ((i & 16) == 0) {
            ...
            draggedElevation2 = OutlinedCardTokens.INSTANCE.m2011getDraggedContainerElevationD9Ej5fM();
        }
        if ((i & 32) == 0) {
            disabledElevation2 = disabledElevation;
        } else {
            disabledElevation2 = OutlinedCardTokens.INSTANCE.m2010getDisabledContainerElevationD9Ej5fM();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final CardColors m1258cardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        if ((i & 4) != 0) {
            m2604copywmQWz5c2 = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.38f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(FilledCardTokens.INSTANCE.getDisabledContainerColor(), $composer, 6)) : 0.0f);
            disabledContainerColor2 = ColorKt.m2651compositeOverOWjLjI(m2604copywmQWz5c2, ColorSchemeKt.m1343surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), FilledCardTokens.INSTANCE.m1910getDisabledContainerElevationD9Ej5fM()));
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            m2604copywmQWz5c = Color.m2604copywmQWz5c(r8, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r8) : 0.38f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r8) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r8) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.m1338contentColorForek8zF_U(containerColor2, $composer, $changed & 14)) : 0.0f);
    ...
    public final CardColors m1260elevatedCardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        long m2604copywmQWz5c;
        ...
        if ((i & 4) != 0) {
            m2604copywmQWz5c2 = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.38f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(ElevatedCardTokens.INSTANCE.getDisabledContainerColor(), $composer, 6)) : 0.0f);
            disabledContainerColor2 = ColorKt.m2651compositeOverOWjLjI(m2604copywmQWz5c2, ColorSchemeKt.m1343surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), ElevatedCardTokens.INSTANCE.m1826getDisabledContainerElevationD9Ej5fM()));
        } else {
            disabledContainerColor2 = disabledContainerColor;
        }
        if ((i & 8) != 0) {
            m2604copywmQWz5c = Color.m2604copywmQWz5c(r9, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r9) : 0.38f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r9) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r9) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(contentColor2) : 0.0f);
            disabledContentColor2 = m2604copywmQWz5c;
        } else {
            disabledContentColor2 = disabledContentColor;
        }
    ...
    public final CardColors m1262outlinedCardColorsro_MJ88(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContainerColor2;
        long disabledContentColor2;
        long m2604copywmQWz5c;
    ...
    public final BorderStroke outlinedCardBorder(boolean enabled, Composer $composer, int $changed, int i) {
        ...
        if (enabled) {
            ...
            m2604copywmQWz5c = Color.m2604copywmQWz5c(r1, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r1) : 0.12f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r1) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r1) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(ColorSchemeKt.toColor(OutlinedCardTokens.INSTANCE.getDisabledOutlineColor(), $composer, 6)) : 0.0f);
            color = ColorKt.m2651compositeOverOWjLjI(m2604copywmQWz5c, ColorSchemeKt.m1343surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme($composer, 6), OutlinedCardTokens.INSTANCE.m2010getDisabledContainerElevationD9Ej5fM()));
            $composer.endReplaceableGroup();
        }
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = BorderStrokeKt.m170BorderStrokecXLIe8U(OutlinedCardTokens.INSTANCE.m2015getOutlineWidthD9Ej5fM(), color);
