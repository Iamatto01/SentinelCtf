...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(670222826, $changed, -1, "androidx.compose.material3.SelectableChipBorder.borderStroke (Chip.kt:2002)");
        }
        if (enabled) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m170BorderStrokecXLIe8U(selected ? this.selectedBorderWidth : this.borderWidth, color), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipBorder) && Color.m2607equalsimpl0(this.borderColor, ((SelectableChipBorder) other).borderColor) && Color.m2607equalsimpl0(this.selectedBorderColor, ((SelectableChipBorder) other).selectedBorderColor) && Color.m2607equalsimpl0(this.disabledBorderColor, ((SelectableChipBorder) other).disabledBorderColor) && Color.m2607equalsimpl0(this.disabledSelectedBorderColor, ((SelectableChipBorder) other).disabledSelectedBorderColor) && Dp.m5127equalsimpl0(this.borderWidth, ((SelectableChipBorder) other).borderWidth) && Dp.m5127equalsimpl0(this.selectedBorderWidth, ((SelectableChipBorder) other).selectedBorderWidth)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2613hashCodeimpl(this.borderColor);
        return (((((((((result * 31) + Color.m2613hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m2613hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2613hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m5128hashCodeimpl(this.borderWidth)) * 31) + Dp.m5128hashCodeimpl(this.selectedBorderWidth);
    }
}
