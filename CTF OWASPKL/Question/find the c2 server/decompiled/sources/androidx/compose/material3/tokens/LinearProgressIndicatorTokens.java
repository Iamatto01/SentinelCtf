...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5122constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m5122constructorimpl((float) 4.0d);
    ...
    public final float m1961getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1962getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
