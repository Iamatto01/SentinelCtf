...
public final class AppBarKt {
    ...
    public static final void TopAppBar(final Function2<? super Composer, ? super Integer, Unit> title, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(TopAppBar)P(5,2,3!1,6)125@6260L12,126@6322L22,132@6517L10,129@6406L374:AppBar.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        ...
        if (i5 != 0) {
            ...
            function22 = function2;
            $dirty2 |= $composer3.changed(function22) ? 256 : 128;
        } else {
            function22 = function2;
        }
        int i6 = i & 8;
        if (i6 != 0) {
            ...
            actions = function3;
            $dirty2 |= $composer3.changed(actions) ? 2048 : 1024;
        } else {
            actions = function3;
        }
        if (($changed & 57344) == 0) {
        ...
        if (i7 != 0) {
            ...
            obj3 = scrollBehavior;
            $dirty2 |= $composer3.changed(obj3) ? 1048576 : 524288;
        } else {
            obj3 = scrollBehavior;
        }
        if (($dirty2 & 2995931) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                ...
                Function2 navigationIcon2 = i5 != 0 ? ComposableSingletons$AppBarKt.INSTANCE.m1344getLambda1$material3_release() : function22;
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1348getLambda2$material3_release();
                }
                if ((i & 16) != 0) {
                    $dirty2 &= -57345;
                ...
                if ((i & 32) != 0) {
                    colors2 = TopAppBarDefaults.INSTANCE.m1713smallTopAppBarColorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty2 &= -458753;
                } else {
                    colors2 = colors;
                }
        ...
        final TopAppBarColors topAppBarColors = colors3;
        final TopAppBarScrollBehavior topAppBarScrollBehavior = scrollBehavior2;
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$TopAppBar$1
            ...
            public final void invoke(Composer composer, int i8) {
                AppBarKt.TopAppBar(title, modifier4, function23, function32, windowInsets4, topAppBarColors, topAppBarScrollBehavior, composer, $changed | 1, i);
            }
        });
    }
    ...
    public static final void SmallTopAppBar(final Function2<? super Composer, ? super Integer, Unit> title, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(SmallTopAppBar)P(5,2,3!1,6)188@9249L12,189@9311L22,191@9391L89:AppBar.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        } else if (($changed & 14) == 0) {
        ...
        if (i7 != 0) {
            ...
            obj4 = scrollBehavior;
            $dirty2 |= $composer3.changed(obj4) ? 1048576 : 524288;
        } else {
            obj4 = scrollBehavior;
        }
        if ((2995931 & $dirty2) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier modifier3 = i4 != 0 ? Modifier.Companion : obj;
                Function2 navigationIcon2 = i5 != 0 ? ComposableSingletons$AppBarKt.INSTANCE.m1349getLambda3$material3_release() : function22;
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1350getLambda4$material3_release();
                }
                if ((i & 16) != 0) {
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
                    $dirty2 &= -57345;
            ...
            $composer2 = $composer3;
            TopAppBar(title, modifier2, navigationIcon, actions2, windowInsets3, colors3, scrollBehavior2, $composer3, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | ($dirty & 458752) | ($dirty & 3670016), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$SmallTopAppBar$1
            ...
            public final void invoke(Composer composer, int i8) {
                AppBarKt.SmallTopAppBar(title, modifier4, function23, function32, windowInsets4, topAppBarColors, topAppBarScrollBehavior, composer, $changed | 1, i);
            }
        });
    }
    ...
    public static final void CenterAlignedTopAppBar(final Function2<? super Composer, ? super Integer, Unit> title, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(CenterAlignedTopAppBar)P(5,2,3!1,6)229@11673L12,230@11735L30,237@11946L10,233@11827L381:AppBar.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        } else if (($changed & 14) == 0) {
        ...
        if (($dirty2 & 2995931) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier modifier3 = i4 != 0 ? Modifier.Companion : obj;
                Function2 navigationIcon2 = i5 != 0 ? ComposableSingletons$AppBarKt.INSTANCE.m1351getLambda5$material3_release() : function22;
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1352getLambda6$material3_release();
                }
                if ((i & 16) != 0) {
                    $dirty2 &= -57345;
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
                ...
                if ((i & 32) != 0) {
                    colors2 = TopAppBarDefaults.INSTANCE.m1710centerAlignedTopAppBarColorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty2 &= -458753;
                } else {
                    colors2 = colors;
                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$CenterAlignedTopAppBar$1
            ...
            public final void invoke(Composer composer, int i8) {
                AppBarKt.CenterAlignedTopAppBar(title, modifier4, function23, function32, windowInsets4, topAppBarColors, topAppBarScrollBehavior, composer, $changed | 1, i);
            }
        });
    }
    ...
    public static final void MediumTopAppBar(final Function2<? super Composer, ? super Integer, Unit> title, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(MediumTopAppBar)P(5,2,3!1,6)284@14526L12,285@14588L23,291@14782L10,292@14884L10,288@14673L646:AppBar.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        } else if (($changed & 14) == 0) {
        ...
        if ((2995931 & $dirty2) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier modifier3 = i4 != 0 ? Modifier.Companion : obj;
                Function2 navigationIcon2 = i5 != 0 ? ComposableSingletons$AppBarKt.INSTANCE.m1353getLambda7$material3_release() : function22;
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1354getLambda8$material3_release();
                }
                if ((i & 16) != 0) {
                    $dirty2 &= -57345;
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
                ...
                if ((i & 32) != 0) {
                    $dirty2 &= -458753;
                    colors2 = TopAppBarDefaults.INSTANCE.m1712mediumTopAppBarColorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                }
                if (i7 != 0) {
                    $dirty = $dirty2;
                    modifier2 = modifier3;
            ...
            $composer2 = $composer3;
            m1232TwoRowsTopAppBartjU4iQQ(modifier2, title, TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, 6), TopAppBarMediumTokens.INSTANCE.getHeadlineFont()), MediumTitleBottomPadding, title, TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, 6), TopAppBarSmallTokens.INSTANCE.getHeadlineFont()), navigationIcon, actions2, windowInsets3, colors3, TopAppBarMediumTokens.INSTANCE.m2162getContainerHeightD9Ej5fM(), TopAppBarSmallTokens.INSTANCE.m2172getContainerHeightD9Ej5fM(), scrollBehavior2, $composer2, (($dirty >> 3) & 14) | 3072 | (($dirty << 3) & 112) | (($dirty << 12) & 57344) | (($dirty << 12) & 3670016) | (($dirty << 12) & 29360128) | (($dirty << 12) & 234881024) | (($dirty << 12) & 1879048192), (($dirty >> 12) & 896) | 54, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$MediumTopAppBar$1
            ...
            public final void invoke(Composer composer, int i8) {
                AppBarKt.MediumTopAppBar(title, modifier4, function23, function32, windowInsets4, topAppBarColors, topAppBarScrollBehavior, composer, $changed | 1, i);
            }
        });
    }
    ...
    public static final void LargeTopAppBar(final Function2<? super Composer, ? super Integer, Unit> title, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, WindowInsets windowInsets, TopAppBarColors colors, TopAppBarScrollBehavior scrollBehavior, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(LargeTopAppBar)P(5,2,3!1,6)342@17629L12,343@17691L22,348@17855L10,349@17956L10,346@17775L643:AppBar.kt#uh7d8r");
        int $dirty2 = $changed;
        if ((i & 1) != 0) {
            $dirty2 |= 6;
        } else if (($changed & 14) == 0) {
        ...
        if ((2995931 & $dirty2) == 599186 && $composer3.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer3.getDefaultsInvalid()) {
                Modifier modifier3 = i4 != 0 ? Modifier.Companion : obj;
                Function2 navigationIcon2 = i5 != 0 ? ComposableSingletons$AppBarKt.INSTANCE.m1355getLambda9$material3_release() : function22;
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m1345getLambda10$material3_release();
                }
                if ((i & 16) != 0) {
                    $dirty2 &= -57345;
                    windowInsets2 = TopAppBarDefaults.INSTANCE.getWindowInsets($composer3, 6);
                ...
                if ((i & 32) != 0) {
                    $dirty2 &= -458753;
                    colors2 = TopAppBarDefaults.INSTANCE.m1711largeTopAppBarColorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer3, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                }
                if (i7 != 0) {
                    $dirty = $dirty2;
                    modifier2 = modifier3;
            ...
            $composer2 = $composer3;
            m1232TwoRowsTopAppBartjU4iQQ(modifier2, title, TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, 6), TopAppBarLargeTokens.INSTANCE.getHeadlineFont()), LargeTitleBottomPadding, title, TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography($composer3, 6), TopAppBarSmallTokens.INSTANCE.getHeadlineFont()), navigationIcon, actions2, windowInsets3, colors3, TopAppBarLargeTokens.INSTANCE.m2158getContainerHeightD9Ej5fM(), TopAppBarSmallTokens.INSTANCE.m2172getContainerHeightD9Ej5fM(), scrollBehavior2, $composer2, (($dirty >> 3) & 14) | 3072 | (($dirty << 3) & 112) | (($dirty << 12) & 57344) | (($dirty << 12) & 3670016) | (($dirty << 12) & 29360128) | (($dirty << 12) & 234881024) | (($dirty << 12) & 1879048192), (($dirty >> 12) & 896) | 54, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            windowInsets2 = windowInsets3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$LargeTopAppBar$1
            ...
            public final void invoke(Composer composer, int i8) {
                AppBarKt.LargeTopAppBar(title, modifier4, function23, function32, windowInsets4, topAppBarColors, topAppBarScrollBehavior, composer, $changed | 1, i);
            }
        });
    }
    ...
    public static final void m1229BottomAppBarSnr_uVM(final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> actions, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, long containerColor, long contentColor, float tonalElevation, PaddingValues contentPadding, WindowInsets windowInsets, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(BottomAppBar)P(!1,5,4,1:c#ui.graphics.Color,2:c#ui.graphics.Color,6:c#ui.unit.Dp)398@20381L14,399@20423L31,402@20649L12,403@20667L634:AppBar.kt#uh7d8r");
        final int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        } else if (($changed & 14) == 0) {
            $dirty |= $composer2.changed(actions) ? 4 : 2;
        }
        int i5 = i & 2;
        if (i5 != 0) {
            $dirty |= 48;
        ...
        if (i6 != 0) {
            ...
            floatingActionButton = function2;
            $dirty |= $composer2.changed(floatingActionButton) ? 256 : 128;
        } else {
            floatingActionButton = function2;
        }
        if (($changed & 7168) == 0) {
        ...
        if (($dirty & 23967451) == 4793490 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    contentColor2 = ColorSchemeKt.m1338contentColorForek8zF_U(containerColor2, $composer2, ($dirty >> 9) & 14);
                    $dirty &= -57345;
                }
                if (i7 != 0) {
                    tonalElevation2 = BottomAppBarDefaults.INSTANCE.m1245getContainerElevationD9Ej5fM();
                }
            ...
            m1228BottomAppBar1oL4kX8(modifier2, containerColor2, contentColor2, tonalElevation2, contentPadding2, windowInsets2, ComposableLambdaKt.composableLambda($composer2, 1974005449, true, new Function3<RowScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(RowScope BottomAppBar, Composer $composer3, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer3, "C411@20890L9,413@20948L33,414@20990L303:AppBar.kt#uh7d8r");
                    int $dirty2 = $changed2;
                    if (($changed2 & 14) == 0) {
                    ...
                    if (($dirty2 & 91) != 18 || !$composer3.getSkipping()) {
                        ...
                        if (floatingActionButton != null) {
                            SpacerKt.Spacer(BottomAppBar.weight(Modifier.Companion, 1.0f, true), $composer3, 0);
                            ...
                            Modifier modifier$iv = PaddingKt.m418paddingqDBjuR0$default(fillMaxHeight$default, 0.0f, f, f2, 0.0f, 9, null);
                            ...
                            if (($changed$iv & 11) == 2 && $composer3.getSkipping()) {
                                ...
                                ComposerKt.sourceInformation($composer3, "C423@21261L22:AppBar.kt#uh7d8r");
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$BottomAppBar$2
            ...
            public final void invoke(Composer composer, int i9) {
                AppBarKt.m1229BottomAppBarSnr_uVM(actions, modifier4, function22, j, j2, f, paddingValues, windowInsets4, composer, $changed | 1, i);
            }
        });
    }
    ...
    */
    public static final void m1228BottomAppBar1oL4kX8(androidx.compose.ui.Modifier r27, long r28, long r30, float r32, androidx.compose.foundation.layout.PaddingValues r33, androidx.compose.foundation.layout.WindowInsets r34, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, androidx.compose.runtime.Composer r36, final int r37, final int r38) {
        /*
            Method dump skipped, instructions count: 540
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AppBarKt.m1228BottomAppBar1oL4kX8(androidx.compose.ui.Modifier, long, long, float, androidx.compose.foundation.layout.PaddingValues, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    public static final androidx.compose.material3.TopAppBarState rememberTopAppBarState(float r18, float r19, float r20, androidx.compose.runtime.Composer r21, int r22, int r23) {
        /*
            ...
            java.lang.String r1 = "C(rememberTopAppBarState)P(2,1)760@36816L145,760@36769L192:AppBar.kt#uh7d8r"
        ...
        L2c:
            ...
            if (r1 == 0) goto L38
            r1 = -1
            java.lang.String r2 = "androidx.compose.material3.rememberTopAppBarState (AppBar.kt:755)"
        ...
        L98:
            ...
            r2 = 0
            r4 = r21
            java.lang.Object r0 = androidx.compose.runtime.saveable.RememberSaveableKt.m2260rememberSaveable(r0, r1, r2, r3, r4, r5, r6)
    ...
    static {
        float arg0$iv = Dp.m5122constructorimpl(16);
        float other$iv = Dp.m5122constructorimpl(12);
        BottomAppBarHorizontalPadding = Dp.m5122constructorimpl(arg0$iv - other$iv);
        float arg0$iv2 = Dp.m5122constructorimpl(16);
        float other$iv2 = Dp.m5122constructorimpl(12);
        BottomAppBarVerticalPadding = Dp.m5122constructorimpl(arg0$iv2 - other$iv2);
        float arg0$iv3 = Dp.m5122constructorimpl(16);
        float other$iv3 = BottomAppBarHorizontalPadding;
        FABHorizontalPadding = Dp.m5122constructorimpl(arg0$iv3 - other$iv3);
        float arg0$iv4 = Dp.m5122constructorimpl(12);
        float other$iv4 = BottomAppBarVerticalPadding;
        FABVerticalPadding = Dp.m5122constructorimpl(arg0$iv4 - other$iv4);
        TopTitleAlphaEasing = new CubicBezierEasing(0.8f, 0.0f, 0.8f, 0.15f);
        MediumTitleBottomPadding = Dp.m5122constructorimpl(24);
        LargeTitleBottomPadding = Dp.m5122constructorimpl(28);
        TopAppBarHorizontalPadding = Dp.m5122constructorimpl(4);
        float arg0$iv5 = Dp.m5122constructorimpl(16);
        float other$iv5 = TopAppBarHorizontalPadding;
        TopAppBarTitleInset = Dp.m5122constructorimpl(arg0$iv5 - other$iv5);
    }
    ...
    */
    ...
    private static final long m1230SingleRowTopAppBar$lambda3(State<Color> state) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1232TwoRowsTopAppBartjU4iQQ(androidx.compose.ui.Modifier r45, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r46, final androidx.compose.ui.text.TextStyle r47, final float r48, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r49, final androidx.compose.ui.text.TextStyle r50, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r51, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r52, final androidx.compose.foundation.layout.WindowInsets r53, final androidx.compose.material3.TopAppBarColors r54, final float r55, final float r56, final androidx.compose.material3.TopAppBarScrollBehavior r57, androidx.compose.runtime.Composer r58, final int r59, final int r60, final int r61) {
        /*
            Method dump skipped, instructions count: 1126
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AppBarKt.m1232TwoRowsTopAppBartjU4iQQ(androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, androidx.compose.ui.text.TextStyle, float, kotlin.jvm.functions.Function2, androidx.compose.ui.text.TextStyle, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, androidx.compose.foundation.layout.WindowInsets, androidx.compose.material3.TopAppBarColors, float, float, androidx.compose.material3.TopAppBarScrollBehavior, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: TwoRowsTopAppBar_tjU4iQQ$lambda-8  reason: not valid java name */
    public static final long m1233TwoRowsTopAppBar_tjU4iQQ$lambda8(State<Color> state) {
        Object thisObj$iv = state.getValue();
        return ((Color) thisObj$iv).m2616unboximpl();
    }
    ...
    public static final void m1231TopAppBarLayoutkXwM9vE(final Modifier modifier, final float heightPx, final long navigationIconContentColor, final long titleContentColor, final long actionIconContentColor, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle titleTextStyle, final float titleAlpha, final Arrangement.Vertical titleVerticalArrangement, final Arrangement.Horizontal titleHorizontalArrangement, final int titleBottomPadding, final boolean hideTitleSemantics, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, Composer $composer, final int $changed, final int $changed1) {
        ...
        if (($changed & 896) == 0) {
            $dirty = $dirty2 | ($composer3.changed(navigationIconContentColor) ? 256 : 128);
        } else {
            $dirty = $dirty2;
        }
        if (($changed & 7168) == 0) {
            $dirty |= $composer3.changed(titleContentColor) ? 2048 : 1024;
        }
        if (($changed & 57344) == 0) {
            $dirty |= $composer3.changed(actionIconContentColor) ? 16384 : 8192;
        }
        if (($changed & 458752) == 0) {
            $dirty |= $composer3.changed(function2) ? 131072 : 65536;
        }
        if ((3670016 & $changed) == 0) {
            $dirty |= $composer3.changed(titleTextStyle) ? 1048576 : 524288;
        }
        if ((29360128 & $changed) == 0) {
            $dirty |= $composer3.changed(titleAlpha) ? 8388608 : 4194304;
        }
        if (($changed & 234881024) == 0) {
            $dirty |= $composer3.changed(titleVerticalArrangement) ? 67108864 : 33554432;
        }
        if (($changed & 1879048192) == 0) {
            $dirty |= $composer3.changed(titleHorizontalArrangement) ? 536870912 : 268435456;
        }
        ...
        if (($changed1 & 896) == 0) {
            $dirty1 |= $composer3.changed(function22) ? 256 : 128;
        }
        if (($changed1 & 7168) == 0) {
            $dirty1 |= $composer3.changed(function23) ? 2048 : 1024;
        }
        if ((1533916891 & $dirty3) != 306783378 || ($dirty1 & 5851) != 1170 || !$composer3.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-6794037, $dirty3, $dirty1, "androidx.compose.material3.TopAppBarLayout (AppBar.kt:1238)");
            }
                ...
                public final MeasureResult mo11measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, final long constraints) {
                    ...
                    for (Object element$iv : $this$first$iv) {
                        ...
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "navigationIcon")) {
                            ...
                            final Placeable navigationIconPlaceable = ((Measurable) element$iv).mo4125measureBRTryo0(m5068copyZbe2FdA);
                            ...
                            for (Object element$iv2 : $this$first$iv2) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "actionIcons")) {
                                    ...
                                    m5068copyZbe2FdA2 = Constraints.m5068copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(constraints) : 0, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(constraints) : 0);
                                    final Placeable actionIconsPlaceable = measurable.mo4125measureBRTryo0(m5068copyZbe2FdA2);
                                    if (Constraints.m5078getMaxWidthimpl(constraints) == Integer.MAX_VALUE) {
                                        maxTitleWidth = Constraints.m5078getMaxWidthimpl(constraints);
                                    } else {
                                        maxTitleWidth = RangesKt.coerceAtLeast((Constraints.m5078getMaxWidthimpl(constraints) - navigationIconPlaceable.getWidth()) - actionIconsPlaceable.getWidth(), 0);
                                    }
                                    ...
                                    for (Object element$iv3 : $this$first$iv3) {
                                        ...
                                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it3), "title")) {
                                            m5068copyZbe2FdA3 = Constraints.m5068copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(constraints) : maxTitleWidth, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(constraints) : 0);
                                            final Placeable titlePlaceable = ((Measurable) element$iv3).mo4125measureBRTryo0(m5068copyZbe2FdA3);
                                            ...
                                            return MeasureScope.layout$default(Layout, m5078getMaxWidthimpl, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AppBarKt$TopAppBarLayout$2$measure$1
                                                /* JADX INFO: Access modifiers changed from: package-private */
                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                {
                                                    super(1);
                                                ...
                                                public final void invoke2(Placeable.PlacementScope layout) {
                                                    ...
                                                    if (Intrinsics.areEqual(horizontal2, Arrangement.INSTANCE.getCenter())) {
                                                        max = (Constraints.m5078getMaxWidthimpl(constraints) - titlePlaceable.getWidth()) / 2;
                                                    } else if (Intrinsics.areEqual(horizontal2, Arrangement.INSTANCE.getEnd())) {
                                                        max = (Constraints.m5078getMaxWidthimpl(constraints) - titlePlaceable.getWidth()) - actionIconsPlaceable.getWidth();
                                                    } else {
                                                        MeasureScope measureScope = Layout;
                                                        f = AppBarKt.TopAppBarTitleInset;
                                                        max = Math.max(measureScope.mo295roundToPx0680j_4(f), Placeable.this.getWidth());
                                                    }
                                                    ...
                                                    Placeable.PlacementScope.placeRelative$default(layout, actionIconsPlaceable, Constraints.m5078getMaxWidthimpl(constraints) - actionIconsPlaceable.getWidth(), (layoutHeight - actionIconsPlaceable.getHeight()) / 2, 0.0f, 4, null);
                                                }
                                            }, 4, null);
                                        }
                                    }
            ...
            $composer3.startReplaceableGroup(2058660585);
            $composer3.startReplaceableGroup(1688650562);
            ComposerKt.sourceInformation($composer3, "C1256@56514L352,1266@56879L547,1279@57439L336:AppBar.kt#uh7d8r");
            if ((($changed$iv$iv >> 9) & 14 & 11) != 2 || !$composer3.getSkipping()) {
                ...
                Modifier modifier$iv = PaddingKt.m418paddingqDBjuR0$default(layoutId, f, 0.0f, 0.0f, 0.0f, 14, null);
                $composer3.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer3, "C(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                Alignment contentAlignment$iv = Alignment.Companion.getTopStart();
                ...
                if (($changed$iv2 & 11) == 2 && $composer3.getSkipping()) {
                    ...
                    BoxScopeInstance boxScopeInstance = BoxScopeInstance.INSTANCE;
                    $composer3.startReplaceableGroup(1034743112);
                    ComposerKt.sourceInformation($composer3, "C1261@56689L163:AppBar.kt#uh7d8r");
                    if (((((6 >> 6) & 112) | 6) & 81) != 16 || !$composer3.getSkipping()) {
                        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2596boximpl(navigationIconContentColor))}, function22, $composer3, (($dirty1 >> 3) & 112) | 8);
                    } else {
                        $composer3.skipToGroupEnd();
                    }
                    $composer3.endReplaceableGroup();
                ...
                $composer3.endReplaceableGroup();
                $composer3.endReplaceableGroup();
                Modifier m416paddingVpY3zN4$default = PaddingKt.m416paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.Companion, "title"), f, 0.0f, 2, null);
                ...
                Modifier modifier$iv2 = m416paddingVpY3zN4$default.then(companion);
                $composer3.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer3, "C(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                if (($changed$iv3 & 11) == 2 && $composer3.getSkipping()) {
                    ...
                    $composer3.startReplaceableGroup(-280006401);
                    ComposerKt.sourceInformation($composer3, "C1272@57149L263:AppBar.kt#uh7d8r");
                    if (((((0 >> 6) & 112) | 6) & 81) != 16 || !$composer3.getSkipping()) {
                        TextKt.ProvideTextStyle(titleTextStyle, ComposableLambdaKt.composableLambda($composer3, 824316656, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$TopAppBarLayout$1$3$1
                            ...
                            public final void invoke(Composer $composer4, int $changed2) {
                                ...
                                ComposerKt.sourceInformation($composer4, "C1273@57212L182:AppBar.kt#uh7d8r");
                                if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(824316656, $changed2, -1, "androidx.compose.material3.TopAppBarLayout.<anonymous>.<anonymous>.<anonymous> (AppBar.kt:1272)");
                                    }
                                    ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
                                    m2604copywmQWz5c = Color.m2604copywmQWz5c(r2, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r2) : titleAlpha, (r12 & 2) != 0 ? Color.m2612getRedimpl(r2) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r2) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(titleContentColor) : 0.0f);
                                    CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{localContentColor.provides(Color.m2596boximpl(m2604copywmQWz5c))}, function2, $composer4, (($dirty3 >> 12) & 112) | 8);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                ...
                $composer3.endReplaceableGroup();
                $composer3.endReplaceableGroup();
                Modifier modifier$iv3 = PaddingKt.m418paddingqDBjuR0$default(LayoutIdKt.layoutId(Modifier.Companion, "actionIcons"), 0.0f, 0.0f, f, 0.0f, 11, null);
                $composer3.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation($composer3, "C(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                if (($changed$iv4 & 11) == 2 && $composer3.getSkipping()) {
                    ...
                    $composer3.startReplaceableGroup(1192272192);
                    ComposerKt.sourceInformation($composer3, "C1284@57609L152:AppBar.kt#uh7d8r");
                    if (((((6 >> 6) & 112) | 6) & 81) != 16 || !$composer3.getSkipping()) {
                        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2596boximpl(actionIconContentColor))}, function23, $composer3, (($dirty1 >> 6) & 112) | 8);
                    } else {
                        $composer3.skipToGroupEnd();
                    }
                    $composer3.endReplaceableGroup();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AppBarKt$TopAppBarLayout$3
            ...
            public final void invoke(Composer composer, int i) {
                AppBarKt.m1231TopAppBarLayoutkXwM9vE(Modifier.this, heightPx, navigationIconContentColor, titleContentColor, actionIconContentColor, function2, titleTextStyle, titleAlpha, titleVerticalArrangement, titleHorizontalArrangement, titleBottomPadding, hideTitleSemantics, function22, function23, composer, $changed | 1, $changed1);
            }
        });
    }
