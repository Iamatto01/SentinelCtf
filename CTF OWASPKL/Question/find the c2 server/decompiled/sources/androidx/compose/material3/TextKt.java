    ...
    public static final void m1640TextfLXpl1I(final String text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        if (($dirty & 1533916891) == 306783378 && (374491 & $dirty12) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                lineHeight2 = i13 != 0 ? TextUnit.Companion.m5314getUnspecifiedXSAIIZE() : lineHeight;
            ...
            if ($this$takeOrElse_u2dDxMtmZc$iv != Color.Companion.m2642getUnspecified0d7_KjU()) {
                ...
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != Color.Companion.m2642getUnspecified0d7_KjU()) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    $this$takeOrElse_u2dDxMtmZc$iv2 = ((Color) consume2).m2616unboximpl();
                }
            ...
            BasicTextKt.m694BasicTextBpD7jsM(text, modifier2, mergedStyle, onTextLayout, overflow2, softWrap2, maxLines2, $composer2, ($dirty & 14) | ($dirty & 112) | (($dirty1 >> 3) & 7168) | (($dirty1 << 9) & 57344) | (($dirty1 << 9) & 458752) | (3670016 & ($dirty1 << 9)), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$2
            ...
            public final void invoke(Composer composer, int i21) {
                TextKt.m1640TextfLXpl1I(text, modifier7, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration7, textAlign4, j4, i19, z, i20, function12, textStyle, composer, $changed | 1, $changed1, i);
            }
        });
    }

    /* renamed from: Text--4IGK_g  reason: not valid java name */
    public static final void m1639Text4IGK_g(final AnnotatedString text, Modifier modifier, long color, long fontSize, FontStyle fontStyle, FontWeight fontWeight, FontFamily fontFamily, long letterSpacing, TextDecoration textDecoration, TextAlign textAlign, long lineHeight, int overflow, boolean softWrap, int maxLines, Map<String, InlineTextContent> map, Function1<? super TextLayoutResult, Unit> function1, TextStyle style, Composer $composer, final int $changed, final int $changed1, final int i) {
        int i2;
        long color2;
        long fontSize2;
        FontStyle fontStyle2;
        ...
        if (i17 == 16384 && (1533916891 & $dirty2) == 306783378 && (2995931 & $dirty12) == 599186 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                TextDecoration textDecoration4 = i11 != 0 ? null : textDecoration;
                textAlign2 = i12 != 0 ? null : textAlign;
                long lineHeight4 = i13 != 0 ? TextUnit.Companion.m5314getUnspecifiedXSAIIZE() : lineHeight;
                int overflow4 = i14 != 0 ? TextOverflow.Companion.m5041getClipgIe3tQ8() : overflow;
            ...
            $dirty = $dirty2;
            BasicTextKt.m692BasicText4YKlhWE(text, modifier2, mergedStyle, onTextLayout, overflow2, softWrap2, maxLines3, inlineContent3, $composer2, (($dirty1 >> 6) & 7168) | ($dirty2 & 14) | 16777216 | ($dirty2 & 112) | (($dirty1 << 9) & 57344) | (($dirty1 << 9) & 458752) | (($dirty1 << 9) & 3670016), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextKt$Text$4
            ...
            public final void invoke(Composer composer, int i22) {
                TextKt.m1639Text4IGK_g(AnnotatedString.this, modifier6, j, j2, fontStyle4, fontWeight4, fontFamily4, j3, textDecoration6, textAlign4, j4, i20, z, i21, map2, function12, textStyle, composer, $changed | 1, $changed1, i);
            }
        });
    }
