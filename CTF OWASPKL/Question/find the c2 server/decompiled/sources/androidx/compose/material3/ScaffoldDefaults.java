...
public final class ScaffoldDefaults {
    ...
    public final WindowInsets getContentWindowInsets(Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C282@12529L29:Scaffold.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(757124140, $changed, -1, "androidx.compose.material3.ScaffoldDefaults.<get-contentWindowInsets> (Scaffold.kt:282)");
        }
