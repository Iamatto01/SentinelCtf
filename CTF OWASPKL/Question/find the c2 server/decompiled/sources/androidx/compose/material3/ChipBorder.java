...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1899621712, $changed, -1, "androidx.compose.material3.ChipBorder.borderStroke (Chip.kt:2055)");
        }
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m170BorderStrokecXLIe8U(this.borderWidth, enabled ? this.borderColor : this.disabledBorderColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipBorder) && Color.m2607equalsimpl0(this.borderColor, ((ChipBorder) other).borderColor) && Color.m2607equalsimpl0(this.disabledBorderColor, ((ChipBorder) other).disabledBorderColor) && Dp.m5127equalsimpl0(this.borderWidth, ((ChipBorder) other).borderWidth)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((result * 31) + Color.m2613hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m5128hashCodeimpl(this.borderWidth);
    }
}
