...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m1713smallTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
        ...
        long scrolledContainerColor2 = (i & 2) != 0 ? ColorSchemeKt.m1336applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme($composer, 6), containerColor2, TopAppBarSmallTokens.INSTANCE.m2174getOnScrollContainerElevationD9Ej5fM()) : scrolledContainerColor;
    ...
    public final WindowInsets getWindowInsets(Composer $composer, int $changed) {
        ...
        WindowInsets m474onlybOOhFvg = WindowInsetsKt.m474onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, $composer, 8), WindowInsetsSides.m485plusgK_yJZ4(WindowInsetsSides.Companion.m495getHorizontalJoeWqyM(), WindowInsetsSides.Companion.m499getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public final TopAppBarColors m1710centerAlignedTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
    ...
    public final TopAppBarColors m1712mediumTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
    ...
    public final TopAppBarColors m1711largeTopAppBarColorszjMxDiM(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor, Composer $composer, int $changed, int i) {
