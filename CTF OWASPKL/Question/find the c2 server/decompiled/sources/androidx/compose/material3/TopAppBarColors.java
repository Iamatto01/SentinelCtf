...
public final class TopAppBarColors {
    ...
    public final long m1708getNavigationIconContentColor0d7_KjU$material3_release() {
    ...
    public final long m1709getTitleContentColor0d7_KjU$material3_release() {
        return this.titleContentColor;
    }

    /* renamed from: getActionIconContentColor-0d7_KjU$material3_release  reason: not valid java name */
    public final long m1707getActionIconContentColor0d7_KjU$material3_release() {
        return this.actionIconContentColor;
    }

    /* renamed from: containerColor-XeAY9LY$material3_release  reason: not valid java name */
    public final long m1706containerColorXeAY9LY$material3_release(float colorTransitionFraction, Composer $composer, int $changed) {
        ...
        long m2657lerpjxsXWHM = ColorKt.m2657lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m2657lerpjxsXWHM;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof TopAppBarColors) && Color.m2607equalsimpl0(this.containerColor, ((TopAppBarColors) other).containerColor) && Color.m2607equalsimpl0(this.scrolledContainerColor, ((TopAppBarColors) other).scrolledContainerColor) && Color.m2607equalsimpl0(this.navigationIconContentColor, ((TopAppBarColors) other).navigationIconContentColor) && Color.m2607equalsimpl0(this.titleContentColor, ((TopAppBarColors) other).titleContentColor) && Color.m2607equalsimpl0(this.actionIconContentColor, ((TopAppBarColors) other).actionIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m2613hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2613hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2613hashCodeimpl(this.titleContentColor)) * 31) + Color.m2613hashCodeimpl(this.actionIconContentColor);
    }
}
