...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m5122constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m5122constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m5122constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m1833getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m1832getLevel0D9Ej5fM();
    ...
    public final float m1983getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1984getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1985getContainerWidthD9Ej5fM() {
    ...
    public final float m1986getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m1987getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1988getStandardContainerElevationD9Ej5fM() {
