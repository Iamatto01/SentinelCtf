...
public final class SelectableChipElevation {
    ...
    private SelectableChipElevation(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation, float draggedElevation, float disabledElevation) {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(664514136, $changed, -1, "androidx.compose.material3.SelectableChipElevation.animateElevation (Chip.kt:1658)");
        }
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv3 = (Function2) new SelectableChipElevation$animateElevation$1$1(interactionSource, interactions, null);
        ...
        if (enabled) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5120boximpl(target), new SelectableChipElevation$animateElevation$3(animatable, this, target, interaction, null), $composer, 64);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(-699481518);
            ComposerKt.sourceInformation($composer, "1718@81551L52");
            EffectsKt.LaunchedEffect(Dp.m5120boximpl(target), new SelectableChipElevation$animateElevation$2(animatable, target, null), $composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipElevation) && Dp.m5127equalsimpl0(this.defaultElevation, ((SelectableChipElevation) other).defaultElevation) && Dp.m5127equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) && Dp.m5127equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) && Dp.m5127equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) && Dp.m5127equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
