...
public final class CheckboxKt {
    ...
    public static final void Checkbox(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Checkbox)P(!1,5,4,2)92@4151L8,93@4211L39,98@4380L29,95@4259L304:Checkbox.kt#uh7d8r");
        int $dirty = $changed;
        if ((i & 1) != 0) {
            $dirty |= 6;
        ...
        if ((374491 & $dirty) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    $dirty &= -57345;
                    colors2 = CheckboxDefaults.INSTANCE.m1264colors5tl4gsc(0L, 0L, 0L, 0L, 0L, 0L, $composer2, 1572864, 63);
                }
                if (i5 != 0) {
            ...
            TriStateCheckbox(ToggleableState, function0, modifier2, enabled2, colors2, interactionSource3, $composer2, ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | ($dirty & 458752), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.CheckboxKt$Checkbox$3
            ...
            public final void invoke(Composer composer, int i7) {
                CheckboxKt.Checkbox(checked, function1, modifier4, z2, checkboxColors, mutableInteractionSource, composer, $changed | 1, i);
            }
        });
    }
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(TriStateCheckbox)P(5,4,3,1)140@6419L8,141@6479L39,159@7047L403:Checkbox.kt#uh7d8r");
        int $dirty3 = $changed;
        if ((i & 1) != 0) {
            $dirty3 |= 6;
        } else if (($changed & 14) == 0) {
        ...
        if (i3 != 0) {
            ...
            obj = modifier;
            $dirty3 |= $composer2.changed(obj) ? 256 : 128;
        } else {
            obj = modifier;
        }
        int i4 = i & 8;
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            $composer2.endDefaults();
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1608358065, $dirty, -1, "androidx.compose.material3.TriStateCheckbox (Checkbox.kt:135)");
            }
            $composer2.startReplaceableGroup(1797978036);
            ComposerKt.sourceInformation($composer2, "151@6847L133");
            if (function0 != null) {
                Modifier.Companion companion2 = Modifier.Companion;
                int m4482getCheckboxo7Vup1c = Role.Companion.m4482getCheckboxo7Vup1c();
                float arg0$iv = CheckboxTokens.INSTANCE.m1746getStateLayerSizeD9Ej5fM();
                $dirty2 = $dirty;
                companion = ToggleableKt.m667triStateToggleableO2vRcR0(companion2, state, interactionSource2, RippleKt.m1217rememberRipple9IZ8Weo(false, Dp.m5122constructorimpl(arg0$iv / 2), 0L, $composer2, 54, 4), enabled2, Role.m4474boximpl(m4482getCheckboxo7Vup1c), function0);
            } else {
                $dirty2 = $dirty;
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m414padding3ABfNKs(modifier2.then(function0 != null ? TouchTargetKt.minimumTouchTargetSize(Modifier.Companion) : Modifier.Companion).then(toggleableModifier), CheckboxDefaultPadding), colors3, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 3) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.CheckboxKt$TriStateCheckbox$2
            ...
            public final void invoke(Composer composer, int i6) {
                CheckboxKt.TriStateCheckbox(ToggleableState.this, function0, modifier4, z2, checkboxColors, mutableInteractionSource, composer, $changed | 1, i);
            }
        });
    }
    ...
    public static final void CheckboxImpl(final boolean enabled, final ToggleableState value, final Modifier modifier, final CheckboxColors colors, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(CheckboxImpl)P(1,3,2)233@10125L23,234@10188L443,250@10690L458,265@11170L32,266@11231L21,267@11279L24,268@11333L27,273@11483L538,269@11365L656:Checkbox.kt#uh7d8r");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty2 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2007131616, $dirty2, -1, "androidx.compose.material3.CheckboxImpl (Checkbox.kt:227)");
            }
            ...
            Function3 transitionSpec$iv = new Function3<Transition.Segment<ToggleableState>, Composer, Integer, FiniteAnimationSpec<Float>>() { // from class: androidx.compose.material3.CheckboxKt$CheckboxImpl$checkDrawFraction$1
                ...
                public final FiniteAnimationSpec<Float> invoke(Transition.Segment<ToggleableState> animateFloat, Composer $composer3, int $changed2) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(1373301606, $changed2, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:235)");
                    }
            ...
            if (ComposerKt.isTraceInProgress()) {
                str = "C(animateFloat)P(2)925@36712L78:Transition.kt#pdpnli";
                ComposerKt.traceEventStart(1800065638, $changed2, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:242)");
            } else {
                str = "C(animateFloat)P(2)925@36712L78:Transition.kt#pdpnli";
            }
            float f4 = 0.0f;
            ...
            ComposerKt.sourceInformation($composer2, "C:Checkbox.kt#uh7d8r");
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1800065638, $changed3, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:242)");
            }
            ...
            Function3 transitionSpec$iv2 = new Function3<Transition.Segment<ToggleableState>, Composer, Integer, FiniteAnimationSpec<Float>>() { // from class: androidx.compose.material3.CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$1
                ...
                public final FiniteAnimationSpec<Float> invoke(Transition.Segment<ToggleableState> animateFloat, Composer $composer3, int $changed4) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1324481169, $changed4, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:251)");
                    }
                    if (animateFloat.getInitialState() == ToggleableState.Off) {
            ...
            ComposerKt.sourceInformation($composer2, "C:Checkbox.kt#uh7d8r");
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1426969489, $changed4, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:258)");
            }
            ...
            ComposerKt.sourceInformation($composer2, "C:Checkbox.kt#uh7d8r");
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1426969489, $changed5, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:258)");
            }
            ...
            if (invalid$iv || value$iv$iv2 == Composer.Companion.getEmpty()) {
                value$iv$iv2 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.CheckboxKt$CheckboxImpl$1$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        ...
                        float strokeWidthPx = (float) Math.floor(Canvas.mo301toPx0680j_4(f5));
                        long m2616unboximpl = boxColor.getValue().m2616unboximpl();
                        long m2616unboximpl2 = borderColor.getValue().m2616unboximpl();
                        f6 = CheckboxKt.RadiusSize;
                        CheckboxKt.m1267drawBox1wkBAMs(Canvas, m2616unboximpl, m2616unboximpl2, Canvas.mo301toPx0680j_4(f6), strokeWidthPx);
                        CheckboxKt.m1268drawCheck3IgeMak(Canvas, checkColor.getValue().m2616unboximpl(), checkDrawFraction.getValue().floatValue(), checkCenterGravitationShiftFraction.getValue().floatValue(), strokeWidthPx, checkCache);
                    }
                };
                $composer2.updateRememberedValue(value$iv$iv2);
            }
            $composer2.endReplaceableGroup();
            CanvasKt.Canvas(m449requiredSize3ABfNKs, (Function1) value$iv$iv2, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.CheckboxKt$CheckboxImpl$2
            ...
            public final void invoke(Composer composer, int i) {
                CheckboxKt.CheckboxImpl(enabled, value, modifier, colors, composer, $changed | 1);
            }
        });
    }
    ...
    public static final void m1267drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
        ...
        float checkboxSize = Size.m2437getWidthimpl($this$drawBox_u2d1wkBAMs.mo3146getSizeNHjbRc());
        if (Color.m2607equalsimpl0(boxColor, borderColor)) {
            DrawScope.m3143drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, 0L, androidx.compose.ui.geometry.SizeKt.Size(checkboxSize, checkboxSize), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f = 2;
        DrawScope.m3143drawRoundRectuAw5IA$default($this$drawBox_u2d1wkBAMs, boxColor, OffsetKt.Offset(strokeWidth, strokeWidth), androidx.compose.ui.geometry.SizeKt.Size(checkboxSize - (strokeWidth * f), checkboxSize - (f * strokeWidth)), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, radius - strokeWidth), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
    ...
    public static final void m1268drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
        Stroke stroke = new Stroke(strokeWidthPx, 0.0f, StrokeCap.Companion.m2951getSquareKaPHkGw(), 0, null, 26, null);
        float width = Size.m2437getWidthimpl($this$drawCheck_u2d3IgeMak.mo3146getSizeNHjbRc());
        ...
        DrawScope.m3137drawPathLG529CI$default($this$drawCheck_u2d3IgeMak, drawingCache.getPathToDraw(), checkColor, 0.0f, stroke, null, 0, 52, null);
    }
}
