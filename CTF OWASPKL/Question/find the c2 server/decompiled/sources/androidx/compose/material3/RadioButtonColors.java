...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            ComposerKt.sourceInformation($composer, "193@8110L75");
            rememberUpdatedState = SingleValueAnimationKt.m67animateColorAsStateKTwxG1Y(target, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, $composer, 48, 4);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(-1943770035);
            ComposerKt.sourceInformation($composer, "195@8215L28");
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof RadioButtonColors) && Color.m2607equalsimpl0(this.selectedColor, ((RadioButtonColors) other).selectedColor) && Color.m2607equalsimpl0(this.unselectedColor, ((RadioButtonColors) other).unselectedColor) && Color.m2607equalsimpl0(this.disabledSelectedColor, ((RadioButtonColors) other).disabledSelectedColor) && Color.m2607equalsimpl0(this.disabledUnselectedColor, ((RadioButtonColors) other).disabledUnselectedColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2613hashCodeimpl(this.selectedColor);
        return (((((result * 31) + Color.m2613hashCodeimpl(this.unselectedColor)) * 31) + Color.m2613hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m2613hashCodeimpl(this.disabledUnselectedColor);
    }
}
