...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5122constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5122constructorimpl((float) 24.0d);
    ...
    public final float m2017getContainerSizeD9Ej5fM() {
    ...
    public final float m2018getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2019getUnselectedOutlineWidthD9Ej5fM() {
