...
public final class TopAppBarState {
    ...
    public final float getHeightOffsetLimit() {
        State $this$getValue$iv = this.heightOffsetLimit$delegate;
        return ((Number) $this$getValue$iv.getValue()).floatValue();
    }

    public final void setHeightOffsetLimit(float f) {
        MutableState $this$setValue$iv = this.heightOffsetLimit$delegate;
    ...
    public final float getContentOffset() {
        State $this$getValue$iv = this.contentOffset$delegate;
        return ((Number) $this$getValue$iv.getValue()).floatValue();
    }

    public final void setContentOffset(float f) {
        MutableState $this$setValue$iv = this.contentOffset$delegate;
        $this$setValue$iv.setValue(Float.valueOf(f));
    }
