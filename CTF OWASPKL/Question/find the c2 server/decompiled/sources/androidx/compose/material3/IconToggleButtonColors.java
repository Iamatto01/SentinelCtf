...
public final class IconToggleButtonColors {
    ...
    public final State<Color> containerColor$material3_release(boolean enabled, boolean checked, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(containerColor)P(1)892@42282L28:IconButton.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1175394478, $changed, -1, "androidx.compose.material3.IconToggleButtonColors.containerColor (IconButton.kt:886)");
        }
        if (enabled) {
    ...
    public final State<Color> contentColor$material3_release(boolean enabled, boolean checked, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(contentColor)P(1)908@42824L28:IconButton.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1340854054, $changed, -1, "androidx.compose.material3.IconToggleButtonColors.contentColor (IconButton.kt:902)");
        }
        if (enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof IconToggleButtonColors) && Color.m2607equalsimpl0(this.containerColor, ((IconToggleButtonColors) other).containerColor) && Color.m2607equalsimpl0(this.contentColor, ((IconToggleButtonColors) other).contentColor) && Color.m2607equalsimpl0(this.disabledContainerColor, ((IconToggleButtonColors) other).disabledContainerColor) && Color.m2607equalsimpl0(this.disabledContentColor, ((IconToggleButtonColors) other).disabledContentColor) && Color.m2607equalsimpl0(this.checkedContainerColor, ((IconToggleButtonColors) other).checkedContainerColor) && Color.m2607equalsimpl0(this.checkedContentColor, ((IconToggleButtonColors) other).checkedContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m2613hashCodeimpl(this.contentColor)) * 31) + Color.m2613hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2613hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2613hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m2613hashCodeimpl(this.checkedContentColor);
    }
}
