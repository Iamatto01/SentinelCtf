...
public final class NavigationRailKt {
    ...
    private static final float NavigationRailVerticalPadding = Dp.m5122constructorimpl(4);
    private static final float NavigationRailHeaderPadding = Dp.m5122constructorimpl(8);
    private static final float NavigationRailItemWidth = NavigationRailTokens.INSTANCE.m1992getContainerWidthD9Ej5fM();
    private static final float NavigationRailItemHeight = NavigationRailTokens.INSTANCE.m1995getNoLabelActiveIndicatorHeightD9Ej5fM();
    private static final float NavigationRailItemVerticalPadding = Dp.m5122constructorimpl(4);
    ...
    */
    public static final void m1491NavigationRailqi6gXK8(androidx.compose.ui.Modifier r26, long r27, long r29, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, androidx.compose.foundation.layout.WindowInsets r32, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, androidx.compose.runtime.Composer r34, final int r35, final int r36) {
        /*
            Method dump skipped, instructions count: 449
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.NavigationRailKt.m1491NavigationRailqi6gXK8(androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    public static final float m1492NavigationRailItem$lambda5$lambda2(State<Float> state) {
    ...
    public static final void NavigationRailItemBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean alwaysShowLabel, final float animationProgress, Composer $composer, final int $changed) {
        ...
        if (($changed & 7168) == 0) {
            $dirty |= $composer3.changed(function24) ? 2048 : 1024;
        }
        if ((57344 & $changed) == 0) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItemBaselineLayout$2
                ...
                public final MeasureResult mo11measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list, long constraints) {
                    ...
                    MeasureResult m1497placeLabelAndIconzUg2_y0;
                    MeasureResult m1496placeIconX9ElhV4;
                    ...
                    for (Object element$iv2 : measurables) {
                        ...
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it), "icon")) {
                            Placeable iconPlaceable = ((Measurable) element$iv2).mo4125measureBRTryo0(constraints);
                            int width = iconPlaceable.getWidth();
                            arg0$iv = NavigationRailKt.IndicatorHorizontalPadding;
                            int totalIndicatorWidth2 = width + Layout.mo295roundToPx0680j_4(Dp.m5122constructorimpl(2 * arg0$iv));
                            ...
                            int other$iv = Layout.mo295roundToPx0680j_4(Dp.m5122constructorimpl(2 * indicatorVerticalPadding));
                            ...
                            for (Object element$iv3 : $this$first$iv) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it2), "indicatorRipple")) {
                                    Placeable indicatorRipplePlaceable = ((Measurable) element$iv3).mo4125measureBRTryo0(Constraints.Companion.m5086fixedJhjzzOo(totalIndicatorWidth2, indicatorHeight));
                                    ...
                                    Placeable indicatorPlaceable = measurable != null ? measurable.mo4125measureBRTryo0(Constraints.Companion.m5086fixedJhjzzOo(animatedIndicatorWidth, indicatorHeight)) : null;
                                    ...
                                    if (it5 != null) {
                                        ...
                                        for (Object element$iv4 : $this$first$iv3) {
                                            ...
                                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it6), "label")) {
                                                ...
                                                labelPlaceable = ((Measurable) element$iv4).mo4125measureBRTryo0(m5068copyZbe2FdA);
                                            } else {
                                                it5 = it7;
                                    ...
                                    labelPlaceable = null;
                                    if (function24 == null) {
                                        m1496placeIconX9ElhV4 = NavigationRailKt.m1496placeIconX9ElhV4($this$Layout, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints);
                                        return m1496placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(labelPlaceable);
                                    m1497placeLabelAndIconzUg2_y0 = NavigationRailKt.m1497placeLabelAndIconzUg2_y0($this$Layout, labelPlaceable, iconPlaceable, indicatorRipplePlaceable, indicatorPlaceable, constraints, alwaysShowLabel, animationProgress);
                                    return m1497placeLabelAndIconzUg2_y0;
                                }
                                measurables = list;
            ...
            $composer3.startReplaceableGroup(2083574754);
            ComposerKt.sourceInformation($composer3, "C390@16520L17,395@16618L50,398@16711L178:NavigationRail.kt#uh7d8r");
            if ((($changed$iv$iv >> 9) & 14 & 11) != 2 || !$composer3.getSkipping()) {
                function2.invoke($composer3, Integer.valueOf($dirty2 & 14));
                $composer3.startReplaceableGroup(935754904);
                ComposerKt.sourceInformation($composer3, "392@16587L11");
                ...
                if (($changed$iv & 11) == 2 && $composer3.getSkipping()) {
                    ...
                    $composer3.startReplaceableGroup(-1582262808);
                    ComposerKt.sourceInformation($composer3, "C395@16660L6:NavigationRail.kt#uh7d8r");
                ...
                $composer3.endReplaceableGroup();
                if (function24 != null) {
                    Modifier modifier$iv3 = AlphaKt.alpha(LayoutIdKt.layoutId(Modifier.Companion, LabelLayoutIdTag), alwaysShowLabel ? 1.0f : animationProgress);
                    $composer3.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation($composer3, "C(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    if (($changed$iv2 & 11) == 2 && $composer3.getSkipping()) {
                        ...
                        $composer3.startReplaceableGroup(6101178);
                        ComposerKt.sourceInformation($composer3, "C402@16880L7:NavigationRail.kt#uh7d8r");
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItemBaselineLayout$3
            ...
            public final void invoke(Composer composer, int i) {
                NavigationRailKt.NavigationRailItemBaselineLayout(function2, function22, function23, function24, alwaysShowLabel, animationProgress, composer, $changed | 1);
            }
        });
    }
    ...
    public static final MeasureResult m1496placeIconX9ElhV4(MeasureScope $this$placeIcon_u2dX9ElhV4, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints) {
        final int width = ConstraintsKt.m5092constrainWidthK40F9xA(constraints, Math.max(iconPlaceable.getWidth(), Math.max(indicatorRipplePlaceable.getWidth(), indicatorPlaceable != null ? indicatorPlaceable.getWidth() : 0)));
        final int height = Constraints.m5077getMaxHeightimpl(constraints);
    ...
    public static final MeasureResult m1497placeLabelAndIconzUg2_y0(final MeasureScope $this$placeLabelAndIcon_u2dzUg2_y0, final Placeable labelPlaceable, final Placeable iconPlaceable, final Placeable indicatorRipplePlaceable, final Placeable indicatorPlaceable, long constraints, final boolean alwaysShowLabel, final float animationProgress) {
        int height = Constraints.m5077getMaxHeightimpl(constraints);
        float f = NavigationRailItemVerticalPadding;
        final int labelY = (height - labelPlaceable.getHeight()) - $this$placeLabelAndIcon_u2dzUg2_y0.mo295roundToPx0680j_4(f);
        final int selectedIconY = $this$placeLabelAndIcon_u2dzUg2_y0.mo295roundToPx0680j_4(f);
        ...
        final int width = ConstraintsKt.m5092constrainWidthK40F9xA(constraints, Math.max(iconPlaceable.getWidth(), Math.max(labelPlaceable.getWidth(), indicatorPlaceable != null ? indicatorPlaceable.getWidth() : 0)));
        final int labelX = (width - labelPlaceable.getWidth()) / 2;
        final int iconX = (width - iconPlaceable.getWidth()) / 2;
        final int rippleX = (width - indicatorRipplePlaceable.getWidth()) / 2;
        final int rippleY = selectedIconY - $this$placeLabelAndIcon_u2dzUg2_y0.mo295roundToPx0680j_4(IndicatorVerticalPaddingWithLabel);
            ...
            */
            public final void invoke2(androidx.compose.ui.layout.Placeable.PlacementScope r11) {
                /*
                    ...
                    int r3 = r3.mo295roundToPx0680j_4(r5)
                    int r9 = r1 - r3
                    int r4 = r4 + r9
                    r5 = 0
                    r6 = 4
    ...
    static {
        float arg0$iv = NavigationRailTokens.INSTANCE.m1990getActiveIndicatorWidthD9Ej5fM();
        float other$iv = NavigationRailTokens.INSTANCE.m1993getIconSizeD9Ej5fM();
        IndicatorHorizontalPadding = Dp.m5122constructorimpl(Dp.m5122constructorimpl(arg0$iv - other$iv) / 2);
        float arg0$iv2 = NavigationRailTokens.INSTANCE.m1989getActiveIndicatorHeightD9Ej5fM();
        float other$iv2 = NavigationRailTokens.INSTANCE.m1993getIconSizeD9Ej5fM();
        IndicatorVerticalPaddingWithLabel = Dp.m5122constructorimpl(Dp.m5122constructorimpl(arg0$iv2 - other$iv2) / 2);
        float arg0$iv3 = NavigationRailTokens.INSTANCE.m1995getNoLabelActiveIndicatorHeightD9Ej5fM();
        float other$iv3 = NavigationRailTokens.INSTANCE.m1993getIconSizeD9Ej5fM();
        IndicatorVerticalPaddingNoLabel = Dp.m5122constructorimpl(Dp.m5122constructorimpl(arg0$iv3 - other$iv3) / 2);
    }
