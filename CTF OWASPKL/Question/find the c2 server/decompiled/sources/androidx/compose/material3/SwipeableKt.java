...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableState(final T initialValue, final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        if ((i & 4) != 0) {
            Function1 confirmStateChange = new Function1<T, Boolean>() { // from class: androidx.compose.material3.SwipeableKt$rememberSwipeableState$1
                ...
                public /* bridge */ /* synthetic */ Boolean invoke(Object p1) {
                    return invoke((SwipeableKt$rememberSwipeableState$1<T>) p1);
                }
            };
        ...
        SwipeableState<T> swipeableState = (SwipeableState) RememberSaveableKt.m2260rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) SwipeableState.Companion.Saver(animationSpec, function1), (String) null, (Function0<? extends Object>) new Function0<SwipeableState<T>>() { // from class: androidx.compose.material3.SwipeableKt$rememberSwipeableState$2
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(final T value, final Function1<? super T, Unit> onValueChange, AnimationSpec<Float> animationSpec, Composer $composer, int $changed, int i) {
        ...
        SpringSpec<Float> animationSpec$material3_release = (i & 4) != 0 ? SwipeableDefaults.INSTANCE.getAnimationSpec$material3_release() : animationSpec;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = new SwipeableState(value, animationSpec$material3_release, new Function1<T, Boolean>() { // from class: androidx.compose.material3.SwipeableKt$rememberSwipeableStateFor$swipeableState$1$1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(T it) {
                    Intrinsics.checkNotNullParameter(it, "it");
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Boolean invoke(Object p1) {
                    return invoke((SwipeableKt$rememberSwipeableStateFor$swipeableState$1$1<T>) p1);
                }
            });
        ...
        EffectsKt.DisposableEffect(swipeableState.getCurrentValue(), new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.material3.SwipeableKt$rememberSwipeableStateFor$2
            ...
            public final DisposableEffectResult invoke2(DisposableEffectScope DisposableEffect) {
                ...
                if (!Intrinsics.areEqual(value, swipeableState.getCurrentValue())) {
                    ...
                    MutableState<Boolean> mutableState = forceAnimationCheck;
    ...
    public static final <T> Modifier m1575swipeablepPrIpRY(Modifier swipeable, final SwipeableState<T> state, final Map<Float, ? extends T> anchors, final Orientation orientation, final boolean enabled, final boolean reverseDirection, final MutableInteractionSource interactionSource, final Function2<? super T, ? super T, ? extends ThresholdConfig> thresholds, final ResistanceConfig resistance, final float velocityThreshold) {
        ...
        return ComposedModifierKt.composed(swipeable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material3.SwipeableKt$swipeable-pPrIpRY$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("velocityThreshold", Dp.m5120boximpl(velocityThreshold));
            }
                        ...
                        case 0:
                            ...
                            swipeableState.setThresholds$material3_release(new Function2<Float, Float, Float>() { // from class: androidx.compose.material3.SwipeableKt.swipeable.3.3.1
                                ...
                                public final Float invoke(float a, float b) {
                                    ...
                                    ThresholdConfig $this$invoke_u24lambda_u2d0 = function2.invoke(from, to);
                                    return Float.valueOf($this$invoke_u24lambda_u2d0.computeThreshold(density, a, b));
                                }
                            });
                            Density $this$invokeSuspend_u24lambda_u2d0 = this.$density;
                            this.$state.setVelocityThreshold$material3_release($this$invokeSuspend_u24lambda_u2d0.mo301toPx0680j_4(this.$velocityThreshold));
                            this.label = 1;
    ...
    public static final List<Float> findBounds(float offset, Set<Float> $this$filter$iv) {
        ...
        Float a = CollectionsKt.maxOrNull((Iterable<? extends Float>) ((List) destination$iv$iv));
        ...
        Float b = CollectionsKt.minOrNull((Iterable<? extends Float>) ((List) destination$iv$iv2));
        if (a == null) {
