...
public final class ButtonElevation {
    ...
    public final State<Dp> tonalElevation$material3_release(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-423890235, $changed, -1, "androidx.compose.material3.ButtonElevation.tonalElevation (Button.kt:779)");
        }
    ...
    public final State<Dp> shadowElevation$material3_release(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2045116089, $changed, -1, "androidx.compose.material3.ButtonElevation.shadowElevation (Button.kt:795)");
        }
        State<Dp> animateElevation = animateElevation(enabled, interactionSource, $composer, ($changed & 14) | ($changed & 112) | ($changed & 896));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1312510462, $changed, -1, "androidx.compose.material3.ButtonElevation.animateElevation (Button.kt:803)");
        }
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv3 = (Function2) new ButtonElevation$animateElevation$1$1(interactionSource, interactions, null);
        ...
        if (enabled) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5120boximpl(target), new ButtonElevation$animateElevation$3(animatable, this, target, interaction, null), $composer, 64);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(-719929912);
            ComposerKt.sourceInformation($composer, "854@41077L52");
            EffectsKt.LaunchedEffect(Dp.m5120boximpl(target), new ButtonElevation$animateElevation$2(animatable, target, null), $composer, 64);
            $composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ButtonElevation) && Dp.m5127equalsimpl0(this.defaultElevation, ((ButtonElevation) other).defaultElevation) && Dp.m5127equalsimpl0(this.pressedElevation, ((ButtonElevation) other).pressedElevation) && Dp.m5127equalsimpl0(this.focusedElevation, ((ButtonElevation) other).focusedElevation) && Dp.m5127equalsimpl0(this.hoveredElevation, ((ButtonElevation) other).hoveredElevation) && Dp.m5127equalsimpl0(this.disabledElevation, ((ButtonElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
