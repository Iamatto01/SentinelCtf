...
public final class CheckboxColors {
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState state, Composer $composer, int $changed) {
        ...
        State<Color> m67animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m67animateColorAsStateKTwxG1Y(target, AnimationSpecKt.tween$default(duration, 0, null, 6, null), null, $composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m67animateColorAsStateKTwxG1Y;
    }
    ...
    public final State<Color> boxColor$material3_release(boolean enabled, ToggleableState state, Composer $composer, int $changed) {
        ...
        if (enabled) {
            ...
            int duration = state == ToggleableState.Off ? 100 : 50;
            rememberUpdatedState = SingleValueAnimationKt.m67animateColorAsStateKTwxG1Y(target, AnimationSpecKt.tween$default(duration, 0, null, 6, null), null, $composer, 0, 4);
            $composer.endReplaceableGroup();
        } else {
            $composer.startReplaceableGroup(1143718380);
            ComposerKt.sourceInformation($composer, "435@17290L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2596boximpl(target), $composer, 0);
            $composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CheckboxColors) && Color.m2607equalsimpl0(this.checkedCheckmarkColor, ((CheckboxColors) other).checkedCheckmarkColor) && Color.m2607equalsimpl0(this.uncheckedCheckmarkColor, ((CheckboxColors) other).uncheckedCheckmarkColor) && Color.m2607equalsimpl0(this.checkedBoxColor, ((CheckboxColors) other).checkedBoxColor) && Color.m2607equalsimpl0(this.uncheckedBoxColor, ((CheckboxColors) other).uncheckedBoxColor) && Color.m2607equalsimpl0(this.disabledCheckedBoxColor, ((CheckboxColors) other).disabledCheckedBoxColor) && Color.m2607equalsimpl0(this.disabledUncheckedBoxColor, ((CheckboxColors) other).disabledUncheckedBoxColor) && Color.m2607equalsimpl0(this.disabledIndeterminateBoxColor, ((CheckboxColors) other).disabledIndeterminateBoxColor) && Color.m2607equalsimpl0(this.checkedBorderColor, ((CheckboxColors) other).checkedBorderColor) && Color.m2607equalsimpl0(this.uncheckedBorderColor, ((CheckboxColors) other).uncheckedBorderColor) && Color.m2607equalsimpl0(this.disabledBorderColor, ((CheckboxColors) other).disabledBorderColor) && Color.m2607equalsimpl0(this.disabledIndeterminateBorderColor, ((CheckboxColors) other).disabledIndeterminateBorderColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2613hashCodeimpl(this.checkedCheckmarkColor);
        return (((((((((((((((((((result * 31) + Color.m2613hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m2613hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m2613hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m2613hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m2613hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m2613hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m2613hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m2613hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m2613hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2613hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}
