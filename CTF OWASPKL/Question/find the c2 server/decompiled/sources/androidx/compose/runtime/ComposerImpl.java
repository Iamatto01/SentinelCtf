...
public final class ComposerImpl implements Composer {
    ...
    public void startReplaceableGroup(int key) {
        m2225startBaiHCIY(key, null, GroupKind.Companion.m2235getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m2225startBaiHCIY(-127, null, GroupKind.Companion.m2235getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m2225startBaiHCIY(key, dataKey, GroupKind.Companion.m2235getGroupULZAiWs(), null);
    }
    ...
    private final void startRoot() {
        ...
        Set it = (Set) resolveCompositionLocal(InspectionTablesKt.getLocalInspectionTables(), this.parentProvider);
        if (it != null) {
    ...
    public void startNode() {
        m2225startBaiHCIY(125, null, GroupKind.Companion.m2236getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m2225startBaiHCIY(125, null, GroupKind.Companion.m2237getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m2225startBaiHCIY(key, null, GroupKind.Companion.m2235getGroupULZAiWs(), dataKey);
    }
    ...
    public void endToMarker(int marker) {
        if (marker < 0) {
            ...
            while (this.writer.getParent() > writerLocation) {
                end(false);
            }
            return;
        }
    ...
    public final Object nextSlot() {
        if (getInserting()) {
            ...
            Object it = Composer.Companion.getEmpty();
            return it;
        }
        Object it2 = this.reader.next();
        if (this.reusing) {
            Object it3 = Composer.Companion.getEmpty();
            return it3;
        }
        return it2;
    }
    ...
    public final void updateValue(final Object value) {
        ...
        recordSlotTableOperation(true, new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$updateValue$2
            ...
            public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                ...
                } else if ((previous instanceof RecomposeScopeImpl) && (composition = ((RecomposeScopeImpl) previous).getComposition()) != null) {
    ...
    private final PersistentMap<CompositionLocal<Object>, State<Object>> currentCompositionLocalScope() {
        PersistentMap it = this.providerCache;
        if (it != null) {
            return it;
        }
        ...
        if (getInserting() && this.writerHasAProvider) {
            ...
            while (current > 0) {
                if (this.writer.groupKey(current) == 202 && Intrinsics.areEqual(this.writer.groupObjectKey(current), ComposerKt.getCompositionLocalMap())) {
                    ...
                    PersistentMap providers = (PersistentMap) groupAux;
        ...
        if (this.reader.getSize() > 0) {
            ...
            while (current2 > 0) {
                if (this.reader.groupKey(current2) == 202 && Intrinsics.areEqual(this.reader.groupObjectKey(current2), ComposerKt.getCompositionLocalMap())) {
                    PersistentMap persistentMap = this.providerUpdates.get(current2);
                    if (persistentMap == null) {
                        ...
                        persistentMap = (PersistentMap) groupAux2;
                    }
                    PersistentMap providers2 = persistentMap;
    ...
    private final PersistentMap<CompositionLocal<Object>, State<Object>> updateProviderMapGroup(PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>> persistentMap, PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>> persistentMap2) {
        ...
        PersistentMap.Builder<CompositionLocal<Object>, ? extends State<? extends Object>> it = builder;
        it.putAll(persistentMap2);
        PersistentMap $this$mutate$iv = builder.build();
        startGroup(ComposerKt.providerMapsKey, ComposerKt.getProviderMaps());
        changed($this$mutate$iv);
    ...
    public void startProviders(final ProvidedValue<?>[] values) {
        PersistentMap providers;
        boolean invalid;
        int asInt;
        Intrinsics.checkNotNullParameter(values, "values");
        final PersistentMap parentScope = currentCompositionLocalScope();
        ...
        PersistentMap currentProviders = (PersistentMap) ActualJvm_jvmKt.invokeComposableForResult(this, new Function2<Composer, Integer, PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>>>() { // from class: androidx.compose.runtime.ComposerImpl$startProviders$currentProviders$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final PersistentMap<CompositionLocal<Object>, State<Object>> invoke(Composer $composer, int $changed) {
                ...
                compositionLocalMapOf = ComposerKt.compositionLocalMapOf(values, parentScope, $composer, 8);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (getInserting()) {
            ...
            PersistentMap oldScope = (PersistentMap) groupGet;
            ...
            PersistentMap oldValues = (PersistentMap) groupGet2;
        ...
        this.providerCache = providers;
        m2225startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m2235getGroupULZAiWs(), providers);
    }
    ...
    private final void m2225startBaiHCIY(int key, Object objectKey, int kind, Object data) {
        Pending newPending;
        validateNodeNotExpected();
        updateCompoundKeyWhenWeEnterGroup(key, objectKey, data);
        boolean isNode = kind != GroupKind.Companion.m2235getGroupULZAiWs();
        if (getInserting()) {
            ...
            if (isNode) {
                ...
                this.writer.startData(key, objectKey == null ? Composer.Companion.getEmpty() : objectKey, data);
            } else {
                this.writer.startGroup(key, objectKey == null ? Composer.Companion.getEmpty() : objectKey);
            }
        ...
        boolean forceReplace = (kind != GroupKind.Companion.m2236getNodeULZAiWs() ? 1 : 0) == 0 && this.reusing;
    ...
    public final boolean tryImminentInvalidation$runtime_release(RecomposeScopeImpl scope, Object instance) {
        ...
        int location = anchor.toIndexFor(this.slotTable);
                            ...
                            if (data instanceof RememberObserver) {
                                ...
                                ComposerImpl.recordSlotTableOperation$default(composerImpl, false, new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$deactivateToEndGroup$3.1
                                    ...
                                    public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                                        ...
                                        Intrinsics.checkNotNullParameter(slots, "slots");
                                        Intrinsics.checkNotNullParameter(rememberManager, "rememberManager");
                                        boolean value$iv3 = Intrinsics.areEqual(data, slots.slot(i, index));
                                        if (value$iv3) {
                                ...
                                CompositionImpl composition = ((RecomposeScopeImpl) data).getComposition();
                                if (composition != null) {
                                    composition.setPendingInvalidScopes$runtime_release(true);
                                ...
                                ComposerImpl.recordSlotTableOperation$default(composerImpl2, false, new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$deactivateToEndGroup$3.2
                                    ...
                                    public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                                        ...
                                        Intrinsics.checkNotNullParameter(slots, "slots");
                                        Intrinsics.checkNotNullParameter(rememberManager, "<anonymous parameter 2>");
                                        boolean value$iv3 = Intrinsics.areEqual(data, slots.slot(i2, index));
                                        if (value$iv3) {
                                            slots.set(index, Composer.Companion.getEmpty());
                                        } else {
                                            ComposerKt.composeRuntimeError("Slot table is out of sync".toString());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void invokeMovableContentLambda(final MovableContent<Object> movableContent, PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>> persistentMap, final Object parameter, boolean force) {
        ...
        try {
            ...
            if (!getInserting() && !Intrinsics.areEqual(this.reader.getGroupAux(), persistentMap)) {
                z = true;
            }
            ...
            m2225startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m2235getGroupULZAiWs(), persistentMap);
            if (getInserting() && !force) {
                this.writerHasAProvider = true;
                this.providerCache = null;
                SlotWriter slotWriter = this.writer;
                Anchor anchor = slotWriter.anchor(slotWriter.parent(slotWriter.getParent()));
                MovableContentStateReference reference = new MovableContentStateReference(movableContent, parameter, getComposition(), this.insertTable, anchor, CollectionsKt.emptyList(), currentCompositionLocalScope());
                ...
                ActualJvm_jvmKt.invokeComposable(this, ComposableLambdaKt.composableLambdaInstance(694380496, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$invokeMovableContentLambda$1
                    ...
                    public final void invoke(Composer $composer, int $changed) {
                        ...
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(694380496, $changed, -1, "androidx.compose.runtime.ComposerImpl.invokeMovableContentLambda.<anonymous> (Composer.kt:2946)");
                        }
                        movableContent.getContent().invoke(parameter, $composer, 8);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
    ...
    private final void insertMovableContentGuarded(List<Pair<MovableContentStateReference, MovableContentStateReference>> list) {
        ...
        try {
            ...
            while (index$iv2 < size) {
                ...
                final Anchor anchor2 = to.getAnchor$runtime_release();
                int location = to.getSlotTable$runtime_release().anchorIndex(anchor2);
                ...
                if (from == null) {
                    try {
                        ...
                        final SlotReader reader$iv = to.getSlotTable$runtime_release().openReader();
                        try {
                                ...
                                try {
                                    recomposeMovableContent$default(this, null, null, null, null, new Function0<Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$2$1
                                        ...
                                        public final void invoke2() {
                                            ...
                                            List newChanges$iv = offsetChanges2;
                                            ...
                                            try {
                                                this_$iv.changes = newChanges$iv;
                                                ...
                                                this_$iv2.invokeMovableContentLambda(movableContentStateReference.getContent$runtime_release(), movableContentStateReference.getLocals$runtime_release(), movableContentStateReference.getParameter$runtime_release(), true);
                                                Unit unit = Unit.INSTANCE;
                    ...
                    if (resolvedState == null || (slotTable$runtime_release2 = resolvedState.getSlotTable$runtime_release()) == null || (anchor$runtime_release = slotTable$runtime_release2.anchor(0)) == null) {
                        anchor$runtime_release = from.getAnchor$runtime_release();
                    }
                    Anchor fromAnchor = anchor$runtime_release;
                        ...
                        record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$3
                            ...
                            public final void invoke2(Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
                                ...
                                for (int index$iv3 = 0; index$iv3 < size2; index$iv3++) {
                                    ...
                                    int i2 = index$iv3;
                                    applier.insertBottomUp(base + i2, item$iv2);
                                    applier.insertTopDown(base + i2, item$iv2);
                                }
                            }
                        });
                    ...
                    record(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$4
                        ...
                        public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                            ...
                            if (!anchors.isEmpty()) {
                                ...
                                for (int index$iv3 = 0; index$iv3 < size2; index$iv3++) {
                                    Object item$iv2 = anchors.get(index$iv3);
                                    Anchor anchor3 = (Anchor) item$iv2;
                                    Object slot = slots.slot(anchor3, 0);
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        try {
                                            recomposeMovableContent(from.getComposition$runtime_release(), to.getComposition$runtime_release(), Integer.valueOf(reader$iv2.getCurrentGroup()), from.getInvalidations$runtime_release(), new Function0<Unit>() { // from class: androidx.compose.runtime.ComposerImpl$insertMovableContentGuarded$1$1$5$1$1$1
                                                /* JADX INFO: Access modifiers changed from: package-private */
                                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                {
                                                    super(0);
    ...
    private final <R> R recomposeMovableContent(ControlledComposition from, ControlledComposition to, Integer index, List<Pair<RecomposeScopeImpl, IdentityArraySet<Object>>> list, Function0<? extends R> function0) {
        R r;
        ...
        try {
            ...
            while (index$iv < size) {
                ...
                Pair<RecomposeScopeImpl, IdentityArraySet<Object>> pair = (Pair) item$iv;
                RecomposeScopeImpl scope = pair.component1();
                IdentityArraySet instances = pair.component2();
                if (instances == null) {
                    ...
                    int i$iv = 0;
                    $this$fastForEach$iv = $this$fastForEach$iv2;
                    for (int size2 = instances.size(); i$iv < size2; size2 = size2) {
                        Object instance = instances.get(i$iv);
    ...
    public void sourceInformationMarkerStart(int key, String sourceInformation) {
        ...
        if (this.sourceInformationEnabled) {
            m2225startBaiHCIY(key, null, GroupKind.Companion.m2235getGroupULZAiWs(), sourceInformation);
        }
    }
        ...
        if (value$iv) {
            ...
            try {
                ...
                for (int index$iv = 0; index$iv < size$runtime_release; index$iv++) {
                    Object obj = identityArrayMap.getKeys$runtime_release()[index$iv];
                    Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type Key of androidx.compose.runtime.collection.IdentityArrayMap");
                    IdentityArraySet set = (IdentityArraySet) identityArrayMap.getValues$runtime_release()[index$iv];
                ...
                if ($this$sortBy$iv.size() > 1) {
                    CollectionsKt.sortWith($this$sortBy$iv, new Comparator() { // from class: androidx.compose.runtime.ComposerImpl$doCompose$lambda$37$$inlined$sortBy$1
                ...
                this.isComposing = true;
                startRoot();
                final Object savedContent = nextSlot();
    ...
    private final void recordSlotTableOperation(boolean forParent, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
        ...
        if (this.insertFixups.isEmpty()) {
            ...
            recordSlotEditingOperation(new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$recordInsert$1
                ...
                public final void invoke2(Applier<?> applier, SlotWriter slots, RememberManager rememberManager) {
                    ...
                    slots.moveFrom(slotTable, anchor.toIndexFor(slotTable));
                    slots.endInsert();
                }
            });
            return;
    ...
    private static final int reportFreeMovableContent$reportGroup(final ComposerImpl this$0, int group, boolean needsNodeDelete, int nodeIndex) {
        ...
        } else if (this$0.reader.containsMark(group)) {
    ...
    public final void releaseMovableGroupAtCurrent(MovableContentStateReference reference, SlotWriter slots) {
        ...
        try {
            ...
            writer$iv.update(reference.getParameter$runtime_release());
            slots.moveTo(reference.getAnchor$runtime_release(), 1, writer$iv);
            writer$iv.skipGroup();
            writer$iv.endGroup();
            writer$iv.endInsert();
            Unit unit = Unit.INSTANCE;
    ...
    private final void recordReaderMoving(int location) {
        int distance = this.reader.getCurrentGroup() - this.writersReaderDelta;
    ...
    private final void recordSlotEditing() {
        ...
        int location;
        Function3 function3;
        if (this.reader.getSize() > 0 && this.startedGroups.peekOr(-2) != (location = (reader = this.reader).getParent())) {
    ...
    private final void recordRemoveNode(int nodeIndex, int count) {
        if (count > 0) {
            ...
            if (!value$iv) {
                ...
                throw new KotlinNothingValueException();
            } else if (this.previousRemove != nodeIndex) {
                realizeMovement();
    ...
    public final class CompositionContextImpl extends CompositionContext {
        ...
        private final PersistentMap<CompositionLocal<Object>, State<Object>> getCompositionLocalScope() {
            ...
            return (PersistentMap) $this$getValue$iv.getValue();
        }
        ...
        private final void setCompositionLocalScope(PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>> persistentMap) {
            ...
            $this$setValue$iv.setValue(persistentMap);
        }
