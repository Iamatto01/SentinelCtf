...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m2238boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl */
    public static <T> Composer m2239constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl */
    public static boolean m2240equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).m2245unboximpl());
    }

    /* renamed from: equals-impl0 */
    public static final boolean m2241equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2242hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl */
    public static String m2243toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2240equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2242hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2243toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl */
    public final /* synthetic */ Composer m2245unboximpl() {
    ...
    public static final void m2244updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        arg0.startReplaceableGroup(509942095);
        block.invoke(Updater.m2246boximpl(Updater.m2247constructorimpl(arg0)));
