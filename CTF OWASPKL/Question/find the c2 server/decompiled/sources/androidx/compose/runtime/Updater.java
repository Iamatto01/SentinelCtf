...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2246boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m2247constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2248equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).m2258unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2249equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2250hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2255toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2248equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2250hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2255toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m2258unboximpl() {
    ...
    public static final void m2253setimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* renamed from: set-impl  reason: not valid java name */
    public static final <V> void m2254setimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2256updateimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* renamed from: update-impl  reason: not valid java name */
    public static final <V> void m2257updateimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = arg0.getInserting();
    ...
    public static final void m2251initimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        if (arg0.getInserting()) {
            arg0.apply(Unit.INSTANCE, new Function2<T, Unit, Unit>() { // from class: androidx.compose.runtime.Updater$init$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Object p1, Unit unit) {
                    invoke2((Updater$init$1<T>) p1, unit);
    ...
    public static final void m2252reconcileimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        arg0.apply(Unit.INSTANCE, new Function2<T, Unit, Unit>() { // from class: androidx.compose.runtime.Updater$reconcile$1
            ...
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Unit invoke(Object p1, Unit unit) {
                invoke2((Updater$reconcile$1<T>) p1, unit);
                return Unit.INSTANCE;
            }
