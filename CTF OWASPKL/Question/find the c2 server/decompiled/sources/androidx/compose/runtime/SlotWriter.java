...
public final class SlotWriter {
    ...
    public final Object groupAux(int index) {
        ...
        return hasAux ? this.slots[auxIndex(this.groups, address)] : Composer.Companion.getEmpty();
    }
    ...
    public final Object set(int index, Object value) {
        ...
        value$iv = (slotsIndex < slotsStart || slotsIndex >= slotsEnd) ? false : false;
        if (!value$iv) {
    ...
    private final void startGroup(int key, Object objectKey, boolean isNode, Object aux) {
        ...
        if (inserting) {
            ...
            nodeCount = SlotTableKt.nodeCount(this.groups, currentGroupAddress);
            this.nodeCount = nodeCount;
            this.parent = currentGroup;
            this.currentGroup = currentGroup + 1;
            groupSize = SlotTableKt.groupSize(this.groups, currentGroupAddress);
            newCurrent = groupSize + currentGroup;
        }
    ...
    public final List<Anchor> moveTo(Anchor anchor, int offset, SlotWriter writer) {
        ...
        List result = Companion.moveGroup(this, location, writer, false, false);
    ...
    public final List<Anchor> moveFrom(SlotTable table, int index) {
        ...
        try {
            return Companion.moveGroup(writer$iv, index, this, true, true);
        } finally {
            writer$iv.close();
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0017, code lost:
        if (groupSize(r16.currentGroup + r17) == 1) goto L5;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.util.List<androidx.compose.runtime.Anchor> moveIntoGroupFrom(int r17, androidx.compose.runtime.SlotTable r18, int r19) {
        /*
            r16 = this;
            r7 = r16
            ...
            int r0 = r7.insertCount
            if (r0 > 0) goto L1a
            int r0 = r7.currentGroup
            int r0 = r0 + r17
            int r0 = r7.groupSize(r0)
            r1 = 1
            if (r0 != r1) goto L1a
            goto L1b
        L1a:
        ...
        L1b:
            ...
            int r9 = r7.currentGroup
            int r10 = r7.currentSlot
            int r11 = r7.currentSlotEnd
            r16.advanceBy(r17)
            r16.startGroup()
            r16.beginInsert()
            r12 = r18
            ...
            r2 = r14
            r0 = 0
            androidx.compose.runtime.SlotWriter$Companion r1 = androidx.compose.runtime.SlotWriter.Companion     // Catch: java.lang.Throwable -> L5e
            r5 = 0
            r6 = 1
            r3 = r19
            r4 = r16
            java.util.List r1 = androidx.compose.runtime.SlotWriter.Companion.access$moveGroup(r1, r2, r3, r4, r5, r6)     // Catch: java.lang.Throwable -> L5e
            r14.close()
            r0 = r1
            r16.endInsert()
            r16.endGroup()
    ...
    public final void updateContainsMark(int group) {
        if (group >= 0) {
            PrioritySet it = this.pendingRecalculateMarks;
            if (it == null) {
                it = new PrioritySet(null, 1, null);
    ...
    public final void moveSlotGapTo(int index, int group) {
        ...
        if (gapStart != index) {
            ...
            ArraysKt.fill(slots, (Object) null, index, index + gapLen);
        }
