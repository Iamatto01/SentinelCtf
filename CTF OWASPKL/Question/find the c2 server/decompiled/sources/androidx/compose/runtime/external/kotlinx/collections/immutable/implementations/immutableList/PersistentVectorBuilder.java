...
public final class PersistentVectorBuilder<E> extends AbstractMutableList<E> implements PersistentList.Builder<E> {
    ...
    public boolean add(E e) {
        ...
        if (tailSize < 32) {
            ...
            mutableTail[tailSize] = e;
            this.tail = mutableTail;
            this.size = size() + 1;
        } else {
            Object[] newTail = mutableBufferWith(e);
    ...
    private final Object[] copyToBuffer(Object[] buffer, int bufferIndex, Iterator<? extends Object> it) {
        for (int index = bufferIndex; index < 32 && it.hasNext(); index++) {
    ...
    private final Object[] pushBuffers(Object[] root, int rootSize, int shift, Iterator<Object[]> it) {
        if (!it.hasNext()) {
        ...
        mutableRoot[index] = pushBuffers((Object[]) mutableRoot[index], rootSize, shift - 5, it);
        while (true) {
            index++;
            if (index >= 32 || !it.hasNext()) {
                break;
            }
            mutableRoot[index] = pushBuffers((Object[]) mutableRoot[index], 0, shift - 5, it);
        }
        return mutableRoot;
    }
    ...
    public void add(int index, E e) {
        ...
        if (index >= rootSize) {
            insertIntoTail(this.root, index - rootSize, e);
            return;
        }
        ObjectRef elementCarry = new ObjectRef(null);
        Object[] objArr = this.root;
        Intrinsics.checkNotNull(objArr);
        Object[] newRest = insertIntoRoot(objArr, this.rootShift, index, e, elementCarry);
        insertIntoTail(newRest, 0, elementCarry.getValue());
    }

    private final void insertIntoTail(Object[] root, int index, E e) {
        int tailSize = tailSize();
        Object[] mutableTail = makeMutable(this.tail);
        if (tailSize < 32) {
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (buffersSize == 0) {
            CommonFunctionsKt.m2259assert(index >= rootSize());
    ...
    private final void insertIntoRoot(Collection<? extends E> collection, int index, int rightShift, Object[][] buffers, int nullBuffers, Object[] nextBuffer) {
        ...
        splitToBuffers(collection, index, startLeaf, 32, buffers, newNullBuffers, newNextBuffer);
    }
    ...
    private final void splitToBuffers(Collection<? extends E> collection, int index, Object[] startBuffer, int startBufferSize, Object[][] buffers, int nullBuffers, Object[] nextBuffer) {
        if (!(nullBuffers >= 1)) {
            throw new IllegalStateException("Check failed.".toString());
        }
        ...
        int endBufferEndIndex = ((index + collection.size()) - 1) & 31;
        ...
        Iterator elementsIterator = collection.iterator();
    ...
    public E removeAt(int index) {
        ...
        Object[] objArr = this.root;
        Intrinsics.checkNotNull(objArr);
        Object[] newRoot = removeFromRootAt(objArr, this.rootShift, index, elementCarry);
    ...
    private final Object removeFromTailAt(Object[] root, int rootSize, int shift, int index) {
        ...
        CommonFunctionsKt.m2259assert(index < tailSize);
        if (tailSize == 1) {
    ...
    public boolean removeAll(final Collection<? extends Object> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
        return removeAllWithPredicate((Function1) ((Function1<E, Boolean>) new Function1<E, Boolean>() { // from class: androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableList.PersistentVectorBuilder$removeAll$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Object p1) {
                return invoke((PersistentVectorBuilder$removeAll$1<E>) p1);
            }
        }));
    }
    ...
    private final boolean removeAll(Function1<? super E, Boolean> function1) {
        ...
        if (this.root == null) {
            return removeAllFromTail(function1, tailSize, bufferRef) != tailSize;
        }
        ...
        if (bufferSize == 32) {
            CommonFunctionsKt.m2259assert(!leafIterator.hasNext());
        ...
        while (leafIterator.hasNext()) {
            ...
            bufferSize2 = recyclableRemoveAll(function1, leaf, 32, bufferSize2, bufferRef, recyclableBuffers, buffers);
            unaffectedElementsCount = unaffectedElementsCount;
        }
        int unaffectedElementsCount2 = unaffectedElementsCount;
        int newTailSize2 = recyclableRemoveAll(function1, this.tail, tailSize, bufferSize2, bufferRef, recyclableBuffers, buffers);
    ...
    private final int removeAllFromTail(Function1<? super E, Boolean> function1, int tailSize, ObjectRef bufferRef) {
        int newTailSize = removeAll(function1, this.tail, tailSize, bufferRef);
        if (newTailSize == tailSize) {
            CommonFunctionsKt.m2259assert(bufferRef.getValue() == this.tail);
            return tailSize;
        }
        Object value = bufferRef.getValue();
        Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
    ...
    private final int removeAll(Function1<? super E, Boolean> function1, Object[] buffer, int bufferSize, ObjectRef bufferRef) {
    ...
    private final int recyclableRemoveAll(Function1<? super E, Boolean> function1, Object[] buffer, int bufferSize, int toBufferSize, ObjectRef bufferRef, List<Object[]> list, List<Object[]> list2) {
    ...
    public E set(int index, E e) {
        ...
        if (rootSize() <= index) {
            ...
            E e2 = (E) mutableTail[tailIndex];
            mutableTail[tailIndex] = e;
            this.tail = mutableTail;
            return e2;
        }
        ...
        Object[] objArr = this.root;
        Intrinsics.checkNotNull(objArr);
        this.root = setInRoot(objArr, this.rootShift, index, e, oldElementCarry);
