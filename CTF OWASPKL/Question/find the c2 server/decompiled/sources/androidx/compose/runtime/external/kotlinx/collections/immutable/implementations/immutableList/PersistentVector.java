...
public final class PersistentVector<E> extends AbstractPersistentList<E> implements PersistentList<E> {
    ...
    public PersistentVector(Object[] root, Object[] tail, int size, int rootShift) {
        ...
        CommonFunctionsKt.m2259assert(size() - UtilsKt.rootSize(size()) <= RangesKt.coerceAtMost(tail.length, 32));
    }
    ...
    */
    ...
    public PersistentList<E> add(int index, E e) {
        ...
        if (index >= rootSize) {
            return insertIntoTail(this.root, index - rootSize, e);
        }
        ObjectRef elementCarry = new ObjectRef(null);
        Object[] newRoot = insertIntoRoot(this.root, this.rootShift, index, e, elementCarry);
    ...
    public PersistentList<E> set(int index, E e) {
        ListImplementation.checkElementIndex$runtime_release(index, size());
        if (rootSize() <= index) {
            Object[] newTail = Arrays.copyOf(this.tail, 32);
            Intrinsics.checkNotNullExpressionValue(newTail, "copyOf(this, newSize)");
        ...
        Object[] newRoot = setInRoot(this.root, this.rootShift, index, e);
