...
public final class SlotReader {
    ...
    public final int skipGroup() {
        ...
        if (value$iv) {
            isNode = SlotTableKt.isNode(this.groups, this.currentGroup);
            int count = isNode ? 1 : SlotTableKt.nodeCount(this.groups, this.currentGroup);
            int i = this.currentGroup;
            groupSize = SlotTableKt.groupSize(this.groups, i);
    ...
    /* JADX WARN: Incorrect condition in loop: B:24:0x0012 */
    /*
    ...
    */
    public final java.util.List<androidx.compose.runtime.KeyInfo> extractKeys() {
        ...
        Lc:
            r1 = 0
            int r2 = r10.currentGroup
            r8 = r1
        L10:
            int r1 = r10.currentEnd
            if (r2 >= r1) goto L48
        L15:
