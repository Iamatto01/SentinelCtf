...
public final class PersistentHashMap<K, V> extends AbstractMap<K, V> implements PersistentMap<K, V> {
    ...
    public PersistentHashMap<K, V> put(K k, V v) {
        TrieNode.ModificationResult newNodeResult = this.node.put(k != null ? k.hashCode() : 0, k, v, 0);
    ...
    public PersistentHashMap<K, V> remove(K k) {
        TrieNode newNode = this.node.remove(k != null ? k.hashCode() : 0, k, 0);
        return this.node == newNode ? this : newNode == null ? Companion.emptyOf$runtime_release() : new PersistentHashMap<>(newNode, size() - 1);
    }

    @Override // java.util.Map, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentMap
    public PersistentHashMap<K, V> remove(K k, V v) {
        TrieNode newNode = this.node.remove(k != null ? k.hashCode() : 0, k, v, 0);
        return this.node == newNode ? this : newNode == null ? Companion.emptyOf$runtime_release() : new PersistentHashMap<>(newNode, size() - 1);
    }
