...
public final class MutableVector<T> implements RandomAccess {
    ...
    public final void ensureCapacity(int capacity) {
        ...
        if (oldContent.length < capacity) {
            ...
            T[] tArr = (T[]) Arrays.copyOf(oldContent, newSize);
    ...
    public final <R> R fold(R r, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        if (size > 0) {
            ...
            Object[] content = getContent();
            do {
                acc = (R) operation.invoke(acc, content[i]);
                i++;
            } while (i < size);
            return (R) acc;
        }
    ...
    public final <R> R foldIndexed(R r, Function3<? super Integer, ? super R, ? super T, ? extends R> operation) {
        ...
        if (size > 0) {
            ...
            Object[] content = getContent();
            do {
                acc = (R) operation.invoke(Integer.valueOf(i), acc, content[i]);
                i++;
            } while (i < size);
            return (R) acc;
        }
    ...
    public final <R> R foldRight(R r, Function2<? super T, ? super R, ? extends R> operation) {
        ...
        if (size > 0) {
            ...
            Object[] content = getContent();
            do {
                acc = (R) operation.invoke(content[i], acc);
                i--;
            } while (i >= 0);
            return (R) acc;
        }
    ...
    public final <R> R foldRightIndexed(R r, Function3<? super Integer, ? super T, ? super R, ? extends R> operation) {
        ...
        if (size > 0) {
            ...
            Object[] content = getContent();
            do {
                acc = (R) operation.invoke(Integer.valueOf(i), content[i], acc);
                i--;
            } while (i >= 0);
            return (R) acc;
        }
    ...
    public final int indexOf(T t) {
        ...
        if (size > 0) {
            int i = 0;
            Object[] content = this.content;
            while (!Intrinsics.areEqual(t, content[i])) {
                i++;
                if (i >= size) {
                    return -1;
                }
