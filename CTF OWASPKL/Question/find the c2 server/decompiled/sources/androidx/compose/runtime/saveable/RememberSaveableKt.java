...
public final class RememberSaveableKt {
    ...
    public static final <T> T m2260rememberSaveable(Object[] inputs, Saver<T, ? extends Object> saver, String key, Function0<? extends T> init, Composer $composer, int $changed, int i) {
        String key2;
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] inputs, Saver<T, ? extends Object> stateSaver, String key, Function0<? extends MutableState<T>> init, Composer $composer, int $changed, int i) {
        ...
        MutableState<T> mutableState = (MutableState) m2260rememberSaveable(Arrays.copyOf(inputs, inputs.length), (Saver<Object, ? extends Object>) mutableStateSaver(stateSaver), key, (Function0<? extends Object>) init, $composer, ($changed & 896) | 8 | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
