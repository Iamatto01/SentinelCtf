...
public final class GroupKind {
    ...
    private static final int Group = m2227constructorimpl(0);
    private static final int Node = m2227constructorimpl(1);
    private static final int ReusableNode = m2227constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ GroupKind m2226boximpl(int i) {
    ...
    public static boolean m2228equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m2234unboximpl();
    }
    ...
    public static final boolean m2231isNodeimpl(int arg0) {
        return arg0 != Companion.m2235getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl  reason: not valid java name */
    public static final boolean m2232isReusableimpl(int arg0) {
        return arg0 != Companion.m2236getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m2235getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs  reason: not valid java name */
        public final int m2236getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs  reason: not valid java name */
        public final int m2237getReusableNodeULZAiWs() {
