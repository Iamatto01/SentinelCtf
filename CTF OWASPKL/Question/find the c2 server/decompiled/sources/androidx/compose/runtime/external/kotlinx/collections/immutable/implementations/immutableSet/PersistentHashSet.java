...
public final class PersistentHashSet<E> extends AbstractSet<E> implements PersistentSet<E> {
    ...
    public /* bridge */ /* synthetic */ PersistentCollection add(Object element) {
        return add((PersistentHashSet<E>) element);
    }
    ...
    public /* bridge */ /* synthetic */ PersistentCollection remove(Object element) {
        return remove((PersistentHashSet<E>) element);
    }
    ...
    public PersistentSet<E> add(E e) {
        TrieNode newNode = this.node.add(e != null ? e.hashCode() : 0, e, 0);
    ...
    public PersistentSet<E> remove(E e) {
        TrieNode newNode = this.node.remove(e != null ? e.hashCode() : 0, e, 0);
        return this.node == newNode ? this : new PersistentHashSet(newNode, size() - 1);
    }
