...
public final class PersistentOrderedSet<E> extends AbstractSet<E> implements PersistentSet<E> {
    ...
    public /* bridge */ /* synthetic */ PersistentCollection add(Object element) {
        return add((PersistentOrderedSet<E>) element);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Collection, java.util.Set, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    public /* bridge */ /* synthetic */ PersistentCollection remove(Object element) {
        return remove((PersistentOrderedSet<E>) element);
    }
    ...
    public PersistentSet<E> add(E e) {
        ...
        if (isEmpty()) {
            PersistentHashMap newMap = this.hashMap.put((PersistentHashMap<E, Links>) e, (E) new Links());
            return new PersistentOrderedSet(e, e, newMap);
        }
        Object lastElement = this.lastElement;
        Links links = this.hashMap.get(lastElement);
        Intrinsics.checkNotNull(links);
        Links lastLinks = links;
        PersistentHashMap newMap2 = ((PersistentHashMap<E, Links>) this.hashMap).put((ImmutableMap) lastElement, (Object) lastLinks.withNext(e)).put((PersistentHashMap) e, (E) new Links(lastElement));
        return new PersistentOrderedSet(this.firstElement, e, newMap2);
    }
    ...
    public PersistentSet<E> remove(E e) {
        ...
        if (links.getHasPrevious()) {
            ...
            Links previousLinks = links2;
            remove = remove.put((PersistentHashMap<E, Links>) links.getPrevious(), (Object) previousLinks.withNext(links.getNext()));
        }
        if (links.getHasNext()) {
            Links links3 = remove.get(links.getNext());
            Intrinsics.checkNotNull(links3);
            Links nextLinks = links3;
            remove = remove.put((PersistentHashMap<E, Links>) links.getNext(), (Object) nextLinks.withPrevious(links.getPrevious()));
        }
        ...
        return new PersistentOrderedSet(newFirstElement, newLastElement, remove);
    }
