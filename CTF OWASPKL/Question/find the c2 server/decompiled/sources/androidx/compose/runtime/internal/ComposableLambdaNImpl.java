        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.runtime.internal.ComposableLambdaNImpl$invoke$1
                ...
                public final void invoke(Composer nc, int i) {
                    ...
                    int changed = ((Integer) obj4).intValue();
                    Object[] objArr = args;
                    Collection $this$toTypedArray$iv3 = ArraysKt.slice(objArr, RangesKt.until(realParams + 2, objArr.length));
                    Object[] changedN = $this$toTypedArray$iv3.toArray(new Object[0]);
