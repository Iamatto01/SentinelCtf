...
public final class AppBarKt {
    private static final float AppBarHeight = Dp.m5122constructorimpl(56);
    private static final float AppBarHorizontalPadding = Dp.m5122constructorimpl(4);
    ...
    public static final void m895TopAppBarxWeB9s(final Function2<? super Composer, ? super Integer, Unit> title, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, long backgroundColor, long contentColor, float elevation, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty2 & 2995931) == 599186 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i6 != 0) {
                    actions = ComposableSingletons$AppBarKt.INSTANCE.m985getLambda1$material_release();
                }
                if ((i & 16) != 0) {
                ...
                if ((i & 32) != 0) {
                    contentColor2 = ColorsKt.m980contentColorForek8zF_U(backgroundColor2, $composer2, ($dirty2 >> 12) & 14);
                    $dirty2 &= -458753;
                }
                if (i7 != 0) {
                    $dirty = $dirty2;
                    elevation2 = AppBarDefaults.INSTANCE.m891getTopAppBarElevationD9Ej5fM();
                ...
                public final void invoke(RowScope AppBar, Composer $composer3, int $changed2) {
                    ...
                    if (($dirty3 & 91) != 18 || !$composer3.getSkipping()) {
                        ...
                        if (navigationIcon == null) {
                            ...
                            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh($composer3, 6)))}, function22, $composer3, ((i8 >> 3) & 112) | 8);
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            ComposerKt.sourceInformationMarkerEnd($composer3);
                            $composer3.endReplaceableGroup();
                            $composer3.endNode();
                        ...
                        String str3 = str2;
                        Modifier modifier$iv2 = RowScope.weight$default(AppBar, SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null), 1.0f, false, 2, null);
                        ...
                        TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography($composer3, 6).getH6(), ComposableLambdaKt.composableLambda($composer3, -2021518195, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1$2$1
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(ContentAlpha.INSTANCE.getHigh($composer4, 6)))}, function23, $composer4, ((i11 << 3) & 112) | 8);
                                    if (ComposerKt.isTraceInProgress()) {
                        ...
                        final int i14 = $dirty;
                        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda($composer3, 1157662914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$1.3
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    Modifier modifier$iv3 = SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$TopAppBar$2
            ...
            public final void invoke(Composer composer, int i8) {
                AppBarKt.m895TopAppBarxWeB9s(title, modifier4, function22, function32, j, j2, f, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    public static final void m894TopAppBarHsRjFd4(androidx.compose.ui.Modifier r24, long r25, long r27, float r29, androidx.compose.foundation.layout.PaddingValues r30, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, androidx.compose.runtime.Composer r32, final int r33, final int r34) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m893BottomAppBarY1yfwus(androidx.compose.ui.Modifier r26, long r27, long r29, androidx.compose.ui.graphics.Shape r31, float r32, androidx.compose.foundation.layout.PaddingValues r33, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, androidx.compose.runtime.Composer r35, final int r36, final int r37) {
        /*
    ...
    public static final void m892AppBarcelAv9A(final long backgroundColor, final long contentColor, final float elevation, final PaddingValues contentPadding, final Shape shape, Modifier modifier, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed, final int i) {
        ...
        if ((2995931 & $dirty) != 599186 || !$composer2.getSkipping()) {
            ...
            SurfaceKt.m1124SurfaceFjzlyU(modifier2, shape, backgroundColor, contentColor, null, elevation, ComposableLambdaKt.composableLambda($composer2, -1027830352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        ...
                        final int i3 = $dirty;
                        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda($composer3, 1296061040, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    ...
                                    Modifier padding = PaddingKt.padding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), PaddingValues.this);
                                    f = AppBarKt.AppBarHeight;
                                    Modifier modifier$iv = SizeKt.m443height3ABfNKs(padding, f);
                                    Arrangement.Horizontal horizontalArrangement$iv = Arrangement.INSTANCE.getStart();
                                    Alignment.Vertical verticalAlignment$iv = Alignment.Companion.getCenterVertically();
                                    Function3 content$iv = function32;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.AppBarKt$AppBar$2
            ...
            public final void invoke(Composer composer, int i3) {
                AppBarKt.m892AppBarcelAv9A(backgroundColor, contentColor, elevation, contentPadding, shape, modifier4, function3, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    static {
        ...
        TitleInsetWithoutIcon = SizeKt.m462width3ABfNKs(Modifier.Companion, Dp.m5122constructorimpl(arg0$iv - other$iv));
        Modifier fillMaxHeight$default = SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null);
        float arg0$iv2 = Dp.m5122constructorimpl(72);
        float other$iv2 = AppBarHorizontalPadding;
        TitleIconModifier = SizeKt.m462width3ABfNKs(fillMaxHeight$default, Dp.m5122constructorimpl(arg0$iv2 - other$iv2));
        BottomAppBarCutoutOffset = Dp.m5122constructorimpl(8);
        BottomAppBarRoundedEdgeRadius = Dp.m5122constructorimpl(4);
    }
}
