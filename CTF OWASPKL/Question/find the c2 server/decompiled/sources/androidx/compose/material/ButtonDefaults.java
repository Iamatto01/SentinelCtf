...
public final class ButtonDefaults {
    ...
    static {
        float m5122constructorimpl = Dp.m5122constructorimpl(16);
        ...
        MinWidth = Dp.m5122constructorimpl(64);
        MinHeight = Dp.m5122constructorimpl(36);
        IconSize = Dp.m5122constructorimpl(18);
        IconSpacing = Dp.m5122constructorimpl(8);
        OutlinedBorderSize = Dp.m5122constructorimpl(1);
        float m5122constructorimpl3 = Dp.m5122constructorimpl(8);
        TextButtonHorizontalPadding = m5122constructorimpl3;
        TextButtonContentPadding = PaddingKt.m410PaddingValuesa9UjIt4(m5122constructorimpl3, m410PaddingValuesa9UjIt4.mo397calculateTopPaddingD9Ej5fM(), m5122constructorimpl3, m410PaddingValuesa9UjIt4.mo394calculateBottomPaddingD9Ej5fM());
    }
    ...
    public final /* synthetic */ ButtonElevation m929elevationyajeYGU(float defaultElevation, float pressedElevation, float disabledElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? Dp.m5122constructorimpl(2) : defaultElevation;
        if ((i & 2) == 0) {
            pressedElevation2 = pressedElevation;
        } else {
            pressedElevation2 = Dp.m5122constructorimpl(8);
        }
        if ((i & 4) == 0) {
        ...
        ButtonElevation m928elevationR_JCAzs = m928elevationR_JCAzs(defaultElevation2, pressedElevation2, disabledElevation2, Dp.m5122constructorimpl(4), Dp.m5122constructorimpl(4), $composer, $this$dp$iv | 27648 | ($changed & 112) | ($changed & 896) | (($changed << 6) & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m928elevationR_JCAzs(float defaultElevation, float pressedElevation, float disabledElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        float pressedElevation2;
        float disabledElevation2;
        ...
        if ((i & 8) == 0) {
            ...
            hoveredElevation2 = Dp.m5122constructorimpl(4);
        }
        if ((i & 16) == 0) {
            focusedElevation2 = focusedElevation;
        } else {
            focusedElevation2 = Dp.m5122constructorimpl(4);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-737170518, $changed, -1, "androidx.compose.material.ButtonDefaults.elevation (Button.kt:371)");
        }
        Object[] keys$iv = {Dp.m5120boximpl(defaultElevation2), Dp.m5120boximpl(pressedElevation2), Dp.m5120boximpl(disabledElevation2), Dp.m5120boximpl(hoveredElevation2), Dp.m5120boximpl(focusedElevation2)};
    ...
    public final ButtonColors m927buttonColorsro_MJ88(long backgroundColor, long contentColor, long disabledBackgroundColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        ...
        long backgroundColor2 = (i & 1) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m962getPrimary0d7_KjU() : backgroundColor;
        if ((i & 2) == 0) {
            contentColor2 = contentColor;
        } else {
            contentColor2 = ColorsKt.m980contentColorForek8zF_U(backgroundColor2, $composer, $changed & 14);
        }
        if ((i & 4) != 0) {
            m2604copywmQWz5c = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : 0.12f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m961getOnSurface0d7_KjU()) : 0.0f);
            disabledBackgroundColor2 = ColorKt.m2651compositeOverOWjLjI(m2604copywmQWz5c, MaterialTheme.INSTANCE.getColors($composer, 6).m966getSurface0d7_KjU());
        } else {
            disabledBackgroundColor2 = disabledBackgroundColor;
        }
        if ((i & 8) != 0) {
            disabledContentColor2 = Color.m2604copywmQWz5c(r7, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r7) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r7) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r7) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m961getOnSurface0d7_KjU()) : 0.0f);
        } else {
    ...
    public final ButtonColors m935outlinedButtonColorsRGew2ao(long backgroundColor, long contentColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
    ...
    public final ButtonColors m936textButtonColorsRGew2ao(long backgroundColor, long contentColor, long disabledContentColor, Composer $composer, int $changed, int i) {
        long contentColor2;
        long disabledContentColor2;
        long m2604copywmQWz5c;
        ...
        long backgroundColor2 = (i & 1) != 0 ? Color.Companion.m2641getTransparent0d7_KjU() : backgroundColor;
        if ((i & 2) == 0) {
            contentColor2 = contentColor;
        } else {
            contentColor2 = MaterialTheme.INSTANCE.getColors($composer, 6).m962getPrimary0d7_KjU();
        ...
        if ((i & 4) != 0) {
            m2604copywmQWz5c = Color.m2604copywmQWz5c(r6, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r6) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r6) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r6) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m961getOnSurface0d7_KjU()) : 0.0f);
