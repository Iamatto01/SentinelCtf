...
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    public State<Dp> elevation(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv3 = (Function2) new DefaultFloatingActionButtonElevation$elevation$1$1(interactionSource, interactions, null);
        ...
        EffectsKt.LaunchedEffect(Dp.m5120boximpl(target), new DefaultFloatingActionButtonElevation$elevation$2(animatable, this, target, interaction, null), $composer, 64);
