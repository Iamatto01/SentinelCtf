...
public final class CheckCircleKt {
    ...
    public static final ImageVector getCheckCircle(Icons.Rounded $this$CheckCircle) {
        ...
        ImageVector.Builder $this$_get_CheckCircle__u24lambda_u241 = new ImageVector.Builder("Rounded.CheckCircle", Dp.m5122constructorimpl(24.0f), Dp.m5122constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.moveTo(9.29f, 16.29f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.lineTo(5.7f, 12.7f);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.lineTo(10.0f, 14.17f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.lineToRelative(6.88f, -6.88f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.curveToRelative(0.39f, -0.39f, 1.02f, -0.39f, 1.41f, 0.0f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.lineToRelative(-7.59f, 7.59f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.curveToRelative(-0.38f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.close();
        m3228addPathoIyEayM = $this$_get_CheckCircle__u24lambda_u241.m3228addPathoIyEayM($this$PathData_u24lambda_u2d0$iv$iv$iv.getNodes(), (r30 & 2) != 0 ? VectorKt.getDefaultFillType() : pathFillType$iv, (r30 & 4) != 0 ? "" : "", (r30 & 8) != 0 ? null : fill$iv$iv, (r30 & 16) != 0 ? 1.0f : 1.0f, (r30 & 32) == 0 ? null : null, (r30 & 64) != 0 ? 1.0f : 1.0f, (r30 & 128) != 0 ? 0.0f : 1.0f, (r30 & 256) != 0 ? VectorKt.getDefaultStrokeLineCap() : strokeLineCap$iv$iv, (r30 & 512) != 0 ? VectorKt.getDefaultStrokeLineJoin() : strokeLineJoin$iv$iv, (r30 & 1024) != 0 ? 4.0f : 1.0f, (r30 & 2048) != 0 ? 0.0f : 0.0f, (r30 & 4096) == 0 ? 0.0f : 1.0f, (r30 & 8192) == 0 ? 0.0f : 0.0f);
