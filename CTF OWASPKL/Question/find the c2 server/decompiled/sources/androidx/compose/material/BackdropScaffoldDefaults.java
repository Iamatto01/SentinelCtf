...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m5122constructorimpl(56);
    private static final float HeaderHeight = Dp.m5122constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m5122constructorimpl(1);

    private BackdropScaffoldDefaults() {
    }

    /* renamed from: getPeekHeight-D9Ej5fM  reason: not valid java name */
    public final float m899getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }

    /* renamed from: getHeaderHeight-D9Ej5fM  reason: not valid java name */
    public final float m898getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m680CornerSize0680j_4(Dp.m5122constructorimpl(16)), CornerSizeKt.m680CornerSize0680j_4(Dp.m5122constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final float m897getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        m2604copywmQWz5c = Color.m2604copywmQWz5c(r1, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r1) : 0.6f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r1) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r1) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m966getSurface0d7_KjU()) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
