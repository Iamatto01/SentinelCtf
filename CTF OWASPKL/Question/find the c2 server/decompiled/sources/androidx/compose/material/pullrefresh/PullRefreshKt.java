...
public final class PullRefreshKt {
    ...
    public static final Modifier pullRefresh(Modifier $this$pullRefresh, final PullRefreshState state, final boolean enabled) {
        ...
        Modifier $this$pullRefresh_u24lambda_u241 = pullRefresh(Modifier.Companion, new PullRefreshKt$pullRefresh$2$1(state), new PullRefreshKt$pullRefresh$2$2(state), enabled);
    ...
    public static final Modifier pullRefresh(Modifier $this$pullRefresh, final Function1<? super Float, Float> onPull, final Function2<? super Float, ? super Continuation<? super Float>, ? extends Object> onRelease, final boolean enabled) {
        ...
        Modifier.Companion companion = Modifier.Companion;
        Modifier $this$pullRefresh_u24lambda_u243 = NestedScrollModifierKt.nestedScroll$default(Modifier.Companion, new PullRefreshNestedScrollConnection(onPull, onRelease, enabled), null, 2, null);
