...
public final class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo193createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Path boundingRectangle = AndroidPath_androidKt.Path();
        boundingRectangle.addRect(new Rect(0.0f, 0.0f, Size.m2437getWidthimpl(size), Size.m2434getHeightimpl(size)));
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.mo2501opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.Companion.m2888getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        ...
        float cutoutOffset = density.mo301toPx0680j_4(f);
        float f3 = 2;
        ...
        float cutoutEndX = cutoutStartX + Size.m2437getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m2434getHeightimpl(cutoutSize) / 2.0f;
        float cutoutStartY = -cutoutRadius;
        OutlineKt.addOutline($this$addCutoutShape, this.cutoutShape.mo193createOutlinePq9zytI(cutoutSize, layoutDirection, density));
        $this$addCutoutShape.mo2503translatek4lQ0M(OffsetKt.Offset(cutoutStartX, cutoutStartY));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            f2 = AppBarKt.BottomAppBarRoundedEdgeRadius;
            float edgeRadius = density.mo301toPx0680j_4(f2);
