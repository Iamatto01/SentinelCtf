...
public final class TwoLine {
    ...
    private static final float MinHeight = Dp.m5122constructorimpl(64);
    private static final float MinHeightWithIcon = Dp.m5122constructorimpl(72);
    ...
    private static final float IconVerticalPadding = Dp.m5122constructorimpl(16);
    ...
    private static final float OverlineBaselineOffset = Dp.m5122constructorimpl(24);
    private static final float OverlineToPrimaryBaselineOffset = Dp.m5122constructorimpl(20);
    private static final float PrimaryBaselineOffsetNoIcon = Dp.m5122constructorimpl(28);
    private static final float PrimaryBaselineOffsetWithIcon = Dp.m5122constructorimpl(32);
    private static final float PrimaryToSecondaryBaselineOffsetNoIcon = Dp.m5122constructorimpl(20);
    private static final float PrimaryToSecondaryBaselineOffsetWithIcon = Dp.m5122constructorimpl(20);
