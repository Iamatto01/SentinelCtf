...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m457size3ABfNKs(Modifier.Companion, Dp.m5122constructorimpl(24));

    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m1043Iconww6aTOc(ImageVector imageVector, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        long tint2;
        ...
        if ((i & 8) != 0) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            m2604copywmQWz5c = Color.m2604copywmQWz5c(m2616unboximpl, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(m2616unboximpl) : ((Number) consume2).floatValue(), (r12 & 2) != 0 ? Color.m2612getRedimpl(m2616unboximpl) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(m2616unboximpl) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(m2616unboximpl) : 0.0f);
            tint2 = m2604copywmQWz5c;
        } else {
            tint2 = tint;
        }
        ...
        m1042Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, $composer, $changed & 14), contentDescription, modifier2, tint2, $composer, VectorPainter.$stable | ($changed & 112) | ($changed & 896) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m1041Iconww6aTOc(ImageBitmap bitmap, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        long tint2;
        long m2604copywmQWz5c;
        ...
        m1042Iconww6aTOc(painter, contentDescription, modifier2, tint2, $composer, ($changed & 112) | 8 | ($changed & 896) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    /* renamed from: Icon-ww6aTOc  reason: not valid java name */
    public static final void m1042Iconww6aTOc(final Painter painter, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        final long tint2;
        int $dirty;
        ...
        if ((i & 8) != 0) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            tint3 = Color.m2604copywmQWz5c(m2616unboximpl, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(m2616unboximpl) : ((Number) consume2).floatValue(), (r12 & 2) != 0 ? Color.m2612getRedimpl(m2616unboximpl) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(m2616unboximpl) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(m2616unboximpl) : 0.0f);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.IconKt$Icon$1
            ...
            public final void invoke(Composer composer, int i3) {
                IconKt.m1042Iconww6aTOc(Painter.this, contentDescription, modifier3, tint2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    private static final Modifier defaultSizeFor(Modifier $this$defaultSizeFor, Painter painter) {
        Modifier.Companion companion;
        if (Size.m2433equalsimpl0(painter.mo3215getIntrinsicSizeNHjbRc(), Size.Companion.m2445getUnspecifiedNHjbRc()) || m1044isInfiniteuvyYCjk(painter.mo3215getIntrinsicSizeNHjbRc())) {
    ...
    private static final boolean m1044isInfiniteuvyYCjk(long $this$isInfinite_u2duvyYCjk) {
