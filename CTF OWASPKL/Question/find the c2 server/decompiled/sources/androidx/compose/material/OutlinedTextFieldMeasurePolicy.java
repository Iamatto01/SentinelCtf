...
public final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(final MeasureScope measure, List<? extends Measurable> list, long constraints) {
        ...
        Object obj4;
        final int width;
        int m1071calculateHeightzUg2_y0;
        ...
        final Placeable trailingPlaceable = measurable2 != null ? measurable2.mo4125measureBRTryo0(ConstraintsKt.m5095offsetNN6EwU$default(relaxedConstraints, -occupiedSpaceHorizontally2, 0, 2, null)) : null;
        ...
        if (isLabelInMiddleSection) {
            i = (-occupiedSpaceHorizontally) - labelHorizontalPaddingOffset;
        } else {
            i = -labelHorizontalPaddingOffset;
        }
        long labelConstraints = ConstraintsKt.m5094offsetNN6EwU(relaxedConstraints, i, -bottomPadding);
        ...
        m5068copyZbe2FdA = Constraints.m5068copyZbe2FdA(r18, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(r18) : 0, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(r18) : 0, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(r18) : 0, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(ConstraintsKt.m5094offsetNN6EwU(constraints, -occupiedSpaceHorizontally, (-bottomPadding) - topPadding)) : 0);
        long textConstraints2 = m5068copyZbe2FdA;
        Iterable $this$first$iv = measurables;
        boolean z = false;
        Iterator<T> it8 = $this$first$iv.iterator();
        while (true) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it9), "TextField")) {
                final Placeable textFieldPlaceable = ((Measurable) element$iv).mo4125measureBRTryo0(textConstraints2);
                placeholderConstraints = Constraints.m5068copyZbe2FdA(r18, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(r18) : 0, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(r18) : 0, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(r18) : 0, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(textConstraints2) : 0);
                ...
                width = OutlinedTextFieldKt.m1072calculateWidthO3s9Psw(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable), TextFieldImplKt.widthOrZero(placeholderPlaceable), isLabelInMiddleSection, constraints, measure.getDensity(), this.paddingValues);
                m1071calculateHeightzUg2_y0 = OutlinedTextFieldKt.m1071calculateHeightzUg2_y0(TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable), textFieldPlaceable.getHeight(), TextFieldImplKt.heightOrZero(labelPlaceable), TextFieldImplKt.heightOrZero(placeholderPlaceable), constraints, measure.getDensity(), this.paddingValues);
                int bottomPadding2 = m1071calculateHeightzUg2_y0;
                ...
                for (Object element$iv2 : $this$first$iv3) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it12), OutlinedTextFieldKt.BorderId)) {
                        final Placeable borderPlaceable = ((Measurable) element$iv2).mo4125measureBRTryo0(ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : 0, width, bottomPadding2 != Integer.MAX_VALUE ? bottomPadding2 : 0, bottomPadding2));
                        final int i2 = bottomPadding2;
                        ...
                        return MeasureScope.layout$default(measure, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.OutlinedTextFieldMeasurePolicy$measure$2
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                OutlinedTextFieldKt.place(layout, i3, i4, placeable, placeable2, placeable3, placeable4, placeable5, placeable6, f, z3, density, layoutDirection, paddingValues);
                            }
                        }, 4, null);
                    }
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope $this$intrinsicWidth, List<? extends IntrinsicMeasurable> list, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj3;
        Object obj4;
        int m1072calculateWidthO3s9Psw;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1072calculateWidthO3s9Psw = OutlinedTextFieldKt.m1072calculateWidthO3s9Psw(leadingWidth, trailingWidth, textFieldWidth, labelWidth, placeholderWidth, this.animationProgress < 1.0f, TextFieldImplKt.getZeroConstraints(), $this$intrinsicWidth.getDensity(), this.paddingValues);
                return m1072calculateWidthO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1071calculateHeightzUg2_y0 = OutlinedTextFieldKt.m1071calculateHeightzUg2_y0(leadingHeight, trailingHeight, textFieldHeight, labelHeight, placeholderHeight, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
                return m1071calculateHeightzUg2_y0;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
