        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    animateTo = animatable.animateTo(Boxing.boxFloat(1.0f), (r12 & 2) != 0 ? animatable.defaultSpringSpec : AnimationSpecKt.tween$default(75, 0, EasingKt.getLinearEasing(), 2, null), (r12 & 4) != 0 ? animatable.getVelocity() : null, (r12 & 8) != 0 ? null : null, this);
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    animateTo = animatable.animateTo(Boxing.boxFloat(1.0f), (r12 & 2) != 0 ? animatable.defaultSpringSpec : AnimationSpecKt.tween$default(225, 0, EasingKt.getFastOutSlowInEasing(), 2, null), (r12 & 4) != 0 ? animatable.getVelocity() : null, (r12 & 8) != 0 ? null : null, this);
                    if (animateTo != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    animateTo = animatable.animateTo(Boxing.boxFloat(1.0f), (r12 & 2) != 0 ? animatable.defaultSpringSpec : AnimationSpecKt.tween$default(225, 0, EasingKt.getLinearEasing(), 2, null), (r12 & 4) != 0 ? animatable.getVelocity() : null, (r12 & 8) != 0 ? null : null, this);
                    if (animateTo != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
