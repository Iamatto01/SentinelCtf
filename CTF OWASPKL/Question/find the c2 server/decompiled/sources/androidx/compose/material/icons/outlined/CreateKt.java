...
public final class CreateKt {
    ...
    public static final ImageVector getCreate(Icons.Outlined $this$Create) {
        ...
        ImageVector.Builder $this$_get_Create__u24lambda_u241 = new ImageVector.Builder("Outlined.Create", Dp.m5122constructorimpl(24.0f), Dp.m5122constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.moveTo(3.0f, 17.25f);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.moveTo(5.92f, 19.0f);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.reflectiveCurveToRelative(-0.51f, 0.1f, -0.7f, 0.29f);
