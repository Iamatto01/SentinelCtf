...
public final class StateLayer {
    ...
    public final void m1220drawStateLayerH2RKhps(DrawScope drawStateLayer, float radius, long color) {
        float targetRadius;
        long modulatedColor;
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        if (Float.isNaN(radius)) {
            targetRadius = RippleAnimationKt.m1211getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo3146getSizeNHjbRc());
        } else {
            targetRadius = drawStateLayer.mo301toPx0680j_4(radius);
        }
        float alpha = this.animatedAlpha.getValue().floatValue();
        if (alpha > 0.0f) {
            modulatedColor = Color.m2604copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(color) : alpha, (r12 & 2) != 0 ? Color.m2612getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(color) : 0.0f);
            if (!this.bounded) {
                DrawScope.m3128drawCircleVaOC9Bg$default(drawStateLayer, modulatedColor, targetRadius, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float right$iv = Size.m2437getWidthimpl(drawStateLayer.mo3146getSizeNHjbRc());
            float bottom$iv = Size.m2434getHeightimpl(drawStateLayer.mo3146getSizeNHjbRc());
            int clipOp$iv = ClipOp.Companion.m2595getIntersectrtfAjoo();
            DrawContext $this$withTransform_u24lambda_u2d6$iv$iv = drawStateLayer.getDrawContext();
