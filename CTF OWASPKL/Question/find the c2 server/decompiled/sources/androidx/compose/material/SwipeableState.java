...
public class SwipeableState<T> {
    ...
    public final void setAnimationRunning(boolean z) {
        MutableState $this$setValue$iv = this.isAnimationRunning$delegate;
        $this$setValue$iv.setValue(Boolean.valueOf(z));
    }

    public final boolean isAnimationRunning() {
        State $this$getValue$iv = this.isAnimationRunning$delegate;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:82:0x0232, code lost:
        if (r2.snapInternalToOffset(r13, r15) == r1) goto L80;
     */
    ...
    */
    ...
    public final Function2<Float, Float, Float> getThresholds$material_release() {
        State $this$getValue$iv = this.thresholds$delegate;
    ...
    public final void setResistance$material_release(ResistanceConfig resistanceConfig) {
        MutableState $this$setValue$iv = this.resistance$delegate;
        ...
        public final <T> Saver<SwipeableState<T>, T> Saver(final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> confirmStateChange) {
            ...
            return SaverKt.Saver(new Function2<SaverScope, SwipeableState<T>, T>() { // from class: androidx.compose.material.SwipeableState$Companion$Saver$1
                ...
                public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Object p2) {
                    return invoke(saverScope, (SwipeableState) ((SwipeableState) p2));
                }
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object p1) {
                    return invoke((SwipeableState$Companion$Saver$2<T>) p1);
                }
