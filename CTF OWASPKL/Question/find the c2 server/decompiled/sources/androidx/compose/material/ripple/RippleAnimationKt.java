...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5122constructorimpl(10);
    ...
    public static final float m1212getRippleStartRadiusuvyYCjk(long size) {
        return Math.max(Size.m2437getWidthimpl(size), Size.m2434getHeightimpl(size)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m1211getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean bounded, long size) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float radiusCoveringBounds = Offset.m2366getDistanceimpl(OffsetKt.Offset(Size.m2437getWidthimpl(size), Size.m2434getHeightimpl(size))) / 2.0f;
        if (bounded) {
            return getRippleEndRadius.mo301toPx0680j_4(BoundedRippleExtraRadius) + radiusCoveringBounds;
        }
