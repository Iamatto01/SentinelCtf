...
final class DefaultTextFieldForExposedDropdownMenusColors implements TextFieldColorsWithIcons {
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2596boximpl(this.backgroundColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2607equalsimpl0(this.textColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).textColor) && Color.m2607equalsimpl0(this.disabledTextColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledTextColor) && Color.m2607equalsimpl0(this.cursorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).cursorColor) && Color.m2607equalsimpl0(this.errorCursorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorCursorColor) && Color.m2607equalsimpl0(this.focusedIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedIndicatorColor) && Color.m2607equalsimpl0(this.unfocusedIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).unfocusedIndicatorColor) && Color.m2607equalsimpl0(this.errorIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorIndicatorColor) && Color.m2607equalsimpl0(this.disabledIndicatorColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledIndicatorColor) && Color.m2607equalsimpl0(this.leadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).leadingIconColor) && Color.m2607equalsimpl0(this.disabledLeadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledLeadingIconColor) && Color.m2607equalsimpl0(this.errorLeadingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorLeadingIconColor) && Color.m2607equalsimpl0(this.trailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).trailingIconColor) && Color.m2607equalsimpl0(this.focusedTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedTrailingIconColor) && Color.m2607equalsimpl0(this.disabledTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledTrailingIconColor) && Color.m2607equalsimpl0(this.errorTrailingIconColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorTrailingIconColor) && Color.m2607equalsimpl0(this.backgroundColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).backgroundColor) && Color.m2607equalsimpl0(this.focusedLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).focusedLabelColor) && Color.m2607equalsimpl0(this.unfocusedLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).unfocusedLabelColor) && Color.m2607equalsimpl0(this.disabledLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledLabelColor) && Color.m2607equalsimpl0(this.errorLabelColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).errorLabelColor) && Color.m2607equalsimpl0(this.placeholderColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).placeholderColor) && Color.m2607equalsimpl0(this.disabledPlaceholderColor, ((DefaultTextFieldForExposedDropdownMenusColors) other).disabledPlaceholderColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((((((((((((((((((((((((((((result * 31) + Color.m2613hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2613hashCodeimpl(this.cursorColor)) * 31) + Color.m2613hashCodeimpl(this.errorCursorColor)) * 31) + Color.m2613hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2613hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2613hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2613hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2613hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2613hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2613hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2613hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2613hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2613hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2613hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2613hashCodeimpl(this.backgroundColor)) * 31) + Color.m2613hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2613hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2613hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2613hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2613hashCodeimpl(this.placeholderColor)) * 31) + Color.m2613hashCodeimpl(this.disabledPlaceholderColor);
    }
}
