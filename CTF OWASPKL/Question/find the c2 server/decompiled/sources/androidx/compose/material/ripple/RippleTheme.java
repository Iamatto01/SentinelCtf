...
public interface RippleTheme {
    ...
    long mo1047defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1219defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            float contentLuminance = ColorKt.m2658luminance8_81llA(contentColor);
            if (!lightTheme && contentLuminance < 0.5d) {
                return Color.Companion.m2643getWhite0d7_KjU();
            }
            return contentColor;
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m1218defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            ...
            if (!lightTheme) {
                ...
                return rippleAlpha;
            } else if (ColorKt.m2658luminance8_81llA(contentColor) > 0.5d) {
