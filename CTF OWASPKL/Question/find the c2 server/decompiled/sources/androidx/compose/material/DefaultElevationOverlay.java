...
public final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo996apply7g2Lkgo(long color, float elevation, Composer $composer, int $changed) {
        ...
        int $this$dp$iv = Dp.m5121compareTo0680j_4(elevation, Dp.m5122constructorimpl(0));
        if ($this$dp$iv > 0 && !colors.isLight()) {
            foregroundColor2 = ElevationOverlayKt.m1021calculateForegroundColorCLU3JFs(color, elevation, $composer, ($changed & 14) | ($changed & 112));
            foregroundColor = ColorKt.m2651compositeOverOWjLjI(foregroundColor2, color);
        } else {
