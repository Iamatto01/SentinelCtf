...
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1047defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long m1219defaultRippleColor5vOe2sY = RippleTheme.Companion.m1219defaultRippleColor5vOe2sY(Color.Companion.m2632getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha m1218defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m1218defaultRippleAlphaDxMtmZc(Color.Companion.m2632getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
