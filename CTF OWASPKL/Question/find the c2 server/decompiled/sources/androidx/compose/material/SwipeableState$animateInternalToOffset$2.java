        ...
        try {
            switch (swipeableState$animateInternalToOffset$2.label) {
                case 0:
                    ...
                    animateTo = r11.animateTo(Boxing.boxFloat(swipeableState$animateInternalToOffset$2.$target), (r12 & 2) != 0 ? r11.defaultSpringSpec : swipeableState$animateInternalToOffset$2.$spec, (r12 & 4) != 0 ? AnimatableKt.Animatable$default(prevValue.element, 0.0f, 2, null).getVelocity() : null, (r12 & 8) != 0 ? null : new Function1<Animatable<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.material.SwipeableState$animateInternalToOffset$2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
