...
public final class ThreeLine {
    ...
    private static final float MinHeight = Dp.m5122constructorimpl(88);
    ...
    private static final float IconThreeLineVerticalPadding = Dp.m5122constructorimpl(16);
    ...
    private static final float ThreeLineBaselineFirstOffset = Dp.m5122constructorimpl(28);
    private static final float ThreeLineBaselineSecondOffset = Dp.m5122constructorimpl(20);
    private static final float ThreeLineBaselineThirdOffset = Dp.m5122constructorimpl(20);
    private static final float ThreeLineTrailingTopPadding = Dp.m5122constructorimpl(16);
