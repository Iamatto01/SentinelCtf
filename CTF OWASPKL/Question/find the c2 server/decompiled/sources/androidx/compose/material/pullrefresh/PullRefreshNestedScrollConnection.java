...
public final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo309onPreScrollOzD1aCk(long available, int source) {
        return !this.enabled ? Offset.Companion.m2384getZeroF1C5BW0() : (!NestedScrollSource.m3901equalsimpl0(source, NestedScrollSource.Companion.m3906getDragWNlRxjI()) || Offset.m2369getYimpl(available) >= 0.0f) ? Offset.Companion.m2384getZeroF1C5BW0() : OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m2369getYimpl(available))).floatValue());
    }
    ...
    */
    public java.lang.Object mo478onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r7 = this;
        ...
        L35:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m5348getYimpl(r8)
        ...
        L50:
            ...
            androidx.compose.ui.unit.Velocity r8 = androidx.compose.ui.unit.Velocity.m5338boximpl(r8)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.mo478onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
