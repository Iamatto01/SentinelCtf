...
public final class PullRefreshIndicatorTransformKt {
    ...
    public static final Modifier pullRefreshIndicatorTransform(Modifier $this$pullRefreshIndicatorTransform, final PullRefreshState state, final boolean scale) {
        ...
        Modifier $this$pullRefreshIndicatorTransform_u24lambda_u241 = GraphicsLayerModifierKt.graphicsLayer(DrawModifierKt.drawWithContent(Modifier.Companion, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorTransformKt$pullRefreshIndicatorTransform$2$1
            @Override // kotlin.jvm.functions.Function1
            ...
            public final void invoke2(ContentDrawScope drawWithContent) {
                ...
                $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo3074clipRectN_I0leg(-3.4028235E38f, 0.0f, Float.MAX_VALUE, Float.MAX_VALUE, clipOp$iv);
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayer) {
                ...
                graphicsLayer.setTranslationY(PullRefreshState.this.getPosition$material_release() - Size.m2434getHeightimpl(graphicsLayer.mo2788getSizeNHjbRc()));
