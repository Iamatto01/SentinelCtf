...
public final class SwipeToDismissKt {
    private static final float DISMISS_THRESHOLD = Dp.m5122constructorimpl(56);
    ...
    public static final DismissState rememberDismissState(final DismissValue initialValue, final Function1<? super DismissValue, Boolean> function1, Composer $composer, int $changed, int i) {
        ...
        DismissState dismissState = (DismissState) RememberSaveableKt.m2260rememberSaveable(objArr, Saver, (String) null, (Function0<? extends Object>) value$iv$iv, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
