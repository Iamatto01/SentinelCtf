...
public final class TabRowKt {
    ...
    public static final void m1160TabRowpAZo6Ak(final int selectedTabIndex, Modifier modifier, long backgroundColor, long contentColor, Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> tabs, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 2995931) == 599186 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    $dirty &= -7169;
                    contentColor2 = ColorsKt.m980contentColorForek8zF_U(backgroundColor2, $composer2, ($dirty >> 6) & 14);
                }
                if (i5 != 0) {
                    indicator = ComposableLambdaKt.composableLambda($composer2, -553782708, true, new Function3<List<? extends TabPosition>, Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$1
                        ...
                        public final void invoke(List<TabPosition> tabPositions, Composer $composer3, int $changed2) {
                            ...
                            TabRowDefaults.INSTANCE.m1155Indicator9IZ8Weo(TabRowDefaults.INSTANCE.tabIndicatorOffset(Modifier.Companion, tabPositions.get(selectedTabIndex)), 0.0f, 0L, $composer3, 3072, 6);
                            if (ComposerKt.isTraceInProgress()) {
                ...
                divider = i6 != 0 ? ComposableSingletons$TabRowKt.INSTANCE.m993getLambda1$material_release() : function22;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 4) != 0) {
                    $dirty &= -897;
            ...
            SurfaceKt.m1124SurfaceFjzlyU(SelectableGroupKt.selectableGroup(modifier2), null, backgroundColor2, contentColor2, null, 0.0f, ComposableLambdaKt.composableLambda($composer2, -1961746365, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    ...
                    if (invalid$iv$iv || value$iv$iv == Composer.Companion.getEmpty()) {
                        value$iv$iv = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                return m1162invoke0kLqBqw(subcomposeMeasureScope, constraints.m5084unboximpl());
                            }

                            /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                            public final MeasureResult m1162invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, final long constraints) {
                                Object maxElem$iv;
                                long m5068copyZbe2FdA;
                                Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                                final int tabRowWidth = Constraints.m5078getMaxWidthimpl(constraints);
                                ...
                                for (Object item$iv$iv : $this$map$iv) {
                                    ...
                                    m5068copyZbe2FdA = Constraints.m5068copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(constraints) : tabWidth, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(constraints) : tabWidth, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(constraints) : 0);
                                    destination$iv$iv.add(it.mo4125measureBRTryo0(m5068copyZbe2FdA));
                                ...
                                for (int i9 = 0; i9 < tabCount; i9++) {
                                    int index = i9;
                                    float arg0$iv = SubcomposeLayout.mo298toDpu2uoSUM(tabWidth);
                                    arrayList.add(new TabPosition(Dp.m5122constructorimpl(index * arg0$iv), SubcomposeLayout.mo298toDpu2uoSUM(tabWidth), null));
                                }
                                ...
                                return MeasureScope.layout$default(SubcomposeLayout, tabRowWidth, tabRowHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$2$1$1.1
                                    ...
                                    public final void invoke2(Placeable.PlacementScope layout) {
                                        ...
                                        for (Object element$iv : $this$forEach$iv) {
                                            ...
                                            m5068copyZbe2FdA2 = Constraints.m5068copyZbe2FdA(r10, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(r10) : 0, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(r10) : 0, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(r10) : 0, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(j) : 0);
                                            Placeable placeable2 = it5.mo4125measureBRTryo0(m5068copyZbe2FdA2);
                                        ...
                                        for (Object element$iv2 : $this$forEach$iv2) {
                                            ...
                                            Placeable.PlacementScope.placeRelative$default(layout, it6.mo4125measureBRTryo0(Constraints.Companion.m5086fixedJhjzzOo(i14, i15)), 0, 0, 0.0f, 4, null);
                                        }
                                    }
                                }, 4, null);
                            }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowKt$TabRow$3
            ...
            public final void invoke(Composer composer, int i7) {
                TabRowKt.m1160TabRowpAZo6Ak(selectedTabIndex, modifier4, j, j2, function32, function23, tabs, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    */
    public static final void m1159ScrollableTabRowsKfQg0A(final int r28, androidx.compose.ui.Modifier r29, long r30, long r32, float r34, kotlin.jvm.functions.Function3<? super java.util.List<androidx.compose.material.TabPosition>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r37, androidx.compose.runtime.Composer r38, final int r39, final int r40) {
        /*
