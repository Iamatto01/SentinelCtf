...
public final class RippleAnimation {
    ...
    */
    ...
    public final void m1210draw4WTKRHQ(DrawScope draw, long color) {
        float floatValue;
        long modulatedColor;
        Float valueOf;
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1212getRippleStartRadiusuvyYCjk(draw.mo3146getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            float $this$isUnspecified$iv = this.radius;
            if (Float.isNaN($this$isUnspecified$iv)) {
                valueOf = Float.valueOf(RippleAnimationKt.m1211getRippleEndRadiuscSwnlzA(draw, this.bounded, draw.mo3146getSizeNHjbRc()));
            } else {
                valueOf = Float.valueOf(draw.mo301toPx0680j_4(this.radius));
            }
            this.targetRadius = valueOf;
        }
        if (this.origin == null) {
            this.origin = Offset.m2357boximpl(draw.mo3145getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m2357boximpl(OffsetKt.Offset(Size.m2437getWidthimpl(draw.mo3146getSizeNHjbRc()) / 2.0f, Size.m2434getHeightimpl(draw.mo3146getSizeNHjbRc()) / 2.0f));
        }
        ...
        float m2368getXimpl = Offset.m2368getXimpl(offset.m2378unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp = MathHelpersKt.lerp(m2368getXimpl, Offset.m2368getXimpl(offset2.m2378unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m2369getYimpl = Offset.m2369getYimpl(offset3.m2378unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long centerOffset = OffsetKt.Offset(lerp, MathHelpersKt.lerp(m2369getYimpl, Offset.m2369getYimpl(offset4.m2378unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        modulatedColor = Color.m2604copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(color) : Color.m2608getAlphaimpl(color) * alpha, (r12 & 2) != 0 ? Color.m2612getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(color) : 0.0f);
        if (!this.bounded) {
            DrawScope.m3128drawCircleVaOC9Bg$default(draw, modulatedColor, radius, centerOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
        float right$iv = Size.m2437getWidthimpl(draw.mo3146getSizeNHjbRc());
        float bottom$iv = Size.m2434getHeightimpl(draw.mo3146getSizeNHjbRc());
        ...
        $this$clipRect_rOu3jXo_u24lambda_u2d4$iv.mo3074clipRectN_I0leg(0.0f, 0.0f, right$iv, bottom$iv, clipOp$iv);
        DrawScope.m3128drawCircleVaOC9Bg$default(draw, modulatedColor, radius, centerOffset, 0.0f, null, null, 0, 120, null);
