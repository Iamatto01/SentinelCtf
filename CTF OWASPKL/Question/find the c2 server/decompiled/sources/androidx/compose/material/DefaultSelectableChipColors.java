...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(backgroundColor)660@28989L28:Chip.kt#jmzs0o");
    ...
    public State<Color> contentColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(contentColor)670@29301L28:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> leadingIconColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(leadingIconColor)680@29629L28:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2607equalsimpl0(this.backgroundColor, ((DefaultSelectableChipColors) other).backgroundColor) && Color.m2607equalsimpl0(this.contentColor, ((DefaultSelectableChipColors) other).contentColor) && Color.m2607equalsimpl0(this.leadingIconColor, ((DefaultSelectableChipColors) other).leadingIconColor) && Color.m2607equalsimpl0(this.disabledBackgroundColor, ((DefaultSelectableChipColors) other).disabledBackgroundColor) && Color.m2607equalsimpl0(this.disabledContentColor, ((DefaultSelectableChipColors) other).disabledContentColor) && Color.m2607equalsimpl0(this.disabledLeadingIconColor, ((DefaultSelectableChipColors) other).disabledLeadingIconColor) && Color.m2607equalsimpl0(this.selectedBackgroundColor, ((DefaultSelectableChipColors) other).selectedBackgroundColor) && Color.m2607equalsimpl0(this.selectedContentColor, ((DefaultSelectableChipColors) other).selectedContentColor) && Color.m2607equalsimpl0(this.selectedLeadingIconColor, ((DefaultSelectableChipColors) other).selectedLeadingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Color.m2613hashCodeimpl(this.backgroundColor);
        return (((((((((((((((result * 31) + Color.m2613hashCodeimpl(this.contentColor)) * 31) + Color.m2613hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2613hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2613hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2613hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2613hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m2613hashCodeimpl(this.selectedContentColor)) * 31) + Color.m2613hashCodeimpl(this.selectedLeadingIconColor);
    }
}
