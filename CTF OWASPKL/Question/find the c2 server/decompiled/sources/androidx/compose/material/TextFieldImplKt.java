...
public final class TextFieldImplKt {
    ...
    public static final void CommonDecorationBox(final TextFieldType type, final String value, final Function2<? super Composer, ? super Integer, Unit> innerTextField, final VisualTransformation visualTransformation, final Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean singleLine, boolean enabled, boolean isError, final InteractionSource interactionSource, final PaddingValues contentPadding, final TextFieldColors colors, Function2<? super Composer, ? super Integer, Unit> function25, Composer $composer, final int $changed, final int $changed1, final int i) {
        ...
        ComposerKt.sourceInformation($composer3, "C(CommonDecorationBox)P(12,13,4,14,7,9,8,11,10,3,6,5,2,1)80@3167L105,84@3322L25,101@3932L10,108@4267L5060:TextFieldImpl.kt#jmzs0o");
        int $dirty = $changed;
        int $dirty1 = $changed1;
        if ((i & 1) != 0) {
            $dirty |= 6;
        ...
        if (($dirty & 1533916891) == 306783378 && (46811 & $dirty1) == 9362 && $composer3.getSkipping()) {
            ...
            Function3 labelColor = new Function3<InputPhase, Composer, Integer, Color>() { // from class: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$labelColor$1
                ...
                public /* bridge */ /* synthetic */ Color invoke(InputPhase inputPhase2, Composer composer, Integer num) {
                    return Color.m2596boximpl(m1183invokeXeAY9LY(inputPhase2, composer, num.intValue()));
                }

                /* renamed from: invoke-XeAY9LY  reason: not valid java name */
                public final long m1183invokeXeAY9LY(InputPhase it, Composer $composer4, int $changed2) {
                    ...
                    boolean z4 = z2;
                    boolean z5 = it == InputPhase.UnfocusedEmpty ? false : z3;
                    InteractionSource interactionSource2 = interactionSource;
                    int i10 = $dirty12;
                    long m2616unboximpl = textFieldColors.labelColor(z4, z5, interactionSource2, $composer4, (($dirty2 >> 27) & 14) | ((i10 << 3) & 896) | (i10 & 7168)).getValue().m2616unboximpl();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    $composer4.endReplaceableGroup();
                    return m2616unboximpl;
                }
            };
            ...
            final boolean shouldOverrideTextStyleColor = (Color.m2607equalsimpl0(subtitle1.m4657getColor0d7_KjU(), Color.Companion.m2642getUnspecified0d7_KjU()) && !Color.m2607equalsimpl0(caption.m4657getColor0d7_KjU(), Color.Companion.m2642getUnspecified0d7_KjU())) || (!Color.m2607equalsimpl0(subtitle1.m4657getColor0d7_KjU(), Color.Companion.m2642getUnspecified0d7_KjU()) && Color.m2607equalsimpl0(caption.m4657getColor0d7_KjU(), Color.Companion.m2642getUnspecified0d7_KjU()));
            TextFieldTransitionScope textFieldTransitionScope = TextFieldTransitionScope.INSTANCE;
            $composer3.startReplaceableGroup(2129141006);
            ComposerKt.sourceInformation($composer3, "*110@4363L10,111@4455L22");
            long $this$CommonDecorationBox_u24lambda_u242 = MaterialTheme.INSTANCE.getTypography($composer3, 6).getCaption().m4657getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if (!($this$takeOrElse_u2dDxMtmZc$iv != Color.Companion.m2642getUnspecified0d7_KjU())) {
                    $this$takeOrElse_u2dDxMtmZc$iv = labelColor.invoke(inputState, $composer3, 0).m2616unboximpl();
                }
            ...
            long $this$CommonDecorationBox_u24lambda_u244 = MaterialTheme.INSTANCE.getTypography($composer3, 6).getSubtitle1().m4657getColor0d7_KjU();
            if (shouldOverrideTextStyleColor) {
                ...
                if ($this$takeOrElse_u2dDxMtmZc$iv2 != Color.Companion.m2642getUnspecified0d7_KjU()) {
                    ...
                    z = false;
                    $this$takeOrElse_u2dDxMtmZc$iv2 = labelColor.invoke(inputState, $composer3, 0).m2616unboximpl();
                }
            ...
            $composer2 = $composer3;
            textFieldTransitionScope.m1188TransitionDTcfvLk(inputState, j, j2, labelColor, z4, ComposableLambdaKt.composableLambda($composer2, 341865432, true, new Function6<Float, Color, Color, Float, Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$3
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Float f, Color color, Color color2, Float f2, Composer composer, Integer num) {
                    m1181invokeRIQooxk(f.floatValue(), color.m2616unboximpl(), color2.m2616unboximpl(), f2.floatValue(), composer, num.intValue());
                ...
                */
                public final void m1181invokeRIQooxk(final float r34, final long r35, final long r37, final float r39, androidx.compose.runtime.Composer r40, int r41) {
                    /*
                        Method dump skipped, instructions count: 1026
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TextFieldImplKt$CommonDecorationBox$3.m1181invokeRIQooxk(float, long, long, float, androidx.compose.runtime.Composer, int):void");
                }
            }), $composer2, 1769472);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
    ...
    public static final void m1180DecorationeuL9pac(final long contentColor, TextStyle typography, Float contentAlpha, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        Object obj;
        Object obj2;
        ...
        if (($dirty2 & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            Float contentAlpha3 = i3 != 0 ? null : obj2;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-399493340, $dirty2, -1, "androidx.compose.material.Decoration (TextFieldImpl.kt:231)");
            }
            ...
            Function2 colorAndEmphasis = ComposableLambdaKt.composableLambda($composer2, 494684590, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$Decoration$colorAndEmphasis$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ComposerKt.sourceInformation($composer3, "C238@9719L476:TextFieldImpl.kt#jmzs0o");
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(494684590, $changed2, -1, "androidx.compose.material.Decoration.<anonymous> (TextFieldImpl.kt:237)");
                        }
                        ...
                        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.composableLambda($composer3, -1132188434, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$Decoration$colorAndEmphasis$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer $composer4, int $changed3) {
                                ...
                                if (($changed3 & 11) != 2 || !$composer4.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-1132188434, $changed3, -1, "androidx.compose.material.Decoration.<anonymous>.<anonymous> (TextFieldImpl.kt:238)");
                                    }
                                    if (f2 != null) {
                                        $composer4.startReplaceableGroup(-452622131);
                                        ComposerKt.sourceInformation($composer4, "240@9843L142");
                                        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(f2)}, function2, $composer4, ((i4 >> 6) & 112) | 8);
                                        $composer4.endReplaceableGroup();
                                    } else {
                                        $composer4.startReplaceableGroup(-452621951);
                                        ComposerKt.sourceInformation($composer4, "245@10023L148");
                                        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m2608getAlphaimpl(j)))}, function2, $composer4, ((i4 >> 6) & 112) | 8);
                                        $composer4.endReplaceableGroup();
                                    }
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
            ...
            if (typography3 != null) {
                $composer2.startReplaceableGroup(-2009952864);
                ComposerKt.sourceInformation($composer2, "252@10230L46");
                TextKt.ProvideTextStyle(typography3, colorAndEmphasis, $composer2, (($dirty2 >> 3) & 14) | 48);
            } else {
                $composer2.startReplaceableGroup(-2009952812);
                ComposerKt.sourceInformation($composer2, "252@10282L18");
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TextFieldImplKt$Decoration$1
            ...
            public final void invoke(Composer composer, int i4) {
                TextFieldImplKt.m1180DecorationeuL9pac(contentColor, textStyle, f2, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
