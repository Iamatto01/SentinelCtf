...
public final class CheckCircleKt {
    ...
    public static final ImageVector getCheckCircle(Icons.Filled $this$CheckCircle) {
        ...
        ImageVector.Builder $this$_get_CheckCircle__u24lambda_u241 = new ImageVector.Builder("Filled.CheckCircle", Dp.m5122constructorimpl(24.0f), Dp.m5122constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.moveTo(10.0f, 17.0f);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.lineTo(19.0f, 8.0f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.lineToRelative(-9.0f, 9.0f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.close();
