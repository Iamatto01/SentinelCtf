...
public final class Strings {
    ...
    private static final int NavigationMenu = m1109constructorimpl(0);
    private static final int CloseDrawer = m1109constructorimpl(1);
    private static final int CloseSheet = m1109constructorimpl(2);
    private static final int DefaultErrorMessage = m1109constructorimpl(3);
    private static final int ExposedDropdownMenu = m1109constructorimpl(4);
    private static final int SliderRangeStart = m1109constructorimpl(5);
    private static final int SliderRangeEnd = m1109constructorimpl(6);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Strings m1108boximpl(int i) {
        return new Strings(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1109constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1110equalsimpl(int i, Object obj) {
        return (obj instanceof Strings) && i == ((Strings) obj).m1114unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1111equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1112hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1113toStringimpl(int i) {
        return "Strings(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m1110equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1112hashCodeimpl(this.value);
    }

    public String toString() {
        return m1113toStringimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m1114unboximpl() {
        return this.value;
    }
