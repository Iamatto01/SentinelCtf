...
public final class DragGestureDetectorCopyKt {
    ...
    /* JADX WARN: Removed duplicated region for block: B:53:0x01a5 A[RETURN, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:54:0x01a7  */
    /* JADX WARN: Removed duplicated region for block: B:60:0x00f8 A[SYNTHETIC] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:44:0x014a -> B:18:0x009b). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:50:0x0195 -> B:51:0x019f). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:59:0x01c3 -> B:18:0x009b). Please submit an issue!!! */
    ...
    */
    ...
    private static final Object m999awaitPointerSlopOrCancellationpn7EDYM(AwaitPointerEventScope $this$awaitPointerSlopOrCancellation_u2dpn7EDYM, long pointerId, int pointerType, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function1<? super Offset, Float> function1, Continuation<? super PointerInputChange> continuation) {
        ...
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(dragEvent)) {
                ...
                float positionChange = function1.invoke(Offset.m2357boximpl(currentPosition)).floatValue() - function1.invoke(Offset.m2357boximpl(previousPosition)).floatValue();
    ...
    private static final boolean m1000isPointerUpDmW0f2w(PointerEvent $this$isPointerUp_u2dDmW0f2w, long pointerId) {
        Object it$iv;
    ...
    public static final float m1001pointerSlopE8SPZFQ(ViewConfiguration pointerSlop, int pointerType) {
