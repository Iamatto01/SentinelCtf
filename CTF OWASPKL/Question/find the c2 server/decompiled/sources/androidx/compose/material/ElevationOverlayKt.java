...
public final class ElevationOverlayKt {
    ...
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material.ElevationOverlayKt$LocalAbsoluteElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m5120boximpl(m1022invokeD9Ej5fM());
        }

        /* renamed from: invoke-D9Ej5fM  reason: not valid java name */
        public final float m1022invokeD9Ej5fM() {
    ...
    public static final long m1021calculateForegroundColorCLU3JFs(long backgroundColor, float elevation, Composer $composer, int $changed) {
        ...
        long baseForegroundColor = ColorsKt.m980contentColorForek8zF_U(backgroundColor, $composer, $changed & 14);
        m2604copywmQWz5c = Color.m2604copywmQWz5c(baseForegroundColor, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(baseForegroundColor) : alpha, (r12 & 2) != 0 ? Color.m2612getRedimpl(baseForegroundColor) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(baseForegroundColor) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(baseForegroundColor) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
