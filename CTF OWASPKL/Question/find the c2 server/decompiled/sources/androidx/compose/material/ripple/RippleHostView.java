...
public final class RippleHostView extends View {
    ...
    public final void m1214addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m1215updateRipplePropertiesbiQXAtU(size, radius, color, alpha);
        if (bounded) {
            ripple.setHotspot(Offset.m2368getXimpl(interaction.m333getPressPositionF1C5BW0()), Offset.m2369getYimpl(interaction.m333getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m1215updateRipplePropertiesbiQXAtU(long size, int radius, long color, float alpha) {
        UnprojectedRipple ripple = this.ripple;
        if (ripple == null) {
            return;
        }
        ripple.trySetRadius(radius);
        ripple.m1222setColorDxMtmZc(color, alpha);
        Rect newBounds = new Rect(0, 0, MathKt.roundToInt(Size.m2437getWidthimpl(size)), MathKt.roundToInt(Size.m2434getHeightimpl(size)));
