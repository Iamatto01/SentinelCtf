...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition $this$calculateTabOffset, Density density, int edgeOffset, List<TabPosition> list) {
        int totalTabRowWidth = density.mo295roundToPx0680j_4(((TabPosition) CollectionsKt.last((List<? extends Object>) list)).m1152getRightD9Ej5fM()) + edgeOffset;
        int visibleWidth = totalTabRowWidth - this.scrollState.getMaxValue();
        int tabOffset = density.mo295roundToPx0680j_4($this$calculateTabOffset.m1151getLeftD9Ej5fM());
        int scrollerCenter = visibleWidth / 2;
        int tabWidth = density.mo295roundToPx0680j_4($this$calculateTabOffset.m1153getWidthD9Ej5fM());
