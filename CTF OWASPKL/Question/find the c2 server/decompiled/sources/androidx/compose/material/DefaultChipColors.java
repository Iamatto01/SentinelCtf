...
final class DefaultChipColors implements ChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(backgroundColor)593@26442L79:Chip.kt#jmzs0o");
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2596boximpl(enabled ? this.backgroundColor : this.disabledBackgroundColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> contentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(contentColor)598@26624L73:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(483145880, $changed, -1, "androidx.compose.material.DefaultChipColors.contentColor (Chip.kt:597)");
        }
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2596boximpl(enabled ? this.contentColor : this.disabledContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public State<Color> leadingIconContentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(leadingIconContentColor)603@26811L117:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2607equalsimpl0(this.backgroundColor, ((DefaultChipColors) other).backgroundColor) && Color.m2607equalsimpl0(this.contentColor, ((DefaultChipColors) other).contentColor) && Color.m2607equalsimpl0(this.leadingIconContentColor, ((DefaultChipColors) other).leadingIconContentColor) && Color.m2607equalsimpl0(this.disabledBackgroundColor, ((DefaultChipColors) other).disabledBackgroundColor) && Color.m2607equalsimpl0(this.disabledContentColor, ((DefaultChipColors) other).disabledContentColor) && Color.m2607equalsimpl0(this.disabledLeadingIconContentColor, ((DefaultChipColors) other).disabledLeadingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m2613hashCodeimpl(this.contentColor)) * 31) + Color.m2613hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m2613hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2613hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2613hashCodeimpl(this.disabledLeadingIconContentColor);
    }
}
