...
final class DefaultSwitchColors implements SwitchColors {
    ...
    public State<Color> thumbColor(boolean enabled, boolean checked, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(thumbColor)P(1)329@13567L253:Switch.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-66424183, $changed, -1, "androidx.compose.material.DefaultSwitchColors.thumbColor (Switch.kt:328)");
        }
        if (enabled) {
    ...
    public State<Color> trackColor(boolean enabled, boolean checked, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(trackColor)P(1)340@13939L253:Switch.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1176343362, $changed, -1, "androidx.compose.material.DefaultSwitchColors.trackColor (Switch.kt:339)");
        }
        if (enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m2607equalsimpl0(this.checkedThumbColor, ((DefaultSwitchColors) other).checkedThumbColor) && Color.m2607equalsimpl0(this.checkedTrackColor, ((DefaultSwitchColors) other).checkedTrackColor) && Color.m2607equalsimpl0(this.uncheckedThumbColor, ((DefaultSwitchColors) other).uncheckedThumbColor) && Color.m2607equalsimpl0(this.uncheckedTrackColor, ((DefaultSwitchColors) other).uncheckedTrackColor) && Color.m2607equalsimpl0(this.disabledCheckedThumbColor, ((DefaultSwitchColors) other).disabledCheckedThumbColor) && Color.m2607equalsimpl0(this.disabledCheckedTrackColor, ((DefaultSwitchColors) other).disabledCheckedTrackColor) && Color.m2607equalsimpl0(this.disabledUncheckedThumbColor, ((DefaultSwitchColors) other).disabledUncheckedThumbColor) && Color.m2607equalsimpl0(this.disabledUncheckedTrackColor, ((DefaultSwitchColors) other).disabledUncheckedTrackColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((result * 31) + Color.m2613hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m2613hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m2613hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m2613hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m2613hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m2613hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m2613hashCodeimpl(this.disabledUncheckedTrackColor);
    }
}
