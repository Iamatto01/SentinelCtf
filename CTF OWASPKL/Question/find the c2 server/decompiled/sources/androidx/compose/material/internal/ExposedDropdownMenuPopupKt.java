...
public final class ExposedDropdownMenuPopupKt {
    ...
    public static final void ExposedDropdownMenuPopup(Function0<Unit> function0, final PopupPositionProvider popupPositionProvider, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        ...
        Composer $composer3 = $composer.startRestartGroup(-841446797);
        ComposerKt.sourceInformation($composer3, "C(ExposedDropdownMenuPopup)P(1,2)84@3429L7,85@3468L7,86@3512L7,87@3567L7,88@3603L28,89@3658L29,90@3706L38,91@3767L907,118@4680L380,132@5066L192,140@5264L166,149@5608L647:ExposedDropdownMenuPopup.kt#mnwmf7");
        int $dirty2 = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty2 |= 6;
            ...
            $dirty2 |= $composer3.changedInstance(function03) ? 4 : 2;
        ...
        if (($dirty3 & 731) == 146 && $composer3.getSkipping()) {
            ...
            Function0 onDismissRequest2 = i2 != 0 ? null : function02;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-841446797, $dirty3, -1, "androidx.compose.material.internal.ExposedDropdownMenuPopup (ExposedDropdownMenuPopup.kt:79)");
            }
            ...
            UUID popupId = (UUID) RememberSaveableKt.m2260rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Function0<? extends Object>) new Function0<UUID>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupId$1
                @Override // kotlin.jvm.functions.Function0
            ...
            if (it$iv$iv == Composer.Companion.getEmpty()) {
                ...
                $dirty = $dirty3;
                $composer2 = $composer3;
                final PopupLayout $this$ExposedDropdownMenuPopup_u24lambda_u242_u24lambda_u241 = new PopupLayout(onDismissRequest2, testTag2, view, density, popupPositionProvider, popupId);
                currentContent$delegate = currentContent$delegate2;
                parentComposition = parentComposition2;
                $this$ExposedDropdownMenuPopup_u24lambda_u242_u24lambda_u241.setContent(parentComposition, ComposableLambdaKt.composableLambdaInstance(144472904, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1
                    ...
                    public final void invoke(Composer $composer4, int $changed2) {
                        ComposerKt.sourceInformation($composer4, "C101@4111L533:ExposedDropdownMenuPopup.kt#mnwmf7");
                        if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(144472904, $changed2, -1, "androidx.compose.material.internal.ExposedDropdownMenuPopup.<anonymous>.<anonymous>.<anonymous> (ExposedDropdownMenuPopup.kt:100)");
                            }
                            ...
                            Modifier modifier$iv = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                {
                                    super(1);
                                }
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                    m1196invokeozmzZPI(intSize.m5286unboximpl());
                                    return Unit.INSTANCE;
                                }

                                /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                                public final void m1196invokeozmzZPI(long it) {
                                    PopupLayout.this.m1198setPopupContentSizefhxjrPA(IntSize.m5274boximpl(it));
                            ...
                            Function2 content$iv = ComposableLambdaKt.composableLambda($composer4, 2080999218, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(2);
                                ...
                                public final void invoke(Composer $composer5, int $changed3) {
                                    ...
                                    ComposerKt.sourceInformation($composer5, "C112@4610L16:ExposedDropdownMenuPopup.kt#mnwmf7");
                                    if (($changed3 & 11) != 2 || !$composer5.getSkipping()) {
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventStart(2080999218, $changed3, -1, "androidx.compose.material.internal.ExposedDropdownMenuPopup.<anonymous>.<anonymous>.<anonymous>.<anonymous> (ExposedDropdownMenuPopup.kt:111)");
                                        }
                                        ExposedDropdownMenuPopup$lambda$0 = ExposedDropdownMenuPopupKt.ExposedDropdownMenuPopup$lambda$0(state);
                                        ExposedDropdownMenuPopup$lambda$0.invoke($composer5, 0);
                                        if (ComposerKt.isTraceInProgress()) {
                            ...
                            $composer4.startReplaceableGroup(1769324208);
                            ComposerKt.sourceInformation($composer4, "CC(SimpleStack)P(1)178@6799L979:ExposedDropdownMenuPopup.kt#mnwmf7");
                            ...
                            Composer $this$Layout_u24lambda_u240$iv$iv = Updater.m2247constructorimpl($composer4);
                ...
                $composer3.updateRememberedValue($this$ExposedDropdownMenuPopup_u24lambda_u242_u24lambda_u241);
            ...
            EffectsKt.DisposableEffect(popupLayout2, new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$1
                ...
                public final DisposableEffectResult invoke(DisposableEffectScope DisposableEffect) {
                    ...
                    PopupLayout.this.updateParameters(onDismissRequest, testTag3, layoutDirection);
            ...
            Modifier modifier$iv = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.Companion, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$6
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$7
            ...
            public final void invoke(Composer composer, int i4) {
                ExposedDropdownMenuPopupKt.ExposedDropdownMenuPopup(function04, popupPositionProvider, content, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
