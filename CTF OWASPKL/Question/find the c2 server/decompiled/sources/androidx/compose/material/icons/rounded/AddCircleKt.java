...
public final class AddCircleKt {
    ...
    public static final ImageVector getAddCircle(Icons.Rounded $this$AddCircle) {
        ...
        ImageVector.Builder $this$_get_AddCircle__u24lambda_u241 = new ImageVector.Builder("Rounded.AddCircle", Dp.m5122constructorimpl(24.0f), Dp.m5122constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.verticalLineToRelative(-3.0f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.lineTo(8.0f, 13.0f);
