...
public final class SnackbarHostState {
    ...
    public final void setCurrentSnackbarData(SnackbarData snackbarData) {
        MutableState $this$setValue$iv = this.currentSnackbarData$delegate;
        $this$setValue$iv.setValue(snackbarData);
    }

    public final SnackbarData getCurrentSnackbarData() {
        State $this$getValue$iv = this.currentSnackbarData$delegate;
    ...
    /* JADX WARN: Removed duplicated region for block: B:29:0x00f2 A[Catch: all -> 0x010b, TRY_LEAVE, TryCatch #4 {all -> 0x010b, blocks: (B:27:0x00dc, B:29:0x00f2), top: B:60:0x00dc }] */
    ...
    public static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                this.continuation.resumeWith(Result.m5433constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                Result.Companion companion = Result.Companion;
                this.continuation.resumeWith(Result.m5433constructorimpl(SnackbarResult.Dismissed));
            }
        }
    }
}
