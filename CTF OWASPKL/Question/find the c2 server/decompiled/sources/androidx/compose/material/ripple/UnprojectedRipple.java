...
public final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1222setColorDxMtmZc(long color, float alpha) {
        long newColor = m1221calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m2607equalsimpl0(color2.m2616unboximpl(), newColor))) {
            this.rippleColor = Color.m2596boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m2660toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m1221calculateRippleColor5vOe2sY(long color, float alpha) {
        long m2604copywmQWz5c;
        float transformedAlpha = RangesKt.coerceAtMost(alpha, 1.0f);
        m2604copywmQWz5c = Color.m2604copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(color) : transformedAlpha, (r12 & 2) != 0 ? Color.m2612getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(color) : 0.0f);
