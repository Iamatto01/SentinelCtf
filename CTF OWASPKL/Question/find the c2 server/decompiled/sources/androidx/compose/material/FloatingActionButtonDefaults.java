...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m1037elevationixp7dh8(float defaultElevation, float pressedElevation, Composer $composer, int $changed, int i) {
        ...
        if ((i & 1) != 0) {
            defaultElevation = Dp.m5122constructorimpl(6);
        }
        if ((i & 2) != 0) {
            pressedElevation = Dp.m5122constructorimpl(12);
        }
        ...
        FloatingActionButtonElevation m1038elevationxZ9QkE = m1038elevationxZ9QkE(defaultElevation, pressedElevation, Dp.m5122constructorimpl(8), Dp.m5122constructorimpl(8), $composer, $this$dp$iv | 3456 | ($changed & 112) | (($changed << 6) & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1038elevationxZ9QkE;
    }

    /* renamed from: elevation-xZ9-QkE  reason: not valid java name */
    public final FloatingActionButtonElevation m1038elevationxZ9QkE(float defaultElevation, float pressedElevation, float hoveredElevation, float focusedElevation, Composer $composer, int $changed, int i) {
        ...
        float defaultElevation2 = (i & 1) != 0 ? Dp.m5122constructorimpl(6) : defaultElevation;
        if ((i & 2) == 0) {
            pressedElevation2 = pressedElevation;
        } else {
            pressedElevation2 = Dp.m5122constructorimpl(12);
        }
        if ((i & 4) == 0) {
            hoveredElevation2 = hoveredElevation;
        } else {
            hoveredElevation2 = Dp.m5122constructorimpl(8);
        }
        if ((i & 8) == 0) {
            focusedElevation2 = focusedElevation;
        } else {
            focusedElevation2 = Dp.m5122constructorimpl(8);
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object[] keys$iv = {Dp.m5120boximpl(defaultElevation2), Dp.m5120boximpl(pressedElevation2), Dp.m5120boximpl(hoveredElevation2), Dp.m5120boximpl(focusedElevation2)};
