...
public final class AccountBoxKt {
    ...
    public static final ImageVector getAccountBox(Icons.Rounded $this$AccountBox) {
        ...
        ImageVector.Builder $this$_get_AccountBox__u24lambda_u241 = new ImageVector.Builder("Rounded.AccountBox", Dp.m5122constructorimpl(24.0f), Dp.m5122constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        $this$PathData_u24lambda_u2d0$iv$iv$iv.horizontalLineTo(5.0f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.verticalLineToRelative(-0.23f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.curveToRelative(0.0f, -0.62f, 0.28f, -1.2f, 0.76f, -1.58f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.curveTo(7.47f, 15.82f, 9.64f, 15.0f, 12.0f, 15.0f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.reflectiveCurveToRelative(4.53f, 0.82f, 6.24f, 2.19f);
        $this$PathData_u24lambda_u2d0$iv$iv$iv.curveToRelative(0.48f, 0.38f, 0.76f, 0.97f, 0.76f, 1.58f);
