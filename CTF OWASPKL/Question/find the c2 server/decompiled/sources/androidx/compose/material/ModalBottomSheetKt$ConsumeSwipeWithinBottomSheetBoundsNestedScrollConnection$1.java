...
public final class ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1(SwipeableV2State<?> swipeableV2State, Orientation $orientation) {
    ...
    public long mo309onPreScrollOzD1aCk(long available, int source) {
        ...
        if (delta < 0.0f && NestedScrollSource.m3901equalsimpl0(source, NestedScrollSource.Companion.m3906getDragWNlRxjI())) {
    ...
    */
    public java.lang.Object mo478onPreFlingQWom1Mo(long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        ...
        L33:
            ...
            if (r5 >= 0) goto L5f
            androidx.compose.material.SwipeableV2State<?> r5 = r2.$state
        ...
        L5f:
            ...
            long r7 = r7.m5358getZero9UxMQ8M()
        L65:
            androidx.compose.ui.unit.Velocity r7 = androidx.compose.ui.unit.Velocity.m5338boximpl(r7)
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1.mo478onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object mo307onPostFlingRZ2iAVY(long r5, long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        /*
            r4 = this;
        ...
        L32:
            kotlin.ResultKt.throwOnFailure(r6)
            r0 = r4
            androidx.compose.material.SwipeableV2State<?> r1 = r0.$state
            ...
            return r9
        L48:
            androidx.compose.ui.unit.Velocity r9 = androidx.compose.ui.unit.Velocity.m5338boximpl(r7)
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1.mo307onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final float velocityToFloat(long $this$toFloat) {
        return this.$orientation == Orientation.Horizontal ? Velocity.m5347getXimpl($this$toFloat) : Velocity.m5348getYimpl($this$toFloat);
    }

    private final float offsetToFloat(long $this$toFloat) {
        return this.$orientation == Orientation.Horizontal ? Offset.m2368getXimpl($this$toFloat) : Offset.m2369getYimpl($this$toFloat);
    }
}
