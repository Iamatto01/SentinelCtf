...
public final class TextFieldDefaults {
    ...
    public static /* synthetic */ Modifier m1163indicatorLinegv0btCI$default(TextFieldDefaults textFieldDefaults, Modifier modifier, boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, int i, Object obj) {
        float f3;
        float f4;
        if ((i & 16) == 0) {
            f3 = f;
        ...
        return textFieldDefaults.m1172indicatorLinegv0btCI(modifier, z, z2, interactionSource, textFieldColors, f3, f4);
    }

    /* renamed from: indicatorLine-gv0btCI  reason: not valid java name */
    public final Modifier m1172indicatorLinegv0btCI(Modifier indicatorLine, final boolean enabled, final boolean isError, final InteractionSource interactionSource, final TextFieldColors colors, final float focusedIndicatorLineThickness, final float unfocusedIndicatorLineThickness) {
        ...
        return ComposedModifierKt.composed(indicatorLine, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.TextFieldDefaults$indicatorLine-gv0btCI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                stroke = TextFieldDefaultsKt.m1179animateBorderStrokeAsStateNuRrP5Q(enabled, isError, interactionSource, colors, focusedIndicatorLineThickness, unfocusedIndicatorLineThickness, $composer, 0);
    ...
    */
    public final void m1167BorderBoxnbWgWpA(final boolean r22, final boolean r23, final androidx.compose.foundation.interaction.InteractionSource r24, final androidx.compose.material.TextFieldColors r25, androidx.compose.ui.graphics.Shape r26, float r27, float r28, androidx.compose.runtime.Composer r29, final int r30, final int r31) {
        /*
    ...
    public static /* synthetic */ PaddingValues m1165textFieldWithLabelPaddinga9UjIt4$default(TextFieldDefaults textFieldDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldDefaults.m1176textFieldWithLabelPaddinga9UjIt4(f, f2, f3, f4);
    }
    ...
    public static /* synthetic */ PaddingValues m1166textFieldWithoutLabelPaddinga9UjIt4$default(TextFieldDefaults textFieldDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = TextFieldImplKt.getTextFieldPadding();
        }
        if ((i & 2) != 0) {
        ...
        return textFieldDefaults.m1177textFieldWithoutLabelPaddinga9UjIt4(f, f2, f3, f4);
    }
    ...
    public static /* synthetic */ PaddingValues m1164outlinedTextFieldPaddinga9UjIt4$default(TextFieldDefaults textFieldDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = TextFieldImplKt.getTextFieldPadding();
        }
        if ((i & 2) != 0) {
        ...
        return textFieldDefaults.m1174outlinedTextFieldPaddinga9UjIt4(f, f2, f3, f4);
    }
    ...
    public final TextFieldColors m1175textFieldColorsdx8h9Zs(long textColor, long disabledTextColor, long backgroundColor, long cursorColor, long errorCursorColor, long focusedIndicatorColor, long unfocusedIndicatorColor, long disabledIndicatorColor, long errorIndicatorColor, long leadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long trailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long placeholderColor, long disabledPlaceholderColor, Composer $composer, int $changed, int $changed1, int $changed2, int i) {
        ...
        if ((i & 4) != 0) {
            m2604copywmQWz5c13 = Color.m2604copywmQWz5c(r14, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r14) : 0.12f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r14) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r14) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m961getOnSurface0d7_KjU()) : 0.0f);
            backgroundColor2 = m2604copywmQWz5c13;
        } else {
        ...
        if ((i & 32) != 0) {
            m2604copywmQWz5c12 = Color.m2604copywmQWz5c(r5, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r5) : ContentAlpha.INSTANCE.getHigh($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r5) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r5) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m962getPrimary0d7_KjU()) : 0.0f);
            focusedIndicatorColor2 = m2604copywmQWz5c12;
        } else {
            focusedIndicatorColor2 = focusedIndicatorColor;
        }
        if ((i & 64) != 0) {
            m2604copywmQWz5c11 = Color.m2604copywmQWz5c(r5, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r5) : 0.42f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r5) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r5) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m961getOnSurface0d7_KjU()) : 0.0f);
            unfocusedIndicatorColor2 = m2604copywmQWz5c11;
        } else {
            unfocusedIndicatorColor2 = unfocusedIndicatorColor;
        }
        if ((i & 128) != 0) {
            m2604copywmQWz5c10 = Color.m2604copywmQWz5c(r90, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r90) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r90) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r90) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(unfocusedIndicatorColor2) : 0.0f);
            disabledIndicatorColor2 = m2604copywmQWz5c10;
        } else {
        ...
        if ((i & 512) != 0) {
            m2604copywmQWz5c9 = Color.m2604copywmQWz5c(r5, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r5) : 0.54f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r5) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r5) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m961getOnSurface0d7_KjU()) : 0.0f);
            leadingIconColor2 = m2604copywmQWz5c9;
        } else {
            leadingIconColor2 = leadingIconColor;
        }
        if ((i & 1024) != 0) {
            m2604copywmQWz5c8 = Color.m2604copywmQWz5c(r90, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r90) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r90) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r90) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(leadingIconColor2) : 0.0f);
            disabledLeadingIconColor2 = m2604copywmQWz5c8;
        } else {
            disabledLeadingIconColor2 = disabledLeadingIconColor;
        }
        long errorLeadingIconColor2 = (i & 2048) != 0 ? leadingIconColor2 : errorLeadingIconColor;
        if ((i & 4096) != 0) {
            m2604copywmQWz5c7 = Color.m2604copywmQWz5c(r5, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r5) : 0.54f, (r12 & 2) != 0 ? Color.m2612getRedimpl(r5) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r5) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m961getOnSurface0d7_KjU()) : 0.0f);
            trailingIconColor2 = m2604copywmQWz5c7;
        } else {
            trailingIconColor2 = trailingIconColor;
        }
        if ((i & 8192) != 0) {
            m2604copywmQWz5c6 = Color.m2604copywmQWz5c(r90, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r90) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r90) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r90) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(trailingIconColor2) : 0.0f);
            disabledTrailingIconColor2 = m2604copywmQWz5c6;
        } else {
            disabledTrailingIconColor2 = disabledTrailingIconColor;
        }
        long errorTrailingIconColor2 = (i & 16384) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m956getError0d7_KjU() : errorTrailingIconColor;
        if ((32768 & i) != 0) {
        ...
        if ((131072 & i) != 0) {
            m2604copywmQWz5c3 = Color.m2604copywmQWz5c(r90, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r90) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r90) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r90) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(unfocusedLabelColor2) : 0.0f);
            disabledLabelColor2 = m2604copywmQWz5c3;
        } else {
            disabledLabelColor2 = disabledLabelColor;
        }
        long errorLabelColor2 = (262144 & i) != 0 ? MaterialTheme.INSTANCE.getColors($composer, 6).m956getError0d7_KjU() : errorLabelColor;
        if ((524288 & i) != 0) {
        ...
        if ((i & 1048576) != 0) {
            m2604copywmQWz5c = Color.m2604copywmQWz5c(r90, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r90) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r90) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r90) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(placeholderColor2) : 0.0f);
    ...
    public final TextFieldColors m1173outlinedTextFieldColorsdx8h9Zs(long textColor, long disabledTextColor, long backgroundColor, long cursorColor, long errorCursorColor, long focusedBorderColor, long unfocusedBorderColor, long disabledBorderColor, long errorBorderColor, long leadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long trailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long placeholderColor, long disabledPlaceholderColor, Composer $composer, int $changed, int $changed1, int $changed2, int i) {
        ...
        if ((i & 2) != 0) {
            m2604copywmQWz5c13 = Color.m2604copywmQWz5c(r5, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r5) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r5) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r5) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(textColor2) : 0.0f);
            disabledTextColor2 = m2604copywmQWz5c13;
        } else {
            disabledTextColor2 = disabledTextColor;
        }
        ...
        if ((i & 32) != 0) {
            m2604copywmQWz5c12 = Color.m2604copywmQWz5c(r5, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r5) : ContentAlpha.INSTANCE.getHigh($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r5) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r5) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m962getPrimary0d7_KjU()) : 0.0f);
            focusedBorderColor2 = m2604copywmQWz5c12;
        } else {
            focusedBorderColor2 = focusedBorderColor;
        }
        if ((i & 64) != 0) {
            m2604copywmQWz5c11 = Color.m2604copywmQWz5c(r5, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r5) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r5) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r5) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m961getOnSurface0d7_KjU()) : 0.0f);
            unfocusedBorderColor2 = m2604copywmQWz5c11;
        } else {
            unfocusedBorderColor2 = unfocusedBorderColor;
        }
        if ((i & 128) != 0) {
            m2604copywmQWz5c10 = Color.m2604copywmQWz5c(r90, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(r90) : ContentAlpha.INSTANCE.getDisabled($composer, 6), (r12 & 2) != 0 ? Color.m2612getRedimpl(r90) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(r90) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(unfocusedBorderColor2) : 0.0f);
            disabledBorderColor2 = m2604copywmQWz5c10;
        } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:135:0x01b5, code lost:
        if (r7.changed(r80) == false) goto L49;
     */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:135:0x01b9, code lost:
        if (r8.changed(r79) == false) goto L49;
     */
