...
public final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(final MeasureScope measure, List<? extends Measurable> list, long constraints) {
        ...
        final int topPaddingValue = measure.mo295roundToPx0680j_4(this.paddingValues.mo397calculateTopPaddingD9Ej5fM());
        int bottomPaddingValue = measure.mo295roundToPx0680j_4(this.paddingValues.mo394calculateBottomPaddingD9Ej5fM());
        ...
        long labelConstraints = ConstraintsKt.m5094offsetNN6EwU(looseConstraints, -occupiedSpaceHorizontally2, -bottomPaddingValue);
        ...
        long textFieldConstraints2 = ConstraintsKt.m5094offsetNN6EwU(m5068copyZbe2FdA, -occupiedSpaceHorizontally2, verticalConstraintOffset);
        ...
        for (Object element$iv : $this$first$iv) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(it9), "TextField")) {
                ...
                width = TextFieldKt.m1187calculateWidthVsPV1Ek(TextFieldImplKt.widthOrZero(leadingPlaceable), TextFieldImplKt.widthOrZero(trailingPlaceable), textFieldPlaceable.getWidth(), TextFieldImplKt.widthOrZero(labelPlaceable), TextFieldImplKt.widthOrZero(placeholderPlaceable), constraints);
                height = TextFieldKt.m1186calculateHeightO3s9Psw(textFieldPlaceable.getHeight(), labelPlaceable != null, effectiveLabelBaseline, TextFieldImplKt.heightOrZero(leadingPlaceable), TextFieldImplKt.heightOrZero(trailingPlaceable), TextFieldImplKt.heightOrZero(placeholderPlaceable), constraints, measure.getDensity(), this.paddingValues);
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> list, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj3;
        Object obj4;
        int m1187calculateWidthVsPV1Ek;
        ...
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1187calculateWidthVsPV1Ek = TextFieldKt.m1187calculateWidthVsPV1Ek(leadingWidth, trailingWidth, textFieldWidth, labelWidth, placeholderWidth, TextFieldImplKt.getZeroConstraints());
                return m1187calculateWidthVsPV1Ek;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> list, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        Object obj3;
        Object obj4;
        int m1186calculateHeightO3s9Psw;
        List<? extends IntrinsicMeasurable> $this$first$iv = list;
        for (Object element$iv : $this$first$iv) {
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) element$iv), "TextField")) {
                ...
                m1186calculateHeightO3s9Psw = TextFieldKt.m1186calculateHeightO3s9Psw(textFieldHeight, labelHeight > 0, labelHeight, leadingHeight, trailingHeight, placeholderHeight, TextFieldImplKt.getZeroConstraints(), $this$intrinsicHeight.getDensity(), this.paddingValues);
                return m1186calculateHeightO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
