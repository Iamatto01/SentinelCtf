...
public final class CheckboxKt {
    ...
    private static final float CheckboxRippleRadius = Dp.m5122constructorimpl(24);
    ...
    public static final void Checkbox(final boolean checked, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    colors3 = CheckboxDefaults.INSTANCE.m940colorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty &= -458753;
                } else {
                    colors3 = colors;
                }
            ...
            $composer2.endReplaceableGroup();
            TriStateCheckbox(ToggleableState, function0, modifier2, enabled2, interactionSource2, colors3, $composer2, ($dirty & 896) | ($dirty & 7168) | (57344 & $dirty) | ($dirty & 458752), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.CheckboxKt$Checkbox$3
            ...
            public final void invoke(Composer composer, int i7) {
                CheckboxKt.Checkbox(checked, function1, modifier4, z2, mutableInteractionSource, checkboxColors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
    ...
    public static final void TriStateCheckbox(final ToggleableState state, final Function0<Unit> function0, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, CheckboxColors colors, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty3) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 32) != 0) {
                    colors2 = CheckboxDefaults.INSTANCE.m940colorszjMxDiM(0L, 0L, 0L, 0L, 0L, $composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
                    $dirty = $dirty3 & (-458753);
                    modifier2 = modifier3;
                    enabled2 = enabled3;
                    interactionSource3 = interactionSource2;
            ...
            if (function0 != null) {
                $dirty2 = $dirty;
                companion = ToggleableKt.m667triStateToggleableO2vRcR0(Modifier.Companion, state, interactionSource3, RippleKt.m1217rememberRipple9IZ8Weo(false, CheckboxRippleRadius, 0L, $composer2, 54, 4), enabled2, Role.m4474boximpl(Role.Companion.m4482getCheckboxo7Vup1c()), function0);
            } else {
                $dirty2 = $dirty;
            ...
            CheckboxImpl(enabled2, state, PaddingKt.m414padding3ABfNKs(modifier2.then(function0 != null ? InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.Companion) : Modifier.Companion).then(toggleableModifier), CheckboxDefaultPadding), colors2, $composer2, (($dirty2 >> 9) & 14) | (($dirty2 << 3) & 112) | (($dirty2 >> 6) & 7168));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.CheckboxKt$TriStateCheckbox$2
            ...
            public final void invoke(Composer composer, int i6) {
                CheckboxKt.TriStateCheckbox(ToggleableState.this, function0, modifier4, z2, mutableInteractionSource, checkboxColors, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
            }
        });
    }
            ...
            if (invalid$iv || value$iv$iv2 == Composer.Companion.getEmpty()) {
                value$iv$iv2 = new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.CheckboxKt$CheckboxImpl$1$1
                    ...
                    public final void invoke2(DrawScope Canvas) {
                        ...
                        CheckboxKt.m943drawBox1wkBAMs(Canvas, CheckboxImpl$lambda$9, CheckboxImpl$lambda$10, Canvas.mo301toPx0680j_4(f6), strokeWidthPx);
                        ...
                        CheckboxKt.m944drawCheck3IgeMak(Canvas, CheckboxImpl$lambda$8, CheckboxImpl$lambda$4, CheckboxImpl$lambda$6, strokeWidthPx, CheckDrawingCache.this);
                    }
                };
                $composer2.updateRememberedValue(value$iv$iv2);
            }
    ...
    public static final void m943drawBox1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
    ...
    public static final void m944drawCheck3IgeMak(DrawScope $this$drawCheck_u2d3IgeMak, long checkColor, float checkFraction, float crossCenterGravitation, float strokeWidthPx, CheckDrawingCache drawingCache) {
