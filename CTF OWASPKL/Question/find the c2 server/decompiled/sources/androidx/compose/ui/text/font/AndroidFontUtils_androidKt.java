...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m4676getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        boolean isBold = fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0;
        boolean isItalic = FontStyle.m4722equalsimpl0(fontStyle, FontStyle.Companion.m4726getItalic_LCdwA());
