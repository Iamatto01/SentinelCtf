...
public final class FocusDirection {
    ...
    private static final int Next = m2292constructorimpl(1);
    private static final int Previous = m2292constructorimpl(2);
    private static final int Left = m2292constructorimpl(3);
    private static final int Right = m2292constructorimpl(4);
    private static final int Up = m2292constructorimpl(5);
    private static final int Down = m2292constructorimpl(6);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FocusDirection m2291boximpl(int i) {
        return new FocusDirection(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2292constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2293equalsimpl(int i, Object obj) {
        return (obj instanceof FocusDirection) && i == ((FocusDirection) obj).m2297unboximpl();
    }
    ...
    public static String m2296toStringimpl(int arg0) {
        if (m2294equalsimpl0(arg0, Next)) {
            return "Next";
        }
        if (m2294equalsimpl0(arg0, Previous)) {
            return "Previous";
        }
        if (m2294equalsimpl0(arg0, Left)) {
            return "Left";
        }
        if (m2294equalsimpl0(arg0, Right)) {
            return "Right";
        }
        if (m2294equalsimpl0(arg0, Up)) {
            return "Up";
        }
        if (m2294equalsimpl0(arg0, Down)) {
            return "Down";
        }
        if (m2294equalsimpl0(arg0, Enter)) {
            return "Enter";
        }
        if (m2294equalsimpl0(arg0, Exit)) {
            return "Exit";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2298getEnterdhqQ8s$annotations() {
        }

        /* renamed from: getExit-dhqQ-8s$annotations  reason: not valid java name */
        public static /* synthetic */ void m2299getExitdhqQ8s$annotations() {
        }
        ...
        public static /* synthetic */ void m2300getIndhqQ8s$annotations() {
        }
        ...
        public static /* synthetic */ void m2301getOutdhqQ8s$annotations() {
        }
        ...
        public final int m2307getNextdhqQ8s() {
            return FocusDirection.Next;
        }

        /* renamed from: getPrevious-dhqQ-8s  reason: not valid java name */
        public final int m2309getPreviousdhqQ8s() {
            return FocusDirection.Previous;
        }

        /* renamed from: getLeft-dhqQ-8s  reason: not valid java name */
        public final int m2306getLeftdhqQ8s() {
            return FocusDirection.Left;
        }

        /* renamed from: getRight-dhqQ-8s  reason: not valid java name */
        public final int m2310getRightdhqQ8s() {
            return FocusDirection.Right;
        }

        /* renamed from: getUp-dhqQ-8s  reason: not valid java name */
        public final int m2311getUpdhqQ8s() {
            return FocusDirection.Up;
        }

        /* renamed from: getDown-dhqQ-8s  reason: not valid java name */
        public final int m2302getDowndhqQ8s() {
            return FocusDirection.Down;
        }

        /* renamed from: getEnter-dhqQ-8s  reason: not valid java name */
        public final int m2303getEnterdhqQ8s() {
            return FocusDirection.Enter;
        }

        /* renamed from: getExit-dhqQ-8s  reason: not valid java name */
        public final int m2304getExitdhqQ8s() {
            return FocusDirection.Exit;
        }

        /* renamed from: getIn-dhqQ-8s  reason: not valid java name */
        public final int m2305getIndhqQ8s() {
            return FocusDirection.In;
        }

        /* renamed from: getOut-dhqQ-8s  reason: not valid java name */
        public final int m2308getOutdhqQ8s() {
            return FocusDirection.Out;
        }
    }

    static {
        int m2292constructorimpl = m2292constructorimpl(7);
        Enter = m2292constructorimpl;
        int m2292constructorimpl2 = m2292constructorimpl(8);
        Exit = m2292constructorimpl2;
        In = m2292constructorimpl;
        Out = m2292constructorimpl2;
    }
}
