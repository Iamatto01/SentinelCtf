...
public final class AndroidFileFont extends AndroidPreloadedFont {
    ...
    */
    ...
    private AndroidFileFont(File file, FontWeight weight, int style, FontVariation.Settings variationSettings) {
    ...
    public String toString() {
        return "Font(file=" + this.file + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4724toStringimpl(mo4677getStyle_LCdwA())) + ')';
    }
}
