...
public final class TextStyleKt {
    ...
    public static final int m4667resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (textDirection == null ? false : TextDirection.m5003equalsimpl0(textDirection.m5006unboximpl(), TextDirection.Companion.m5007getContents_7Xco())) {
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.Companion.m5008getContentOrLtrs_7Xco();
                case 2:
                    return TextDirection.Companion.m5009getContentOrRtls_7Xco();
                default:
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()]) {
                case 1:
                    return TextDirection.Companion.m5010getLtrs_7Xco();
                case 2:
                    return TextDirection.Companion.m5011getRtls_7Xco();
                default:
                    throw new NoWhenBranchMatchedException();
            }
        } else {
            return textDirection.m5006unboximpl();
        }
    }
