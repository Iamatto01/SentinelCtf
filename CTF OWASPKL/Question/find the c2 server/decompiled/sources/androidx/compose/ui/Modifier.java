...
public interface Modifier {
    ...
    public interface Element extends Modifier {
        ...
        public static final class DefaultImpls {
            ...
            @Deprecated
            public static <R> R foldIn(Element $this, R r, Function2<? super R, ? super Element, ? extends R> operation) {
                Intrinsics.checkNotNullParameter(operation, "operation");
                return (R) Element.super.foldIn(r, operation);
            }

            @Deprecated
            public static <R> R foldOut(Element $this, R r, Function2<? super Element, ? super R, ? extends R> operation) {
                Intrinsics.checkNotNullParameter(operation, "operation");
    ...
    public static abstract class Node implements DelegatableNode {
        ...
        public final boolean m2265isKindH91voCI$ui_release(int kind) {
