...
public final class SemanticsPropertiesKt {
    ...
    public static final int getLiveRegion(SemanticsPropertyReceiver $this$liveRegion) {
        ...
        return SemanticsProperties.INSTANCE.getLiveRegion().getValue($this$liveRegion, $$delegatedProperties[3]).m4471unboximpl();
    }

    /* renamed from: setLiveRegion-hR3wRGc  reason: not valid java name */
    public static final void m4494setLiveRegionhR3wRGc(SemanticsPropertyReceiver liveRegion, int i) {
        Intrinsics.checkNotNullParameter(liveRegion, "$this$liveRegion");
        SemanticsProperties.INSTANCE.getLiveRegion().setValue(liveRegion, $$delegatedProperties[3], LiveRegionMode.m4465boximpl(i));
    }
    ...
    public static final int getRole(SemanticsPropertyReceiver $this$role) {
        ...
        return SemanticsProperties.INSTANCE.getRole().getValue($this$role, $$delegatedProperties[8]).m4480unboximpl();
    }

    /* renamed from: setRole-kuIjeqM  reason: not valid java name */
    public static final void m4495setRolekuIjeqM(SemanticsPropertyReceiver role, int i) {
        Intrinsics.checkNotNullParameter(role, "$this$role");
        SemanticsProperties.INSTANCE.getRole().setValue(role, $$delegatedProperties[8], Role.m4474boximpl(i));
    }
    ...
    public static final long getTextSelectionRange(SemanticsPropertyReceiver $this$textSelectionRange) {
        ...
        return SemanticsProperties.INSTANCE.getTextSelectionRange().getValue($this$textSelectionRange, $$delegatedProperties[11]).m4641unboximpl();
    }

    /* renamed from: setTextSelectionRange-FDrldGo  reason: not valid java name */
    public static final void m4496setTextSelectionRangeFDrldGo(SemanticsPropertyReceiver textSelectionRange, long j) {
        Intrinsics.checkNotNullParameter(textSelectionRange, "$this$textSelectionRange");
        SemanticsProperties.INSTANCE.getTextSelectionRange().setValue(textSelectionRange, $$delegatedProperties[11], TextRange.m4625boximpl(j));
    }
    ...
    public static final int getImeAction(SemanticsPropertyReceiver $this$imeAction) {
        ...
        return SemanticsProperties.INSTANCE.getImeAction().getValue($this$imeAction, $$delegatedProperties[12]).m4776unboximpl();
    }

    /* renamed from: setImeAction-4L7nppU  reason: not valid java name */
    public static final void m4493setImeAction4L7nppU(SemanticsPropertyReceiver imeAction, int i) {
        Intrinsics.checkNotNullParameter(imeAction, "$this$imeAction");
        SemanticsProperties.INSTANCE.getImeAction().setValue(imeAction, $$delegatedProperties[12], ImeAction.m4770boximpl(i));
    }
