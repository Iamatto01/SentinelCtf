...
public final class CompositingStrategy {
    ...
    private static final int Auto = m2684constructorimpl(0);
    private static final int Offscreen = m2684constructorimpl(1);
    private static final int ModulateAlpha = m2684constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m2683boximpl(int i) {
        return new CompositingStrategy(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2684constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2685equalsimpl(int i, Object obj) {
        return (obj instanceof CompositingStrategy) && i == ((CompositingStrategy) obj).m2689unboximpl();
    }
    ...
    public final /* synthetic */ int m2689unboximpl() {
        return this.value;
    }
