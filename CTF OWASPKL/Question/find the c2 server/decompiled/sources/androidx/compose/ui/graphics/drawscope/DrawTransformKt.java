...
public final class DrawTransformKt {
    ...
    public static /* synthetic */ void m3206rotateRad0AR0LA0$default(DrawTransform rotateRad, float radians, long pivot, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = rotateRad.mo3075getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo3077rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
    }

    /* renamed from: rotateRad-0AR0LA0  reason: not valid java name */
    public static final void m3205rotateRad0AR0LA0(DrawTransform rotateRad, float radians, long pivot) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo3077rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
    }

    /* renamed from: scale-0AR0LA0$default  reason: not valid java name */
    public static /* synthetic */ void m3208scale0AR0LA0$default(DrawTransform scale, float scale2, long pivot, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = scale.mo3075getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo3078scale0AR0LA0(scale2, scale2, pivot);
    }

    /* renamed from: scale-0AR0LA0  reason: not valid java name */
    public static final void m3207scale0AR0LA0(DrawTransform scale, float scale2, long pivot) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo3078scale0AR0LA0(scale2, scale2, pivot);
    }
}
