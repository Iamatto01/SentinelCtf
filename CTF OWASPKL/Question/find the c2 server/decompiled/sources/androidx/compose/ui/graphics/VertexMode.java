...
public final class VertexMode {
    ...
    private static final int Triangles = m2989constructorimpl(0);
    private static final int TriangleStrip = m2989constructorimpl(1);
    private static final int TriangleFan = m2989constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ VertexMode m2988boximpl(int i) {
    ...
    public static boolean m2990equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).m2994unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2997getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI  reason: not valid java name */
        public final int m2996getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI  reason: not valid java name */
        public final int m2995getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2993toStringimpl(int arg0) {
        return m2991equalsimpl0(arg0, Triangles) ? "Triangles" : m2991equalsimpl0(arg0, TriangleStrip) ? "TriangleStrip" : m2991equalsimpl0(arg0, TriangleFan) ? "TriangleFan" : "Unknown";
    }
