    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            for (int i$iv = 0; i$iv < lastIndex; i$iv++) {
                ...
                result$iv.add(Offset.m2357boximpl(OffsetKt.Offset(Math.abs(Offset.m2368getXimpl(el1.getBoundsInRoot().m2398getCenterF1C5BW0()) - Offset.m2368getXimpl(el2.getBoundsInRoot().m2398getCenterF1C5BW0())), Math.abs(Offset.m2369getYimpl(el1.getBoundsInRoot().m2398getCenterF1C5BW0()) - Offset.m2369getYimpl(el2.getBoundsInRoot().m2398getCenterF1C5BW0())))));
                current$iv = next$iv;
            }
        }
        List $this$fastZipWithNext$iv = result$iv;
        if ($this$fastZipWithNext$iv.size() == 1) {
            m2378unboximpl = ((Offset) CollectionsKt.first((List<? extends Object>) $this$fastZipWithNext$iv)).m2378unboximpl();
        } else if ($this$fastZipWithNext$iv.isEmpty()) {
            ...
            if (1 <= lastIndex2) {
                while (true) {
                    long element = ((Offset) $this$fastZipWithNext$iv.get(i$iv2)).m2378unboximpl();
                    long result = ((Offset) accumulator$iv).m2378unboximpl();
                    accumulator$iv = Offset.m2357boximpl(Offset.m2373plusMKHz9U(result, element));
                    if (i$iv2 == lastIndex2) {
                        break;
                    }
                    i$iv2++;
            ...
            m2378unboximpl = ((Offset) accumulator$iv).m2378unboximpl();
        }
        float deltaX = Offset.m2358component1impl(m2378unboximpl);
        float deltaY = Offset.m2359component2impl(m2378unboximpl);
