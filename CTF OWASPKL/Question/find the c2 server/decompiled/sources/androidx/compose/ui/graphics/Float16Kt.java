...
public final class Float16Kt {
    ...
    public static final short m2748minAoSsdG0(short x, short y) {
        if (Float16.m2720isNaNimpl(x) || Float16.m2720isNaNimpl(y)) {
            return Float16.Companion.m2742getNaNslo4al4();
        }
        return Float16.m2707compareTo41bOqos(x, y) <= 0 ? x : y;
    }

    /* renamed from: max-AoSsdG0  reason: not valid java name */
    public static final short m2747maxAoSsdG0(short x, short y) {
        if (Float16.m2720isNaNimpl(x) || Float16.m2720isNaNimpl(y)) {
            return Float16.Companion.m2742getNaNslo4al4();
        }
        return Float16.m2707compareTo41bOqos(x, y) >= 0 ? x : y;
