...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String m5064getEnterjXw82LU;
        Intrinsics.checkNotNullParameter(animation, "animation");
        this.animation = animation;
        if (getAnimation().m5050getAnimationObject().getCurrentState().booleanValue()) {
            m5064getEnterjXw82LU = AnimatedVisibilityState.Companion.m5065getExitjXw82LU();
        } else {
            m5064getEnterjXw82LU = AnimatedVisibilityState.Companion.m5064getEnterjXw82LU();
        }
        this.state = m5064getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ AnimatedVisibilityState getState() {
        return AnimatedVisibilityState.m5057boximpl(m5055getStatejXw82LU());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(AnimatedVisibilityState animatedVisibilityState) {
        m5056setState7IW2chM(animatedVisibilityState.m5063unboximpl());
    }

    /* renamed from: getState-jXw82LU  reason: not valid java name */
    public String m5055getStatejXw82LU() {
        return this.state;
    }

    /* renamed from: setState-7IW2chM  reason: not valid java name */
    public void m5056setState7IW2chM(String value) {
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m5056setState7IW2chM(((AnimatedVisibilityState) par1).m5063unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition it = getAnimation().m5050getAnimationObject();
        Pair<Boolean, Boolean> m5054toCurrentTargetPair7IW2chM = m5054toCurrentTargetPair7IW2chM(m5055getStatejXw82LU());
        boolean current = m5054toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = m5054toCurrentTargetPair7IW2chM.component2().booleanValue();
    ...
    private final Pair<Boolean, Boolean> m5054toCurrentTargetPair7IW2chM(String $this$toCurrentTargetPair_u2d7IW2chM) {
        return AnimatedVisibilityState.m5060equalsimpl0($this$toCurrentTargetPair_u2d7IW2chM, AnimatedVisibilityState.Companion.m5064getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
