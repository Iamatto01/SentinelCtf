...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m5066boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m5067constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m5070equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).m5084unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m5071equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m5081hashCodeimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m5070equalsimpl(this.value, obj);
    }
    ...
    private static final int m5072getFocusIndeximpl(long arg0) {
        return (int) (3 & arg0);
    }

    /* renamed from: getMinWidth-impl  reason: not valid java name */
    public static final int m5080getMinWidthimpl(long arg0) {
        int mask = WidthMask[m5072getFocusIndeximpl(arg0)];
        return ((int) (arg0 >> MinFocusHeight)) & mask;
    }

    /* renamed from: getMaxWidth-impl  reason: not valid java name */
    public static final int m5078getMaxWidthimpl(long arg0) {
        int mask = WidthMask[m5072getFocusIndeximpl(arg0)];
    ...
    public static final int m5079getMinHeightimpl(long arg0) {
        int focus = m5072getFocusIndeximpl(arg0);
    ...
    public static final int m5077getMaxHeightimpl(long arg0) {
        int focus = m5072getFocusIndeximpl(arg0);
        int mask = HeightMask[focus];
    ...
    public static final boolean m5074getHasBoundedWidthimpl(long arg0) {
        int mask = WidthMask[m5072getFocusIndeximpl(arg0)];
        return (((int) (arg0 >> 33)) & mask) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl  reason: not valid java name */
    public static final boolean m5073getHasBoundedHeightimpl(long arg0) {
        int focus = m5072getFocusIndeximpl(arg0);
        int mask = HeightMask[focus];
        int offset = MinHeightOffsets[focus] + 31;
    ...
    public static final boolean m5076getHasFixedWidthimpl(long arg0) {
        return m5078getMaxWidthimpl(arg0) == m5080getMinWidthimpl(arg0);
    }

    /* renamed from: getHasFixedHeight-impl  reason: not valid java name */
    public static final boolean m5075getHasFixedHeightimpl(long arg0) {
        return m5077getMaxHeightimpl(arg0) == m5079getMinHeightimpl(arg0);
    }

    /* renamed from: isZero-impl  reason: not valid java name */
    public static final boolean m5082isZeroimpl(long arg0) {
        return m5078getMaxWidthimpl(arg0) == 0 || m5077getMaxHeightimpl(arg0) == 0;
    }

    /* renamed from: copy-Zbe2FdA  reason: not valid java name */
    public static final long m5068copyZbe2FdA(long arg0, int minWidth, int maxWidth, int minHeight, int maxHeight) {
        boolean z = true;
        ...
        return Companion.m5085createConstraintsZbe2FdA$ui_unit_release(minWidth, maxWidth, minHeight, maxHeight);
    }

    public String toString() {
        return m5083toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m5083toStringimpl(long arg0) {
        int maxWidth = m5078getMaxWidthimpl(arg0);
        String maxWidthStr = maxWidth == Integer.MAX_VALUE ? "Infinity" : String.valueOf(maxWidth);
        int maxHeight = m5077getMaxHeightimpl(arg0);
        String maxHeightStr = maxHeight != Integer.MAX_VALUE ? String.valueOf(maxHeight) : "Infinity";
        return "Constraints(minWidth = " + m5080getMinWidthimpl(arg0) + ", maxWidth = " + maxWidthStr + ", minHeight = " + m5079getMinHeightimpl(arg0) + ", maxHeight = " + maxHeightStr + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m5086fixedJhjzzOo(int width, int height) {
            if (!(width >= 0 && height >= 0)) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m5085createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* renamed from: fixedWidth-OenEA2s  reason: not valid java name */
        public final long m5088fixedWidthOenEA2s(int width) {
            if (width >= 0) {
                return m5085createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
            }
            throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
        }

        /* renamed from: fixedHeight-OenEA2s  reason: not valid java name */
        public final long m5087fixedHeightOenEA2s(int height) {
            if (height >= 0) {
                return m5085createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
            }
            throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release  reason: not valid java name */
        public final long m5085createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long focus;
            ...
            if (widthBits + heightBits <= 31) {
                ...
                return Constraints.m5067constructorimpl(value);
            }
