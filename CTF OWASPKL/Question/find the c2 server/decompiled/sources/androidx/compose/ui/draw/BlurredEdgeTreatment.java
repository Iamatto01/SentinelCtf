...
public final class BlurredEdgeTreatment {
    ...
    private static final Shape Rectangle = m2271constructorimpl(RectangleShapeKt.getRectangleShape());
    private static final Shape Unbounded = m2271constructorimpl(null);
    private final Shape shape;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ BlurredEdgeTreatment m2270boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static Shape m2271constructorimpl(Shape shape) {
        return shape;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2272equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m2276unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2273equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2274hashCodeimpl(Shape shape) {
        if (shape == null) {
            return 0;
        }
    ...
    public static String m2275toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object obj) {
        return m2272equalsimpl(this.shape, obj);
    }

    public int hashCode() {
        return m2274hashCodeimpl(this.shape);
    }

    public String toString() {
        return m2275toStringimpl(this.shape);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Shape m2276unboximpl() {
        return this.shape;
    }
