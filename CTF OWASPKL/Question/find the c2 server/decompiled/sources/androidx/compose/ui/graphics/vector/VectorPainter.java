...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2425boximpl(Size.Companion.m2446getZeroNHjbRc()), null, 2, null);
    ...
    public final long m3241getSizeNHjbRc$ui_release() {
        State $this$getValue$iv = this.size$delegate;
        return ((Size) $this$getValue$iv.getValue()).m2442unboximpl();
    }

    /* renamed from: setSize-uvyYCjk$ui_release  reason: not valid java name */
    public final void m3242setSizeuvyYCjk$ui_release(long j) {
        MutableState $this$setValue$iv = this.size$delegate;
        $this$setValue$iv.setValue(Size.m2425boximpl(j));
    }
    ...
    private final Composition composeVector(CompositionContext parent, final Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4) {
        Composition next;
    ...
    private final boolean isDirty() {
        State $this$getValue$iv = this.isDirty$delegate;
        return ((Boolean) $this$getValue$iv.getValue()).booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void setDirty(boolean z) {
        MutableState $this$setValue$iv = this.isDirty$delegate;
        $this$setValue$iv.setValue(Boolean.valueOf(z));
    }
    ...
    public long mo3215getIntrinsicSizeNHjbRc() {
        return m3241getSizeNHjbRc$ui_release();
    }
    ...
    public void onDraw(DrawScope $this$onDraw) {
        ...
        if (!getAutoMirror$ui_release() || $this$onDraw.getLayoutDirection() != LayoutDirection.Rtl) {
            ...
            long pivot$iv$iv = $this$onDraw.mo3145getCenterF1C5BW0();
            DrawContext $this$withTransform_u24lambda_u246$iv$iv$iv = $this$onDraw.getDrawContext();
            long previousSize$iv$iv$iv = $this$withTransform_u24lambda_u246$iv$iv$iv.mo3071getSizeNHjbRc();
            ...
            $this$scale_Fgt4K4Q_u24lambda_u242$iv$iv.mo3078scale0AR0LA0(-1.0f, 1.0f, pivot$iv$iv);
            ...
            $this$withTransform_u24lambda_u246$iv$iv$iv.mo3072setSizeuvyYCjk(previousSize$iv$iv$iv);
        }
        if (isDirty()) {
            setDirty(false);
        }
