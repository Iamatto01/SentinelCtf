...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int mo4677getStyle_LCdwA() {
        return this.style;
    }

    private AndroidPreloadedFont(FontWeight weight, int style, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m4714getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, variationSettings, null);
        this.weight = weight;
        this.style = style;
    }
