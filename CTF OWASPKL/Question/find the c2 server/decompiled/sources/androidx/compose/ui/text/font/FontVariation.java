...
public final class FontVariation {
        ...
        public Settings(Setting... settings) {
            ...
            for (Setting setting : settings) {
                ...
                if (value$iv$iv$iv == null) {
                    ...
                    destination$iv$iv.put(axisName, arrayList);
                } else {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public final long m4744getValueXSAIIZE() {
            return this.value;
        }
        ...
        public float toVariationValue(Density density) {
            if (density != null) {
                return TextUnit.m5303getValueimpl(this.value) * density.getFontScale();
            }
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof SettingTextUnit) && Intrinsics.areEqual(getAxisName(), ((SettingTextUnit) other).getAxisName()) && TextUnit.m5300equalsimpl0(this.value, ((SettingTextUnit) other).value);
        }

        public int hashCode() {
            int result = getAxisName().hashCode();
            return (result * 31) + TextUnit.m5304hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + ((Object) TextUnit.m5310toStringimpl(this.value)) + ')';
        }
    }
    ...
    public final Setting m4743opticalSizingR2X_6o(long textSize) {
        if (!TextUnit.m5306isSpimpl(textSize)) {
    ...
    public final Settings m4742Settings6EWAqTQ(FontWeight weight, int style, Setting... settings) {
