...
public final class PointerType {
    ...
    private static final int Unknown = m4076constructorimpl(0);
    private static final int Touch = m4076constructorimpl(1);
    private static final int Mouse = m4076constructorimpl(2);
    private static final int Stylus = m4076constructorimpl(3);
    private static final int Eraser = m4076constructorimpl(4);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PointerType m4075boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m4076constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4077equalsimpl(int i, Object obj) {
        return (obj instanceof PointerType) && i == ((PointerType) obj).m4081unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4078equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m4077equalsimpl(this.value, obj);
    }
    ...
    public static String m4080toStringimpl(int arg0) {
        switch (arg0) {
            case 1:
                return "Touch";
            case 2:
