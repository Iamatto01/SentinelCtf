...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    public FontFamilyResolverImpl(PlatformFontLoader platformFontLoader, PlatformResolveInterceptor platformResolveInterceptor, TypefaceRequestCache typefaceRequestCache, FontListFontFamilyTypefaceAdapter fontListFontFamilyTypefaceAdapter, PlatformFontFamilyTypefaceAdapter platformFamilyTypefaceAdapter) {
        ...
        this.createDefaultTypeface = new Function1<TypefaceRequest, Object>() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$createDefaultTypeface$1
            ...
            public final Object invoke(TypefaceRequest it) {
                ...
                resolve = FontFamilyResolverImpl.this.resolve(TypefaceRequest.m4761copye1PVR60$default(it, null, null, 0, 0, null, 30, null));
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x0082 A[LOOP:0: B:22:0x0080->B:23:0x0082, LOOP_END] */
    ...
    */
    ...
    public State<Object> mo4697resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m4745interceptFontStyleT2F_aPo(fontStyle), this.platformResolveInterceptor.m4746interceptFontSynthesisMscr08Y(fontSynthesis), this.platformFontLoader.getCacheKey(), null));
    }
