...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.mo4747createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4765getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo4748createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4765getFontStyle_LCdwA());
            ...
            result = ((AndroidTypeface) typeface).mo4849getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4765getFontStyle_LCdwA(), typefaceRequest.m4766getFontSynthesisGVVA2EU());
        }
