...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    public Map<AlignmentLine, Integer> getAlignmentLinesMap(NodeCoordinator $this$alignmentLinesMap) {
        ...
        LookaheadDelegate lookaheadDelegate$ui_release = $this$alignmentLinesMap.getLookaheadDelegate$ui_release();
    ...
    public int getPositionFor(NodeCoordinator $this$getPositionFor, AlignmentLine alignmentLine) {
        ...
        LookaheadDelegate lookaheadDelegate$ui_release = $this$getPositionFor.getLookaheadDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadDelegate$ui_release);
    ...
    protected long mo4210calculatePositionInParentR5De75A(NodeCoordinator calculatePositionInParent, long position) {
        Intrinsics.checkNotNullParameter(calculatePositionInParent, "$this$calculatePositionInParent");
        LookaheadDelegate lookaheadDelegate$ui_release = calculatePositionInParent.getLookaheadDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadDelegate$ui_release);
        long $this$toOffset_u2d_u2dgyyYBs$iv = lookaheadDelegate$ui_release.mo4276getPositionnOccac();
        return Offset.m2373plusMKHz9U(OffsetKt.Offset(IntOffset.m5240getXimpl($this$toOffset_u2d_u2dgyyYBs$iv), IntOffset.m5241getYimpl($this$toOffset_u2d_u2dgyyYBs$iv)), position);
    }
}
