...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m2475actualTintColorFilterxETnrds(long color, int blendMode) {
        android.graphics.ColorFilter androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m2552BlendModeColorFilterxETnrds(color, blendMode);
        return new ColorFilter(androidColorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final ColorFilter m2473actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final ColorFilter m2474actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m2660toArgb8_81llA(multiply), ColorKt.m2660toArgb8_81llA(add)));
    }
}
