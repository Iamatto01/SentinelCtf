...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m4153roundToPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo294roundToPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4  reason: not valid java name */
        public static int m4154roundToPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo295roundToPx0680j_4($receiver);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA  reason: not valid java name */
        public static float m4155toDpGaN1DYA(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo296toDpGaN1DYA($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM  reason: not valid java name */
        public static float m4156toDpu2uoSUM(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo297toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM  reason: not valid java name */
        public static float m4157toDpu2uoSUM(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo298toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM  reason: not valid java name */
        public static long m4158toDpSizekrfVVM(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo299toDpSizekrfVVM($receiver);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o  reason: not valid java name */
        public static float m4159toPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo300toPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4  reason: not valid java name */
        public static float m4160toPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo301toPx0680j_4($receiver);
        }
        ...
        public static long m4161toSizeXkaWNTQ(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo302toSizeXkaWNTQ($receiver);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do  reason: not valid java name */
        public static long m4162toSp0xMU5do(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo303toSp0xMU5do($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
        public static long m4163toSpkPz2Gy4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo304toSpkPz2Gy4($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
        public static long m4164toSpkPz2Gy4(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo305toSpkPz2Gy4($receiver);
        }
