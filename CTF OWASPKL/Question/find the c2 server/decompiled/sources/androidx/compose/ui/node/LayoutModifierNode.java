...
public interface LayoutModifierNode extends Remeasurement, DelegatableNode {
    ...
    MeasureResult mo2285measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(this, $this$minIntrinsicWidth, measurable, height);
    }
    ...
    default int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(this, $this$minIntrinsicHeight, measurable, width);
    }
    ...
    default int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(this, $this$maxIntrinsicWidth, measurable, height);
    }
    ...
    default int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(this, $this$maxIntrinsicHeight, measurable, width);
    }
}
