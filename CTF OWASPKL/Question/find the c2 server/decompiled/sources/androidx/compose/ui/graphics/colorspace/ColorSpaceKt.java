...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m3015connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m3029getPerceptualuksYyKA();
        }
        return m3014connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m3014connectYBCOT_4(ColorSpace connect, ColorSpace destination, int intent) {
        ...
        if (connect == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (destination == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m3024equalsimpl0(intent, RenderIntent.Companion.m3029getPerceptualuksYyKA())) {
                return Connector.Companion.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (connect == ColorSpaces.INSTANCE.getOklab() && destination == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m3024equalsimpl0(intent, RenderIntent.Companion.m3029getPerceptualuksYyKA())) {
        ...
        if (ColorModel.m3003equalsimpl0(connect.m3012getModelxdoWZVw(), ColorModel.Companion.m3010getRgbxdoWZVw()) && ColorModel.m3003equalsimpl0(destination.m3012getModelxdoWZVw(), ColorModel.Companion.m3010getRgbxdoWZVw())) {
            return new Connector.RgbConnector((Rgb) connect, (Rgb) destination, intent, null);
        }
        return new Connector(connect, destination, intent, null);
    }
    ...
    public static final ColorSpace adapt(ColorSpace $this$adapt, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (ColorModel.m3003equalsimpl0($this$adapt.m3012getModelxdoWZVw(), ColorModel.Companion.m3010getRgbxdoWZVw())) {
