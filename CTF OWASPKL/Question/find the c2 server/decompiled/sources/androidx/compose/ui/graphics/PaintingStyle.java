...
public final class PaintingStyle {
    ...
    private static final int Fill = m2860constructorimpl(0);
    private static final int Stroke = m2860constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m2859boximpl(int i) {
    ...
    public static boolean m2861equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).m2865unboximpl();
    }
    ...
    public final /* synthetic */ int m2865unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m2866getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m2867getStrokeTiuSbCo() {
    ...
    public static String m2864toStringimpl(int arg0) {
        return m2862equalsimpl0(arg0, Fill) ? "Fill" : m2862equalsimpl0(arg0, Stroke) ? "Stroke" : "Unknown";
    }
