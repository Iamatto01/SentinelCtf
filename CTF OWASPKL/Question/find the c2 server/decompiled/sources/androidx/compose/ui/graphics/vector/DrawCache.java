...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m5287getZeroYbymL2g();
    ...
    public final void m3222drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (targetImage == null || targetCanvas == null || IntSize.m5282getWidthimpl(size) > targetImage.getWidth() || IntSize.m5281getHeightimpl(size) > targetImage.getHeight()) {
            targetImage = ImageBitmapKt.m2827ImageBitmapx__hDU$default(IntSize.m5282getWidthimpl(size), IntSize.m5281getHeightimpl(size), 0, false, null, 28, null);
        ...
        long size$iv = IntSizeKt.m5292toSizeozmzZPI(size);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.m3130drawImageAZ2fEMs$default(target, targetImage, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope $this$clear) {
        DrawScope.m3141drawRectnJ9OG0$default($this$clear, Color.Companion.m2632getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m2523getClear0nO6VwU(), 62, null);
    }
}
