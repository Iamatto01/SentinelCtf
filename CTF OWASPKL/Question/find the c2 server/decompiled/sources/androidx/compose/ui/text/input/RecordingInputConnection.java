...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            TextRange m4845getCompositionMzsxiRA = state.m4845getCompositionMzsxiRA();
            ...
            TextRange m4845getCompositionMzsxiRA2 = state.m4845getCompositionMzsxiRA();
            ...
            inputMethodManager.updateSelection(TextRange.m4635getMinimpl(state.m4846getSelectiond9O1mEE()), TextRange.m4634getMaximpl(state.m4846getSelectiond9O1mEE()), compositionStart, compositionEnd);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4631getCollapsedimpl(this.mTextFieldValue.m4846getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (applying$iv) {
            switch (editorAction) {
                case 0:
                    imeAction = ImeAction.Companion.m4785getDefaulteUduSuo();
                    break;
                case 1:
                default:
                    ...
                    break;
                case 2:
                    imeAction = ImeAction.Companion.m4787getGoeUduSuo();
                    break;
                case 3:
                    imeAction = ImeAction.Companion.m4791getSearcheUduSuo();
                    break;
                case 4:
                    imeAction = ImeAction.Companion.m4792getSendeUduSuo();
                    break;
                case 5:
                    imeAction = ImeAction.Companion.m4788getNexteUduSuo();
                    break;
                case 6:
                    imeAction = ImeAction.Companion.m4786getDoneeUduSuo();
                    break;
                case 7:
                    imeAction = ImeAction.Companion.m4790getPreviouseUduSuo();
                    break;
            }
            this.eventCallback.mo4800onImeActionKlQnJC8(imeAction);
            return true;
        }
        return applying$iv;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4635getMinimpl(this.mTextFieldValue.m4846getSelectiond9O1mEE()), reqModes);
    }
