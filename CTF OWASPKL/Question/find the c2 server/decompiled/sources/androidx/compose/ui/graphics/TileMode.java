...
public final class TileMode {
    ...
    private static final int Clamp = m2963constructorimpl(0);
    private static final int Repeated = m2963constructorimpl(1);
    private static final int Mirror = m2963constructorimpl(2);
    private static final int Decal = m2963constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TileMode m2962boximpl(int i) {
        return new TileMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2963constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2964equalsimpl(int i, Object obj) {
        return (obj instanceof TileMode) && i == ((TileMode) obj).m2968unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2969getClamp3opZhB0() {
            return TileMode.Clamp;
        }

        /* renamed from: getRepeated-3opZhB0  reason: not valid java name */
        public final int m2972getRepeated3opZhB0() {
            return TileMode.Repeated;
        }

        /* renamed from: getMirror-3opZhB0  reason: not valid java name */
        public final int m2971getMirror3opZhB0() {
            return TileMode.Mirror;
        }

        /* renamed from: getDecal-3opZhB0  reason: not valid java name */
        public final int m2970getDecal3opZhB0() {
    ...
    public static String m2967toStringimpl(int arg0) {
        return m2965equalsimpl0(arg0, Clamp) ? "Clamp" : m2965equalsimpl0(arg0, Repeated) ? "Repeated" : m2965equalsimpl0(arg0, Mirror) ? "Mirror" : m2965equalsimpl0(arg0, Decal) ? "Decal" : "Unknown";
    }
