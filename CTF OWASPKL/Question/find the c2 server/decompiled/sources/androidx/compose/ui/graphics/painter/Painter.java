...
public abstract class Painter {
    ...
    public abstract long mo3215getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3220drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        float f2;
        ...
        painter.m3221drawx_KDEd0(drawScope, j, f2, colorFilter2);
    }

    /* renamed from: draw-x_KDEd0  reason: not valid java name */
    public final void m3221drawx_KDEd0(DrawScope draw, long size, float alpha, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(alpha);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float right$iv = Size.m2437getWidthimpl(draw.mo3146getSizeNHjbRc()) - Size.m2437getWidthimpl(size);
        float bottom$iv = Size.m2434getHeightimpl(draw.mo3146getSizeNHjbRc()) - Size.m2434getHeightimpl(size);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, right$iv, bottom$iv);
        if (alpha > 0.0f && Size.m2437getWidthimpl(size) > 0.0f && Size.m2434getHeightimpl(size) > 0.0f) {
            if (this.useLayer) {
                Rect layerRect = RectKt.m2408Recttz77jQw(Offset.Companion.m2384getZeroF1C5BW0(), SizeKt.Size(Size.m2437getWidthimpl(size), Size.m2434getHeightimpl(size)));
