        ...
        switch (this.label) {
            case 0:
                ...
                if (!this.$consumed) {
                    ...
                    this.label = 1;
                    if (nestedScrollDispatcher2.m3894dispatchPostFlingRZ2iAVY(Velocity.Companion.m5358getZero9UxMQ8M(), this.$viewVelocity, this) != coroutine_suspended) {
                        break;
                    } else {
                    ...
                    this.label = 2;
                    if (nestedScrollDispatcher.m3894dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.Companion.m5358getZero9UxMQ8M(), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }
