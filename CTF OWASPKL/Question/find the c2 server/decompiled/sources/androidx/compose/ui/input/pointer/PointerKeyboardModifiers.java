...
public final class PointerKeyboardModifiers {
    ...
    public static final /* synthetic */ PointerKeyboardModifiers m4068boximpl(int i) {
        return new PointerKeyboardModifiers(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4069constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4070equalsimpl(int i, Object obj) {
        return (obj instanceof PointerKeyboardModifiers) && i == ((PointerKeyboardModifiers) obj).m4074unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4071equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4072hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m4070equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4072hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m4073toStringimpl(this.packedValue);
    }
