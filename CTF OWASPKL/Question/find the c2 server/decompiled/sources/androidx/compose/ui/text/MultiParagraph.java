...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics intrinsics, long constraints, int maxLines, boolean ellipsis) {
        ...
        Rect it;
        int m5077getMaxHeightimpl;
        this.intrinsics = intrinsics;
        this.maxLines = maxLines;
        int i = 0;
        if (!(Constraints.m5080getMinWidthimpl(constraints) == 0 && Constraints.m5079getMinHeightimpl(constraints) == 0)) {
        ...
        while (index < size) {
            ...
            if (Constraints.m5073getHasBoundedHeightimpl(constraints)) {
                m5077getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m5077getMaxHeightimpl(constraints) - ParagraphKt.ceilToInt(currentHeight), i);
            } else {
                m5077getMaxHeightimpl = Constraints.m5077getMaxHeightimpl(constraints);
            }
            Paragraph paragraph = ParagraphKt.m4539Paragraph_EkL_Y(intrinsics2, ConstraintsKt.Constraints$default(0, m5078getMaxWidthimpl, 0, m5077getMaxHeightimpl, 5, null), this.maxLines - currentLineCount2, ellipsis);
            ...
            arrayList.add(new ParagraphInfo(paragraph, paragraphInfo.getStartIndex(), paragraphInfo.getEndIndex(), startLineIndex, endLineIndex, paragraphTop, paragraphBottom));
        ...
        this.width = Constraints.m5078getMaxWidthimpl(constraints);
        List $this$fastFlatMap$iv = arrayList;
        ...
        while (index$iv$iv < size2) {
            ...
            while (index$iv$iv2 < size3) {
                ...
                int i2 = size3;
                ArrayList arrayList2 = (Collection) target$iv2;
        ...
        if (it3.size() < this.intrinsics.getPlaceholders().size()) {
            ...
            list = CollectionsKt.plus((Collection) list2, (Iterable) arrayList3);
        } else {
            list = it3;
        }
    ...
    */
    ...
    public final void m4530paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            it.getParagraph().mo4502paintRPmYEkk(canvas, color, shadow, decoration);
    ...
    public final void m4529paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        canvas.save();
        List $this$fastForEach$iv = this.paragraphInfoList;
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
            Object item$iv = $this$fastForEach$iv.get(index$iv);
            ParagraphInfo it = (ParagraphInfo) item$iv;
            it.getParagraph().mo4501paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas.translate(0.0f, it.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m4531painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        AndroidMultiParagraphDrawKt.m4851drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }

    public final Path getPathForRange(int start, int end) {
        boolean z = true;
        if (!((!(start >= 0 && start <= end) || end > getAnnotatedString().getText().length()) ? false : false)) {
        ...
        for (int i = paragraphIndex; i < size; i++) {
            ...
            if (p.getStartIndex() != p.getEndIndex()) {
                Path.m2868addPathUv8p0NA$default(path, p.toGlobal(p.getParagraph().getPathForRange(p.toLocalIndex(start), p.toLocalIndex(end))), 0L, 2, null);
            }
        }
        return path;
    }
    ...
    public final int m4527getOffsetForPositionk4lQ0M(long position) {
        int paragraphIndex;
        if (Offset.m2369getYimpl(position) <= 0.0f) {
            paragraphIndex = 0;
        } else {
            paragraphIndex = Offset.m2369getYimpl(position) >= this.height ? CollectionsKt.getLastIndex(this.paragraphInfoList) : MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m2369getYimpl(position));
        }
        ...
        return $this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.toGlobalIndex($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.getParagraph().mo4499getOffsetForPositionk4lQ0M($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2412.m4536toLocalMKHz9U(position)));
    }
    ...
    public final long m4528getWordBoundaryjx7JFs(int offset) {
        int paragraphIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            paragraphIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        return $this$getWordBoundary__jx7JFs_u24lambda_u2417.m4535toGlobalGEjPoXI($this$getWordBoundary__jx7JFs_u24lambda_u2417.getParagraph().mo4500getWordBoundaryjx7JFs($this$getWordBoundary__jx7JFs_u24lambda_u2417.toLocalIndex(offset)));
    }
