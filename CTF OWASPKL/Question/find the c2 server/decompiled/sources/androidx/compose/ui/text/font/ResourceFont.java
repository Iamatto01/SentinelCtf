...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m4758getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    */
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        Ld:
            ...
            int r10 = r9.m4727getNormal_LCdwA()
            r3 = r10
            goto L1a
        L19:
            r3 = r10
        L1a:
            ...
            androidx.compose.ui.text.font.FontVariation$Settings r11 = r9.m4742Settings6EWAqTQ(r2, r3, r10)
            r4 = r11
            goto L2a
        L29:
            r4 = r11
        L2a:
            ...
            int r12 = r9.m4713getAsyncPKNRLFQ()
            r5 = r12
            goto L37
        L36:
            r5 = r12
    ...
    public int mo4677getStyle_LCdwA() {
        return this.style;
    }
    ...
    public int mo4669getLoadingStrategyPKNRLFQ() {
        return this.loadingStrategy;
    }

    /* renamed from: copy-RetOiIg$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m4757copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.mo4677getStyle_LCdwA();
        }
        return resourceFont.m4760copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m4760copyRetOiIg(int resId, FontWeight weight, int style) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return m4756copyF3nL8kk$default(this, resId, weight, style, mo4669getLoadingStrategyPKNRLFQ(), null, 16, null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m4756copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        return resourceFont.m4759copyF3nL8kk(i, (i4 & 2) != 0 ? resourceFont.getWeight() : fontWeight, (i4 & 4) != 0 ? resourceFont.mo4677getStyle_LCdwA() : i2, (i4 & 8) != 0 ? resourceFont.mo4669getLoadingStrategyPKNRLFQ() : i3, (i4 & 16) != 0 ? resourceFont.variationSettings : settings);
    }

    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m4759copyF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(weight, "weight");
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ResourceFont) && this.resId == ((ResourceFont) other).resId && Intrinsics.areEqual(getWeight(), ((ResourceFont) other).getWeight()) && FontStyle.m4722equalsimpl0(mo4677getStyle_LCdwA(), ((ResourceFont) other).mo4677getStyle_LCdwA()) && Intrinsics.areEqual(this.variationSettings, ((ResourceFont) other).variationSettings) && FontLoadingStrategy.m4709equalsimpl0(mo4669getLoadingStrategyPKNRLFQ(), ((ResourceFont) other).mo4669getLoadingStrategyPKNRLFQ());
    }

    public int hashCode() {
        int result = this.resId;
        return (((((((result * 31) + getWeight().hashCode()) * 31) + FontStyle.m4723hashCodeimpl(mo4677getStyle_LCdwA())) * 31) + FontLoadingStrategy.m4710hashCodeimpl(mo4669getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4724toStringimpl(mo4677getStyle_LCdwA())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m4711toStringimpl(mo4669getLoadingStrategyPKNRLFQ())) + ')';
    }
}
