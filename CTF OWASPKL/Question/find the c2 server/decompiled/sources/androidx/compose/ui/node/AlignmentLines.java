...
public abstract class AlignmentLines {
    ...
    protected abstract long mo4210calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            position = mo4210calculatePositionInParentR5De75A(coordinator, position);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            positionInContainer = MathKt.roundToInt(Offset.m2369getYimpl(position));
        } else {
            positionInContainer = MathKt.roundToInt(Offset.m2368getXimpl(position));
        }
