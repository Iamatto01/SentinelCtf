...
public final class EmojiSupportMatch {
    ...
    private static final int Default = m4516constructorimpl(0);
    private static final int None = m4516constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ EmojiSupportMatch m4515boximpl(int i) {
        return new EmojiSupportMatch(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m4516constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4517equalsimpl(int i, Object obj) {
        return (obj instanceof EmojiSupportMatch) && i == ((EmojiSupportMatch) obj).m4521unboximpl();
    }
    ...
    public static String m4520toStringimpl(int arg0) {
    ...
    public static final class Companion {
        ...
        public final int m4522getDefault_3YsG6Y() {
            return EmojiSupportMatch.Default;
        }

        /* renamed from: getNone-_3YsG6Y  reason: not valid java name */
        public final int m4523getNone_3YsG6Y() {
