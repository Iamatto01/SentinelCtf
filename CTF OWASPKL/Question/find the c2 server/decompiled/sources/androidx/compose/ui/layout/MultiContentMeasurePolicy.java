...
public interface MultiContentMeasurePolicy {
    ...
    MeasureResult m4165measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j);
    ...
    default int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> measurables, int height) {
        ...
        while (index$iv$iv < size) {
            ...
            boolean z3 = z;
            int $i$f$fastMap = $this$fastForEach$iv$iv2.size();
            List $this$fastForEach$iv$iv3 = $this$fastForEach$iv$iv;
            int index$iv$iv2 = 0;
            while (index$iv$iv2 < $i$f$fastMap) {
                int i = $i$f$fastMap;
        ...
        MeasureResult layoutResult = m4165measure3p2s80s(layoutReceiver, mapped, constraints);
