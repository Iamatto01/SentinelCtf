...
public final class ImageVector {
    ...
    public final float m3224getDefaultWidthD9Ej5fM() {
        return this.defaultWidth;
    }

    /* renamed from: getDefaultHeight-D9Ej5fM  reason: not valid java name */
    public final float m3223getDefaultHeightD9Ej5fM() {
    ...
    public final long m3226getTintColor0d7_KjU() {
        return this.tintColor;
    }

    /* renamed from: getTintBlendMode-0nO6VwU  reason: not valid java name */
    public final int m3225getTintBlendMode0nO6VwU() {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m2642getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m2548getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m2642getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m2548getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
        ...
        public final Builder m3228addPathoIyEayM(List<? extends PathNode> pathData, int pathFillType, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ImageVector) && Intrinsics.areEqual(this.name, ((ImageVector) other).name) && Dp.m5127equalsimpl0(this.defaultWidth, ((ImageVector) other).defaultWidth) && Dp.m5127equalsimpl0(this.defaultHeight, ((ImageVector) other).defaultHeight)) {
            if (this.viewportWidth == ((ImageVector) other).viewportWidth) {
                return ((this.viewportHeight > ((ImageVector) other).viewportHeight ? 1 : (this.viewportHeight == ((ImageVector) other).viewportHeight ? 0 : -1)) == 0) && Intrinsics.areEqual(this.root, ((ImageVector) other).root) && Color.m2607equalsimpl0(this.tintColor, ((ImageVector) other).tintColor) && BlendMode.m2519equalsimpl0(this.tintBlendMode, ((ImageVector) other).tintBlendMode) && this.autoMirror == ((ImageVector) other).autoMirror;
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        ...
        return (((((((((((((((result * 31) + Dp.m5128hashCodeimpl(this.defaultWidth)) * 31) + Dp.m5128hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m2613hashCodeimpl(this.tintColor)) * 31) + BlendMode.m2520hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}
