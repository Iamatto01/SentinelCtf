...
public final class AndroidAccessibilitySpannableString_androidKt {
    ...
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString $this$toAccessibilitySpannableString, Density density, FontFamily.Resolver fontFamilyResolver) {
        ...
        if ($this$fastForEach$iv != null) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                ...
                SpanStyle noFontStyle = SpanStyle.m4589copyIuqyXdg$default(style, 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, 16351, null);
    ...
    private static final void setSpanStyle(SpannableString $this$setSpanStyle, SpanStyle spanStyle, int start, int end, Density density, FontFamily.Resolver fontFamilyResolver) {
        SpannableExtensions_androidKt.m4874setColorRPmYEkk($this$setSpanStyle, spanStyle.m4597getColor0d7_KjU(), start, end);
        SpannableExtensions_androidKt.m4875setFontSizeKmRG4DE($this$setSpanStyle, spanStyle.m4598getFontSizeXSAIIZE(), density, start, end);
        if (spanStyle.getFontWeight() != null || spanStyle.m4599getFontStyle4Lr2A7w() != null) {
            FontWeight fontWeight = spanStyle.getFontWeight();
            if (fontWeight == null) {
                fontWeight = FontWeight.Companion.getNormal();
            }
            FontStyle m4599getFontStyle4Lr2A7w = spanStyle.m4599getFontStyle4Lr2A7w();
            int fontStyle = m4599getFontStyle4Lr2A7w != null ? m4599getFontStyle4Lr2A7w.m4725unboximpl() : FontStyle.Companion.m4727getNormal_LCdwA();
            $this$setSpanStyle.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m4676getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle)), start, end, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m4696resolveDPcqOEQ$default(fontFamilyResolver, fontFamily, null, 0, m4600getFontSynthesisZQGJjVo != null ? m4600getFontSynthesisZQGJjVo.m4736unboximpl() : FontSynthesis.Companion.m4737getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m4872setBackgroundRPmYEkk($this$setSpanStyle, spanStyle.m4595getBackground0d7_KjU(), start, end);
    }
}
