...
public final class Float16 implements Comparable<Float16> {
    ...
    private static final short Epsilon = m2710constructorimpl((short) 5120);
    private static final short LowestValue = m2710constructorimpl((short) -1025);
    private static final short MaxValue = m2710constructorimpl((short) 31743);
    private static final short MinNormal = m2710constructorimpl((short) 1024);
    private static final short MinValue = m2710constructorimpl((short) 1);
    private static final short NaN = m2710constructorimpl((short) 32256);
    private static final short NegativeInfinity = m2710constructorimpl((short) -1024);
    private static final short NegativeZero = m2710constructorimpl((short) ShortCompanionObject.MIN_VALUE);
    private static final short PositiveInfinity = m2710constructorimpl((short) 31744);
    private static final short PositiveZero = m2710constructorimpl((short) 0);
    private static final short One = m2709constructorimpl(1.0f);
    private static final short NegativeOne = m2709constructorimpl(-1.0f);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Float16 m2705boximpl(short s) {
        return new Float16(s);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short m2710constructorimpl(short s) {
        return s;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2711equalsimpl(short s, Object obj) {
        return (obj instanceof Float16) && s == ((Float16) obj).m2736unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2712equalsimpl0(short s, short s2) {
        return s == s2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2717hashCodeimpl(short s) {
        return Short.hashCode(s);
    }

    public boolean equals(Object obj) {
        return m2711equalsimpl(this.halfValue, obj);
    }

    public int hashCode() {
        return m2717hashCodeimpl(this.halfValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ short m2736unboximpl() {
        return this.halfValue;
    }

    @Override // java.lang.Comparable
    public /* bridge */ /* synthetic */ int compareTo(Float16 float16) {
        return m2735compareTo41bOqos(float16.m2736unboximpl());
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static short m2709constructorimpl(float value) {
        return m2710constructorimpl(Companion.floatToHalf(value));
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short m2708constructorimpl(double value) {
        return m2709constructorimpl((float) value);
    }

    /* renamed from: toByte-impl  reason: not valid java name */
    public static final byte m2724toByteimpl(short arg0) {
        return (byte) m2726toFloatimpl(arg0);
    }

    /* renamed from: toShort-impl  reason: not valid java name */
    public static final short m2731toShortimpl(short arg0) {
        return (short) m2726toFloatimpl(arg0);
    }

    /* renamed from: toInt-impl  reason: not valid java name */
    public static final int m2728toIntimpl(short arg0) {
        return (int) m2726toFloatimpl(arg0);
    }

    /* renamed from: toLong-impl  reason: not valid java name */
    public static final long m2729toLongimpl(short arg0) {
        return m2726toFloatimpl(arg0);
    }

    /* renamed from: toFloat-impl  reason: not valid java name */
    public static final float m2726toFloatimpl(short arg0) {
        int bits = 65535 & arg0;
        int s = 32768 & bits;
        int e = (bits >>> 10) & 31;
    ...
    public static final double m2725toDoubleimpl(short arg0) {
        return m2726toFloatimpl(arg0);
    }

    /* renamed from: toBits-impl  reason: not valid java name */
    public static final int m2723toBitsimpl(short arg0) {
        if (m2720isNaNimpl(arg0)) {
            return NaN;
        }
        return 65535 & arg0;
    }
    ...
    public static final int m2730toRawBitsimpl(short arg0) {
        return 65535 & arg0;
    }

    public String toString() {
        return m2732toStringimpl(this.halfValue);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2732toStringimpl(short arg0) {
        return String.valueOf(m2726toFloatimpl(arg0));
    }

    /* renamed from: compareTo-41bOqos  reason: not valid java name */
    public int m2735compareTo41bOqos(short other) {
        return m2707compareTo41bOqos(this.halfValue, other);
    }

    /* renamed from: compareTo-41bOqos  reason: not valid java name */
    public static int m2707compareTo41bOqos(short arg0, short other) {
        if (m2720isNaNimpl(arg0)) {
            return !m2720isNaNimpl(other) ? 1 : 0;
        }
        if (m2720isNaNimpl(other)) {
            return -1;
        }
    ...
    public static final short m2715getSignslo4al4(short arg0) {
        if (m2720isNaNimpl(arg0)) {
            return NaN;
        }
        return m2707compareTo41bOqos(arg0, NegativeZero) < 0 ? NegativeOne : m2707compareTo41bOqos(arg0, PositiveZero) > 0 ? One : arg0;
    }

    /* renamed from: withSign-qCeQghg  reason: not valid java name */
    public static final short m2734withSignqCeQghg(short arg0, short sign) {
        return m2710constructorimpl((short) ((32768 & sign) | (arg0 & ShortCompanionObject.MAX_VALUE)));
    }

    /* renamed from: absoluteValue-slo4al4  reason: not valid java name */
    public static final short m2704absoluteValueslo4al4(short arg0) {
        return m2710constructorimpl((short) (arg0 & ShortCompanionObject.MAX_VALUE));
    }

    /* renamed from: round-slo4al4  reason: not valid java name */
    public static final short m2722roundslo4al4(short arg0) {
        ...
        return m2710constructorimpl((short) result);
    }

    /* renamed from: ceil-slo4al4  reason: not valid java name */
    public static final short m2706ceilslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & FP16_COMBINED;
        int result = bits;
        if (e < 15360) {
    ...
    public static final short m2713floorslo4al4(short arg0) {
        int i = SupportMenu.USER_MASK;
        int bits = arg0 & UShort.MAX_VALUE;
        int e = bits & FP16_COMBINED;
        int result = bits;
    ...
    public static final short m2733truncslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & FP16_COMBINED;
        int result = bits;
        if (e < 15360) {
    ...
    public static final int m2714getExponentimpl(short arg0) {
        return ((arg0 >>> 10) & 31) - 15;
    }

    /* renamed from: getSignificand-impl  reason: not valid java name */
    public static final int m2716getSignificandimpl(short arg0) {
        return arg0 & 1023;
    }

    /* renamed from: isNaN-impl  reason: not valid java name */
    public static final boolean m2720isNaNimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) > FP16_EXPONENT_MAX;
    }

    /* renamed from: isInfinite-impl  reason: not valid java name */
    public static final boolean m2719isInfiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) == FP16_EXPONENT_MAX;
    }

    /* renamed from: isFinite-impl  reason: not valid java name */
    public static final boolean m2718isFiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) != FP16_EXPONENT_MAX;
    }

    /* renamed from: isNormalized-impl  reason: not valid java name */
    public static final boolean m2721isNormalizedimpl(short arg0) {
        return ((arg0 & 31744) == 0 || (arg0 & 31744) == FP16_EXPONENT_MAX) ? false : true;
    }

    /* renamed from: toHexString-impl  reason: not valid java name */
    public static final String m2727toHexStringimpl(short arg0) {
