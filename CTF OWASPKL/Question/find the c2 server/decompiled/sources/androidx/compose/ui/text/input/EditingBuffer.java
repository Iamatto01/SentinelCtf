...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m4635getMinimpl(selection);
        this.selectionEnd = TextRange.m4634getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m4635getMinimpl(selection);
        int end = TextRange.m4634getMaximpl(selection);
    ...
    public final TextRange m4767getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m4625boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release  reason: not valid java name */
    public final long m4768getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m4769updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m4635getMinimpl(newSelection));
        setSelectionEnd(TextRange.m4634getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m4769updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
            if (TextRange.m4631getCollapsedimpl(newComposition)) {
                commitComposition$ui_text_release();
                return;
            }
            this.compositionStart = TextRange.m4635getMinimpl(newComposition);
            this.compositionEnd = TextRange.m4634getMaximpl(newComposition);
        }
    }
