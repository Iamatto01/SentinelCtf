...
public final class Vertices {
    ...
    public final int m2998getVertexModec2xauaI() {
    ...
    private final int[] encodeColorList(List<Color> list) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m2660toArgb8_81llA(list.get(i).m2616unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i = 0; i < size; i++) {
            int pointIndex = i / 2;
            long point = list.get(pointIndex).m2378unboximpl();
            if (i % 2 == 0) {
                m2369getYimpl = Offset.m2368getXimpl(point);
            } else {
                m2369getYimpl = Offset.m2369getYimpl(point);
            }
            fArr[i] = m2369getYimpl;
        }
        return fArr;
    }
}
