...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4433calculateMatrixGrdbGEg(T t) {
        float[] it = this.matrixCache;
        if (it == null) {
            it = androidx.compose.ui.graphics.Matrix.m2830constructorimpl$default(null, 1, null);
            this.matrixCache = it;
        }
        if (!this.isDirty) {
            return it;
    ...
    public final float[] m4432calculateInverseMatrixbWbORWo(T t) {
        ...
        if (this.isInverseDirty) {
            float[] normalMatrix = m4433calculateMatrixGrdbGEg(t);
            this.isInverseValid = InvertMatrixKt.m4430invertToJiSxe2E(normalMatrix, it);
