...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        if (!(Constraints.m5079getMinHeightimpl(constraints) == 0 && Constraints.m5080getMinWidthimpl(constraints) == 0)) {
        ...
        if (AndroidParagraph_androidKt.access$shouldAttachIndentationFixSpan(style, ellipsis)) {
        ...
        int alignment = AndroidParagraph_androidKt.m4504access$toLayoutAlignAMY3VfE(style.m4665getTextAlignbuA522U());
        TextAlign m4665getTextAlignbuA522U = style.m4665getTextAlignbuA522U();
        int justificationMode = m4665getTextAlignbuA522U == null ? false : TextAlign.m4990equalsimpl0(m4665getTextAlignbuA522U.m4993unboximpl(), TextAlign.Companion.m4996getJustifye0LSkKk()) ? 1 : 0;
        int hyphens = AndroidParagraph_androidKt.m4506access$toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle$ui_text_release().m4549getHyphensEaSxIns());
        LineBreak m4663getLineBreakLgCVezo = style.m4663getLineBreakLgCVezo();
        int breakStrategy = AndroidParagraph_androidKt.m4505access$toLayoutBreakStrategyu6PBz3U(m4663getLineBreakLgCVezo != null ? LineBreak.Strategy.m4927boximpl(LineBreak.m4918getStrategyfcGXIks(m4663getLineBreakLgCVezo.m4923unboximpl())) : null);
        LineBreak m4663getLineBreakLgCVezo2 = style.m4663getLineBreakLgCVezo();
        int lineBreakStyle = AndroidParagraph_androidKt.m4507access$toLayoutLineBreakStyle4a2g8L8(m4663getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m4937boximpl(LineBreak.m4919getStrictnessusljTpc(m4663getLineBreakLgCVezo2.m4923unboximpl())) : null);
        LineBreak m4663getLineBreakLgCVezo3 = style.m4663getLineBreakLgCVezo();
        int lineBreakWordStyle = AndroidParagraph_androidKt.m4508access$toLayoutLineBreakWordStylegvcdTPQ(m4663getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m4948boximpl(LineBreak.m4920getWordBreakjp8hJ3c(m4663getLineBreakLgCVezo3.m4923unboximpl())) : null);
        if (ellipsis) {
        ...
        if (!ellipsis || firstLayout.getHeight() <= Constraints.m5077getMaxHeightimpl(constraints) || maxLines <= 1) {
            androidParagraph = this;
            i = 0;
            androidParagraph.layout = firstLayout;
        } else {
            int calculatedMaxLines = AndroidParagraph_androidKt.access$numberOfLinesThatFitMaxHeight(firstLayout, Constraints.m5077getMaxHeightimpl(constraints));
        ...
        getTextPaint$ui_text_release().m4863setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        ...
        for (int i2 = i; i2 < length; i2++) {
            shaderBrushSpans[i2].m4882setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
        CharSequence $this$placeholderRects_u24lambda_u246 = androidParagraph.charSequence;
        boolean z2 = false;
        if ($this$placeholderRects_u24lambda_u246 instanceof Spanned) {
            ...
            int i3 = 0;
            while (i3 < length2) {
                Object item$iv$iv = $this$mapTo$iv$iv2[i3];
                ...
                int line = androidParagraph.layout.getLineForOffset(start);
                boolean z5 = z2;
                boolean exceedsMaxLines = line >= androidParagraph.maxLines;
                Object[] $this$map$iv2 = $this$map$iv;
                boolean isPlaceholderSpanEllipsized = androidParagraph.layout.getLineEllipsisCount(line) > 0 && end > androidParagraph.layout.getLineEllipsisOffset(line);
                boolean z6 = z3;
                boolean isPlaceholderSpanTruncated = end > androidParagraph.layout.getLineEnd(line);
                if (isPlaceholderSpanEllipsized || isPlaceholderSpanTruncated) {
                    ...
                    ResolvedTextDirection direction = androidParagraph.getBidiRunDirection(start);
                    switch (WhenMappings.$EnumSwitchMapping$0[direction.ordinal()]) {
                        case 1:
                            horizontalPosition = androidParagraph.getHorizontalPosition(start, true);
                            break;
                        case 2:
                            horizontalPosition = androidParagraph.getHorizontalPosition(start, true) - span.getWidthPx();
                            break;
                        default:
                    ...
                    TextLayout $this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244 = androidParagraph.layout;
                    switch (span.getVerticalAlign()) {
                        ...
                        case 6:
                            ...
                            $this$mapTo$iv$iv = $this$mapTo$iv$iv2;
                            int i4 = $this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244_u24lambda_u243.ascent;
                            z = z4;
                            int $i$f$mapTo = $this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244_u24lambda_u243.descent;
                            lineBaseline = (((i4 + $i$f$mapTo) - span.getHeightPx()) / 2) + $this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244.getLineBaseline(line);
                            break;
                        default:
        ...
        androidParagraph.wordBoundary$delegate = LazyKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new Function0<WordBoundary>() { // from class: androidx.compose.ui.text.AndroidParagraph$wordBoundary$2
    ...
    public final long m4498getConstraintsmsEJaDk() {
    ...
    public float getWidth() {
        return Constraints.m5078getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4499getOffsetForPositionk4lQ0M(long position) {
        int line = this.layout.getLineForVertical((int) Offset.m2369getYimpl(position));
        return this.layout.getOffsetForHorizontal(line, Offset.m2368getXimpl(position));
    }
    ...
    public final void m4497fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4635getMinimpl(range), TextRange.m4634getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo4500getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo4502paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u248 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u248.m4864setColor8_81llA(color);
    ...
    public void mo4501paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int currBlendMode = getTextPaint$ui_text_release().m4861getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_LG529CI_u24lambda_u249 = getTextPaint$ui_text_release();
        $this$paint_LG529CI_u24lambda_u249.m4864setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u249.m4862setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4862setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg  reason: not valid java name */
    public void mo4503painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int currBlendMode = getTextPaint$ui_text_release().m4861getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2410.m4863setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2410.m4862setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4862setBlendModes9anfk8(currBlendMode);
    }
