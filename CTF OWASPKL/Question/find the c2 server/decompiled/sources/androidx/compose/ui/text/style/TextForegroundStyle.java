...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public long mo4897getColor0d7_KjU() {
            return Color.Companion.m2642getUnspecified0d7_KjU();
        }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m5013from8_81llA(long color) {
            return (color > Color.Companion.m2642getUnspecified0d7_KjU() ? 1 : (color == Color.Companion.m2642getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(color, null) : Unspecified.INSTANCE;
        }
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m5013from8_81llA(TextDrawStyleKt.m5012modulateDxMtmZc(((SolidColor) brush).m2931getValue0d7_KjU(), alpha));
            }
