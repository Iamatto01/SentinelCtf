...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo2575createShaderuvyYCjk(long j);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.Companion.m2445getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo2553applyToPq9zytI(long size, Paint p, float alpha) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m2433equalsimpl0(this.createdSize, size)) {
            Shader it = mo2575createShaderuvyYCjk(size);
            this.internalShader = it;
            shader = it;
            this.createdSize = size;
        }
        if (!Color.m2607equalsimpl0(p.mo2482getColor0d7_KjU(), Color.Companion.m2632getBlack0d7_KjU())) {
            p.mo2488setColor8_81llA(Color.Companion.m2632getBlack0d7_KjU());
        }
