...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int initialInputMode, Function1<? super InputMode, Boolean> function1) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m3264boximpl(initialInputMode), null, 2, null);
        this.inputMode$delegate = mutableStateOf$default;
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: getInputMode-aOaMEAU */
    public int mo3273getInputModeaOaMEAU() {
        State $this$getValue$iv = this.inputMode$delegate;
        return ((InputMode) $this$getValue$iv.getValue()).m3270unboximpl();
    }

    /* renamed from: setInputMode-iuPiT84  reason: not valid java name */
    public void m3275setInputModeiuPiT84(int i) {
        MutableState $this$setValue$iv = this.inputMode$delegate;
        $this$setValue$iv.setValue(InputMode.m3264boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo3274requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m3264boximpl(inputMode)).booleanValue();
    }
}
