...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m3188rotateRg1IO4c$default(DrawScope rotate, float degrees, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = rotate.mo3145getCenterF1C5BW0();
        }
        ...
        $this$rotate_Rg1IO4c_u24lambda_u240.mo3077rotateUv8p0NA(degrees, pivot);
        block.invoke(rotate);
    ...
    public static final void m3187rotateRg1IO4c(DrawScope rotate, float degrees, long pivot, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = rotate.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3071getSizeNHjbRc();
    ...
    public static /* synthetic */ void m3190rotateRadRg1IO4c$default(DrawScope rotateRad, float radians, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = rotateRad.mo3145getCenterF1C5BW0();
        }
        ...
        $this$rotateRad_Rg1IO4c_u24lambda_u241.mo3077rotateUv8p0NA(DegreesKt.degrees(radians), pivot);
    ...
    public static final void m3189rotateRadRg1IO4c(DrawScope rotateRad, float radians, long pivot, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = rotateRad.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3071getSizeNHjbRc();
    ...
    public static /* synthetic */ void m3192scaleFgt4K4Q$default(DrawScope scale, float scaleX, float scaleY, long pivot, Function1 block, int i, Object obj) {
        if ((i & 4) != 0) {
            pivot = scale.mo3145getCenterF1C5BW0();
        }
        ...
        $this$scale_Fgt4K4Q_u24lambda_u242.mo3078scale0AR0LA0(scaleX, scaleY, pivot);
        block.invoke(scale);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3072setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static final void m3191scaleFgt4K4Q(DrawScope scale, float scaleX, float scaleY, long pivot, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = scale.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3071getSizeNHjbRc();
    ...
    public static /* synthetic */ void m3194scaleRg1IO4c$default(DrawScope scale, float scale2, long pivot, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            pivot = scale.mo3145getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        ...
        $this$scale_Rg1IO4c_u24lambda_u243.mo3078scale0AR0LA0(scale2, scale2, pivot);
        block.invoke(scale);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3072setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static final void m3193scaleRg1IO4c(DrawScope scale, float scale2, long pivot, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = scale.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3071getSizeNHjbRc();
    ...
    public static /* synthetic */ void m3186clipRectrOu3jXo$default(DrawScope clipRect, float left, float top, float right, float bottom, int clipOp, Function1 block, int i, Object obj) {
        float left2 = (i & 1) != 0 ? 0.0f : left;
        float top2 = (i & 2) != 0 ? 0.0f : top;
        float right2 = (i & 4) != 0 ? Size.m2437getWidthimpl(clipRect.mo3146getSizeNHjbRc()) : right;
        float bottom2 = (i & 8) != 0 ? Size.m2434getHeightimpl(clipRect.mo3146getSizeNHjbRc()) : bottom;
        int clipOp2 = (i & 16) != 0 ? ClipOp.Companion.m2595getIntersectrtfAjoo() : clipOp;
        ...
        $this$clipRect_rOu3jXo_u24lambda_u244.mo3074clipRectN_I0leg(left2, top2, right2, bottom2, clipOp2);
    ...
    public static final void m3185clipRectrOu3jXo(DrawScope clipRect, float left, float top, float right, float bottom, int clipOp, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipRect, "$this$clipRect");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = clipRect.getDrawContext();
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3071getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv.getCanvas().save();
        DrawTransform $this$clipRect_rOu3jXo_u24lambda_u244 = $this$withTransform_u24lambda_u246$iv.getTransform();
        $this$clipRect_rOu3jXo_u24lambda_u244.mo3074clipRectN_I0leg(left, top, right, bottom, clipOp);
        block.invoke(clipRect);
        $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv.mo3072setSizeuvyYCjk(previousSize$iv);
    }
    ...
    public static /* synthetic */ void m3184clipPathKD09W0M$default(DrawScope clipPath, Path path, int clipOp, Function1 block, int i, Object obj) {
        if ((i & 2) != 0) {
            clipOp = ClipOp.Companion.m2595getIntersectrtfAjoo();
        }
        ...
        $this$clipPath_KD09W0M_u24lambda_u245.mo3073clipPathmtrdDE(path, clipOp);
    ...
    public static final void m3183clipPathKD09W0M(DrawScope clipPath, Path path, int clipOp, Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipPath, "$this$clipPath");
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext $this$withTransform_u24lambda_u246$iv = clipPath.getDrawContext();
    ...
    public static final void withTransform(DrawScope $this$withTransform, Function1<? super DrawTransform, Unit> transformBlock, Function1<? super DrawScope, Unit> drawBlock) {
        ...
        long previousSize = $this$withTransform_u24lambda_u246.mo3071getSizeNHjbRc();
        ...
        $this$withTransform_u24lambda_u246.mo3072setSizeuvyYCjk(previousSize);
    }
}
