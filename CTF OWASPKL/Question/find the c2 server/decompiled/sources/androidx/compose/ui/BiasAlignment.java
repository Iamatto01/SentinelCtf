...
public final class BiasAlignment implements Alignment {
    ...
    public long mo2264alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float centerX = (IntSize.m5282getWidthimpl(space) - IntSize.m5282getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m5281getHeightimpl(space) - IntSize.m5281getHeightimpl(size)) / 2.0f;
