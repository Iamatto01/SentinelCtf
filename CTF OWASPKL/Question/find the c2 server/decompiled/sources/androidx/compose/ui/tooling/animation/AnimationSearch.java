...
public final class AnimationSearch {
    ...
    private final Collection<Search<? extends Object>> unsupportedSearch() {
        return UnsupportedComposeAnimation.Companion.getApiAvailable() ? SetsKt.setOf((Object[]) new Search[]{new AnimateContentSizeSearch(new Function1<Object, Unit>() { // from class: androidx.compose.ui.tooling.animation.AnimationSearch$unsupportedSearch$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public static class Search<T> {
        ...
        public final void track() {
            Iterable<T> $this$forEach$iv = CollectionsKt.reversed(this.animations);
        ...
        private final List<InfiniteTransitionSearchInfo> findAnimations(Collection<? extends Group> collection) {
            ...
            for (Object element$iv$iv$iv : $this$mapNotNullTo$iv$iv) {
                ...
                for (Object element$iv$iv$iv2 : $this$flatMap$iv$iv) {
                    Iterable iterable = list$iv$iv$iv;
                    Iterable list$iv$iv$iv2 = ((Group) element$iv$iv$iv2).getData();
                    CollectionsKt.addAll(destination$iv$iv$iv, list$iv$iv$iv2);
                    list$iv$iv$iv = iterable;
                }
                Iterable $i$f$mapNotNull = list$iv$iv$iv;
                List dataToSearch$iv = CollectionsKt.plus((Collection) data, (Iterable) ((List) destination$iv$iv$iv));
                ...
                Collection<Group> it$iv = $this$findData$iv.getChildren();
                Collection<Group> $this$flatMap$iv$iv2 = it$iv;
                ...
                for (Object element$iv$iv$iv3 : $this$flatMap$iv$iv2) {
                    ...
                    Group $this$findData$iv2 = $this$findData$iv;
                    Iterable list$iv$iv$iv3 = child$iv.getChildren();
                    CollectionsKt.addAll(destination$iv$iv$iv2, list$iv$iv$iv3);
                    $this$mapNotNullTo$iv$iv = $this$mapNotNullTo$iv$iv;
                    $this$findData$iv = $this$findData$iv2;
                }
                Iterable $this$mapNotNullTo$iv$iv2 = $this$mapNotNullTo$iv$iv;
                Iterable list$iv$iv$iv4 = CollectionsKt.plus((Collection) it$iv, (Iterable) ((List) destination$iv$iv$iv2));
                Collection destination$iv$iv$iv3 = new ArrayList();
                for (Object element$iv$iv$iv4 : list$iv$iv$iv4) {
                    Iterable $this$flatMap$iv$iv3 = list$iv$iv$iv4;
                    Iterable list$iv$iv$iv5 = ((Group) element$iv$iv$iv4).getData();
                    CollectionsKt.addAll(destination$iv$iv$iv3, list$iv$iv$iv5);
                    list$iv$iv$iv4 = $this$flatMap$iv$iv3;
                }
                List dataToSearch$iv3 = CollectionsKt.plus((Collection) data2, (Iterable) ((List) destination$iv$iv$iv3));
    ...
    public static final class AnimateXAsStateSearch extends Search<AnimateXAsStateSearchInfo<?, ?>> {
        ...
        private final <T> List<AnimateXAsStateSearchInfo<T, AnimationVector>> findAnimations(Collection<? extends Group> collection) {
            ...
            Iterable $this$filterIsInstance$iv = (List) destination$iv$iv;
            Collection destination$iv$iv2 = new ArrayList();
            for (T t3 : $this$filterIsInstance$iv) {
            ...
            for (Object element$iv$iv$iv : $this$mapNotNullTo$iv$iv) {
                ...
                while (true) {
                    ...
                    int $this$firstOrNull$iv$iv2 = $i$f$mapNotNull;
                    MutableState mutableState2 = (MutableState) (t instanceof MutableState ? t : null);
                    if (mutableState2 != null) {
                        destination$iv$iv$iv.add(mutableState2);
                    }
                    $i$f$mapNotNull = $this$firstOrNull$iv$iv2;
                    $this$mapNotNull$iv2 = $this$mapNotNull$iv;
                }
                ...
                for (Object element$iv$iv$iv$iv3 : $this$mapNotNull$iv$iv3) {
                    ...
                    Iterable $this$firstOrNull$iv$iv3 = it$iv4.getData();
                    Iterator<T> it4 = $this$firstOrNull$iv$iv3.iterator();
                    while (true) {
                        if (!it4.hasNext()) {
                    ...
                    Iterable $this$firstOrNull$iv$iv4 = $this$mapNotNull$iv$iv3;
                    if (!(obj instanceof MutableState)) {
                        obj = null;
                    }
                    MutableState mutableState3 = (MutableState) obj;
                    if (mutableState3 != null) {
                        destination$iv$iv$iv3.add(mutableState3);
                    }
                    $this$mapNotNull$iv$iv3 = $this$firstOrNull$iv$iv4;
                    rememberCalls$iv2 = rememberCalls$iv;
                }
                MutableState toolingOverride = (MutableState) CollectionsKt.firstOrNull((List<? extends Object>) CollectionsKt.plus((Collection) list, (Iterable) ((List) destination$iv$iv$iv3)));
                if (animatable != null && spec != null && toolingOverride != null) {
                    ...
                    mutableState = new AnimateXAsStateSearchInfo(animatable, spec, (ToolingState) value);
                }
                if (mutableState != null) {
                    destination$iv$iv3.add(mutableState);
                }
        ...
        private final <T> AnimationSpec<T> findAnimationSpec(CallGroup group) {
            ...
            Iterable $this$flatMap$iv2 = CollectionsKt.plus((Collection) arrayList, (Iterable) ((List) destination$iv$iv2));
            Collection destination$iv$iv3 = new ArrayList();
            for (Object element$iv$iv2 : $this$flatMap$iv2) {
                Group it3 = (Group) element$iv$iv2;
            ...
            for (T t2 : $this$filterIsInstance$iv) {
                if (t2 instanceof State) {
                    destination$iv$iv4.add(t2);
                }
            }
            ...
            for (T t3 : $this$filterIsInstance$iv2) {
                if (t3 instanceof AnimationSpec) {
                    destination$iv$iv6.add(t3);
                }
            }
            return (AnimationSpec) CollectionsKt.firstOrNull((List<? extends Object>) destination$iv$iv6);
        }
        ...
        private final <T> Animatable<T, AnimationVector> findAnimatable(CallGroup group) {
            ...
            return (Animatable) CollectionsKt.firstOrNull((List<? extends Object>) CollectionsKt.plus((Collection) list, (Iterable) ((List) destination$iv$iv$iv3)));
        }
    }
        ...
        public void addAnimations(Collection<? extends Group> groupsWithLocation) {
            ...
            for (Object element$iv$iv$iv : $this$mapNotNull$iv2) {
                ...
                while (true) {
                    ...
                    Object element$iv = it2.next();
                    if (element$iv != 0 && (cls = element$iv.getClass()) != null) {
                        str = cls.getName();
                    }
                    $this$mapNotNull$iv = $this$mapNotNull$iv2;
    ...
    public static final class TransitionSearch extends Search<Transition<?>> {
        ...
        public void addAnimations(Collection<? extends Group> groupsWithLocation) {
            ...
            for (Object element$iv$iv$iv$iv : $this$mapNotNull$iv$iv) {
                Group it$iv = (Group) element$iv$iv$iv$iv;
                Iterable $this$firstOrNull$iv$iv = it$iv.getData();
                Iterator<T> it2 = $this$firstOrNull$iv$iv.iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        obj2 = null;
                        break;
            ...
            for (Object element$iv$iv$iv$iv3 : $this$mapNotNull$iv$iv3) {
                ...
                Iterator<T> it3 = $this$firstOrNull$iv$iv2.iterator();
                while (true) {
                    if (!it3.hasNext()) {
            ...
            animations.addAll(CollectionsKt.plus((Collection) list, (Iterable) ((List) destination$iv$iv$iv3)));
        }
    }
    ...
    public static final class AnimatedVisibilitySearch extends Search<Transition<?>> {
        ...
        public void addAnimations(Collection<? extends Group> groupsWithLocation) {
            ...
            Iterable it$iv$iv$iv = (Collection) ((List) destination$iv$iv2);
            boolean z2 = false;
            Iterable $this$mapNotNull$iv$iv = it$iv$iv$iv;
            Collection destination$iv$iv$iv = new ArrayList();
            for (Object element$iv$iv$iv$iv : $this$mapNotNull$iv$iv) {
                Group it$iv = (Group) element$iv$iv$iv$iv;
                Iterable $this$firstOrNull$iv$iv = it$iv.getData();
            ...
            List selfData$iv = (List) destination$iv$iv$iv;
            Collection destination$iv$iv$iv2 = new ArrayList();
            for (Object element$iv$iv$iv$iv2 : it$iv$iv$iv) {
                Group it$iv2 = (Group) element$iv$iv$iv$iv2;
                Iterable $this$findRememberedData$iv = it$iv$iv$iv;
                Group firstOrNull = PreviewUtilsKt.firstOrNull(it$iv2, AnimationSearchKt$findRememberedData$rememberCalls$1$1.INSTANCE);
                if (firstOrNull != null) {
                    destination$iv$iv$iv2.add(firstOrNull);
                }
            ...
            for (Object element$iv$iv$iv$iv3 : rememberCalls$iv2) {
                ...
                Iterator<T> it5 = $this$firstOrNull$iv$iv3.iterator();
                while (true) {
                    if (!it5.hasNext()) {
                        rememberCalls$iv = rememberCalls$iv2;
                        obj = null;
