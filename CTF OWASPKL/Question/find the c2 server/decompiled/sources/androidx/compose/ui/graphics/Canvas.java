...
public interface Canvas {
    ...
    void mo2462clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg */
    void mo2463clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: concat-58bKbWc */
    void mo2464concat58bKbWc(float[] fArr);
    ...
    void mo2465drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo2466drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo2467drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo2468drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void mo2469drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo2470drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void mo2471drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2584clipRectmtrdDE(Canvas $this, Rect rect, int clipOp) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Canvas.super.m2581clipRectmtrdDE(rect, clipOp);
        }
    ...
    static /* synthetic */ void m2579clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-mtrdD-E");
        }
        if ((i2 & 2) != 0) {
            i = ClipOp.Companion.m2595getIntersectrtfAjoo();
        }
        canvas.m2581clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
    default void m2581clipRectmtrdDE(Rect rect, int clipOp) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        mo2463clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
    static /* synthetic */ void m2578clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        int i3;
        if (obj != null) {
        ...
        if ((i2 & 16) == 0) {
            ...
            i3 = ClipOp.Companion.m2595getIntersectrtfAjoo();
        }
        canvas.mo2463clipRectN_I0leg(f, f2, f3, f4, i3);
    }

    /* renamed from: clipPath-mtrdD-E$default  reason: not valid java name */
    static /* synthetic */ void m2577clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo2462clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m2580drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long m5250getZeronOccac = (i & 2) != 0 ? IntOffset.Companion.m5250getZeronOccac() : j;
        long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo2467drawImageRectHPBpro0(imageBitmap, m5250getZeronOccac, IntSize, (i & 8) != 0 ? IntOffset.Companion.m5250getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
    }
}
