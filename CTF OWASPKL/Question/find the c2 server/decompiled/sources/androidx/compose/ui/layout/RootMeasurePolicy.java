...
public final class RootMeasurePolicy extends LayoutNode.NoIntrinsicsMeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        if (measurables.isEmpty()) {
            return MeasureScope.layout$default(measure, Constraints.m5080getMinWidthimpl(constraints), Constraints.m5079getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$1
        ...
        if (measurables.size() == 1) {
            final Placeable placeable = measurables.get(0).mo4125measureBRTryo0(constraints);
            return MeasureScope.layout$default(measure, ConstraintsKt.m5092constrainWidthK40F9xA(constraints, placeable.getWidth()), ConstraintsKt.m5091constrainHeightK40F9xA(constraints, placeable.getHeight()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$2
        ...
        return MeasureScope.layout$default(measure, ConstraintsKt.m5092constrainWidthK40F9xA(constraints, maxWidth), ConstraintsKt.m5091constrainHeightK40F9xA(constraints, maxHeight), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.RootMeasurePolicy$measure$4
            /* JADX INFO: Access modifiers changed from: package-private */
