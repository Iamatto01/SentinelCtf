...
public final class RenderIntent {
    ...
    private static final int Perceptual = m3022constructorimpl(0);
    private static final int Relative = m3022constructorimpl(1);
    private static final int Saturation = m3022constructorimpl(2);
    private static final int Absolute = m3022constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ RenderIntent m3021boximpl(int i) {
    ...
    public static boolean m3023equalsimpl(int i, Object obj) {
        return (obj instanceof RenderIntent) && i == ((RenderIntent) obj).m3027unboximpl();
    }
    ...
    public static String m3026toStringimpl(int arg0) {
        return m3024equalsimpl0(arg0, Perceptual) ? "Perceptual" : m3024equalsimpl0(arg0, Relative) ? "Relative" : m3024equalsimpl0(arg0, Saturation) ? "Saturation" : m3024equalsimpl0(arg0, Absolute) ? "Absolute" : "Unknown";
    }
