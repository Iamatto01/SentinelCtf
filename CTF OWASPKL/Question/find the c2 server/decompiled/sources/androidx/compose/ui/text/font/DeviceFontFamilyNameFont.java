...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    private DeviceFontFamilyNameFont(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m4715getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, variationSettings, null);
    ...
    public final android.graphics.Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().mo4749optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), mo4677getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DeviceFontFamilyNameFont) && DeviceFontFamilyName.m4690equalsimpl0(this.familyName, ((DeviceFontFamilyNameFont) other).familyName) && Intrinsics.areEqual(getWeight(), ((DeviceFontFamilyNameFont) other).getWeight()) && FontStyle.m4722equalsimpl0(mo4677getStyle_LCdwA(), ((DeviceFontFamilyNameFont) other).mo4677getStyle_LCdwA()) && Intrinsics.areEqual(getVariationSettings(), ((DeviceFontFamilyNameFont) other).getVariationSettings());
    }

    public int hashCode() {
        int result = DeviceFontFamilyName.m4691hashCodeimpl(this.familyName);
        return (((((result * 31) + getWeight().hashCode()) * 31) + FontStyle.m4723hashCodeimpl(mo4677getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m4692toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4724toStringimpl(mo4677getStyle_LCdwA())) + ')';
    }
}
