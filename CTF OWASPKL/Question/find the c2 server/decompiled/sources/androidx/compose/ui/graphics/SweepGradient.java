    ...
    */
    ...
    public Shader mo2575createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2389isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m2447getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset((Offset.m2368getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m2368getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m2437getWidthimpl(size) : Offset.m2368getXimpl(this.center), Offset.m2369getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2434getHeightimpl(size) : Offset.m2369getYimpl(this.center));
        }
        return ShaderKt.m2915SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SweepGradient) && Offset.m2365equalsimpl0(this.center, ((SweepGradient) other).center) && Intrinsics.areEqual(this.colors, ((SweepGradient) other).colors) && Intrinsics.areEqual(this.stops, ((SweepGradient) other).stops);
    }

    public int hashCode() {
        int result = Offset.m2370hashCodeimpl(this.center);
