...
public final class Rect {
    ...
    public static /* synthetic */ void m2393getSizeNHjbRc$annotations() {
    }
    ...
    public final long m2401getSizeNHjbRc() {
    ...
    public final Rect m2405translatek4lQ0M(long offset) {
        return new Rect(this.left + Offset.m2368getXimpl(offset), this.top + Offset.m2369getYimpl(offset), this.right + Offset.m2368getXimpl(offset), this.bottom + Offset.m2369getYimpl(offset));
    }
    ...
    public final long m2403getTopLeftF1C5BW0() {
        return OffsetKt.Offset(this.left, this.top);
    }

    /* renamed from: getTopCenter-F1C5BW0  reason: not valid java name */
    public final long m2402getTopCenterF1C5BW0() {
        return OffsetKt.Offset(this.left + (getWidth() / 2.0f), this.top);
    }

    /* renamed from: getTopRight-F1C5BW0  reason: not valid java name */
    public final long m2404getTopRightF1C5BW0() {
        return OffsetKt.Offset(this.right, this.top);
    }

    /* renamed from: getCenterLeft-F1C5BW0  reason: not valid java name */
    public final long m2399getCenterLeftF1C5BW0() {
        return OffsetKt.Offset(this.left, this.top + (getHeight() / 2.0f));
    }

    /* renamed from: getCenter-F1C5BW0  reason: not valid java name */
    public final long m2398getCenterF1C5BW0() {
        return OffsetKt.Offset(this.left + (getWidth() / 2.0f), this.top + (getHeight() / 2.0f));
    }

    /* renamed from: getCenterRight-F1C5BW0  reason: not valid java name */
    public final long m2400getCenterRightF1C5BW0() {
        return OffsetKt.Offset(this.right, this.top + (getHeight() / 2.0f));
    }

    /* renamed from: getBottomLeft-F1C5BW0  reason: not valid java name */
    public final long m2396getBottomLeftF1C5BW0() {
        return OffsetKt.Offset(this.left, this.bottom);
    }

    /* renamed from: getBottomCenter-F1C5BW0  reason: not valid java name */
    public final long m2395getBottomCenterF1C5BW0() {
        return OffsetKt.Offset(this.left + (getWidth() / 2.0f), this.bottom);
    }

    /* renamed from: getBottomRight-F1C5BW0  reason: not valid java name */
    public final long m2397getBottomRightF1C5BW0() {
        return OffsetKt.Offset(this.right, this.bottom);
    }

    /* renamed from: contains-k-4lQ0M  reason: not valid java name */
    public final boolean m2394containsk4lQ0M(long offset) {
        return Offset.m2368getXimpl(offset) >= this.left && Offset.m2368getXimpl(offset) < this.right && Offset.m2369getYimpl(offset) >= this.top && Offset.m2369getYimpl(offset) < this.bottom;
    }
