...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
        ...
        if (textPaint != null) {
            ...
            if (!Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                if (drawStyle instanceof Stroke) {
                    ...
                    textPaint.setStrokeJoin(m4880toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).m3210getJoinLxFBmk8()));
                    textPaint.setStrokeCap(m4879toAndroidCapBeK7IIE(((Stroke) this.drawStyle).m3209getCapKaPHkGw()));
    ...
    private final Paint.Join m4880toAndroidJoinWw9F2mQ(int $this$toAndroidJoin_u2dWw9F2mQ) {
        return StrokeJoin.m2955equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m2960getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m2955equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m2961getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m2955equalsimpl0($this$toAndroidJoin_u2dWw9F2mQ, StrokeJoin.Companion.m2959getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE  reason: not valid java name */
    private final Paint.Cap m4879toAndroidCapBeK7IIE(int $this$toAndroidCap_u2dBeK7IIE) {
        return StrokeCap.m2945equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m2949getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m2945equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m2950getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m2945equalsimpl0($this$toAndroidCap_u2dBeK7IIE, StrokeCap.Companion.m2951getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
