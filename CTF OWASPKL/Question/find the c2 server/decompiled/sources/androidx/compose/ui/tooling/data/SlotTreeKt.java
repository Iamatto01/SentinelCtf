...
public final class SlotTreeKt {
            ...
            while (!parseParameters$isChar(currentResult, ")")) {
                if (parseParameters$isChar(currentResult, "!")) {
                    ...
                    for (int i = 0; i < count; i++) {
                        result.add(new Parameter(((Number) CollectionsKt.first((List<? extends Object>) expectedSortedIndex)).intValue(), null, 2, null));
    ...
    */
    ...
    private static final Group getGroup(CompositionGroup $this$getGroup, SourceInformationContext parentContext) {
        ...
        boolean z = false;
        SourceLocation location = (!(context != null && context.isCall()) || parentContext == null) ? null : parentContext.nextSourceLocation();
        if (node != null) {
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = node.getCoordinates().mo4130getSizeYbymL2g();
        int left = MathKt.roundToInt(Offset.m2368getXimpl(position));
        int top = MathKt.roundToInt(Offset.m2369getYimpl(position));
        int right = IntSize.m5282getWidthimpl(size) + left;
        int bottom = IntSize.m5281getHeightimpl(size) + top;
    ...
    public static final <T> T mapTree(CompositionData $this$mapTree, Function3<? super CompositionGroup, ? super SourceContext, ? super List<? extends T>, ? extends T> factory, ContextCache cache) {
        ...
        callStack.convert(group, 0, arrayList);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:107:0x0046 A[EDGE_INSN: B:107:0x0046->B:16:0x0046 ?: BREAK  , SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:113:0x010e A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:51:0x010b A[Catch: all -> 0x0208, TryCatch #1 {all -> 0x0208, blocks: (B:39:0x00c4, B:41:0x00de, B:43:0x00f0, B:51:0x010b, B:52:0x010e, B:53:0x011c, B:55:0x0143, B:58:0x014d, B:60:0x0154, B:62:0x015c, B:64:0x016c, B:66:0x0177, B:70:0x0192, B:74:0x01ad, B:78:0x01b4, B:82:0x01bd, B:87:0x01e4, B:63:0x0165, B:57:0x0149), top: B:103:0x00c4 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
