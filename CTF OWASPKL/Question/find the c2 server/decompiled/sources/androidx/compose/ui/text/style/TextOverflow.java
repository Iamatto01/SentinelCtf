...
public final class TextOverflow {
    ...
    private static final int Clip = m5032constructorimpl(1);
    private static final int Ellipsis = m5032constructorimpl(2);
    private static final int Visible = m5032constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextOverflow m5031boximpl(int i) {
    ...
    public static boolean m5033equalsimpl(int i, Object obj) {
        return (obj instanceof TextOverflow) && i == ((TextOverflow) obj).m5037unboximpl();
    }
    ...
    public static String m5036toStringimpl(int arg0) {
        return m5034equalsimpl0(arg0, Clip) ? "Clip" : m5034equalsimpl0(arg0, Ellipsis) ? "Ellipsis" : m5034equalsimpl0(arg0, Visible) ? "Visible" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m5038getClipgIe3tQ8$annotations() {
        }

        /* renamed from: getEllipsis-gIe3tQ8$annotations  reason: not valid java name */
        public static /* synthetic */ void m5039getEllipsisgIe3tQ8$annotations() {
        }

        /* renamed from: getVisible-gIe3tQ8$annotations  reason: not valid java name */
        public static /* synthetic */ void m5040getVisiblegIe3tQ8$annotations() {
        }
        ...
        public final int m5041getClipgIe3tQ8() {
            return TextOverflow.Clip;
        }

        /* renamed from: getEllipsis-gIe3tQ8  reason: not valid java name */
        public final int m5042getEllipsisgIe3tQ8() {
            return TextOverflow.Ellipsis;
        }

        /* renamed from: getVisible-gIe3tQ8  reason: not valid java name */
        public final int m5043getVisiblegIe3tQ8() {
