...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m4025processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m4026processBIzXfog(pointerInputEvent, positionCalculator, z);
    }

    /* JADX WARN: Removed duplicated region for block: B:82:0x0067 A[SYNTHETIC] */
    /* renamed from: process-BIzXfog  reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final int m4026processBIzXfog(androidx.compose.ui.input.pointer.PointerInputEvent r24, androidx.compose.ui.input.pointer.PositionCalculator r25, boolean r26) {
        /*
            Method dump skipped, instructions count: 325
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.PointerInputEventProcessor.m4026processBIzXfog(androidx.compose.ui.input.pointer.PointerInputEvent, androidx.compose.ui.input.pointer.PositionCalculator, boolean):int");
    }
