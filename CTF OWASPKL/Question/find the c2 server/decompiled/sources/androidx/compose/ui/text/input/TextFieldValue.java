...
public final class TextFieldValue {
    ...
    private static final Saver<TextFieldValue, Object> Saver = SaverKt.Saver(new Function2<SaverScope, TextFieldValue, Object>() { // from class: androidx.compose.ui.text.input.TextFieldValue$Companion$Saver$1
        ...
        public final Object invoke(SaverScope Saver2, TextFieldValue it) {
            ...
            return CollectionsKt.arrayListOf(SaversKt.save(it.getAnnotatedString(), SaversKt.getAnnotatedStringSaver(), Saver2), SaversKt.save(TextRange.m4625boximpl(it.m4846getSelectiond9O1mEE()), SaversKt.getSaver(TextRange.Companion), Saver2));
        }
        ...
        public final TextFieldValue invoke(Object it) {
            ...
            return new TextFieldValue(restore, textRange.m4641unboximpl(), (TextRange) null, 4, (DefaultConstructorMarker) null);
        }
    });
    ...
    private TextFieldValue(AnnotatedString annotatedString, long selection, TextRange composition) {
        ...
        this.selection = TextRangeKt.m4643constrain8ffj60Q(selection, 0, getText().length());
        this.composition = composition != null ? TextRange.m4625boximpl(TextRangeKt.m4643constrain8ffj60Q(composition.m4641unboximpl(), 0, getText().length())) : null;
    }
    ...
    */
    public /* synthetic */ TextFieldValue(androidx.compose.ui.text.AnnotatedString r7, long r8, androidx.compose.ui.text.TextRange r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        /*
            ...
            long r8 = r8.m4642getZerod9O1mEE()
            r2 = r8
            goto Ld
        Lc:
            r2 = r8
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.Companion.m4642getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public final long m4846getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: getComposition-MzsxiRA  reason: not valid java name */
    public final TextRange m4845getCompositionMzsxiRA() {
        return this.composition;
    }

    /* renamed from: copy-3r_uNRQ$default  reason: not valid java name */
    public static /* synthetic */ TextFieldValue m4841copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m4843copy3r_uNRQ(annotatedString, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ  reason: not valid java name */
    public final TextFieldValue m4843copy3r_uNRQ(AnnotatedString annotatedString, long selection, TextRange composition) {
        Intrinsics.checkNotNullParameter(annotatedString, "annotatedString");
        return new TextFieldValue(annotatedString, selection, composition, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default  reason: not valid java name */
    public static /* synthetic */ TextFieldValue m4842copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m4844copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ  reason: not valid java name */
    public final TextFieldValue m4844copy3r_uNRQ(String text, long selection, TextRange composition) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof TextFieldValue) {
            return TextRange.m4630equalsimpl0(this.selection, ((TextFieldValue) other).selection) && Intrinsics.areEqual(this.composition, ((TextFieldValue) other).composition) && Intrinsics.areEqual(this.annotatedString, ((TextFieldValue) other).annotatedString);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((result * 31) + TextRange.m4638hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return result2 + (textRange != null ? TextRange.m4638hashCodeimpl(textRange.m4641unboximpl()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.annotatedString) + "', selection=" + ((Object) TextRange.m4640toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
