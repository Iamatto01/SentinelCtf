...
public final class AndroidShader_androidKt {
    ...
    public static final Shader m2509ActualLinearGradientShaderVjE6UOU(long from, long to, List<Color> colors, List<Float> list, int tileMode) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int numTransparentColors = countTransparentColors(colors);
        return new android.graphics.LinearGradient(Offset.m2368getXimpl(from), Offset.m2369getYimpl(from), Offset.m2368getXimpl(to), Offset.m2369getYimpl(to), makeTransparentColors(colors, numTransparentColors), makeTransparentStops(list, colors, numTransparentColors), AndroidTileMode_androidKt.m2513toAndroidTileMode0vamqd0(tileMode));
    }

    /* renamed from: ActualRadialGradientShader-8uybcMk  reason: not valid java name */
    public static final Shader m2510ActualRadialGradientShader8uybcMk(long center, float radius, List<Color> colors, List<Float> list, int tileMode) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int numTransparentColors = countTransparentColors(colors);
        return new android.graphics.RadialGradient(Offset.m2368getXimpl(center), Offset.m2369getYimpl(center), radius, makeTransparentColors(colors, numTransparentColors), makeTransparentStops(list, colors, numTransparentColors), AndroidTileMode_androidKt.m2513toAndroidTileMode0vamqd0(tileMode));
    }

    /* renamed from: ActualSweepGradientShader-9KIMszo  reason: not valid java name */
    public static final Shader m2511ActualSweepGradientShader9KIMszo(long center, List<Color> colors, List<Float> list) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int numTransparentColors = countTransparentColors(colors);
        return new android.graphics.SweepGradient(Offset.m2368getXimpl(center), Offset.m2369getYimpl(center), makeTransparentColors(colors, numTransparentColors), makeTransparentStops(list, colors, numTransparentColors));
    }

    /* renamed from: ActualImageShader-F49vj9s  reason: not valid java name */
    public static final Shader m2508ActualImageShaderF49vj9s(ImageBitmap image, int tileModeX, int tileModeY) {
        Intrinsics.checkNotNullParameter(image, "image");
        return new BitmapShader(AndroidImageBitmap_androidKt.asAndroidBitmap(image), AndroidTileMode_androidKt.m2513toAndroidTileMode0vamqd0(tileModeX), AndroidTileMode_androidKt.m2513toAndroidTileMode0vamqd0(tileModeY));
    }
    ...
    public static final int[] makeTransparentColors(List<Color> colors, int numTransparentColors) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m2660toArgb8_81llA(colors.get(i).m2616unboximpl());
        }
        return iArr;
    }
    ...
    public static final float[] makeTransparentStops(List<Float> list, List<Color> colors, int numTransparentColors) {
        ...
        for (int i = 1; i < lastIndex; i++) {
            long color = colors.get(i).m2616unboximpl();
            ...
            if (!(Color.m2608getAlphaimpl(color) == 0.0f)) {
