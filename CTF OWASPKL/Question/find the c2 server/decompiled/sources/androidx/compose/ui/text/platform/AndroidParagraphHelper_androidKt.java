...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float contextFontSize, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, boolean useEmojiCompat) {
        ...
        if (spanStyles.isEmpty() && placeholders.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.Companion.getNone()) && TextUnitKt.m5321isUnspecifiedR2X_6o(contextTextStyle.m4664getLineHeightXSAIIZE())) {
            return currentText;
        }
        ...
        if (isIncludeFontPaddingEnabled(contextTextStyle) && contextTextStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m4877setLineHeightr9BaKPg(spannableString, contextTextStyle.m4664getLineHeightXSAIIZE(), contextFontSize, density);
        } else {
            ...
            SpannableExtensions_androidKt.m4876setLineHeightKmRG4DE(spannableString, contextTextStyle.m4664getLineHeightXSAIIZE(), contextFontSize, density, lineHeightStyle2);
        }
