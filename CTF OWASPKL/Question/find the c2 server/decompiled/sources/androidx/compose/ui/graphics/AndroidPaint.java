...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.Companion.m2550getSrcOver0nO6VwU();
    }
    ...
    public long mo2482getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public void mo2488setColor8_81llA(long color) {
        AndroidPaint_androidKt.m2494setNativeColor4WTKRHQ(this.internalPaint, color);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public int mo2481getBlendMode0nO6VwU() {
        return this._blendMode;
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public void mo2487setBlendModes9anfk8(int value) {
        if (!BlendMode.m2519equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m2493setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo  reason: not valid java name */
    public int mo2486getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s  reason: not valid java name */
    public void mo2492setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m2498setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo2484getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE  reason: not valid java name */
    public void mo2490setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m2496setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8  reason: not valid java name */
    public int mo2485getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ  reason: not valid java name */
    public void mo2491setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m2497setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int mo2483getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo  reason: not valid java name */
    public void mo2489setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m2495setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }
