...
public final class PlatformTextInputPluginRegistryImpl implements PlatformTextInputPluginRegistry {
    ...
    public <T extends PlatformTextInputAdapter> T rememberAdapter(PlatformTextInputPlugin<T> plugin, Composer $composer, int $changed) {
        AdapterHandle value$iv$iv;
        Object value$iv$iv$iv;
        Intrinsics.checkNotNullParameter(plugin, "plugin");
        $composer.startReplaceableGroup(-845039128);
        ComposerKt.sourceInformation($composer, "C(rememberAdapter)166@6812L47,171@7094L24,172@7127L1452:PlatformTextInputAdapter.kt#n30j42");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-845039128, $changed, -1, "androidx.compose.ui.text.input.PlatformTextInputPluginRegistryImpl.rememberAdapter (PlatformTextInputAdapter.kt:161)");
        }
        int i = $changed & 14;
        ...
        final AdapterHandle adapterHandle = value$iv$iv;
    ...
    private final <T extends PlatformTextInputAdapter> AdapterWithRefCount<T> instantiateAdapter(PlatformTextInputPlugin<T> platformTextInputPlugin) {
        AdapterInput input = new AdapterInput(this, platformTextInputPlugin);
        PlatformTextInputAdapter invoke = this.factory.invoke(platformTextInputPlugin, input);
        ...
        this.adaptersByPlugin.put(platformTextInputPlugin, withRefCount);
        return withRefCount;
    }
    ...
    public final class AdapterWithRefCount<T extends PlatformTextInputAdapter> {
        ...
        private final int getRefCount() {
            State $this$getValue$iv = this.refCount$delegate;
            return ((Number) $this$getValue$iv.getValue()).intValue();
        }

        private final void setRefCount(int i) {
            MutableState $this$setValue$iv = this.refCount$delegate;
