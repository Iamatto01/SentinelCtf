...
public final class NodeKind<T> {
    ...
    public static final /* synthetic */ NodeKind m4326boximpl(int i) {
        return new NodeKind(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> int m4327constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4328equalsimpl(int i, Object obj) {
        return (obj instanceof NodeKind) && i == ((NodeKind) obj).m4334unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m4328equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m4330hashCodeimpl(this.mask);
    }

    public String toString() {
        return m4333toStringimpl(this.mask);
    }
    ...
    public static final int m4331orH91voCI(int arg0, int other) {
        return arg0 | other;
    }

    /* renamed from: or-impl  reason: not valid java name */
    public static final int m4332orimpl(int arg0, int other) {
        return arg0 | other;
    }
}
