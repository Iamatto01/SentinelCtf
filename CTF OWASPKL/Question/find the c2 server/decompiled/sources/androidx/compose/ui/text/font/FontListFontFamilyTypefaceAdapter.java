...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily family, PlatformFontLoader resourceLoader, Continuation<? super Unit> continuation) {
        ...
        if (family instanceof FontListFontFamily) {
            ...
            while (index$iv$iv < size) {
                ...
                int mo4669getLoadingStrategyPKNRLFQ = it.mo4669getLoadingStrategyPKNRLFQ();
                boolean z2 = z;
                int $i$f$fastFilter = FontLoadingStrategy.Companion.m4713getAsyncPKNRLFQ();
                if (FontLoadingStrategy.m4709equalsimpl0(mo4669getLoadingStrategyPKNRLFQ, $i$f$fastFilter)) {
                    target$iv.add(it);
                }
                index$iv$iv++;
            ...
            while (index$iv$iv2 < size2) {
                ...
                target$iv2.add(TuplesKt.to(it2.getWeight(), FontStyle.m4719boximpl(it2.mo4677getStyle_LCdwA())));
                index$iv$iv2++;
            ...
            while (index$iv < size4) {
                ...
                int fontStyle = ((FontStyle) pair.component2()).m4725unboximpl();
                List matched = fontMatcher.m4718matchFontRetOiIg(allFonts, fontWeight, fontStyle);
                int index$iv2 = index$iv;
                TypefaceRequest typeRequest = new TypefaceRequest(family, fontWeight, fontStyle, FontSynthesis.Companion.m4737getAllGVVA2EU(), resourceLoader.getCacheKey(), null);
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (typefaceRequest.getFontFamily() instanceof FontListFontFamily) {
            List matched = fontMatcher.m4718matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m4765getFontStyle_LCdwA());
