    ...
    */
    public /* synthetic */ AndroidAssetFont(android.content.res.AssetManager r8, java.lang.String r9, androidx.compose.ui.text.font.FontWeight r10, int r11, androidx.compose.ui.text.font.FontVariation.Settings r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        Ld:
            ...
            int r11 = r10.m4727getNormal_LCdwA()
            r4 = r11
            goto L1a
        L19:
            r4 = r11
    ...
    public String toString() {
        return "Font(assetManager, path=" + this.path + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4724toStringimpl(mo4677getStyle_LCdwA())) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof AndroidAssetFont) && Intrinsics.areEqual(this.path, ((AndroidAssetFont) other).path) && Intrinsics.areEqual(getVariationSettings(), ((AndroidAssetFont) other).getVariationSettings());
    }
