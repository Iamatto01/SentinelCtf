...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m4089boximpl(int i) {
        return new ProcessResult(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4090constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4091equalsimpl(int i, Object obj) {
        return (obj instanceof ProcessResult) && i == ((ProcessResult) obj).m4097unboximpl();
    }
    ...
    public static int m4095hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4096toStringimpl(int i) {
    ...
    public static final boolean m4094getDispatchedToAPointerInputModifierimpl(int arg0) {
        return (arg0 & 1) != 0;
    }

    /* renamed from: getAnyMovementConsumed-impl  reason: not valid java name */
    public static final boolean m4093getAnyMovementConsumedimpl(int arg0) {
        return (arg0 & 2) != 0;
    }
}
