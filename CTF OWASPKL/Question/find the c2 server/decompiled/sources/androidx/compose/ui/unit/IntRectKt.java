...
public final class IntRectKt {
    ...
    public static final IntRect m5272IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m5240getXimpl(offset), IntOffset.m5241getYimpl(offset), IntOffset.m5240getXimpl(offset) + IntSize.m5282getWidthimpl(size), IntOffset.m5241getYimpl(offset) + IntSize.m5281getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m5271IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m5240getXimpl(topLeft), IntOffset.m5241getYimpl(topLeft), IntOffset.m5240getXimpl(bottomRight), IntOffset.m5241getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m5273IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m5240getXimpl(center) - radius, IntOffset.m5241getYimpl(center) - radius, IntOffset.m5240getXimpl(center) + radius, IntOffset.m5241getYimpl(center) + radius);
    }
