...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo2464concat58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        if (!MatrixKt.m2854isIdentity58bKbWc(matrix)) {
            android.graphics.Matrix frameworkMatrix = new android.graphics.Matrix();
            AndroidMatrixConversions_androidKt.m2479setFromEL8BTi8(frameworkMatrix, matrix);
    ...
    public void mo2463clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m2472toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void mo2462clipPathmtrdDE(Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m2472toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m2472toRegionOp7u2Bmg(int $this$toRegionOp_u2d_u2d7u2Bmg) {
        return ClipOp.m2590equalsimpl0($this$toRegionOp_u2d_u2d7u2Bmg, ClipOp.Companion.m2594getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    public void mo2468drawLineWko1d7g(long p1, long p2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m2368getXimpl(p1), Offset.m2369getYimpl(p1), Offset.m2368getXimpl(p2), Offset.m2369getYimpl(p2), paint.asFrameworkPaint());
    }
    ...
    public void mo2465drawCircle9KIMszo(long center, float radius, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m2368getXimpl(center), Offset.m2369getYimpl(center), radius, paint.asFrameworkPaint());
    }
    ...
    public void mo2466drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m2368getXimpl(topLeftOffset), Offset.m2369getYimpl(topLeftOffset), paint.asFrameworkPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0  reason: not valid java name */
    public void mo2467drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        android.graphics.Canvas canvas = this.internalCanvas;
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m5240getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m5241getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m5240getXimpl(srcOffset) + IntSize.m5282getWidthimpl(srcSize);
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m5241getYimpl(srcOffset) + IntSize.m5281getHeightimpl(srcSize);
        Unit unit = Unit.INSTANCE;
        Rect $this$drawImageRect_HPBpro0_u24lambda_u241 = this.dstRect;
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m5240getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m5241getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m5240getXimpl(dstOffset) + IntSize.m5282getWidthimpl(dstSize);
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m5241getYimpl(dstOffset) + IntSize.m5281getHeightimpl(dstSize);
    ...
    public void mo2469drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (!PointMode.m2897equalsimpl0(pointMode, PointMode.Companion.m2901getLinesr_lszbg())) {
            if (!PointMode.m2897equalsimpl0(pointMode, PointMode.Companion.m2903getPolygonr_lszbg())) {
                if (PointMode.m2897equalsimpl0(pointMode, PointMode.Companion.m2902getPointsr_lszbg())) {
    ...
    private final void drawPoints(List<Offset> list, Paint paint) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            long point = ((Offset) item$iv).m2378unboximpl();
            this.internalCanvas.drawPoint(Offset.m2368getXimpl(point), Offset.m2369getYimpl(point), paint.asFrameworkPaint());
        }
    }

    private final void drawLines(List<Offset> list, Paint paint, int stepBy) {
        if (list.size() >= 2) {
            IntProgression step = RangesKt.step(RangesKt.until(0, list.size() - 1), stepBy);
            int i = step.getFirst();
            ...
            while (true) {
                long p1 = list.get(i).m2378unboximpl();
                long p2 = list.get(i + 1).m2378unboximpl();
                this.internalCanvas.drawLine(Offset.m2368getXimpl(p1), Offset.m2369getYimpl(p1), Offset.m2368getXimpl(p2), Offset.m2369getYimpl(p2), paint.asFrameworkPaint());
                if (i == last) {
                    return;
                }
    ...
    public void mo2470drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
    ...
    private final void drawRawPoints(float[] points, Paint paint, int stepBy) {
        if (points.length % 2 == 0) {
            ...
            while (true) {
                float x = points[i];
                float y = points[i + 1];
                this.internalCanvas.drawPoint(x, y, paint.asFrameworkPaint());
                if (i == last) {
                    return;
                }
                i += step2;
    ...
    private final void drawRawLines(float[] points, Paint paint, int stepBy) {
        if (points.length >= 4 && points.length % 2 == 0) {
            ...
            while (true) {
                ...
                float x2 = points[i + 2];
                float y2 = points[i + 3];
                this.internalCanvas.drawLine(x1, y1, x2, y2, paint.asFrameworkPaint());
                if (i == last) {
                    return;
                }
                i += step2;
    ...
    public void mo2471drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        Intrinsics.checkNotNullParameter(vertices, "vertices");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m2514toAndroidVertexModeJOOmi9M(vertices.m2998getVertexModec2xauaI()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.asFrameworkPaint());
    }
}
