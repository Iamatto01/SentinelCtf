...
public final class PasswordVisualTransformation implements VisualTransformation {
    ...
    public TransformedText filter(AnnotatedString text) {
        ...
        return new TransformedText(new AnnotatedString(StringsKt.repeat(String.valueOf(this.mask), text.getText().length()), null, null, 6, null), OffsetMapping.Companion.getIdentity());
    }
