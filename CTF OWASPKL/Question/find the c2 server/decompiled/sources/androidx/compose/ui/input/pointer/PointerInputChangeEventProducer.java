...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        while (index$iv < size) {
            ...
            PointerInputData previousData = this.previousPointerInputData.get(PointerId.m3989boximpl(it.m4020getIdJ3iCeTQ()));
            if (previousData == null) {
                previousTime = it.getUptime();
                previousPosition = it.m4021getPositionF1C5BW0();
                previousDown = false;
                i = size;
            } else {
                ...
                i = size;
                previousPosition = positionCalculator2.mo4088screenToLocalMKHz9U(previousData.m4011getPositionOnScreenF1C5BW0());
            }
            changes.put(PointerId.m3989boximpl(it.m4020getIdJ3iCeTQ()), new PointerInputChange(it.m4020getIdJ3iCeTQ(), it.getUptime(), it.m4021getPositionF1C5BW0(), it.getDown(), it.getPressure(), previousTime, previousPosition, previousDown, false, it.m4024getTypeT8wyACA(), (List) it.getHistorical(), it.m4023getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (it.getDown()) {
                this.previousPointerInputData.put(PointerId.m3989boximpl(it.m4020getIdJ3iCeTQ()), new PointerInputData(it.getUptime(), it.m4022getPositionOnScreenF1C5BW0(), it.getDown(), it.m4024getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m3989boximpl(it.m4020getIdJ3iCeTQ()));
            }
            index$iv++;
    ...
    private static final class PointerInputData {
        ...
        public final int m4012getTypeT8wyACA() {
            return this.type;
        }
    }
}
