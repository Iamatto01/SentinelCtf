...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float fraction) {
        ...
        if (!(start instanceof BrushStyle) && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m5013from8_81llA(ColorKt.m2657lerpjxsXWHM(start.mo4897getColor0d7_KjU(), stop.mo4897getColor0d7_KjU(), fraction));
        }
        if ((start instanceof BrushStyle) && (stop instanceof BrushStyle)) {
    ...
    public static final long m5012modulateDxMtmZc(long $this$modulate_u2dDxMtmZc, float alpha) {
        long m2604copywmQWz5c;
        if (Float.isNaN(alpha) || alpha >= 1.0f) {
            return $this$modulate_u2dDxMtmZc;
        }
        m2604copywmQWz5c = Color.m2604copywmQWz5c($this$modulate_u2dDxMtmZc, (r12 & 1) != 0 ? Color.m2608getAlphaimpl($this$modulate_u2dDxMtmZc) : Color.m2608getAlphaimpl($this$modulate_u2dDxMtmZc) * alpha, (r12 & 2) != 0 ? Color.m2612getRedimpl($this$modulate_u2dDxMtmZc) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl($this$modulate_u2dDxMtmZc) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl($this$modulate_u2dDxMtmZc) : 0.0f);
