...
public final class PathOperation {
    ...
    private static final int Difference = m2882constructorimpl(0);
    private static final int Intersect = m2882constructorimpl(1);
    private static final int Union = m2882constructorimpl(2);
    private static final int Xor = m2882constructorimpl(3);
    private static final int ReverseDifference = m2882constructorimpl(4);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PathOperation m2881boximpl(int i) {
    ...
    public static boolean m2883equalsimpl(int i, Object obj) {
        return (obj instanceof PathOperation) && i == ((PathOperation) obj).m2887unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2888getDifferenceb3I0S0c() {
            return PathOperation.Difference;
        }

        /* renamed from: getIntersect-b3I0S0c  reason: not valid java name */
        public final int m2889getIntersectb3I0S0c() {
            return PathOperation.Intersect;
        }

        /* renamed from: getUnion-b3I0S0c  reason: not valid java name */
        public final int m2891getUnionb3I0S0c() {
            return PathOperation.Union;
        }

        /* renamed from: getXor-b3I0S0c  reason: not valid java name */
        public final int m2892getXorb3I0S0c() {
            return PathOperation.Xor;
        }

        /* renamed from: getReverseDifference-b3I0S0c  reason: not valid java name */
        public final int m2890getReverseDifferenceb3I0S0c() {
    ...
    public static String m2886toStringimpl(int arg0) {
        return m2884equalsimpl0(arg0, Difference) ? "Difference" : m2884equalsimpl0(arg0, Intersect) ? "Intersect" : m2884equalsimpl0(arg0, Union) ? "Union" : m2884equalsimpl0(arg0, Xor) ? "Xor" : m2884equalsimpl0(arg0, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }
