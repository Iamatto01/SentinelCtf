...
public final class DeviceFontFamilyNameFontKt {
    ...
    public static /* synthetic */ Font m4695Fontvxs03AY$default(String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        return m4694Fontvxs03AY(str, fontWeight, i, settings);
    }

    /* renamed from: Font-vxs03AY  reason: not valid java name */
    public static final Font m4694Fontvxs03AY(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(familyName, "familyName");
        Intrinsics.checkNotNullParameter(weight, "weight");
        Intrinsics.checkNotNullParameter(variationSettings, "variationSettings");
        return new DeviceFontFamilyNameFont(familyName, weight, style, variationSettings, null);
    }
}
