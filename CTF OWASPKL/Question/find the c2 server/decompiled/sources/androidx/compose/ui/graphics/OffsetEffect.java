...
public final class OffsetEffect extends RenderEffect {
    ...
    protected android.graphics.RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m2907createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof OffsetEffect) && Intrinsics.areEqual(this.renderEffect, ((OffsetEffect) other).renderEffect) && Offset.m2365equalsimpl0(this.offset, ((OffsetEffect) other).offset);
    }

    public int hashCode() {
        RenderEffect renderEffect = this.renderEffect;
        int result = renderEffect != null ? renderEffect.hashCode() : 0;
        return (result * 31) + Offset.m2370hashCodeimpl(this.offset);
    }

    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + ((Object) Offset.m2376toStringimpl(this.offset)) + ')';
    }
}
