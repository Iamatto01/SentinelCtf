...
public final class SaversKt {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[marker.ordinal()]) {
                case 1:
                    ...
                    if (!Intrinsics.areEqual(value$iv5, (Object) false) && value$iv5 != null) {
                        str2 = saver$iv3.restore(value$iv5);
                    }
                    Intrinsics.checkNotNull(str2);
                    return new AnnotatedString.Range<>(str2, start, end, tag);
                case 2:
                    ...
                    if (!Intrinsics.areEqual(value$iv6, (Object) false) && value$iv6 != null) {
                        str2 = saver$iv4.restore(value$iv6);
                    }
                    Intrinsics.checkNotNull(str2);
                    return new AnnotatedString.Range<>(str2, start, end, tag);
                case 3:
                    ...
                    if (!Intrinsics.areEqual(value$iv7, (Object) false) && value$iv7 != null) {
                        str2 = (VerbatimTtsAnnotation) saver$iv.restore(value$iv7);
                    }
                    Intrinsics.checkNotNull(str2);
                    return new AnnotatedString.Range<>(str2, start, end, tag);
                case 4:
                    ...
                    if (!Intrinsics.areEqual(value$iv8, (Object) false) && value$iv8 != null) {
                        str2 = (UrlAnnotation) saver$iv2.restore(value$iv8);
                    }
                    Intrinsics.checkNotNull(str2);
                    return new AnnotatedString.Range<>(str2, start, end, tag);
                case 5:
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2<SaverScope, ParagraphStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope Saver, ParagraphStyle it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(it.m4554getTextAlignbuA522U()), SaversKt.save(it.m4556getTextDirectionmmuk1to()), SaversKt.save(TextUnit.m5293boximpl(it.m4553getLineHeightXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.getTextIndent(), SaversKt.getSaver(TextIndent.Companion), Saver));
        }
        ...
        public final ParagraphStyle invoke(Object it) {
            ...
            long m5312unboximpl = restore.m5312unboximpl();
            ...
            return new ParagraphStyle(textAlign, textDirection, m5312unboximpl, restore2, (PlatformParagraphStyle) null, (LineHeightStyle) null, (LineBreak) null, (Hyphens) null, 240, (DefaultConstructorMarker) null);
        }
    });
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2<SaverScope, SpanStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final Object invoke(SaverScope Saver, SpanStyle it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m2596boximpl(it.m4597getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(TextUnit.m5293boximpl(it.m4598getFontSizeXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.getFontWeight(), SaversKt.getSaver(FontWeight.Companion), Saver), SaversKt.save(it.m4599getFontStyle4Lr2A7w()), SaversKt.save(it.m4600getFontSynthesisZQGJjVo()), SaversKt.save(-1), SaversKt.save(it.getFontFeatureSettings()), SaversKt.save(TextUnit.m5293boximpl(it.m4601getLetterSpacingXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(it.m4596getBaselineShift5SSeXJ0(), SaversKt.getSaver(BaselineShift.Companion), Saver), SaversKt.save(it.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.Companion), Saver), SaversKt.save(it.getLocaleList(), SaversKt.getSaver(LocaleList.Companion), Saver), SaversKt.save(Color.m2596boximpl(it.m4595getBackground0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(it.getTextDecoration(), SaversKt.getSaver(TextDecoration.Companion), Saver), SaversKt.save(it.getShadow(), SaversKt.getSaver(Shadow.Companion), Saver));
        }
        ...
        public final SpanStyle invoke(Object it) {
            ...
            Intrinsics.checkNotNull(restore);
            long m2616unboximpl = restore.m2616unboximpl();
            Object value$iv2 = list.get(1);
            ...
            long m5312unboximpl = restore2.m5312unboximpl();
            Object value$iv3 = list.get(2);
            Saver saver$iv3 = SaversKt.getSaver(FontWeight.Companion);
            if (Intrinsics.areEqual(value$iv3, (Object) false)) {
                restore3 = null;
            } else {
            ...
            Saver saver$iv4 = SaversKt.getSaver(TextUnit.Companion);
            ...
            long m5312unboximpl2 = restore4.m5312unboximpl();
            Object value$iv8 = list.get(8);
            Saver saver$iv5 = SaversKt.getSaver(BaselineShift.Companion);
            ...
            Saver saver$iv6 = SaversKt.getSaver(TextGeometricTransform.Companion);
            ...
            Saver $this$restore_u24lambda_u243_u24lambda_u242$iv = SaversKt.getSaver(LocaleList.Companion);
            ...
            Saver $this$restore_u24lambda_u243_u24lambda_u242$iv2 = SaversKt.getSaver(Color.Companion);
            ...
            long m2616unboximpl2 = restore8.m2616unboximpl();
            Object value$iv12 = list.get(12);
            Saver $this$restore_u24lambda_u243_u24lambda_u242$iv3 = SaversKt.getSaver(TextDecoration.Companion);
            ...
            Saver saver$iv7 = SaversKt.getSaver(Shadow.Companion);
            if (Intrinsics.areEqual(value$iv13, (Object) false)) {
                restore10 = null;
            } else {
                restore10 = value$iv13 != null ? saver$iv7.restore(value$iv13) : null;
            }
            return new SpanStyle(m2616unboximpl, m5312unboximpl, restore3, fontStyle, fontSynthesis, (FontFamily) null, str, m5312unboximpl2, restore5, restore6, restore7, m2616unboximpl2, restore9, restore10, 32, (DefaultConstructorMarker) null);
        }
    });
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2<SaverScope, TextIndent, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope Saver, TextIndent it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m5293boximpl(it.m5016getFirstLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver), SaversKt.save(TextUnit.m5293boximpl(it.m5017getRestLineXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), Saver));
        }
        ...
        public final TextIndent invoke(Object it) {
            ...
            return new TextIndent(m5312unboximpl, textUnit.m5312unboximpl(), null);
        }
    });
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2<SaverScope, BaselineShift, Object>() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, BaselineShift baselineShift) {
            return m4577invoke8a2Sb4w(saverScope, baselineShift.m4889unboximpl());
        }

        /* renamed from: invoke-8a2Sb4w  reason: not valid java name */
        public final Object m4577invoke8a2Sb4w(SaverScope Saver, float it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
        ...
        public final BaselineShift invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return BaselineShift.m4883boximpl(BaselineShift.m4884constructorimpl(((Float) it).floatValue()));
        }
    });
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextRange textRange) {
            return m4583invokeFDrldGo(saverScope, textRange.m4641unboximpl());
        }

        /* renamed from: invoke-FDrldGo  reason: not valid java name */
        public final Object m4583invokeFDrldGo(SaverScope Saver, long it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf((Integer) SaversKt.save(Integer.valueOf(TextRange.m4637getStartimpl(it))), (Integer) SaversKt.save(Integer.valueOf(TextRange.m4632getEndimpl(it))));
        }
        ...
        public final TextRange invoke(Object it) {
            ...
            Intrinsics.checkNotNull(it$iv2);
            return TextRange.m4625boximpl(TextRangeKt.TextRange(intValue, ((Number) it$iv2).intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope Saver, Shadow it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m2596boximpl(it.m2921getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), Saver), SaversKt.save(Offset.m2357boximpl(it.m2922getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
        }
        ...
        public final Shadow invoke(Object it) {
            ...
            Intrinsics.checkNotNull(restore2);
            long m2378unboximpl = restore2.m2378unboximpl();
            Object value$iv3 = list.get(2);
            Float f = value$iv3 != null ? (Float) value$iv3 : null;
            Intrinsics.checkNotNull(f);
            return new Shadow(m2616unboximpl, m2378unboximpl, f.floatValue(), null);
        }
    });
    private static final Saver<Color, Object> ColorSaver = SaverKt.Saver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m4579invoke4WTKRHQ(saverScope, color.m2616unboximpl());
        }

        /* renamed from: invoke-4WTKRHQ  reason: not valid java name */
        public final Object m4579invoke4WTKRHQ(SaverScope Saver, long it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return ULong.m5601boximpl(it);
        }
        ...
        public final Color invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return Color.m2596boximpl(Color.m2602constructorimpl(((ULong) it).m5659unboximpl()));
        }
    });
    private static final Saver<TextUnit, Object> TextUnitSaver = SaverKt.Saver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextUnit textUnit) {
            return m4585invokempE4wyQ(saverScope, textUnit.m5312unboximpl());
        }

        /* renamed from: invoke-mpE4wyQ  reason: not valid java name */
        public final Object m4585invokempE4wyQ(SaverScope Saver, long it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m5303getValueimpl(it))), SaversKt.save(TextUnitType.m5328boximpl(TextUnit.m5302getTypeUIouoOA(it))));
        }
        ...
        public final TextUnit invoke(Object it) {
            ...
            return TextUnit.m5293boximpl(TextUnitKt.m5315TextUnitanM5pPY(floatValue, textUnitType.m5334unboximpl()));
        }
    });
    private static final Saver<Offset, Object> OffsetSaver = SaverKt.Saver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Offset offset) {
            return m4581invokeUv8p0NA(saverScope, offset.m2378unboximpl());
        }

        /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
        public final Object m4581invokeUv8p0NA(SaverScope Saver, long it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return Offset.m2365equalsimpl0(it, Offset.Companion.m2383getUnspecifiedF1C5BW0()) ? (Serializable) false : CollectionsKt.arrayListOf((Float) SaversKt.save(Float.valueOf(Offset.m2368getXimpl(it))), (Float) SaversKt.save(Float.valueOf(Offset.m2369getYimpl(it))));
        }
        ...
        public final Offset invoke(Object it) {
            ...
            if (Intrinsics.areEqual(it, (Object) false)) {
                return Offset.m2357boximpl(Offset.Companion.m2383getUnspecifiedF1C5BW0());
            }
            List list = (List) it;
            Object value$iv = list.get(0);
            Object it$iv = value$iv != null ? (Float) value$iv : null;
            ...
            Intrinsics.checkNotNull(it$iv2);
            return Offset.m2357boximpl(OffsetKt.Offset(floatValue, ((Number) it$iv2).floatValue()));
        }
    });
    private static final Saver<LocaleList, Object> LocaleListSaver = SaverKt.Saver(new Function2<SaverScope, LocaleList, Object>() { // from class: androidx.compose.ui.text.SaversKt$LocaleListSaver$1
        ...
        public final Object invoke(SaverScope Saver, LocaleList it) {
            ...
            for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
                ...
                target$iv.add(SaversKt.save(locale, SaversKt.getSaver(Locale.Companion), Saver));
            }
            return target$iv;
        }
    ...
    public static final /* synthetic */ <T extends Saver<Original, Saveable>, Original, Saveable, Result> Result restore(Saveable saveable, T saver) {
        ...
        T $this$restore_u24lambda_u243_u24lambda_u242 = saver;
