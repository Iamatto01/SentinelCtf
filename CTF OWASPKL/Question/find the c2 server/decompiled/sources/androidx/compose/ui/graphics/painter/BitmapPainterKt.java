...
public final class BitmapPainterKt {
    ...
    public static final BitmapPainter m3217BitmapPainterQZhYCtY(ImageBitmap image, long srcOffset, long srcSize, int filterQuality) {
        Intrinsics.checkNotNullParameter(image, "image");
        BitmapPainter $this$BitmapPainter_QZhYCtY_u24lambda_u240 = new BitmapPainter(image, srcOffset, srcSize, null);
        $this$BitmapPainter_QZhYCtY_u24lambda_u240.m3216setFilterQualityvDHp3xo$ui_graphics_release(filterQuality);
