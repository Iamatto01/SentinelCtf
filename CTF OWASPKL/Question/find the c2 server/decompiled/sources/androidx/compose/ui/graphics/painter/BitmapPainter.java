...
public final class BitmapPainter extends Painter {
    ...
    */
    ...
    private BitmapPainter(ImageBitmap image, long srcOffset, long srcSize) {
        ...
        this.filterQuality = FilterQuality.Companion.m2701getLowfv9h1I();
        this.size = m3213validateSizeN5eqBDc(srcOffset, srcSize);
        this.alpha = 1.0f;
    }

    /* renamed from: getFilterQuality-f-v9h1I$ui_graphics_release  reason: not valid java name */
    public final int m3214getFilterQualityfv9h1I$ui_graphics_release() {
        return this.filterQuality;
    }

    /* renamed from: setFilterQuality-vDHp3xo$ui_graphics_release  reason: not valid java name */
    public final void m3216setFilterQualityvDHp3xo$ui_graphics_release(int i) {
    ...
    public void onDraw(DrawScope $this$onDraw) {
        ...
        DrawScope.m3130drawImageAZ2fEMs$default($this$onDraw, this.image, this.srcOffset, this.srcSize, 0L, IntSizeKt.IntSize(MathKt.roundToInt(Size.m2437getWidthimpl($this$onDraw.mo3146getSizeNHjbRc())), MathKt.roundToInt(Size.m2434getHeightimpl($this$onDraw.mo3146getSizeNHjbRc()))), this.alpha, null, this.colorFilter, 0, this.filterQuality, 328, null);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    /* renamed from: getIntrinsicSize-NH-jbRc  reason: not valid java name */
    public long mo3215getIntrinsicSizeNHjbRc() {
        return IntSizeKt.m5292toSizeozmzZPI(this.size);
    }
    ...
    private final long m3213validateSizeN5eqBDc(long srcOffset, long srcSize) {
        if (!(IntOffset.m5240getXimpl(srcOffset) >= 0 && IntOffset.m5241getYimpl(srcOffset) >= 0 && IntSize.m5282getWidthimpl(srcSize) >= 0 && IntSize.m5281getHeightimpl(srcSize) >= 0 && IntSize.m5282getWidthimpl(srcSize) <= this.image.getWidth() && IntSize.m5281getHeightimpl(srcSize) <= this.image.getHeight())) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BitmapPainter) && Intrinsics.areEqual(this.image, ((BitmapPainter) other).image) && IntOffset.m5239equalsimpl0(this.srcOffset, ((BitmapPainter) other).srcOffset) && IntSize.m5280equalsimpl0(this.srcSize, ((BitmapPainter) other).srcSize) && FilterQuality.m2696equalsimpl0(this.filterQuality, ((BitmapPainter) other).filterQuality);
    }

    public int hashCode() {
        int result = this.image.hashCode();
        return (((((result * 31) + IntOffset.m5242hashCodeimpl(this.srcOffset)) * 31) + IntSize.m5283hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m2697hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + ((Object) IntOffset.m5247toStringimpl(this.srcOffset)) + ", srcSize=" + ((Object) IntSize.m5285toStringimpl(this.srcSize)) + ", filterQuality=" + ((Object) FilterQuality.m2698toStringimpl(this.filterQuality)) + ')';
    }
}
