...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        ...
        return CornerRadius.m2337constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final long m2354lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m2343getXimpl(start), CornerRadius.m2343getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m2344getYimpl(start), CornerRadius.m2344getYimpl(stop), fraction));
    }
}
