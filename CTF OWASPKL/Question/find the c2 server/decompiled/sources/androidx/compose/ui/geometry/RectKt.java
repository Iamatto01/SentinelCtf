...
public final class RectKt {
    ...
    public static final Rect m2408Recttz77jQw(long offset, long size) {
        return new Rect(Offset.m2368getXimpl(offset), Offset.m2369getYimpl(offset), Offset.m2368getXimpl(offset) + Size.m2437getWidthimpl(size), Offset.m2369getYimpl(offset) + Size.m2434getHeightimpl(size));
    }

    /* renamed from: Rect-0a9Yr6o  reason: not valid java name */
    public static final Rect m2406Rect0a9Yr6o(long topLeft, long bottomRight) {
        return new Rect(Offset.m2368getXimpl(topLeft), Offset.m2369getYimpl(topLeft), Offset.m2368getXimpl(bottomRight), Offset.m2369getYimpl(bottomRight));
    }

    /* renamed from: Rect-3MmeM6k  reason: not valid java name */
    public static final Rect m2407Rect3MmeM6k(long center, float radius) {
        return new Rect(Offset.m2368getXimpl(center) - radius, Offset.m2369getYimpl(center) - radius, Offset.m2368getXimpl(center) + radius, Offset.m2369getYimpl(center) + radius);
    }
