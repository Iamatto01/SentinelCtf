...
public final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public DialogLayout(Context context, Window window) {
        ...
        this.window = window;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m5365getLambda1$ui_release(), null, 2, null);
    ...
    public void Content(Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Content)267@10417L9:AndroidDialog.android.kt#2oxthz");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1735448596, $changed, -1, "androidx.compose.ui.window.DialogLayout.Content (AndroidDialog.android.kt:266)");
        }
