...
public final class Shadow {
    ...
    public static /* synthetic */ void m2918getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations  reason: not valid java name */
    public static /* synthetic */ void m2919getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.Companion.m2384getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public final long m2921getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getOffset-F1C5BW0  reason: not valid java name */
    public final long m2922getOffsetF1C5BW0() {
        return this.offset;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shadow) && Color.m2607equalsimpl0(this.color, ((Shadow) other).color) && Offset.m2365equalsimpl0(this.offset, ((Shadow) other).offset)) {
    ...
    public int hashCode() {
        int result = Color.m2613hashCodeimpl(this.color);
        return (((result * 31) + Offset.m2370hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m2614toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m2376toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM  reason: not valid java name */
    public final Shadow m2920copyqcb84PM(long color, long offset, float blurRadius) {
