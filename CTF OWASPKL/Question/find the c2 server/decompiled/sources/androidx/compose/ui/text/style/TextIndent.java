...
public final class TextIndent {
    ...
    */
    ...
    public final long m5016getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* renamed from: getRestLine-XSAIIZE  reason: not valid java name */
    public final long m5017getRestLineXSAIIZE() {
    ...
    public static /* synthetic */ TextIndent m5014copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m5015copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo  reason: not valid java name */
    public final TextIndent m5015copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextIndent) && TextUnit.m5300equalsimpl0(this.firstLine, ((TextIndent) other).firstLine) && TextUnit.m5300equalsimpl0(this.restLine, ((TextIndent) other).restLine);
    }

    public int hashCode() {
        int result = TextUnit.m5304hashCodeimpl(this.firstLine);
        return (result * 31) + TextUnit.m5304hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m5310toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m5310toStringimpl(this.restLine)) + ')';
    }
}
