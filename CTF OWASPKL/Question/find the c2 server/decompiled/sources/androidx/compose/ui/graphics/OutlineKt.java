...
public final class OutlineKt {
    public static final void addOutline(Path $this$addOutline, Outline outline) {
        ...
        if (!(outline instanceof Outline.Rectangle)) {
            if (!(outline instanceof Outline.Rounded)) {
                ...
                Path.m2868addPathUv8p0NA$default($this$addOutline, ((Outline.Generic) outline).getPath(), 0L, 2, null);
                return;
            }
    ...
    public static final void m2857drawOutlinewDX37Ww(DrawScope drawOutline, Outline outline, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        Intrinsics.checkNotNullParameter(style, "style");
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo3063drawRectnJ9OG0(color, topLeft(rect), size(rect), alpha, style, colorFilter, blendMode);
        } else if (outline instanceof Outline.Rounded) {
            Path path$iv = ((Outline.Rounded) outline).getRoundRectPath$ui_graphics_release();
            if (path$iv != null) {
                drawOutline.mo3059drawPathLG529CI(path$iv, color, alpha, style, colorFilter, blendMode);
                return;
            }
            RoundRect rrect = ((Outline.Rounded) outline).getRoundRect();
            float radius = CornerRadius.m2343getXimpl(rrect.m2416getBottomLeftCornerRadiuskKHJgLs());
            drawOutline.mo3065drawRoundRectuAw5IA(color, topLeft(rrect), size(rrect), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), style, alpha, colorFilter, blendMode);
        } else if (outline instanceof Outline.Generic) {
            Path path = ((Outline.Generic) outline).getPath();
            drawOutline.mo3059drawPathLG529CI(path, color, alpha, style, colorFilter, blendMode);
        } else {
            throw new NoWhenBranchMatchedException();
        }
    }
    ...
    public static final void m2855drawOutlinehn5TExg(DrawScope drawOutline, Outline outline, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        ...
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo3062drawRectAsUm42w(brush, topLeft(rect), size(rect), alpha, style, colorFilter, blendMode);
        } else if (outline instanceof Outline.Rounded) {
            Path path$iv = ((Outline.Rounded) outline).getRoundRectPath$ui_graphics_release();
            if (path$iv != null) {
                drawOutline.mo3058drawPathGBMwjPU(path$iv, brush, alpha, style, colorFilter, blendMode);
                return;
            }
            RoundRect rrect = ((Outline.Rounded) outline).getRoundRect();
            float radius = CornerRadius.m2343getXimpl(rrect.m2416getBottomLeftCornerRadiuskKHJgLs());
            drawOutline.mo3064drawRoundRectZuiqVtQ(brush, topLeft(rrect), size(rrect), CornerRadiusKt.CornerRadius$default(radius, 0.0f, 2, null), alpha, style, colorFilter, blendMode);
        } else if (outline instanceof Outline.Generic) {
            Path path = ((Outline.Generic) outline).getPath();
            drawOutline.mo3058drawPathGBMwjPU(path, brush, alpha, style, colorFilter, blendMode);
        } else {
            throw new NoWhenBranchMatchedException();
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:81:0x00a2 A[ADDED_TO_REGION] */
    /*
    ...
    */
    public static final boolean hasSameCornerRadius(androidx.compose.ui.geometry.RoundRect r6) {
        /*
            long r0 = r6.m2416getBottomLeftCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2343getXimpl(r0)
            long r1 = r6.m2417getBottomRightCornerRadiuskKHJgLs()
            float r1 = androidx.compose.ui.geometry.CornerRadius.m2343getXimpl(r1)
        ...
        L19:
            if (r0 == 0) goto L4f
            long r3 = r6.m2417getBottomRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2343getXimpl(r3)
            long r3 = r6.m2419getTopRightCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m2343getXimpl(r3)
        ...
        L32:
            ...
            long r3 = r6.m2419getTopRightCornerRadiuskKHJgLs()
            float r0 = androidx.compose.ui.geometry.CornerRadius.m2343getXimpl(r3)
            long r3 = r6.m2418getTopLeftCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m2343getXimpl(r3)
            int r0 = (r0 > r3 ? 1 : (r0 == r3 ? 0 : -1))
            if (r0 != 0) goto L4a
            r0 = r1
        ...
        L4f:
            r0 = r2
        L50:
            long r3 = r6.m2416getBottomLeftCornerRadiuskKHJgLs()
            float r3 = androidx.compose.ui.geometry.CornerRadius.m2344getYimpl(r3)
            long r4 = r6.m2417getBottomRightCornerRadiuskKHJgLs()
            float r4 = androidx.compose.ui.geometry.CornerRadius.m2344getYimpl(r4)
