...
public final class FontListFontFamilyTypefaceAdapterKt {
    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        ...
        for (int idx = 0; idx < size; idx++) {
            ...
            int mo4669getLoadingStrategyPKNRLFQ = font.mo4669getLoadingStrategyPKNRLFQ();
            if (!FontLoadingStrategy.m4709equalsimpl0(mo4669getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4714getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m4709equalsimpl0(mo4669getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4715getOptionalLocalPKNRLFQ())) {
                    if (!FontLoadingStrategy.m4709equalsimpl0(mo4669getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4713getAsyncPKNRLFQ())) {
                        throw new IllegalStateException("Unknown font type " + font);
                    }
                    AsyncTypefaceCache.AsyncTypefaceResult cacheResult = asyncTypefaceCache.m4678get1ASDuI8(font, platformFontLoader);
                    if (cacheResult == null) {
                    ...
                    } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m4684isPermanentFailureimpl(cacheResult.m4686unboximpl()) && cacheResult.m4686unboximpl() != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4741synthesizeTypefaceFxwP2eA(typefaceRequest.m4766getFontSynthesisGVVA2EU(), cacheResult.m4686unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m4765getFontStyle_LCdwA()));
                    }
                } else {
                    ...
                    synchronized (lock$iv$iv) {
                        ...
                        if (priorResult$iv == null) {
                            ...
                            try {
                                ...
                                it$iv = Result.m5433constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.Companion;
                                it$iv = Result.m5433constructorimpl(ResultKt.createFailure(th));
                            }
                            if (Result.m5439isFailureimpl(it$iv)) {
                                it$iv = null;
                            }
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, it$iv, false, 8, null);
                            obj = it$iv;
                        } else {
                            obj = priorResult$iv.m4686unboximpl();
                        }
                    }
                    Object result2 = obj;
                    if (result2 != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4741synthesizeTypefaceFxwP2eA(typefaceRequest.m4766getFontSynthesisGVVA2EU(), result2, font, typefaceRequest.getFontWeight(), typefaceRequest.m4765getFontStyle_LCdwA()));
                    }
                }
            } else {
                ...
                synchronized (lock$iv$iv2) {
                    ...
                    if (priorResult$iv2 == null) {
                        ...
                        result = priorResult$iv2.m4686unboximpl();
                    }
                }
                if (result == null) {
                    throw new IllegalStateException("Unable to load font " + font);
                }
                return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m4741synthesizeTypefaceFxwP2eA(typefaceRequest.m4766getFontSynthesisGVVA2EU(), result, font, typefaceRequest.getFontWeight(), typefaceRequest.m4765getFontStyle_LCdwA()));
            }
        }
