...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public ShaderBrushSpan(ShaderBrush shaderBrush, float alpha) {
        ...
        this.alpha = alpha;
        this.size = Size.Companion.m2445getUnspecifiedNHjbRc();
    }

    /* renamed from: getSize-NH-jbRc  reason: not valid java name */
    public final long m4881getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public final void m4882setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void updateDrawState(TextPaint textPaint) {
        ...
        if ($this$isUnspecified$iv == Size.Companion.m2445getUnspecifiedNHjbRc()) {
            return;
        }
        Pair finalCachedShader = this.cachedShader;
        if (finalCachedShader == null || !Size.m2433equalsimpl0(finalCachedShader.getFirst().m2442unboximpl(), this.size)) {
            shader = this.shaderBrush.mo2575createShaderuvyYCjk(this.size);
        } else {
            shader = finalCachedShader.getSecond();
        }
        textPaint.setShader(shader);
        this.cachedShader = TuplesKt.to(Size.m2425boximpl(this.size), shader);
    }
}
