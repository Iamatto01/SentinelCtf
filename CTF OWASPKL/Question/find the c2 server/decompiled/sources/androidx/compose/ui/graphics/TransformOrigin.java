...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m2974boximpl(long j) {
    ...
    public static boolean m2980equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).m2986unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2981equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m2984hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2985toStringimpl(long j) {
        return "TransformOrigin(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m2980equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2984hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m2985toStringimpl(this.packedValue);
    }
    ...
    public static final float m2982getPivotFractionXimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: getPivotFractionY-impl  reason: not valid java name */
    public static final float m2983getPivotFractionYimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (4294967295L & arg0));
    }

    /* renamed from: component1-impl  reason: not valid java name */
    public static final float m2975component1impl(long arg0) {
        return m2982getPivotFractionXimpl(arg0);
    }

    /* renamed from: component2-impl  reason: not valid java name */
    public static final float m2976component2impl(long arg0) {
        return m2983getPivotFractionYimpl(arg0);
    }

    /* renamed from: copy-zey9I6w$default  reason: not valid java name */
    public static /* synthetic */ long m2979copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m2982getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m2983getPivotFractionYimpl(j);
        }
        return m2978copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w  reason: not valid java name */
    public static final long m2978copyzey9I6w(long arg0, float pivotFractionX, float pivotFractionY) {
    ...
    public static final class Companion {
        ...
        public final long m2987getCenterSzJe1aQ() {
