...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    public AnimatedVisibilityComposeAnimation(Transition<Boolean> animationObject, String label) {
        ...
        this.states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m5057boximpl(AnimatedVisibilityState.Companion.m5064getEnterjXw82LU()), AnimatedVisibilityState.m5057boximpl(AnimatedVisibilityState.Companion.m5065getExitjXw82LU())});
    }

    /* renamed from: getAnimationObject */
    public Transition<Boolean> m5050getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m5050getAnimationObject().getTransitions(), 0);
