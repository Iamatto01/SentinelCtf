...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    */
    public void mo4028onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent r19, androidx.compose.ui.input.pointer.PointerEventPass r20, long r21) {
        /*
            r18 = this;
            r0 = r18
            r1 = r20
        ...
        La0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1.mo4028onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
        ...
        if ($this$fastForEach$iv$iv != null) {
            if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                ...
                if (layoutCoordinates$ui_release != null) {
                    long mo4132localToRootMKHz9U = layoutCoordinates$ui_release.mo4132localToRootMKHz9U(Offset.Companion.m2384getZeroF1C5BW0());
                    final PointerInteropFilter pointerInteropFilter = this.this$0;
                    PointerInteropUtils_androidKt.m4065toCancelMotionEventScoped4ec7I(pointerEvent, mo4132localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                        /* JADX INFO: Access modifiers changed from: package-private */
                        {
                            super(1);
                        }
        ...
        if (layoutCoordinates$ui_release2 != null) {
            long mo4132localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo4132localToRootMKHz9U(Offset.Companion.m2384getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m4066toMotionEventScoped4ec7I(pointerEvent, mo4132localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
                /* JADX INFO: Access modifiers changed from: package-private */
