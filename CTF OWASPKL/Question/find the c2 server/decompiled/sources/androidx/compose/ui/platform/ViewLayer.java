...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m2987getCenterSzJe1aQ();
    ...
    */
    ...
    public void mo4372resizeozmzZPI(long size) {
        ...
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m2982getPivotFractionXimpl(this.mTransformOrigin) * width);
            setPivotY(TransformOrigin.m2983getPivotFractionYimpl(this.mTransformOrigin) * height);
    ...
    public void mo4371movegyyYBs(long position) {
        int left = IntOffset.m5240getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m5241getYimpl(position);
        if (top != getTop()) {
    ...
    public long mo4370mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] m4432calculateInverseMatrixbWbORWo = this.matrixCache.m4432calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m2836mapMKHz9U(this.matrixCache.m4433calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        if (inverse) {
            float[] matrix = this.matrixCache.m4432calculateInverseMatrixbWbORWo(this);
            if (matrix != null) {
        ...
        androidx.compose.ui.graphics.Matrix.m2838mapimpl(this.matrixCache.m4433calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4373transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m2847timesAssign58bKbWc(matrix, this.matrixCache.m4433calculateMatrixGrdbGEg(this));
    }
    ...
    public void mo4368inverseTransform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float[] inverse = this.matrixCache.m4432calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {
