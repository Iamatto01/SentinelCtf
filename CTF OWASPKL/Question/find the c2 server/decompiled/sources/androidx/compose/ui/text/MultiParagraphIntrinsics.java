...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(AnnotatedString annotatedString, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, FontFamily.Resolver fontFamilyResolver) {
        ...
        while (index$iv$iv$iv < size) {
            ...
            target$iv$iv.add(new ParagraphIntrinsicInfo(ParagraphIntrinsicsKt.ParagraphIntrinsics(text, merge, $this$fastForEach$iv$iv$iv2, localPlaceholders, density, fontFamilyResolver), paragraphStyleRange$iv.getStart(), paragraphStyleRange$iv.getEnd()));
            index$iv$iv$iv++;
            style2 = style;
            size = size;
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        ParagraphStyle m4547copyciSxzs0;
        TextDirection m4556getTextDirectionmmuk1to = style.m4556getTextDirectionmmuk1to();
        if (m4556getTextDirectionmmuk1to != null) {
            m4556getTextDirectionmmuk1to.m5006unboximpl();
            if (style != null) {
                return style;
            }
        }
        m4547copyciSxzs0 = style.m4547copyciSxzs0((r20 & 1) != 0 ? style.textAlign : null, (r20 & 2) != 0 ? style.textDirection : defaultStyle.m4556getTextDirectionmmuk1to(), (r20 & 4) != 0 ? style.lineHeight : 0L, (r20 & 8) != 0 ? style.textIndent : null, (r20 & 16) != 0 ? style.platformStyle : null, (r20 & 32) != 0 ? style.lineHeightStyle : null, (r20 & 64) != 0 ? style.lineBreak : null, (r20 & 128) != 0 ? style.hyphens : null);
        return m4547copyciSxzs0;
    }
}
