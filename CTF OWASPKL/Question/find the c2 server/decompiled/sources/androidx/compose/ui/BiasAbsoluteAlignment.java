...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2264alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long remaining = IntSizeKt.IntSize(IntSize.m5282getWidthimpl(space) - IntSize.m5282getWidthimpl(size), IntSize.m5281getHeightimpl(space) - IntSize.m5281getHeightimpl(size));
        float centerX = IntSize.m5282getWidthimpl(remaining) / 2.0f;
        float centerY = IntSize.m5281getHeightimpl(remaining) / 2.0f;
        float f = 1;
