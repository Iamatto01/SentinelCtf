...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        if (font instanceof ResourceFont) {
            ...
            } else if (FontLoadingStrategy.m4709equalsimpl0(mo4669getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4715getOptionalLocalPKNRLFQ())) {
                try {
                    ...
                    m5433constructorimpl = Result.m5433constructorimpl(load);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    m5433constructorimpl = Result.m5433constructorimpl(ResultKt.createFailure(th));
                }
                typeface = Result.m5439isFailureimpl(m5433constructorimpl) ? null : m5433constructorimpl;
            } else if (FontLoadingStrategy.m4709equalsimpl0(mo4669getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m4713getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            } else {
                throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m4711toStringimpl(font.mo4669getLoadingStrategyPKNRLFQ())));
            }
