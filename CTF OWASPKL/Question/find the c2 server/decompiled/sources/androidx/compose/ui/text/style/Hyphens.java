...
public final class Hyphens {
    ...
    private static final int None = m4903constructorimpl(1);
    private static final int Auto = m4903constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Hyphens m4902boximpl(int i) {
        return new Hyphens(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m4903constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4904equalsimpl(int i, Object obj) {
        return (obj instanceof Hyphens) && i == ((Hyphens) obj).m4908unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m4910getNonevmbZdU8() {
            return Hyphens.None;
        }

        /* renamed from: getAuto-vmbZdU8  reason: not valid java name */
        public final int m4909getAutovmbZdU8() {
            return Hyphens.Auto;
        }
    }
    ...
    public static String m4907toStringimpl(int arg0) {
        return m4905equalsimpl0(arg0, None) ? "Hyphens.None" : m4905equalsimpl0(arg0, Auto) ? "Hyphens.Auto" : "Invalid";
    }
