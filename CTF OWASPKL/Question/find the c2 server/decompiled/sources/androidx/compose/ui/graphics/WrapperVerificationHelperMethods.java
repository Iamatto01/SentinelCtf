...
public final class WrapperVerificationHelperMethods {
    ...
    public final void m2999setBlendModeGB0RdKg(android.graphics.Paint paint, int mode) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        paint.setBlendMode(AndroidBlendMode_androidKt.m2460toAndroidBlendModes9anfk8(mode));
    }
}
