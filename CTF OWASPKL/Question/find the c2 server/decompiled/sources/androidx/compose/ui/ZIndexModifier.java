...
final class ZIndexModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public ZIndexModifier(float zIndex, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        super(inspectorInfo);
    ...
    public MeasureResult mo24measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.ZIndexModifier$measure$1
    ...
    public boolean equals(Object other) {
        ZIndexModifier otherModifier = other instanceof ZIndexModifier ? (ZIndexModifier) other : null;
        return otherModifier != null && this.zIndex == otherModifier.zIndex;
    }
