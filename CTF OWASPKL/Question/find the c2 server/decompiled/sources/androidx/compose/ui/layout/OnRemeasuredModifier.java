...
public interface OnRemeasuredModifier extends Modifier.Element {
    ...
    void mo224onRemeasuredozmzZPI(long j);
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        public static <R> R foldIn(OnRemeasuredModifier $this, R r, Function2<? super R, ? super Modifier.Element, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(operation, "operation");
            return (R) OnRemeasuredModifier.super.foldIn(r, operation);
        }

        @Deprecated
        public static <R> R foldOut(OnRemeasuredModifier $this, R r, Function2<? super Modifier.Element, ? super R, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(operation, "operation");
