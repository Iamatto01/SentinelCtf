...
public final class SolidColor extends Brush {
    ...
    public final long m2931getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public void mo2553applyToPq9zytI(long size, Paint p, float alpha) {
        long j;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (!(alpha == 1.0f)) {
            long j2 = this.value;
            j = Color.m2604copywmQWz5c(j2, (r12 & 1) != 0 ? Color.m2608getAlphaimpl(j2) : Color.m2608getAlphaimpl(j2) * alpha, (r12 & 2) != 0 ? Color.m2612getRedimpl(j2) : 0.0f, (r12 & 4) != 0 ? Color.m2611getGreenimpl(j2) : 0.0f, (r12 & 8) != 0 ? Color.m2609getBlueimpl(j2) : 0.0f);
        } else {
            j = this.value;
        }
        p.mo2488setColor8_81llA(j);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m2607equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m2614toStringimpl(this.value)) + ')';
    }
}
