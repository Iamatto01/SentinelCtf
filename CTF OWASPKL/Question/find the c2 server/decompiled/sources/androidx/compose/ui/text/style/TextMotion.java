...
public final class TextMotion {
    ...
    private static final TextMotion Static = new TextMotion(Linearity.Companion.m5028getFontHinting4e0Vf04(), false, null);
    private static final TextMotion Animated = new TextMotion(Linearity.Companion.m5029getLinear4e0Vf04(), true, null);
    ...
    public final int m5020getLinearity4e0Vf04$ui_text_release() {
    ...
    public static /* synthetic */ TextMotion m5018copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m5019copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release  reason: not valid java name */
    public final TextMotion m5019copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextMotion) && Linearity.m5024equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning;
    }

    public int hashCode() {
        int result = Linearity.m5025hashCodeimpl(this.linearity);
    ...
    public static final class Linearity {
        ...
        public static final Companion Companion = new Companion(null);
        private static final int Linear = m5022constructorimpl(1);
        private static final int FontHinting = m5022constructorimpl(2);
        private static final int None = m5022constructorimpl(3);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Linearity m5021boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        private static int m5022constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m5023equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).m5027unboximpl();
        }
        ...
        public static final class Companion {
            ...
            public final int m5029getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04  reason: not valid java name */
            public final int m5028getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04  reason: not valid java name */
            public final int m5030getNone4e0Vf04() {
        ...
        public static String m5026toStringimpl(int arg0) {
            return m5024equalsimpl0(arg0, Linear) ? "Linearity.Linear" : m5024equalsimpl0(arg0, FontHinting) ? "Linearity.FontHinting" : m5024equalsimpl0(arg0, None) ? "Linearity.None" : "Invalid";
        }
