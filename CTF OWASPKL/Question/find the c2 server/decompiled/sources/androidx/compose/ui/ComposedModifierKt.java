...
public final class ComposedModifierKt {
    ...
    public static final Modifier materialize(final Composer $this$materialize, Modifier modifier) {
        ...
        Modifier result = (Modifier) modifier.foldIn(Modifier.Companion, new Function2<Modifier, Modifier.Element, Modifier>() { // from class: androidx.compose.ui.ComposedModifierKt$materialize$result$1
            ...
            public final Modifier invoke(Modifier acc, Modifier.Element element) {
                ...
                if (element instanceof ComposedModifier) {
                    ...
                    Modifier composedMod = (Modifier) factory2.invoke(Modifier.Companion, Composer.this, 0);
                    element2 = ComposedModifierKt.materialize(Composer.this, composedMod);
                } else {
                    element2 = element;
                }
