...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.Companion.m2949getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.Companion.m2960getMiterLxFBmk8();
    ...
    public final int m3209getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m3210getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m3211getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m3212getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Stroke) {
            if (this.width == ((Stroke) other).width) {
                return ((this.miter > ((Stroke) other).miter ? 1 : (this.miter == ((Stroke) other).miter ? 0 : -1)) == 0) && StrokeCap.m2945equalsimpl0(this.cap, ((Stroke) other).cap) && StrokeJoin.m2955equalsimpl0(this.join, ((Stroke) other).join) && Intrinsics.areEqual(this.pathEffect, ((Stroke) other).pathEffect);
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        ...
        int result2 = ((((((result * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m2946hashCodeimpl(this.cap)) * 31) + StrokeJoin.m2956hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return result2 + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2947toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2957toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
