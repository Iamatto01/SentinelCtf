...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (target == null) {
            matrix = Matrix.m2830constructorimpl$default(null, 1, null);
            this.groupMatrix = matrix;
        } else {
            matrix = target;
            Matrix.m2839resetimpl(matrix);
        }
        Matrix.m2850translateimpl$default(matrix, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m2842rotateZimpl(matrix, this.rotation);
        Matrix.m2843scaleimpl(matrix, this.scaleX, this.scaleY, 1.0f);
        Matrix.m2850translateimpl$default(matrix, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        if (fArr != null) {
            float[] it = (fArr != null ? Matrix.m2828boximpl(fArr) : null).m2851unboximpl();
            $this$draw_u24lambda_u245.mo3079transform58bKbWc(it);
        }
        Path targetClip = this.clipPath;
        if (getWillClipPath() && targetClip != null) {
            DrawTransform.m3196clipPathmtrdDE$default($this$draw_u24lambda_u245, targetClip, 0, 2, null);
        }
        List $this$fastForEach$iv = this.children;
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
