...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3249getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m2949getButtKaPHkGw();
        }
        return m3248getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m3248getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
    ...
    static /* synthetic */ int m3251getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m2960getMiterLxFBmk8();
        }
        return m3250getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m3250getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) {
        ...
        if (vectorAttrs.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (value.type == 2) {
                tintColor = Color.Companion.m2642getUnspecified0d7_KjU();
            } else {
        ...
        if (blendModeValue != -1) {
            switch (blendModeValue) {
                case 3:
                    tintBlendMode = BlendMode.Companion.m2550getSrcOver0nO6VwU();
                    break;
                case 5:
                    tintBlendMode = BlendMode.Companion.m2548getSrcIn0nO6VwU();
                    break;
                case 9:
                    tintBlendMode = BlendMode.Companion.m2547getSrcAtop0nO6VwU();
                    break;
                case 14:
                    tintBlendMode = BlendMode.Companion.m2539getModulate0nO6VwU();
                    break;
                case 15:
                    tintBlendMode = BlendMode.Companion.m2544getScreen0nO6VwU();
                    break;
                case 16:
                    tintBlendMode = BlendMode.Companion.m2542getPlus0nO6VwU();
                    break;
                default:
                    tintBlendMode = BlendMode.Companion.m2548getSrcIn0nO6VwU();
                    break;
        ...
        float defaultWidthDp = Dp.m5122constructorimpl($this$dp$iv);
        float $this$dp$iv2 = defaultHeight / res.getDisplayMetrics().density;
        float defaultHeightDp = Dp.m5122constructorimpl($this$dp$iv2);
        vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int strokeLineCap = m3248getStrokeLineCapCSYIeUk(lineCap, StrokeCap.Companion.m2949getButtKaPHkGw());
        ...
        int strokeLineJoin = m3250getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.Companion.m2959getBevelLxFBmk8());
        ...
        int lineJoin2 = fillRule == 0 ? companion.m2880getNonZeroRgk1Os() : companion.m2879getEvenOddRgk1Os();
        builder.m3228addPathoIyEayM(pathData, lineJoin2, name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
    }
