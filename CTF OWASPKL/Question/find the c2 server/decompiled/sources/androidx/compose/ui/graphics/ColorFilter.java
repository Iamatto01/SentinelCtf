...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m2647tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m2548getSrcIn0nO6VwU();
            }
            return companion.m2650tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m2650tintxETnrds(long color, int blendMode) {
            return AndroidColorFilter_androidKt.m2475actualTintColorFilterxETnrds(color, blendMode);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m2648colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m2473actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m2649lightingOWjLjI(long multiply, long add) {
            return AndroidColorFilter_androidKt.m2474actualLightingColorFilterOWjLjI(multiply, add);
        }
    }
