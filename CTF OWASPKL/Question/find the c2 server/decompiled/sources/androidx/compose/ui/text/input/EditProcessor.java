...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.Companion.m4642getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    private EditingBuffer mBuffer = new EditingBuffer(this.mBufferState.getAnnotatedString(), this.mBufferState.m4846getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        ...
        boolean compositionChanged = !Intrinsics.areEqual(value.m4845getCompositionMzsxiRA(), this.mBuffer.m4767getCompositionMzsxiRA$ui_text_release());
        if (!Intrinsics.areEqual(this.mBufferState.getAnnotatedString(), value.getAnnotatedString())) {
            this.mBuffer = new EditingBuffer(value.getAnnotatedString(), value.m4846getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
            textChanged = true;
        } else if (!TextRange.m4630equalsimpl0(this.mBufferState.m4846getSelectiond9O1mEE(), value.m4846getSelectiond9O1mEE())) {
            this.mBuffer.setSelection$ui_text_release(TextRange.m4635getMinimpl(value.m4846getSelectiond9O1mEE()), TextRange.m4634getMaximpl(value.m4846getSelectiond9O1mEE()));
            selectionChanged = true;
        }
        if (value.m4845getCompositionMzsxiRA() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m4631getCollapsedimpl(value.m4845getCompositionMzsxiRA().m4641unboximpl())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m4635getMinimpl(value.m4845getCompositionMzsxiRA().m4641unboximpl()), TextRange.m4634getMaximpl(value.m4845getCompositionMzsxiRA().m4641unboximpl()));
        }
        if (textChanged || (!selectionChanged && compositionChanged)) {
            this.mBuffer.commitComposition$ui_text_release();
            newValue = TextFieldValue.m4841copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        } else {
            newValue = value;
        }
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            TextFieldValue newState = new TextFieldValue(this.mBuffer.toAnnotatedString$ui_text_release(), this.mBuffer.m4768getSelectiond9O1mEE$ui_text_release(), this.mBuffer.m4767getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> list, final EditCommand failedCommand) {
        ...
        StringBuilder append = $this$generateBatchErrorMessage_u24lambda_u241.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m4767getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m4640toStringimpl(this.mBuffer.m4768getSelectiond9O1mEE$ui_text_release())) + "):");
        Intrinsics.checkNotNullExpressionValue(append, "append(value)");
        Intrinsics.checkNotNullExpressionValue(append.append('\n'), "append('\\n')");
        CollectionsKt.joinTo(list, $this$generateBatchErrorMessage_u24lambda_u241, (r14 & 2) != 0 ? ", " : "\n", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<EditCommand, CharSequence>() { // from class: androidx.compose.ui.text.input.EditProcessor$generateBatchErrorMessage$1$1
