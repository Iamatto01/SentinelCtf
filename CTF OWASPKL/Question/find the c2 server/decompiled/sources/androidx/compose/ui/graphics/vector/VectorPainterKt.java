...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m3243rememberVectorPaintermlNsNFs(float defaultWidth, float defaultHeight, float viewportWidth, float viewportHeight, String name, long tintColor, int tintBlendMode, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i) {
        ...
        if ((i & 32) == 0) {
            ...
            tintColor2 = Color.Companion.m2642getUnspecified0d7_KjU();
        }
        if ((i & 64) == 0) {
            tintBlendMode2 = tintBlendMode;
        } else {
            tintBlendMode2 = BlendMode.Companion.m2548getSrcIn0nO6VwU();
        }
    ...
    */
    ...
    public static final VectorPainter rememberVectorPainter(final ImageVector image, Composer $composer, int $changed) {
        ...
        VectorPainter m3244rememberVectorPaintervIP8VLU = m3244rememberVectorPaintervIP8VLU(image.m3224getDefaultWidthD9Ej5fM(), image.m3223getDefaultHeightD9Ej5fM(), image.getViewportWidth(), image.getViewportHeight(), image.getName(), image.m3226getTintColor0d7_KjU(), image.m3225getTintBlendMode0nO6VwU(), image.getAutoMirror(), ComposableLambdaKt.composableLambda($composer, 1873274766, true, new Function4<Float, Float, Composer, Integer, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorPainterKt$rememberVectorPainter$3
    ...
    private static final void mirror(DrawScope $this$mirror, Function1<? super DrawScope, Unit> function1) {
        long pivot$iv = $this$mirror.mo3145getCenterF1C5BW0();
