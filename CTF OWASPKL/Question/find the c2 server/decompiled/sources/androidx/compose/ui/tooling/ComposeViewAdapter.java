...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    public ComposeViewAdapter(Context context, AttributeSet attrs) {
        ...
        this.previewComposition = ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5045getLambda2$ui_tooling_release();
        ...
        $this$debugBoundsPaint_u24lambda_u240.setColor(ColorKt.m2660toArgb8_81llA(Color.Companion.m2640getRed0d7_KjU()));
        ...
        this.FakeActivityResultRegistryOwner = new ActivityResultRegistryOwner() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$FakeActivityResultRegistryOwner$1
            private final ComposeViewAdapter$FakeActivityResultRegistryOwner$1$activityResultRegistry$1 activityResultRegistry = new ActivityResultRegistry() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$FakeActivityResultRegistryOwner$1$activityResultRegistry$1
                ...
                public <I, O> void onLaunch(int requestCode, ActivityResultContract<I, O> contract, I i, ActivityOptionsCompat options) {
    ...
    private final ViewInfo toViewInfo(Group $this$toViewInfo) {
        ...
        String str = (location == null || (r2 = location.getSourceFile()) == null) ? "" : "";
        SourceLocation location2 = $this$toViewInfo.getLocation();
        return new ViewInfo(str, location2 != null ? location2.getLineNumber() : -1, $this$toViewInfo.getBox(), $this$toViewInfo.getLocation(), childrenViewInfo, layoutInfo);
    }
    ...
    private final void invalidateComposition() {
        this.content.setValue(ComposableSingletons$ComposeViewAdapterKt.INSTANCE.m5046getLambda3$ui_tooling_release());
    ...
    public final void init$ui_tooling_release(final String className, final String methodName, final Class<? extends PreviewParameterProvider<?>> cls, final int parameterProviderIndex, boolean debugPaintBounds, boolean debugViewInfos, final long animationClockStartTime, boolean forceCompositionInvalidation, boolean lookForDesignInfoProviders, String designInfoProvidersArgument, final Function0<Unit> onCommit, Function0<Unit> onDraw) {
                                ...
                                Function0 composable = new Function0<Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter$init$3$1$composable$1
                                    ...
                                    public final void invoke2() {
                                        ...
                                        try {
                                            ...
                                            Object[] previewProviderParameters = PreviewUtilsKt.getPreviewProviderParameters(cls3, i2);
                                ...
                                if (j >= 0) {
                                    ...
                                    composeViewAdapter4.setClock$ui_tooling_release(new PreviewAnimationClock(new Function0<Unit>() { // from class: androidx.compose.ui.tooling.ComposeViewAdapter.init.3.1.1
                                        ...
                                        public final void invoke2() {
                                            ...
                                            View childAt2 = composeView.getChildAt(0);
