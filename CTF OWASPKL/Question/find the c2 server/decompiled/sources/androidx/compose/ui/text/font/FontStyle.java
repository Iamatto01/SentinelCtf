...
public final class FontStyle {
    ...
    private static final int Normal = m4720constructorimpl(0);
    private static final int Italic = m4720constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FontStyle m4719boximpl(int i) {
    ...
    public static boolean m4721equalsimpl(int i, Object obj) {
        return (obj instanceof FontStyle) && i == ((FontStyle) obj).m4725unboximpl();
    }
    ...
    public final /* synthetic */ int m4725unboximpl() {
        return this.value;
    }
    ...
    public static String m4724toStringimpl(int arg0) {
        return m4722equalsimpl0(arg0, Normal) ? "Normal" : m4722equalsimpl0(arg0, Italic) ? "Italic" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4727getNormal_LCdwA() {
            return FontStyle.Normal;
        }

        /* renamed from: getItalic-_-LCdwA  reason: not valid java name */
        public final int m4726getItalic_LCdwA() {
            return FontStyle.Italic;
        }

        public final List<FontStyle> values() {
            return CollectionsKt.listOf((Object[]) new FontStyle[]{FontStyle.m4719boximpl(m4727getNormal_LCdwA()), FontStyle.m4719boximpl(m4726getItalic_LCdwA())});
        }
    }
}
