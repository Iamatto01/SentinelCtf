...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.Companion.m2445getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope $this$draw, float alpha, ColorFilter colorFilter) {
        ...
        if (colorFilter != null) {
            targetColorFilter = colorFilter;
        } else {
            targetColorFilter = getIntrinsicColorFilter$ui_release();
        }
        if (this.isDirty || !Size.m2433equalsimpl0(this.previousDrawSize, $this$draw.mo3146getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2437getWidthimpl($this$draw.mo3146getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2434getHeightimpl($this$draw.mo3146getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3222drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2437getWidthimpl($this$draw.mo3146getSizeNHjbRc())), (int) Math.ceil(Size.m2434getHeightimpl($this$draw.mo3146getSizeNHjbRc()))), $this$draw, $this$draw.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = $this$draw.mo3146getSizeNHjbRc();
        }
