...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m4066toMotionEventScoped4ec7I(PointerEvent toMotionEventScope, long offset, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toMotionEventScope, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m4067toMotionEventScopeubNVwUQ(toMotionEventScope, offset, block, false);
    }

    /* renamed from: toCancelMotionEventScope-d-4ec7I  reason: not valid java name */
    public static final void m4065toCancelMotionEventScoped4ec7I(PointerEvent toCancelMotionEventScope, long offset, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toCancelMotionEventScope, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m4067toMotionEventScopeubNVwUQ(toCancelMotionEventScope, offset, block, true);
    }
    ...
    private static final void m4067toMotionEventScopeubNVwUQ(PointerEvent $this$toMotionEventScope_u2dubNVwUQ, long offset, Function1<? super MotionEvent, Unit> function1, boolean cancel) {
        ...
        motionEvent.offsetLocation(-Offset.m2368getXimpl(offset), -Offset.m2369getYimpl(offset));
