...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.Companion.m2690getAutoNrFUSI();
    ...
    public int mo4417getCompositingStrategyNrFUSI() {
        return this.internalCompositingStrategy;
    }

    @Override // androidx.compose.ui.platform.DeviceRenderNode
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo4418setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m2686equalsimpl0(value, CompositingStrategy.Companion.m2692getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m2686equalsimpl0(value, CompositingStrategy.Companion.m2691getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m2686equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m2692getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m2577clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, null);
        }
