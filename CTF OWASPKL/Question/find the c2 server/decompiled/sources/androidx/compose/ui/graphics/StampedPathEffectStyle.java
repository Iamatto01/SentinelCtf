...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m2933constructorimpl(0);
    private static final int Rotate = m2933constructorimpl(1);
    private static final int Morph = m2933constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m2932boximpl(int i) {
    ...
    public static boolean m2934equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).m2938unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2935equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m2934equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2936hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2941getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk  reason: not valid java name */
        public final int m2940getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk  reason: not valid java name */
        public final int m2939getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2937toStringimpl(int arg0) {
        return m2935equalsimpl0(arg0, Translate) ? "Translate" : m2935equalsimpl0(arg0, Rotate) ? "Rotate" : m2935equalsimpl0(arg0, Morph) ? "Morph" : "Unknown";
    }

    public String toString() {
        return m2937toStringimpl(this.value);
    }
}
