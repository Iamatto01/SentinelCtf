...
public final class ParagraphInfo {
    ...
    public final long m4536toLocalMKHz9U(long $this$toLocal_u2dMK_u2dHz9U) {
        return OffsetKt.Offset(Offset.m2368getXimpl($this$toLocal_u2dMK_u2dHz9U), Offset.m2369getYimpl($this$toLocal_u2dMK_u2dHz9U) - this.top);
    }

    public final Rect toGlobal(Rect $this$toGlobal) {
        Intrinsics.checkNotNullParameter($this$toGlobal, "<this>");
        return $this$toGlobal.m2405translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path $this$toGlobal) {
        Intrinsics.checkNotNullParameter($this$toGlobal, "<this>");
        $this$toGlobal.mo2503translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return $this$toGlobal;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m4535toGlobalGEjPoXI(long $this$toGlobal_u2dGEjPoXI) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4637getStartimpl($this$toGlobal_u2dGEjPoXI)), toGlobalIndex(TextRange.m4632getEndimpl($this$toGlobal_u2dGEjPoXI)));
    }
}
