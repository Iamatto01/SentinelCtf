            ...
            case 0:
                ...
                Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m2357boximpl(m829invokeF1C5BW0());
                    }
                ...
                if (snapshotFlow.collect(new FlowCollector<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Offset offset, Continuation $completion) {
                        return m830emit3MmeM6k(offset.m2378unboximpl(), $completion);
                    }

                    /* renamed from: emit-3MmeM6k  reason: not valid java name */
                    public final Object m830emit3MmeM6k(long targetValue, Continuation<? super Unit> continuation) {
                        if (OffsetKt.m2387isSpecifiedk4lQ0M(animatable.getValue().m2378unboximpl()) && OffsetKt.m2387isSpecifiedk4lQ0M(targetValue)) {
                            if (!(Offset.m2369getYimpl(animatable.getValue().m2378unboximpl()) == Offset.m2369getYimpl(targetValue))) {
                        ...
                        Object snapTo = animatable.snapTo(Offset.m2357boximpl(targetValue), continuation);
