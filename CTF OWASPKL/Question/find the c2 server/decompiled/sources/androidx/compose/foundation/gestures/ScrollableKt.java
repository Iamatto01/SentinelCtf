...
public final class ScrollableKt {
    ...
    public static final Modifier pointerScrollable(Modifier $this$pointerScrollable, MutableInteractionSource interactionSource, Orientation orientation, boolean reverseDirection, ScrollableState controller, FlingBehavior flingBehavior, OverscrollEffect overscrollEffect, boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2012025036, $changed, -1, "androidx.compose.foundation.gestures.pointerScrollable (Scrollable.kt:241)");
        }
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv6 = scrollableNestedScrollConnection(scrollLogic, enabled);
            $composer.updateRememberedValue(value$iv$iv6);
            value$iv$iv2 = value$iv$iv6;
        } else {
        ...
        ScrollableKt$pointerScrollable$1 scrollableKt$pointerScrollable$1 = new Function1<PointerInputChange, Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$pointerScrollable$1
            ...
            public final Boolean invoke(PointerInputChange down) {
                ...
                return Boolean.valueOf(!PointerType.m4078equalsimpl0(down.m4010getTypeT8wyACA(), PointerType.Companion.m4083getMouseT8wyACA()));
            }
        };
        $composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation($composer, "CC(remember)P(1):Composables.kt#9igjgp");
        ...
        if (invalid$iv$iv2 || it$iv$iv4 == Composer.Companion.getEmpty()) {
            Object value$iv$iv7 = (Function0) new Function0<Boolean>() { // from class: androidx.compose.foundation.gestures.ScrollableKt$pointerScrollable$2$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
        ...
        if (invalid$iv$iv3 || it$iv$iv5 == Composer.Companion.getEmpty()) {
            Object value$iv$iv8 = (Function3) new ScrollableKt$pointerScrollable$3$1(nestedScrollDispatcher, scrollLogic, null);
            $composer.updateRememberedValue(value$iv$iv8);
            value$iv$iv5 = value$iv$iv8;
        } else {
            value$iv$iv5 = it$iv$iv5;
        }
        $composer.endReplaceableGroup();
        Modifier nestedScroll = NestedScrollModifierKt.nestedScroll(mouseWheelScroll(DraggableKt.draggable$default($this$pointerScrollable, scrollDraggableState, scrollableKt$pointerScrollable$1, orientation, enabled, interactionSource, function0, null, (Function3) value$iv$iv5, false, 64, null), scrollLogic, scrollConfig), nestedScrollConnection, (NestedScrollDispatcher) nestedScrollDispatcher.getValue());
        if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:17:0x0047 -> B:18:0x004b). Please submit an issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static final java.lang.Object awaitScrollEvent(androidx.compose.ui.input.pointer.AwaitPointerEventScope r6, kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerEvent> r7) {
        ...
        L4b:
            ...
            int r4 = r4.m3968getScroll7fucELk()
            boolean r3 = androidx.compose.ui.input.pointer.PointerEventType.m3959equalsimpl0(r3, r4)
            if (r3 == 0) goto L5e
            return r0
        L5e:
            r0 = r1
