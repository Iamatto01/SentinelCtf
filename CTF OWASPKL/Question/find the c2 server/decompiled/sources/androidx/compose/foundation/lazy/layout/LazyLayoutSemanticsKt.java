...
public final class LazyLayoutSemanticsKt {
    public static final Modifier lazyLayoutSemantics(Modifier $this$lazyLayoutSemantics, final LazyLayoutItemProvider itemProvider, final LazyLayoutSemanticState state, Orientation orientation, boolean userScrollEnabled, boolean reverseScrolling, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            ...
            final Function1 indexForKeyMapping = new Function1<Object, Integer>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutSemanticsKt$lazyLayoutSemantics$1$indexForKeyMapping$1
                ...
                public final Integer invoke(Object needle) {
                    ...
                    while (true) {
                        if (index >= itemCount) {
                            break;
                        } else if (!Intrinsics.areEqual(LazyLayoutItemProvider.this.getKey(index), needle)) {
                            index++;
                        } else {
                            result = index;
                            break;
            ...
            value$iv$iv = SemanticsModifierKt.semantics$default(Modifier.Companion, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutSemanticsKt$lazyLayoutSemantics$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
