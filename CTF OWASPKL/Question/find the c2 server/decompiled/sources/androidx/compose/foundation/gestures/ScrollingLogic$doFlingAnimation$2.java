...
public final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
            ...
            case 0:
                ...
                final Function1 outerScopeScroll = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                        return Offset.m2357boximpl(m322invokeMKHz9U(offset.m2378unboximpl()));
                    }

                    /* renamed from: invoke-MK-Hz9U  reason: not valid java name */
                    public final long m322invokeMKHz9U(long delta) {
                        ScrollingLogic scrollingLogic4 = ScrollingLogic.this;
                        return scrollingLogic4.m314reverseIfNeededMKHz9U(scrollingLogic4.m310dispatchScroll3eAAhYA($this$scroll, scrollingLogic4.m314reverseIfNeededMKHz9U(delta), NestedScrollSource.Companion.m3907getFlingWNlRxjI()));
                    }
                };
                ...
                ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                    ...
                    public float scrollBy(float pixels) {
                        ...
                        return scrollingLogic5.m318toFloatk4lQ0M(outerScopeScroll.invoke(Offset.m2357boximpl(scrollingLogic5.m319toOffsettuRUvjQ(pixels))).m2378unboximpl());
                    }
                };
                ...
                float reverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m317toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m320updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) $result).floatValue()));
