...
final class ClicksCounter {
    ...
    public final boolean positionIsTolerable(PointerInputChange prevClick, PointerInputChange newClick) {
        Intrinsics.checkNotNullParameter(prevClick, "prevClick");
        Intrinsics.checkNotNullParameter(newClick, "newClick");
        long diff = Offset.m2372minusMKHz9U(newClick.m4007getPositionF1C5BW0(), prevClick.m4007getPositionF1C5BW0());
        return ((double) Offset.m2366getDistanceimpl(diff)) < 100.0d;
    }
}
