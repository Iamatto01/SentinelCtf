...
public final class OverscrollConfiguration {
    ...
    public /* synthetic */ OverscrollConfiguration(long j, PaddingValues paddingValues, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4284900966L) : j, (i & 2) != 0 ? PaddingKt.m409PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null) : paddingValues, null);
    }

    /* renamed from: getGlowColor-0d7_KjU  reason: not valid java name */
    public final long m214getGlowColor0d7_KjU() {
    ...
    public boolean equals(Object other) {
        ...
        if (Intrinsics.areEqual(getClass(), other != null ? other.getClass() : null)) {
            ...
            return Color.m2607equalsimpl0(this.glowColor, ((OverscrollConfiguration) other).glowColor) && Intrinsics.areEqual(this.drawPadding, ((OverscrollConfiguration) other).drawPadding);
        }
        return false;
    }

    public int hashCode() {
        int result = Color.m2613hashCodeimpl(this.glowColor);
        return (result * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m2614toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
}
