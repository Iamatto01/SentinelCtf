...
public interface Selectable {
    ...
    long mo806getHandlePositiondBAh8RU(Selection selection, boolean z);
    ...
    long mo807getRangeOfLineContainingjx7JFs(int i);
    ...
    Pair<Selection, Boolean> mo808updateSelectionqCDeeow(long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection);

    /* renamed from: updateSelection-qCDeeow$default  reason: not valid java name */
    static /* synthetic */ Pair m814updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
        boolean z2;
        ...
        if (obj == null) {
            ...
            return selectable.mo808updateSelectionqCDeeow(j, j2, offset, z2, layoutCoordinates, selectionAdjustment, selection2);
        }
