                    ...
                    if (updatableAnimationState2.animateToZero(new Function1<Float, Unit>() { // from class: androidx.compose.foundation.gestures.ContentInViewModifier.launchAnimation.1.1.1
                        ...
                        public final void invoke2() {
                            ...
                            while (true) {
                                ...
                                if (!(bounds == null ? true : ContentInViewModifier.m222isMaxVisibleO0kMr_c$default(contentInViewModifier3, bounds, 0L, 1, null))) {
                                    break;
                                }
                                ...
                                ((ContentInViewModifier.Request) mutableVector.removeAt(this_$iv$iv.getSize() - 1)).getContinuation().resumeWith(Result.m5433constructorimpl(unit));
                            }
                            z2 = ContentInViewModifier.this.trackingFocusedChild;
                            if (z2) {
                                focusedChildBounds = ContentInViewModifier.this.getFocusedChildBounds();
                                if (focusedChildBounds == null || !ContentInViewModifier.m222isMaxVisibleO0kMr_c$default(ContentInViewModifier.this, focusedChildBounds, 0L, 1, null)) {
                                    z = false;
                                }
                                if (z) {
