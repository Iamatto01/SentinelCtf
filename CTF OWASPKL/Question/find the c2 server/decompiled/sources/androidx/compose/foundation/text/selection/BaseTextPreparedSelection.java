...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m802getOriginalSelectiond9O1mEE() {
    ...
    public final void m804setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            $this$deselect_u24lambda_u241.setCursor(TextRange.m4632getEndimpl($this$deselect_u24lambda_u241.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m4631getCollapsedimpl($this$collapseLeftOr_u24lambda_u244.selection)) {
                ...
                $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m4635getMinimpl($this$collapseLeftOr_u24lambda_u244.selection));
            } else {
                $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m4634getMaximpl($this$collapseLeftOr_u24lambda_u244.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T collapseRightOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m4631getCollapsedimpl($this$collapseRightOr_u24lambda_u245.selection)) {
                ...
                $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m4634getMaximpl($this$collapseRightOr_u24lambda_u245.selection));
            } else {
                $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m4635getMinimpl($this$collapseRightOr_u24lambda_u245.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m4632getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m4632getEndimpl(this.selection));
    }
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            ...
            $this$selectMovement_u24lambda_u2428.selection = TextRangeKt.TextRange(TextRange.m4637getStartimpl($this$selectMovement_u24lambda_u2428.originalSelection), TextRange.m4632getEndimpl($this$selectMovement_u24lambda_u2428.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.originalText.length()) {
            long currentWord = $this$getNextWordOffsetForLayout.m4611getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m4632getEndimpl(currentWord) <= currentOffset) {
                currentOffset++;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m4632getEndimpl(currentWord));
            }
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult $this$getPrevWordOffset, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffset.m4611getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m4637getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m4637getStartimpl(currentWord));
            }
        }
        return 0;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        ...
        if ((!isLtr() || it < $this$jumpByLinesOffset.getLineRight(targetLine)) && (isLtr() || it > $this$jumpByLinesOffset.getLineLeft(targetLine))) {
            ...
            return this.offsetMapping.transformedToOriginal($this$jumpByLinesOffset.m4609getOffsetForPositionk4lQ0M(OffsetKt.Offset(x, y)));
        }
        return $this$jumpByLinesOffset.getLineEnd(targetLine, true);
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4632getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4635getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4634getMaximpl(this.selection));
    }
    ...
    private final int getParagraphStart() {
        return StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m4635getMinimpl(this.selection));
    }

    private final int getParagraphEnd() {
        return StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m4634getMaximpl(this.selection));
    }
