...
public final class ScrollState implements ScrollableState {
    ...
    public ScrollState(int initial) {
        this.value$delegate = SnapshotStateKt.mutableStateOf(Integer.valueOf(initial), SnapshotStateKt.structuralEqualityPolicy());
    }
    ...
    public final void setMaxValue$foundation_release(int newMax) {
        this._maxValueState.setValue(Integer.valueOf(newMax));
        if (getValue() > newMax) {
            setValue(newMax);
        }
    }
