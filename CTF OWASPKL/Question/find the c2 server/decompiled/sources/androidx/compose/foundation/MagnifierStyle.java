...
public final class MagnifierStyle {
    ...
    public final long m200getSizeMYxV2XQ$foundation_release() {
        return this.size;
    }

    /* renamed from: getCornerRadius-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m198getCornerRadiusD9Ej5fM$foundation_release() {
        return this.cornerRadius;
    }

    /* renamed from: getElevation-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m199getElevationD9Ej5fM$foundation_release() {
    ...
    public /* synthetic */ MagnifierStyle(long j, float f, float f2, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? DpSize.Companion.m5229getUnspecifiedMYxV2XQ() : j, (i & 2) != 0 ? Dp.Companion.m5142getUnspecifiedD9Ej5fM() : f, (i & 4) != 0 ? Dp.Companion.m5142getUnspecifiedD9Ej5fM() : f2, (i & 8) != 0 ? true : z, (i & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof MagnifierStyle) && this.useTextDefault == ((MagnifierStyle) other).useTextDefault && DpSize.m5217equalsimpl0(this.size, ((MagnifierStyle) other).size) && Dp.m5127equalsimpl0(this.cornerRadius, ((MagnifierStyle) other).cornerRadius) && Dp.m5127equalsimpl0(this.elevation, ((MagnifierStyle) other).elevation) && this.clippingEnabled == ((MagnifierStyle) other).clippingEnabled && this.fishEyeEnabled == ((MagnifierStyle) other).fishEyeEnabled;
    }

    public int hashCode() {
        int result = Boolean.hashCode(this.useTextDefault);
        return (((((((((result * 31) + DpSize.m5222hashCodeimpl(this.size)) * 31) + Dp.m5128hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5128hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31) + Boolean.hashCode(this.fishEyeEnabled);
    }

    public String toString() {
        return this.useTextDefault ? "MagnifierStyle.TextDefault" : "MagnifierStyle(size=" + ((Object) DpSize.m5227toStringimpl(this.size)) + ", cornerRadius=" + ((Object) Dp.m5133toStringimpl(this.cornerRadius)) + ", elevation=" + ((Object) Dp.m5133toStringimpl(this.elevation)) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }
    ...
    public static final class Companion {
        ...
        public final boolean isStyleSupported$foundation_release(MagnifierStyle style, int sdkVersion) {
            ...
            if (MagnifierKt.isPlatformMagnifierSupported(sdkVersion) && !style.getFishEyeEnabled$foundation_release()) {
                if (style.getUseTextDefault$foundation_release() || Intrinsics.areEqual(style, getDefault())) {
                    return true;
                }
