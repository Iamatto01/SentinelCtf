...
public final class DragInteractionKt {
    public static final State<Boolean> collectIsDraggedAsState(InteractionSource $this$collectIsDraggedAsState, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv3 = (Function2) new DragInteractionKt$collectIsDraggedAsState$1$1($this$collectIsDraggedAsState, isDragged, null);
        ...
        $composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect($this$collectIsDraggedAsState, (Function2) value$iv$iv2, $composer, ($changed & 14) | 64);
        if (ComposerKt.isTraceInProgress()) {
