...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo671createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2437getWidthimpl(size) - topEnd, 0.0f);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2437getWidthimpl(size), topEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2437getWidthimpl(size), Size.m2434getHeightimpl(size) - bottomEnd);
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(Size.m2437getWidthimpl(size) - bottomEnd, Size.m2434getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(bottomStart, Size.m2434getHeightimpl(size));
        $this$createOutline_LjSzlW0_u24lambda_u240.lineTo(0.0f, Size.m2434getHeightimpl(size) - bottomStart);
