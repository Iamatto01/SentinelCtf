...
public final class RowKt {
    ...
    static {
        ...
        float mo364getSpacingD9Ej5fM = Arrangement.INSTANCE.getStart().mo364getSpacingD9Ej5fM();
        ...
        DefaultRowMeasurePolicy = RowColumnImplKt.m435rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.RowKt$DefaultRowMeasurePolicy$1
        ...
        }, mo364getSpacingD9Ej5fM, SizeMode.Wrap, vertical$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy rowMeasurePolicy(final Arrangement.Horizontal horizontalArrangement, Alignment.Vertical verticalAlignment, Composer $composer, int $changed) {
        ...
        if (Intrinsics.areEqual(horizontalArrangement, Arrangement.INSTANCE.getStart()) && Intrinsics.areEqual(verticalAlignment, Alignment.Companion.getTop())) {
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Horizontal;
                float mo364getSpacingD9Ej5fM = horizontalArrangement.mo364getSpacingD9Ej5fM();
                ...
                value$iv$iv = RowColumnImplKt.m435rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new Function5<Integer, int[], LayoutDirection, Density, int[], Unit>() { // from class: androidx.compose.foundation.layout.RowKt$rowMeasurePolicy$1$1
