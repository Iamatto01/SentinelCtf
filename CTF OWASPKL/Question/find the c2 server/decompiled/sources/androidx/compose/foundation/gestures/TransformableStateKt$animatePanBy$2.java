    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.Companion), Offset.m2357boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
                Offset m2357boximpl = Offset.m2357boximpl(this.$offset);
                AnimationSpec<Offset> animationSpec = this.$animationSpec;
                final Ref.LongRef longRef = this.$previous;
                this.label = 1;
                animateTo = SuspendAnimationKt.animateTo(animationState, m2357boximpl, (r12 & 2) != 0 ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : animationSpec, (r12 & 4) != 0 ? false : false, (r12 & 8) != 0 ? new Function1<AnimationScope<T, V>, Unit>() { // from class: androidx.compose.animation.core.SuspendAnimationKt$animateTo$2
                    ...
                    public final void invoke2(AnimationScope<Offset, AnimationVector2D> animateTo2) {
                        ...
                        long delta = Offset.m2372minusMKHz9U(animateTo2.getValue().m2378unboximpl(), Ref.LongRef.this.element);
                        TransformScope.m327transformByd4ec7I$default($this$transform, 0.0f, delta, 0.0f, 5, null);
                        Ref.LongRef.this.element = animateTo2.getValue().m2378unboximpl();
                    }
                }, this);
