...
public final class TextFieldScrollKt {
    ...
    public static final Modifier textFieldScroll(Modifier $this$textFieldScroll, TextFieldScrollerPosition scrollerPosition, TextFieldValue textFieldValue, VisualTransformation visualTransformation, Function0<TextLayoutResultProxy> textLayoutResultProvider) {
        ...
        int cursorOffset = scrollerPosition.m778getOffsetToFollow5zctL8(textFieldValue.m4846getSelectiond9O1mEE());
        scrollerPosition.m780setPreviousSelection5zctL8(textFieldValue.m4846getSelectiond9O1mEE());
    ...
    public static final Rect getCursorRectInScroller(Density $this$getCursorRectInScroller, int cursorOffset, TransformedText transformedText, TextLayoutResult textLayoutResult, boolean rtl, int textFieldWidth) {
        ...
        float cursorRight;
        Rect cursorRect;
        Rect cursorRect2 = (textLayoutResult == null || (cursorRect = textLayoutResult.getCursorRect(transformedText.getOffsetMapping().originalToTransformed(cursorOffset))) == null) ? Rect.Companion.getZero() : cursorRect;
        int thickness = $this$getCursorRectInScroller.mo295roundToPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (rtl) {
