...
public final class TransformableStateKt {
        ...
        if (it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = TransformableState(new Function3<Float, Offset, Float, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$rememberTransformableState$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Float f, Offset offset, Float f2) {
                    m332invoked4ec7I(f.floatValue(), offset.m2378unboximpl(), f2.floatValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-d-4ec7I  reason: not valid java name */
                public final void m332invoked4ec7I(float z, long p, float r) {
                    lambdaState.getValue().invoke(Float.valueOf(z), Offset.m2357boximpl(p), Float.valueOf(r));
                }
            });
    ...
    public static /* synthetic */ Object m330animatePanByubNVwUQ$default(TransformableState transformableState, long j, AnimationSpec animationSpec, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            animationSpec = new SpringSpec(0.0f, 200.0f, null, 5, null);
        }
        return m329animatePanByubNVwUQ(transformableState, j, animationSpec, continuation);
    }

    /* renamed from: animatePanBy-ubNVwUQ  reason: not valid java name */
    public static final Object m329animatePanByubNVwUQ(TransformableState $this$animatePanBy_u2dubNVwUQ, long offset, AnimationSpec<Offset> animationSpec, Continuation<? super Unit> continuation) {
        Ref.LongRef previous = new Ref.LongRef();
        previous.element = Offset.Companion.m2384getZeroF1C5BW0();
    ...
    public static final Object m331panByd4ec7I(TransformableState $this$panBy_u2dd_u2d4ec7I, long offset, Continuation<? super Unit> continuation) {
