...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m790getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m792getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m792getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        long it = position;
        if (coerceInVisibleBounds) {
            it = m789coercedInVisibleBoundsOfInputTextMKHz9U(it);
        }
        long relativePosition = m791relativeToInputTextMKHz9U(it);
        return this.value.m4609getOffsetForPositionk4lQ0M(relativePosition);
    }

    public final int getLineForVerticalPosition(float vertical) {
        float relativeVertical = Offset.m2369getYimpl(m791relativeToInputTextMKHz9U(m789coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical))));
    ...
    public final boolean m793isPositionOnTextk4lQ0M(long offset) {
        long relativeOffset = m791relativeToInputTextMKHz9U(m789coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int line = this.value.getLineForVerticalPosition(Offset.m2369getYimpl(relativeOffset));
        return Offset.m2368getXimpl(relativeOffset) >= this.value.getLineLeft(line) && Offset.m2368getXimpl(relativeOffset) <= this.value.getLineRight(line);
    }
    ...
    private final long m791relativeToInputTextMKHz9U(long $this$relativeToInputText_u2dMK_u2dHz9U) {
        Offset offset;
        long j;
        ...
        if (innerTextFieldCoordinates != null) {
            ...
            if (decorationBoxCoordinates != null) {
                if (innerTextFieldCoordinates.isAttached() && decorationBoxCoordinates.isAttached()) {
                    j = innerTextFieldCoordinates.mo4131localPositionOfR5De75A(decorationBoxCoordinates, $this$relativeToInputText_u2dMK_u2dHz9U);
                } else {
                    j = $this$relativeToInputText_u2dMK_u2dHz9U;
                }
                offset = Offset.m2357boximpl(j);
            } else {
                offset = null;
            }
            if (offset != null) {
                return offset.m2378unboximpl();
            }
        }
    ...
    */
    private final long m789coercedInVisibleBoundsOfInputTextMKHz9U(long r7) {
        /*
            r6 = this;
        ...
        L26:
            r0 = r3
            long r1 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m794access$coerceIn3MmeM6k(r7, r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m789coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}
