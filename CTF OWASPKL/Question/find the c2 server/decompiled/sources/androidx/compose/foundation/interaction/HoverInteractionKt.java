...
public final class HoverInteractionKt {
    public static final State<Boolean> collectIsHoveredAsState(InteractionSource $this$collectIsHoveredAsState, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv3 = (Function2) new HoverInteractionKt$collectIsHoveredAsState$1$1($this$collectIsHoveredAsState, isHovered, null);
        ...
        $composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect($this$collectIsHoveredAsState, (Function2) value$iv$iv2, $composer, ($changed & 14) | 64);
        if (ComposerKt.isTraceInProgress()) {
