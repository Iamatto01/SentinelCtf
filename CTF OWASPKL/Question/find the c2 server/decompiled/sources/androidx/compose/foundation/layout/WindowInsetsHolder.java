...
public final class WindowInsetsHolder {
    ...
    private WindowInsetsHolder(WindowInsetsCompat insets, View view) {
        ...
        this.captionBar = companion.systemInsets(insets, WindowInsetsCompat.Type.captionBar(), "captionBar");
        AndroidWindowInsets systemInsets = companion.systemInsets(insets, WindowInsetsCompat.Type.displayCutout(), "displayCutout");
        this.displayCutout = systemInsets;
        AndroidWindowInsets systemInsets2 = companion.systemInsets(insets, WindowInsetsCompat.Type.ime(), "ime");
        this.ime = systemInsets2;
        AndroidWindowInsets systemInsets3 = companion.systemInsets(insets, WindowInsetsCompat.Type.mandatorySystemGestures(), "mandatorySystemGestures");
        this.mandatorySystemGestures = systemInsets3;
        this.navigationBars = companion.systemInsets(insets, WindowInsetsCompat.Type.navigationBars(), "navigationBars");
        this.statusBars = companion.systemInsets(insets, WindowInsetsCompat.Type.statusBars(), "statusBars");
        AndroidWindowInsets systemInsets4 = companion.systemInsets(insets, WindowInsetsCompat.Type.systemBars(), "systemBars");
        this.systemBars = systemInsets4;
        AndroidWindowInsets systemInsets5 = companion.systemInsets(insets, WindowInsetsCompat.Type.systemGestures(), "systemGestures");
        this.systemGestures = systemInsets5;
        AndroidWindowInsets systemInsets6 = companion.systemInsets(insets, WindowInsetsCompat.Type.tappableElement(), "tappableElement");
        this.tappableElement = systemInsets6;
        Insets insets2 = (insets == null || (displayCutout = insets.getDisplayCutout()) == null || (insets2 = displayCutout.getWaterfallInsets()) == null) ? Insets.NONE : insets2;
        Intrinsics.checkNotNullExpressionValue(insets2, "insets?.displayCutout?.w…ts ?: AndroidXInsets.NONE");
        ValueInsets ValueInsets = WindowInsets_androidKt.ValueInsets(insets2, "waterfall");
        ...
        this.captionBarIgnoringVisibility = companion.valueInsetsIgnoringVisibility(insets, WindowInsetsCompat.Type.captionBar(), "captionBarIgnoringVisibility");
        this.navigationBarsIgnoringVisibility = companion.valueInsetsIgnoringVisibility(insets, WindowInsetsCompat.Type.navigationBars(), "navigationBarsIgnoringVisibility");
        this.statusBarsIgnoringVisibility = companion.valueInsetsIgnoringVisibility(insets, WindowInsetsCompat.Type.statusBars(), "statusBarsIgnoringVisibility");
        this.systemBarsIgnoringVisibility = companion.valueInsetsIgnoringVisibility(insets, WindowInsetsCompat.Type.systemBars(), "systemBarsIgnoringVisibility");
        this.tappableElementIgnoringVisibility = companion.valueInsetsIgnoringVisibility(insets, WindowInsetsCompat.Type.tappableElement(), "tappableElementIgnoringVisibility");
        this.imeAnimationTarget = companion.valueInsetsIgnoringVisibility(insets, WindowInsetsCompat.Type.ime(), "imeAnimationTarget");
        this.imeAnimationSource = companion.valueInsetsIgnoringVisibility(insets, WindowInsetsCompat.Type.ime(), "imeAnimationSource");
    ...
    public static final class Companion {
        ...
        private final WindowInsetsHolder getOrCreateFor(View view) {
            ...
            synchronized (WindowInsetsHolder.viewMap) {
                ...
                if (value$iv == null) {
                    windowInsetsHolder = new WindowInsetsHolder(null, view, null);
                    $this$getOrPut$iv.put(view, windowInsetsHolder);
                } else {
                    windowInsetsHolder = value$iv;
                }
                windowInsetsHolder2 = (WindowInsetsHolder) windowInsetsHolder;
            }
            return windowInsetsHolder2;
        }
