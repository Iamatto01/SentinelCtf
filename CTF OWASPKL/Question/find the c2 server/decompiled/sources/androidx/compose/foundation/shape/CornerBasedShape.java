...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline mo671createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection);
    ...
    public final Outline mo193createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        float topStart;
        float bottomStart;
        float topEnd;
        float bottomEnd;
        ...
        float topStart2 = this.topStart.mo679toPxTmRCtEA(size, density);
        float topEnd2 = this.topEnd.mo679toPxTmRCtEA(size, density);
        float bottomEnd2 = this.bottomEnd.mo679toPxTmRCtEA(size, density);
        float bottomStart2 = this.bottomStart.mo679toPxTmRCtEA(size, density);
        float minDimension = Size.m2436getMinDimensionimpl(size);
        ...
        if (topStart >= 0.0f && topEnd >= 0.0f && bottomEnd >= 0.0f && bottomStart >= 0.0f) {
            return mo671createOutlineLjSzlW0(size, topStart, topEnd, bottomEnd, bottomStart, layoutDirection);
        }
