...
public final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo309onPreScrollOzD1aCk(long available, int source) {
        return m477scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m2368getXimpl(available), Offset.m2369getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo308onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m477scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m2368getXimpl(available), Offset.m2369getYimpl(available)));
    }

    /* renamed from: scroll-8S9VItk  reason: not valid java name */
    private final long m477scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (!(scrollAmount == 0.0f)) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || animationController != null) {
                if (animationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo438consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo478onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        return m476flinghuYlsQE(available, this.sideCalculator.hideMotion(Velocity.m5347getXimpl(available), Velocity.m5348getYimpl(available)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo307onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return m476flinghuYlsQE(available, this.sideCalculator.showMotion(Velocity.m5347getXimpl(available), Velocity.m5348getYimpl(available)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m476flinghuYlsQE(long r25, float r27, boolean r28, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r29) {
        /*
            Method dump skipped, instructions count: 442
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m476flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
