...
final class AlignmentLineOffsetDp extends InspectorValueInfo implements LayoutModifier {
    ...
    private AlignmentLineOffsetDp(AlignmentLine alignmentLine, float before, float after, Function1<? super InspectorInfo, Unit> function1) {
        super(function1);
        this.alignmentLine = alignmentLine;
        this.before = before;
        this.after = after;
        if ((before >= 0.0f || Dp.m5127equalsimpl0(before, Dp.Companion.m5142getUnspecifiedD9Ej5fM())) && (after >= 0.0f || Dp.m5127equalsimpl0(after, Dp.Companion.m5142getUnspecifiedD9Ej5fM()))) {
            return;
        }
    ...
    public MeasureResult mo24measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        return AlignmentLineKt.m334access$alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, constraints);
    }

    public int hashCode() {
        int result = this.alignmentLine.hashCode();
        return (((result * 31) + Dp.m5128hashCodeimpl(this.before)) * 31) + Dp.m5128hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        AlignmentLineOffsetDp otherModifier = other instanceof AlignmentLineOffsetDp ? (AlignmentLineOffsetDp) other : null;
        if (otherModifier == null) {
            return false;
        }
        return Intrinsics.areEqual(this.alignmentLine, otherModifier.alignmentLine) && Dp.m5127equalsimpl0(this.before, otherModifier.before) && Dp.m5127equalsimpl0(this.after, otherModifier.after);
    }

    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) Dp.m5133toStringimpl(this.before)) + ", after=" + ((Object) Dp.m5133toStringimpl(this.after)) + ')';
    }
}
