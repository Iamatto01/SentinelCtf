...
public final class FocusInteractionKt {
    public static final State<Boolean> collectIsFocusedAsState(InteractionSource $this$collectIsFocusedAsState, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv3 = (Function2) new FocusInteractionKt$collectIsFocusedAsState$1$1($this$collectIsFocusedAsState, isFocused, null);
        ...
        $composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect($this$collectIsFocusedAsState, (Function2) value$iv$iv2, $composer, ($changed & 14) | 64);
        if (ComposerKt.isTraceInProgress()) {
