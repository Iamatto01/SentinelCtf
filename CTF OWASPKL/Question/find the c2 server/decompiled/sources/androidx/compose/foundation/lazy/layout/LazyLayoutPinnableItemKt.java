...
public final class LazyLayoutPinnableItemKt {
    public static final void LazyLayoutPinnableItem(final Object key, final int index, final LazyLayoutPinnedItemList pinnedItemList, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(LazyLayoutPinnableItem)P(2,1,3)48@1864L77,50@2039L7,51@2082L43,51@2051L74,52@2130L103:LazyLayoutPinnableItem.kt#wow0x6");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2079116560, $changed, -1, "androidx.compose.foundation.lazy.layout.LazyLayoutPinnableItem (LazyLayoutPinnableItem.kt:42)");
        }
        ...
        if (invalid$iv$iv2 || it$iv$iv2 == Composer.Companion.getEmpty()) {
            value$iv$iv2 = (Function1) new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutPinnableItemKt$LazyLayoutPinnableItem$1$1
        ...
        $composer2.endReplaceableGroup();
        EffectsKt.DisposableEffect(pinnableItem, (Function1) value$iv$iv2, $composer2, 0);
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{PinnableContainerKt.getLocalPinnableContainer().provides(pinnableItem)}, content, $composer2, (($changed >> 6) & 112) | 8);
        if (ComposerKt.isTraceInProgress()) {
