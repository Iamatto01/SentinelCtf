...
public final class AndroidConfig implements ScrollConfig {
    ...
    public long mo217calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long bounds) {
        Intrinsics.checkNotNullParameter(calculateMouseWheelScroll, "$this$calculateMouseWheelScroll");
        Intrinsics.checkNotNullParameter(event, "event");
        List $this$fastFold$iv = event.getChanges();
        Offset m2357boximpl = Offset.m2357boximpl(Offset.Companion.m2384getZeroF1C5BW0());
        int index$iv$iv = 0;
        ...
        while (index$iv$iv < size) {
            ...
            long acc = m2357boximpl.m2378unboximpl();
            m2357boximpl = Offset.m2357boximpl(Offset.m2373plusMKHz9U(acc, c.m4009getScrollDeltaF1C5BW0()));
            index$iv$iv++;
            $this$fastFold$iv = $this$fastFold$iv;
        }
        return Offset.m2375timestuRUvjQ(m2357boximpl.m2378unboximpl(), -calculateMouseWheelScroll.mo301toPx0680j_4(Dp.m5122constructorimpl(64)));
    }
}
