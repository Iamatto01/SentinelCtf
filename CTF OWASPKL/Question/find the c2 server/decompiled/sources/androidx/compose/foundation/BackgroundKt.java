...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m151backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m150backgroundbw27NRU(modifier, j, shape);
    }

    /* renamed from: background-bw27NRU  reason: not valid java name */
    public static final Modifier m150backgroundbw27NRU(Modifier background, final long color, final Shape shape) {
        Intrinsics.checkNotNullParameter(background, "$this$background");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return background.then(new Background(Color.m2596boximpl(color), null, 0.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Color.m2596boximpl(color));
                $this$null.getProperties().set("color", Color.m2596boximpl(color));
    ...
    public static final Modifier background(Modifier $this$background, final Brush brush, final Shape shape, final float alpha) {
        ...
        Intrinsics.checkNotNullParameter(shape, "shape");
        return $this$background.then(new Background(null, brush, alpha, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background$$inlined$debugInspectorInfo$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
