...
public final class LazyListItemPlacementAnimator$getAnimatedOffset$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        LazyListItemPlacementAnimator$getAnimatedOffset$1 lazyListItemPlacementAnimator$getAnimatedOffset$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (this.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                this.label = 1;
                if (this.$item.getAnimatedOffset().snapTo(IntOffset.m5231boximpl(this.$item.m537getTargetOffsetnOccac()), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                lazyListItemPlacementAnimator$getAnimatedOffset$1 = this;
                break;
            case 1:
                lazyListItemPlacementAnimator$getAnimatedOffset$1 = this;
                ResultKt.throwOnFailure($result);
        ...
        lazyListItemPlacementAnimator$getAnimatedOffset$1.$item.setInProgress(false);
