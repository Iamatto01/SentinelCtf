...
public final class ScrollableKt$scrollableNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo309onPreScrollOzD1aCk(long available, int source) {
        if (NestedScrollSource.m3901equalsimpl0(source, NestedScrollSource.Companion.m3907getFlingWNlRxjI())) {
    ...
    public long mo308onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.$enabled) {
            return this.$scrollLogic.getValue().m313performRawScrollMKHz9U(available);
        }
        return Offset.Companion.m2384getZeroF1C5BW0();
    }
    ...
    */
    public java.lang.Object mo307onPostFlingRZ2iAVY(long r4, long r6, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r8) {
        /*
            r3 = this;
        ...
        L37:
            ...
            r2 = 1
            r4.label = r2
            java.lang.Object r1 = r1.m311doFlingAnimationQWom1Mo(r6, r4)
            if (r1 != r8) goto L55
            return r8
        L55:
            r8 = r0
        L56:
            ...
            long r0 = r1.m5356unboximpl()
            long r6 = androidx.compose.ui.unit.Velocity.m5350minusAH228Gc(r6, r0)
            r0 = r8
            goto L68
        L62:
            androidx.compose.ui.unit.Velocity$Companion r6 = androidx.compose.ui.unit.Velocity.Companion
            long r6 = r6.m5358getZero9UxMQ8M()
        L68:
            androidx.compose.ui.unit.Velocity r6 = androidx.compose.ui.unit.Velocity.m5338boximpl(r6)
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.ScrollableKt$scrollableNestedScrollConnection$1.mo307onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
