...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo11measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long constraints) {
        ...
        int width = Constraints.m5076getHasFixedWidthimpl(constraints) ? Constraints.m5078getMaxWidthimpl(constraints) : 0;
        int height = Constraints.m5075getHasFixedHeightimpl(constraints) ? Constraints.m5077getMaxHeightimpl(constraints) : 0;
