...
final class ParentSizeModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public ParentSizeModifier(float fraction, Function1<? super InspectorInfo, Unit> inspectorInfo, State<Integer> state, State<Integer> state2) {
        super(inspectorInfo);
    ...
    public MeasureResult mo24measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int height = i;
        long childConstraints = ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m5080getMinWidthimpl(constraints), width != Integer.MAX_VALUE ? width : Constraints.m5078getMaxWidthimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5079getMinHeightimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m5077getMaxHeightimpl(constraints));
        final Placeable placeable = measurable.mo4125measureBRTryo0(childConstraints);
        return MeasureScope.layout$default(measure, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeModifier$measure$1
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof ParentSizeModifier) {
            if (Intrinsics.areEqual(this.widthState, ((ParentSizeModifier) other).widthState) && Intrinsics.areEqual(this.heightState, ((ParentSizeModifier) other).heightState)) {
