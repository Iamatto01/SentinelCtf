...
public final class LazyGridMeasuredItem {
    ...
    public final int m580getIndexVZbfaAc() {
        return this.index;
    }
    ...
    public final LazyGridPositionedItem position(int mainAxisOffset, int crossAxisOffset, int layoutWidth, int layoutHeight, int row, int column) {
        ...
        return new LazyGridPositionedItem(IntOffset, this.index, this.key, row, column, this.isVertical ? IntSizeKt.IntSize(this.crossAxisSize, this.mainAxisSize) : IntSizeKt.IntSize(this.mainAxisSize, this.crossAxisSize), -this.beforeContentPadding, mainAxisLayoutSize + this.afterContentPadding, this.isVertical, this.placeables, this.placementAnimator, this.visualOffset, mainAxisLayoutSize, this.reverseLayout, null);
    }
}
