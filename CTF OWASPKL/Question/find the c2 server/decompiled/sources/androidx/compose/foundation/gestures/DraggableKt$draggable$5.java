...
public final class DraggableKt$draggable$5 extends SuspendLambda implements Function3<CoroutineScope, Velocity, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(CoroutineScope coroutineScope, Velocity velocity, Continuation<? super Unit> continuation) {
        return m267invokeLuvzFrg(coroutineScope, velocity.m5356unboximpl(), continuation);
    }

    /* renamed from: invoke-LuvzFrg  reason: not valid java name */
    public final Object m267invokeLuvzFrg(CoroutineScope coroutineScope, long j, Continuation<? super Unit> continuation) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                m264toFloatsFctU = DraggableKt.m264toFloatsFctU(velocity, this.$orientation);
                Float boxFloat = Boxing.boxFloat(m264toFloatsFctU);
                this.label = 1;
                if (function3.invoke($this$draggable, boxFloat, this) != coroutine_suspended) {
                    break;
                } else {
