...
public final class ContentInViewModifier implements BringIntoViewResponder, OnRemeasuredModifier, OnPlacedModifier {
    ...
    public ContentInViewModifier(CoroutineScope scope, Orientation orientation, ScrollableState scrollState, boolean reverseDirection) {
        ...
        this.viewportSize = IntSize.Companion.m5287getZeroYbymL2g();
    ...
    public Rect calculateRectForParent(Rect localRect) {
        ...
        if (!(!IntSize.m5280equalsimpl0(this.viewportSize, IntSize.Companion.m5287getZeroYbymL2g()))) {
            throw new IllegalStateException("Expected BringIntoViewRequester to not be used before parents are placed.".toString());
        }
        return m220computeDestinationO0kMr_c(localRect, this.viewportSize);
    }
    ...
    public Object bringChildIntoView(Function0<Rect> function0, Continuation<? super Unit> continuation) {
        ...
        boolean z = false;
        if (invoke != null && !m222isMaxVisibleO0kMr_c$default(this, invoke, 0L, 1, null)) {
            z = true;
        }
        if (z) {
    ...
    public void mo224onRemeasuredozmzZPI(long size) {
        ...
        if (m218compareToTemP2vQ(size, oldSize) < 0 && (focusedChild = getFocusedChildBounds()) != null) {
            ...
            if (!this.isAnimationRunning && !this.trackingFocusedChild && m221isMaxVisibleO0kMr_c(previousFocusedChildBounds, oldSize) && !m221isMaxVisibleO0kMr_c(focusedChild, size)) {
    ...
    public final float calculateScrollDelta() {
        ...
        long size = IntSizeKt.m5292toSizeozmzZPI(this.viewportSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return relocationDistance(rectangleToMakeVisible.getTop(), rectangleToMakeVisible.getBottom(), Size.m2434getHeightimpl(size));
            case 2:
                return relocationDistance(rectangleToMakeVisible.getLeft(), rectangleToMakeVisible.getRight(), Size.m2437getWidthimpl(size));
            default:
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                if (bounds != null) {
                    ...
                    if (m219compareToiLBOSCw(bounds.m2401getSizeNHjbRc(), IntSizeKt.m5292toSizeozmzZPI(this.viewportSize)) <= 0) {
                        rect = bounds;
                    } else {
                        return rect;
                    }
    ...
    private final Rect m220computeDestinationO0kMr_c(Rect childBounds, long containerSize) {
        return childBounds.m2405translatek4lQ0M(Offset.m2377unaryMinusF1C5BW0(m223relocationOffsetBMxPBkI(childBounds, containerSize)));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: isMaxVisible-O0kMr_c$default  reason: not valid java name */
    public static /* synthetic */ boolean m222isMaxVisibleO0kMr_c$default(ContentInViewModifier contentInViewModifier, Rect rect, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = contentInViewModifier.viewportSize;
        }
        return contentInViewModifier.m221isMaxVisibleO0kMr_c(rect, j);
    }

    /* renamed from: isMaxVisible-O0kMr_c  reason: not valid java name */
    private final boolean m221isMaxVisibleO0kMr_c(Rect $this$isMaxVisible_u2dO0kMr_c, long size) {
        return Offset.m2365equalsimpl0(m223relocationOffsetBMxPBkI($this$isMaxVisible_u2dO0kMr_c, size), Offset.Companion.m2384getZeroF1C5BW0());
    }

    /* renamed from: relocationOffset-BMxPBkI  reason: not valid java name */
    private final long m223relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long size = IntSizeKt.m5292toSizeozmzZPI(containerSize);
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return OffsetKt.Offset(0.0f, relocationDistance(childBounds.getTop(), childBounds.getBottom(), Size.m2434getHeightimpl(size)));
            case 2:
                return OffsetKt.Offset(relocationDistance(childBounds.getLeft(), childBounds.getRight(), Size.m2437getWidthimpl(size)), 0.0f);
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    private final int m218compareToTemP2vQ(long $this$compareTo_u2dTemP2vQ, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Intrinsics.compare(IntSize.m5281getHeightimpl($this$compareTo_u2dTemP2vQ), IntSize.m5281getHeightimpl(other));
            case 2:
                return Intrinsics.compare(IntSize.m5282getWidthimpl($this$compareTo_u2dTemP2vQ), IntSize.m5282getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
    ...
    private final int m219compareToiLBOSCw(long $this$compareTo_u2diLBOSCw, long other) {
        switch (WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()]) {
            case 1:
                return Float.compare(Size.m2434getHeightimpl($this$compareTo_u2diLBOSCw), Size.m2434getHeightimpl(other));
            case 2:
                return Float.compare(Size.m2437getWidthimpl($this$compareTo_u2diLBOSCw), Size.m2437getWidthimpl(other));
            default:
                throw new NoWhenBranchMatchedException();
        }
    }
