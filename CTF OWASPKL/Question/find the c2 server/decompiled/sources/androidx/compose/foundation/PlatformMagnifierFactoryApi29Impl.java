...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl create(MagnifierStyle style, View view, Density density, float initialZoom) {
        ...
        if (!Intrinsics.areEqual(style, MagnifierStyle.Companion.getTextDefault())) {
            long size = density.mo302toSizeXkaWNTQ(style.m200getSizeMYxV2XQ$foundation_release());
            float cornerRadius = density.mo301toPx0680j_4(style.m198getCornerRadiusD9Ej5fM$foundation_release());
            float elevation = density.mo301toPx0680j_4(style.m199getElevationD9Ej5fM$foundation_release());
            Magnifier.Builder $this$create_u24lambda_u241_u24lambda_u240 = new Magnifier.Builder(view);
            if (size != Size.Companion.m2445getUnspecifiedNHjbRc()) {
                $this$create_u24lambda_u241_u24lambda_u240.setSize(MathKt.roundToInt(Size.m2437getWidthimpl(size)), MathKt.roundToInt(Size.m2434getHeightimpl(size)));
            }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo216updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            if (!Float.isNaN(zoom)) {
                getMagnifier().setZoom(zoom);
            }
            if (OffsetKt.m2387isSpecifiedk4lQ0M(magnifierCenter)) {
                getMagnifier().show(Offset.m2368getXimpl(sourceCenter), Offset.m2369getYimpl(sourceCenter), Offset.m2368getXimpl(magnifierCenter), Offset.m2369getYimpl(magnifierCenter));
            } else {
                getMagnifier().show(Offset.m2368getXimpl(sourceCenter), Offset.m2369getYimpl(sourceCenter));
            }
        }
    }
}
