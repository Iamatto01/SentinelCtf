        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = (Function2) new Function2<Density, Constraints, List<Integer>>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridDslKt$rememberColumnWidthSums$1$1
                ...
                public /* bridge */ /* synthetic */ List<Integer> invoke(Density density, Constraints constraints) {
                    return m567invoke0kLqBqw(density, constraints.m5084unboximpl());
                }

                /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                public final List<Integer> m567invoke0kLqBqw(Density $this$null, long constraints) {
                    ...
                    GridCells $this$invoke_0kLqBqw_u24lambda_u242 = columns;
                    List $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241 = CollectionsKt.toMutableList((Collection) $this$invoke_0kLqBqw_u24lambda_u242.calculateCrossAxisCellSizes($this$null, gridWidth, $this$null.mo295roundToPx0680j_4(horizontalArrangement.mo364getSpacingD9Ej5fM())));
                    int size = $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241.size();
                    for (int i2 = 1; i2 < size; i2++) {
                        $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241.set(i2, Integer.valueOf($this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241.get(i2).intValue() + $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241.get(i2 - 1).intValue()));
                    }
                    return $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241;
                }
            };
    ...
    private static final Function2<Density, Constraints, List<Integer>> rememberRowHeightSums(final GridCells rows, final Arrangement.Vertical verticalArrangement, final PaddingValues contentPadding, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = (Function2) new Function2<Density, Constraints, List<Integer>>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridDslKt$rememberRowHeightSums$1$1
                ...
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ List<Integer> invoke(Density density, Constraints constraints) {
                    return m568invoke0kLqBqw(density, constraints.m5084unboximpl());
                }

                /* renamed from: invoke-0kLqBqw  reason: not valid java name */
                public final List<Integer> m568invoke0kLqBqw(Density $this$null, long constraints) {
                    Intrinsics.checkNotNullParameter($this$null, "$this$null");
                    ...
                    GridCells $this$invoke_0kLqBqw_u24lambda_u242 = rows;
                    List $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241 = CollectionsKt.toMutableList((Collection) $this$invoke_0kLqBqw_u24lambda_u242.calculateCrossAxisCellSizes($this$null, gridHeight, $this$null.mo295roundToPx0680j_4(verticalArrangement.mo364getSpacingD9Ej5fM())));
                    int size = $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241.size();
                    for (int i2 = 1; i2 < size; i2++) {
                        $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241.set(i2, Integer.valueOf($this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241.get(i2).intValue() + $this$invoke_0kLqBqw_u24lambda_u242_u24lambda_u241.get(i2 - 1).intValue()));
                    }
