...
public final class LazyListState implements ScrollableState {
    ...
    public LazyListState(int firstVisibleItemIndex, int firstVisibleItemScrollOffset) {
        ...
        mutableStateOf$default5 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Constraints.m5066boximpl(ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null)), null, 2, null);
    ...
    public final int getFirstVisibleItemIndex() {
        return this.scrollPosition.m530getIndexjQJCoq8();
    }
    ...
    public final LazyListItemPlacementAnimator getPlacementAnimator$foundation_release() {
        State $this$getValue$iv = this.placementAnimator$delegate;
    ...
    public final void setPlacementAnimator$foundation_release(LazyListItemPlacementAnimator lazyListItemPlacementAnimator) {
        MutableState $this$setValue$iv = this.placementAnimator$delegate;
        $this$setValue$iv.setValue(lazyListItemPlacementAnimator);
    }

    /* renamed from: getPremeasureConstraints-msEJaDk$foundation_release */
    public final long m533getPremeasureConstraintsmsEJaDk$foundation_release() {
        State $this$getValue$iv = this.premeasureConstraints$delegate;
        return ((Constraints) $this$getValue$iv.getValue()).m5084unboximpl();
    }

    /* renamed from: setPremeasureConstraints-BRTryo0$foundation_release */
    public final void m534setPremeasureConstraintsBRTryo0$foundation_release(long j) {
        MutableState $this$setValue$iv = this.premeasureConstraints$delegate;
        $this$setValue$iv.setValue(Constraints.m5066boximpl(j));
    }
    ...
    public final void snapToItemIndexInternal$foundation_release(int index, int scrollOffset) {
        this.scrollPosition.m531requestPositionAhXoVpI(DataIndex.m503constructorimpl(index), scrollOffset);
    ...
    */
    ...
    private final void notifyPrefetch(float delta) {
        ...
        if (!info.getVisibleItemsInfo().isEmpty()) {
            ...
            if (scrollingForward) {
                indexToPrefetch = ((LazyListItemInfo) CollectionsKt.last((List<? extends Object>) info.getVisibleItemsInfo())).getIndex() + 1;
            } else {
                indexToPrefetch = ((LazyListItemInfo) CollectionsKt.first((List<? extends Object>) info.getVisibleItemsInfo())).getIndex() - 1;
            }
            if (indexToPrefetch != this.indexToPrefetch) {
                ...
                if (z) {
                    ...
                    this.currentPrefetchHandle = this.prefetchState.m618schedulePrefetch0kLqBqw(indexToPrefetch, m533getPremeasureConstraintsmsEJaDk$foundation_release());
                }
            }
        }
    }
    ...
    private final void cancelPrefetchIfVisibleItemsChanged(LazyListLayoutInfo info) {
        ...
        if (this.indexToPrefetch != -1 && (!info.getVisibleItemsInfo().isEmpty())) {
            if (this.wasScrollingForward) {
                expectedPrefetchIndex = ((LazyListItemInfo) CollectionsKt.last((List<? extends Object>) info.getVisibleItemsInfo())).getIndex() + 1;
            } else {
                expectedPrefetchIndex = ((LazyListItemInfo) CollectionsKt.first((List<? extends Object>) info.getVisibleItemsInfo())).getIndex() - 1;
            }
