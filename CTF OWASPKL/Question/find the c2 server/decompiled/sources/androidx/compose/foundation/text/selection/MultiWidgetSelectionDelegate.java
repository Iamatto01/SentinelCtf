...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    private final synchronized int getLastVisibleOffset(TextLayoutResult $this$lastVisibleOffset) {
        ...
        if (this._previousTextLayoutResult != $this$lastVisibleOffset) {
            if ($this$lastVisibleOffset.getDidOverflowHeight() && !$this$lastVisibleOffset.getMultiParagraph().getDidExceedMaxLines()) {
                finalVisibleLine = RangesKt.coerceAtMost($this$lastVisibleOffset.getLineForVerticalPosition(IntSize.m5281getHeightimpl($this$lastVisibleOffset.m4610getSizeYbymL2g())), $this$lastVisibleOffset.getLineCount() - 1);
                while ($this$lastVisibleOffset.getLineTop(finalVisibleLine) >= IntSize.m5281getHeightimpl($this$lastVisibleOffset.m4610getSizeYbymL2g())) {
                    finalVisibleLine--;
                }
    ...
    public Pair<Selection, Boolean> mo808updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection) {
        ...
        if (layoutCoordinates != null && (textLayoutResult = this.layoutResultCallback.invoke()) != null) {
            long relativePosition = containerLayoutCoordinates.mo4131localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m2384getZeroF1C5BW0());
            long localStartPosition = Offset.m2372minusMKHz9U(startHandlePosition, relativePosition);
            long localEndPosition = Offset.m2372minusMKHz9U(endHandlePosition, relativePosition);
            if (previousHandlePosition != null) {
                long it = previousHandlePosition.m2378unboximpl();
                offset = Offset.m2357boximpl(Offset.m2372minusMKHz9U(it, relativePosition));
            }
            Offset localPreviousHandlePosition = offset;
            return MultiWidgetSelectionDelegateKt.m812getTextSelectionInfoyM0VcXU(textLayoutResult, localStartPosition, localEndPosition, localPreviousHandlePosition, getSelectableId(), adjustment, previousSelection, isStartHandle);
        }
    ...
    public Selection getSelectAllSelection() {
        ...
        return MultiWidgetSelectionDelegateKt.m809access$getAssembledSelectionInfovJH6DeI(newSelectionRange, false, getSelectableId(), textLayoutResult);
    }

    @Override // androidx.compose.foundation.text.selection.Selectable
    /* renamed from: getHandlePosition-dBAh8RU  reason: not valid java name */
    public long mo806getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle) {
        TextLayoutResult textLayoutResult;
    ...
    public long mo807getRangeOfLineContainingjx7JFs(int offset) {
