...
public final class ScrollKt {
    public static final ScrollState rememberScrollState(final int initial, Composer $composer, int $changed, int i) {
        ...
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = (Function0) new Function0<ScrollState>() { // from class: androidx.compose.foundation.ScrollKt$rememberScrollState$1$1
        ...
        ScrollState scrollState = (ScrollState) RememberSaveableKt.m2260rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) value$iv$iv, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final Modifier scroll(Modifier $this$scroll, final ScrollState state, final boolean reverseScrolling, final FlingBehavior flingBehavior, final boolean isScrollable, final boolean isVertical) {
        return ComposedModifierKt.composed($this$scroll, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ScrollKt$scroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1478351300, $changed, -1, "androidx.compose.foundation.scroll.<anonymous> (Scroll.kt:264)");
                }
                ...
                Modifier semantics = SemanticsModifierKt.semantics$default(Modifier.Companion, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semantics2) {
                        ...
                        ScrollAxisRange accessibilityScrollState = new ScrollAxisRange(new Function0<Float>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1$accessibilityScrollState$1
                            /* JADX INFO: Access modifiers changed from: package-private */
                            {
                                super(0);
                            }
                        ...
                        if (z3) {
                            ...
                            SemanticsPropertiesKt.scrollBy$default(semantics2, null, new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1.1
                                ...
                                public final Boolean invoke(float x, float y) {
                                    BuildersKt__Builders_commonKt.launch$default(CoroutineScope.this, null, null, new C00041(z4, scrollState4, y, x, null), 3, null);
                                    return true;
                                }
                ...
                Modifier scrolling = ScrollableKt.scrollable(companion, state, orientation, overscrollEffect, isScrollable, scrollableDefaults.reverseDirection((LayoutDirection) consume, orientation, reverseScrolling), flingBehavior, state.getInternalInteractionSource$foundation_release());
                ScrollingLayoutModifier layout = new ScrollingLayoutModifier(state, reverseScrolling, isVertical);
