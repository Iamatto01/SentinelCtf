...
public final class SelectionManager {
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2357boximpl(Offset.Companion.m2384getZeroF1C5BW0()), null, 2, null);
        this.dragBeginPosition$delegate = mutableStateOf$default3;
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2357boximpl(Offset.Companion.m2384getZeroF1C5BW0()), null, 2, null);
        ...
        selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m853invoked4ec7I(layoutCoordinates, offset.m2378unboximpl(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-d-4ec7I  reason: not valid java name */
            public final void m853invoked4ec7I(LayoutCoordinates layoutCoordinates, long position, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset positionInContainer = SelectionManager.this.m838convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, position);
                if (positionInContainer != null) {
                    SelectionManager.this.m844startSelection9KIMszo(positionInContainer.m2378unboximpl(), false, selectionMode);
        ...
        selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool, SelectionAdjustment selectionAdjustment) {
                return m854invoke5iVPX68(layoutCoordinates, offset.m2378unboximpl(), offset2.m2378unboximpl(), bool.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-5iVPX68  reason: not valid java name */
            public final Boolean m854invoke5iVPX68(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset newPositionInContainer = SelectionManager.this.m838convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, newPosition);
                Offset previousPositionInContainer = SelectionManager.this.m838convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, previousPosition);
                return Boolean.valueOf(SelectionManager.this.m852updateSelectionRHHTvR4$foundation_release(newPositionInContainer, previousPositionInContainer, isStartHandle, selectionMode));
            }
        });
        selectionRegistrar.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m839setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrar.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long selectableKey) {
                ...
                if (!((selection == null || (start = selection.getStart()) == null || selectableKey != start.getSelectableId()) ? false : true)) {
                    Selection selection2 = SelectionManager.this.getSelection();
                    if (selection2 == null || (end = selection2.getEnd()) == null || selectableKey != end.getSelectableId()) {
                        z = false;
                    }
                    if (!z) {
                        return;
                ...
                SelectionManager.this.m843setStartHandlePosition_kEHs6E(null);
                SelectionManager.this.m842setEndHandlePosition_kEHs6E(null);
            }
        });
    }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.Companion, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m855invokeZmokQxo(keyEvent.m3863unboximpl());
            }

            /* renamed from: invoke-ZmokQxo  reason: not valid java name */
            public final Boolean m855invokeZmokQxo(android.view.KeyEvent it) {
                boolean z;
                Intrinsics.checkNotNullParameter(it, "it");
                if (SelectionManager_androidKt.m859isCopyKeyEventZmokQxo(it)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates value) {
        ...
        if (getHasFocus() && getSelection() != null) {
            Offset positionInWindow = value != null ? Offset.m2357boximpl(LayoutCoordinatesKt.positionInWindow(value)) : null;
    ...
    public final void m840setDragBeginPositionk4lQ0M(long j) {
        MutableState $this$setValue$iv = this.dragBeginPosition$delegate;
        $this$setValue$iv.setValue(Offset.m2357boximpl(j));
    }

    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release  reason: not valid java name */
    public final long m847getDragBeginPositionF1C5BW0$foundation_release() {
        State $this$getValue$iv = this.dragBeginPosition$delegate;
        return ((Offset) $this$getValue$iv.getValue()).m2378unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setDragTotalDistance-k-4lQ0M  reason: not valid java name */
    public final void m841setDragTotalDistancek4lQ0M(long j) {
        MutableState $this$setValue$iv = this.dragTotalDistance$delegate;
        $this$setValue$iv.setValue(Offset.m2357boximpl(j));
    }

    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release  reason: not valid java name */
    public final long m848getDragTotalDistanceF1C5BW0$foundation_release() {
    ...
    public final void m843setStartHandlePosition_kEHs6E(Offset offset) {
        MutableState $this$setValue$iv = this.startHandlePosition$delegate;
        $this$setValue$iv.setValue(offset);
    }

    /* renamed from: getStartHandlePosition-_m7T9-E  reason: not valid java name */
    public final Offset m850getStartHandlePosition_m7T9E() {
    ...
    public final void m842setEndHandlePosition_kEHs6E(Offset offset) {
        MutableState $this$setValue$iv = this.endHandlePosition$delegate;
        $this$setValue$iv.setValue(offset);
    }

    /* renamed from: getEndHandlePosition-_m7T9-E  reason: not valid java name */
    public final Offset m849getEndHandlePosition_m7T9E() {
    ...
    public final void m839setCurrentDragPosition_kEHs6E(Offset offset) {
        MutableState $this$setValue$iv = this.currentDragPosition$delegate;
        $this$setValue$iv.setValue(offset);
    }

    /* renamed from: getCurrentDragPosition-_m7T9-E  reason: not valid java name */
    public final Offset m846getCurrentDragPosition_m7T9E() {
    ...
    */
    public final void updateHandleOffsets() {
        ...
        L49:
            r8 = 1
            long r9 = r4.mo806getHandlePositiondBAh8RU(r1, r8)
            long r9 = r2.mo4131localPositionOfR5De75A(r6, r9)
            r11 = 0
            long r12 = r5.mo806getHandlePositiondBAh8RU(r1, r11)
            long r12 = r2.mo4131localPositionOfR5De75A(r7, r12)
            androidx.compose.ui.geometry.Rect r14 = androidx.compose.foundation.text.selection.SelectionManagerKt.visibleBounds(r2)
            androidx.compose.ui.geometry.Offset r15 = androidx.compose.ui.geometry.Offset.m2357boximpl(r9)
            long r16 = r15.m2378unboximpl()
            r18 = 0
            boolean r19 = androidx.compose.foundation.text.selection.SelectionManagerKt.m858containsInclusiveUv8p0NA(r14, r9)
            if (r19 != 0) goto L84
        ...
        L89:
            r15 = 0
        L8a:
            r0.m843setStartHandlePosition_kEHs6E(r15)
            androidx.compose.ui.geometry.Offset r8 = androidx.compose.ui.geometry.Offset.m2357boximpl(r12)
            long r15 = r8.m2378unboximpl()
            r11 = 0
            boolean r17 = androidx.compose.foundation.text.selection.SelectionManagerKt.m858containsInclusiveUv8p0NA(r14, r12)
            if (r17 != 0) goto Laa
        ...
        Lb3:
            r3 = 0
        Lb4:
            r0.m842setEndHandlePosition_kEHs6E(r3)
            return
        Lb8:
            r18 = r1
            goto Lc3
        ...
        Lc3:
            r1 = 0
            r0.m843setStartHandlePosition_kEHs6E(r1)
            r0.m842setEndHandlePosition_kEHs6E(r1)
            return
        */
        ...
        if (startSelectable != null && (startLayoutCoordinates = startSelectable.getLayoutCoordinates()) != null) {
            if (endSelectable != null && (endLayoutCoordinates = endSelectable.getLayoutCoordinates()) != null) {
                ...
                if (localLayoutCoordinates != null && localLayoutCoordinates.isAttached()) {
                    long startOffset = localLayoutCoordinates.mo4131localPositionOfR5De75A(startLayoutCoordinates, startSelectable.mo806getHandlePositiondBAh8RU(selection, true));
                    long endOffset = localLayoutCoordinates.mo4131localPositionOfR5De75A(endLayoutCoordinates, endSelectable.mo806getHandlePositiondBAh8RU(selection, false));
                    long startOffset2 = localLayoutCoordinates.mo4132localToRootMKHz9U(startOffset);
                    long endOffset2 = localLayoutCoordinates.mo4132localToRootMKHz9U(endOffset);
                    float left = Math.min(Offset.m2368getXimpl(startOffset2), Offset.m2368getXimpl(endOffset2));
                    float right = Math.max(Offset.m2368getXimpl(startOffset2), Offset.m2368getXimpl(endOffset2));
                    long startTop = localLayoutCoordinates.mo4131localPositionOfR5De75A(startLayoutCoordinates, OffsetKt.Offset(0.0f, startSelectable.getBoundingBox(selection.getStart().getOffset()).getTop()));
                    long endTop = localLayoutCoordinates.mo4131localPositionOfR5De75A(endLayoutCoordinates, OffsetKt.Offset(0.0f, endSelectable.getBoundingBox(selection.getEnd().getOffset()).getTop()));
                    float top = Math.min(Offset.m2369getYimpl(localLayoutCoordinates.mo4132localToRootMKHz9U(startTop)), Offset.m2369getYimpl(localLayoutCoordinates.mo4132localToRootMKHz9U(endTop)));
                    float bottom = Math.max(Offset.m2369getYimpl(startOffset2), Offset.m2369getYimpl(endOffset2)) + ((float) (SelectionHandlesKt.getHandleHeight() * 4.0d));
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager$handleDragObserver$1
            ...
            public void mo754onDownk4lQ0M(long point) {
                ...
                long beginCoordinates = SelectionHandlesKt.m825getAdjustedCoordinatesk4lQ0M(selectable.mo806getHandlePositiondBAh8RU(selection, isStartHandle));
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m839setCurrentDragPosition_kEHs6E(Offset.m2357boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo4131localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates)));
            ...
            public void mo756onStartk4lQ0M(long startPoint) {
                ...
                long mo806getHandlePositiondBAh8RU;
                SelectionManager.this.hideSelectionToolbar$foundation_release();
                Selection selection = SelectionManager.this.getSelection();
                ...
                if (isStartHandle) {
                    ...
                    mo806getHandlePositiondBAh8RU = startSelectable.mo806getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(endSelectable);
                    mo806getHandlePositiondBAh8RU = endSelectable.mo806getHandlePositiondBAh8RU(selection, false);
                }
                long beginCoordinates = SelectionHandlesKt.m825getAdjustedCoordinatesk4lQ0M(mo806getHandlePositiondBAh8RU);
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m840setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo4131localPositionOfR5De75A(beginLayoutCoordinates, beginCoordinates));
                SelectionManager.this.m841setDragTotalDistancek4lQ0M(Offset.Companion.m2384getZeroF1C5BW0());
            }
            ...
            public void mo755onDragk4lQ0M(long delta) {
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m841setDragTotalDistancek4lQ0M(Offset.m2373plusMKHz9U(selectionManager.m848getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long endPosition = Offset.m2373plusMKHz9U(SelectionManager.this.m847getDragBeginPositionF1C5BW0$foundation_release(), SelectionManager.this.m848getDragTotalDistanceF1C5BW0$foundation_release());
                boolean consumed = SelectionManager.this.m852updateSelectionRHHTvR4$foundation_release(Offset.m2357boximpl(endPosition), Offset.m2357boximpl(SelectionManager.this.m847getDragBeginPositionF1C5BW0$foundation_release()), isStartHandle, SelectionAdjustment.Companion.getCharacterWithWordAccelerate());
                if (consumed) {
                    SelectionManager.this.m840setDragBeginPositionk4lQ0M(endPosition);
                    SelectionManager.this.m841setDragTotalDistancek4lQ0M(Offset.Companion.m2384getZeroF1C5BW0());
                }
            }
    ...
    public final Offset m838convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates coordinates = this.containerLayoutCoordinates;
        if (coordinates == null || !coordinates.isAttached()) {
            return null;
        }
        return Offset.m2357boximpl(requireContainerCoordinates$foundation_release().mo4131localPositionOfR5De75A(layoutCoordinates, offset));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo  reason: not valid java name */
    public final void m844startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        m851updateSelection3R_tFg$foundation_release(position, position, null, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-RHHTvR4$foundation_release  reason: not valid java name */
    public final boolean m852updateSelectionRHHTvR4$foundation_release(Offset newPosition, Offset previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Selection selection;
        long otherSelectableId;
        Offset m838convertToContainerCoordinatesQ7Q5hAU;
        ...
        if (newPosition != null && (selection = getSelection()) != null) {
            ...
            if (otherSelectable == null) {
                m838convertToContainerCoordinatesQ7Q5hAU = null;
            } else {
                LayoutCoordinates layoutCoordinates = otherSelectable.getLayoutCoordinates();
                Intrinsics.checkNotNull(layoutCoordinates);
                m838convertToContainerCoordinatesQ7Q5hAU = m838convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m825getAdjustedCoordinatesk4lQ0M(otherSelectable.mo806getHandlePositiondBAh8RU(selection, !isStartHandle)));
            }
            if (m838convertToContainerCoordinatesQ7Q5hAU != null) {
                long otherHandlePosition = m838convertToContainerCoordinatesQ7Q5hAU.m2378unboximpl();
                long startHandlePosition = isStartHandle ? newPosition.m2378unboximpl() : otherHandlePosition;
                long endHandlePosition = isStartHandle ? otherHandlePosition : newPosition.m2378unboximpl();
                return m851updateSelection3R_tFg$foundation_release(startHandlePosition, endHandlePosition, previousPosition, isStartHandle, adjustment);
            }
        }
        return false;
    }
    ...
    public final boolean m851updateSelection3R_tFg$foundation_release(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m839setCurrentDragPosition_kEHs6E(isStartHandle ? Offset.m2357boximpl(startHandlePosition) : Offset.m2357boximpl(endHandlePosition));
        ...
        while (index$iv$iv < size) {
            ...
            Pair<Selection, Boolean> mo808updateSelectionqCDeeow = selectable.mo808updateSelectionqCDeeow(startHandlePosition, endHandlePosition, previousHandlePosition, isStartHandle, requireContainerCoordinates$foundation_release(), adjustment, previousSubselection);
            Selection selection2 = mo808updateSelectionqCDeeow.component1();
            boolean consumed = mo808updateSelectionqCDeeow.component2().booleanValue();
    ...
    public final void m845contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        boolean isEmptySelection = selection != null ? TextRange.m4631getCollapsedimpl(selection.m815toTextRanged9O1mEE()) : true;
        if (isEmptySelection) {
            m844startSelection9KIMszo(position, true, SelectionAdjustment.Companion.getWord());
        }
    }
}
