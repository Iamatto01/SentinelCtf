...
public final class OrientationIndependentConstraints {
    ...
    private OrientationIndependentConstraints(long c, LayoutOrientation orientation) {
        this(orientation == LayoutOrientation.Horizontal ? Constraints.m5080getMinWidthimpl(c) : Constraints.m5079getMinHeightimpl(c), orientation == LayoutOrientation.Horizontal ? Constraints.m5078getMaxWidthimpl(c) : Constraints.m5077getMaxHeightimpl(c), orientation == LayoutOrientation.Horizontal ? Constraints.m5079getMinHeightimpl(c) : Constraints.m5080getMinWidthimpl(c), orientation == LayoutOrientation.Horizontal ? Constraints.m5077getMaxHeightimpl(c) : Constraints.m5078getMaxWidthimpl(c));
    }
    ...
    public final long m406toBoxConstraintsOenEA2s(LayoutOrientation orientation) {
