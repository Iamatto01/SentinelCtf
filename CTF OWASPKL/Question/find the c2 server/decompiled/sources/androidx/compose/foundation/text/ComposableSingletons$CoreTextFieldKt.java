...
public final class ComposableSingletons$CoreTextFieldKt {
    ...
    public static Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> f5lambda1 = ComposableLambdaKt.composableLambdaInstance(671295101, false, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.ComposableSingletons$CoreTextFieldKt$lambda-1$1
        ...
        public final void invoke(Function2<? super Composer, ? super Integer, Unit> innerTextField, Composer $composer, int $changed) {
            ...
            ComposerKt.sourceInformation($composer, "C197@11060L16:CoreTextField.kt#423gt5");
            int $dirty = $changed;
            if (($changed & 14) == 0) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(671295101, $dirty, -1, "androidx.compose.foundation.text.ComposableSingletons$CoreTextFieldKt.lambda-1.<anonymous> (CoreTextField.kt:197)");
            }
    ...
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m707getLambda1$foundation_release() {
        return f5lambda1;
    }
}
