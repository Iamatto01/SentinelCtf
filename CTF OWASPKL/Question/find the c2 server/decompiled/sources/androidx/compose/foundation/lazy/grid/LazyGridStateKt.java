...
public final class LazyGridStateKt {
    public static final LazyGridState rememberLazyGridState(int initialFirstVisibleItemIndex, int initialFirstVisibleItemScrollOffset, Composer $composer, int $changed, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(29186956, $changed, -1, "androidx.compose.foundation.lazy.grid.rememberLazyGridState (LazyGridState.kt:57)");
        }
        ...
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m2260rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) key1$iv2, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
