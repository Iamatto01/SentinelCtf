...
public final class LazySaveableStateHolderKt {
    public static final void LazySaveableStateHolderProvider(final Function3<? super SaveableStateHolder, ? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 11) != 2 || !$composer2.getSkipping()) {
            ...
            final LazySaveableStateHolder holder = (LazySaveableStateHolder) RememberSaveableKt.m2260rememberSaveable(new Object[]{currentRegistry}, (Saver<Object, ? extends Object>) LazySaveableStateHolder.Companion.saver(currentRegistry), (String) null, (Function0<? extends Object>) new Function0<LazySaveableStateHolder>() { // from class: androidx.compose.foundation.lazy.layout.LazySaveableStateHolderKt$LazySaveableStateHolderProvider$holder$1
