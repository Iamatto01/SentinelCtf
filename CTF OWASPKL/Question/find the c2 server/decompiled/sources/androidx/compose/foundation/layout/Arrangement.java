...
public final class Arrangement {
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m5122constructorimpl(0);

        @Override // androidx.compose.foundation.layout.Arrangement.HorizontalOrVertical, androidx.compose.foundation.layout.Arrangement.Horizontal, androidx.compose.foundation.layout.Arrangement.Vertical
        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        public float mo364getSpacingD9Ej5fM() {
            return this.spacing;
        }
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m366getSpacingD9Ej5fM(Horizontal $this) {
                return Horizontal.super.mo364getSpacingD9Ej5fM();
            }
        }

        /* renamed from: getSpacing-D9Ej5fM */
        default float mo364getSpacingD9Ej5fM() {
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m374getSpacingD9Ej5fM(Vertical $this) {
                return Vertical.super.mo364getSpacingD9Ej5fM();
            }
        }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m368getSpacingD9Ej5fM(HorizontalOrVertical $this) {
                return HorizontalOrVertical.super.mo364getSpacingD9Ej5fM();
            }
        }
    ...
    public final HorizontalOrVertical m358spacedBy0680j_4(float space) {
    ...
    public final Horizontal m359spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
    ...
    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Vertical m360spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m5122constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m5122constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4  reason: not valid java name */
        public final HorizontalOrVertical m361spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, null, null);
        }

        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Horizontal m362spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Vertical m363spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(Dp.m5122constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(2);
                }
    ...
    public static final class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m369copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m371copy8Feqmps(f, z, function2);
        }
        ...
        public final SpacedAligned m371copy8Feqmps(float f, boolean z, Function2<? super Integer, ? super LayoutDirection, Integer> function2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof SpacedAligned) {
                ...
                return Dp.m5127equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
            }
            return false;
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public int hashCode() {
            int m5128hashCodeimpl = Dp.m5128hashCodeimpl(this.space) * 31;
            boolean z = this.rtlMirror;
            int i = z;
            if (z != 0) {
                i = 1;
            }
            int i2 = (m5128hashCodeimpl + i) * 31;
        ...
        public final float m372getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public void arrange(Density $this$arrange, int totalSize, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            int spacePx = $this$arrange.mo295roundToPx0680j_4(this.space);
            int occupied2 = 0;
            int lastSpace2 = 0;
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m5133toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
    ...
    public final void placeSpaceBetween$foundation_layout_release(int totalSize, int[] size, int[] outPosition, boolean reverseInput) {
        ...
        int initial$iv = accumulator$iv;
        if (size.length > 1) {
            gapSize = (totalSize - initial$iv) / (size.length - 1);
        } else {
            gapSize = 0.0f;
        }
        float current = 0.0f;
