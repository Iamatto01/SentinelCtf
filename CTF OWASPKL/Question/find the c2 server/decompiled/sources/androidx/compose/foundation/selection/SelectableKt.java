...
public final class SelectableKt {
    ...
    public static /* synthetic */ Modifier m662selectableXHw0xAI$default(Modifier modifier, boolean z, boolean z2, Role role, Function0 function0, int i, Object obj) {
        if ((i & 2) != 0) {
            z2 = true;
        }
        if ((i & 4) != 0) {
        ...
        return m661selectableXHw0xAI(modifier, z, z2, role, function0);
    }

    /* renamed from: selectable-XHw0xAI  reason: not valid java name */
    public static final Modifier m661selectableXHw0xAI(Modifier selectable, final boolean selected, final boolean enabled, final Role role, final Function0<Unit> onClick) {
        ...
        return ComposedModifierKt.composed(selectable, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.SelectableKt$selectable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                Modifier m659selectableO2vRcR0 = SelectableKt.m659selectableO2vRcR0(companion, selected, (MutableInteractionSource) value$iv$iv, (Indication) consume, enabled, role, onClick);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return m659selectableO2vRcR0;
            }
        });
    }

    /* renamed from: selectable-O2vRcR0$default  reason: not valid java name */
    public static /* synthetic */ Modifier m660selectableO2vRcR0$default(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Role role, Function0 function0, int i, Object obj) {
        boolean z3;
        Role role2;
        if ((i & 8) == 0) {
            z3 = z2;
        ...
        return m659selectableO2vRcR0(modifier, z, mutableInteractionSource, indication, z3, role2, function0);
    }

    /* renamed from: selectable-O2vRcR0  reason: not valid java name */
    public static final Modifier m659selectableO2vRcR0(Modifier selectable, final boolean selected, final MutableInteractionSource interactionSource, final Indication indication, final boolean enabled, final Role role, final Function0<Unit> onClick) {
        ...
        Modifier.Companion companion = Modifier.Companion;
        m172clickableO2vRcR0 = ClickableKt.m172clickableO2vRcR0(Modifier.Companion, interactionSource, indication, (r14 & 4) != 0 ? true : enabled, (r14 & 8) != 0 ? null : null, (r14 & 16) != 0 ? null : role, onClick);
        return InspectableValueKt.inspectableWrapper(selectable, inspectorInfo$iv, SemanticsModifierKt.semantics$default(m172clickableO2vRcR0, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.selection.SelectableKt$selectable$4$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
