...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m202constructorimpl(0);
    private static final int WhileFocused = m202constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m201boximpl(int i) {
    ...
    public static boolean m203equalsimpl(int i, Object obj) {
        return (obj instanceof MarqueeAnimationMode) && i == ((MarqueeAnimationMode) obj).m207unboximpl();
    }
    ...
    public final /* synthetic */ int m207unboximpl() {
        return this.value;
    }
    ...
    public static String m206toStringimpl(int arg0) {
        if (m204equalsimpl0(arg0, Immediately)) {
            return "Immediately";
        }
        if (m204equalsimpl0(arg0, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m208getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations  reason: not valid java name */
        public static /* synthetic */ void m209getWhileFocusedZbEOnfQ$annotations() {
        }
