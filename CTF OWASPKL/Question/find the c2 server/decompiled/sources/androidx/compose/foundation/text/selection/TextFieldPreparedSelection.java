...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public TextFieldPreparedSelection(TextFieldValue currentValue, OffsetMapping offsetMapping, TextLayoutResultProxy layoutResultProxy, TextPreparedSelectionState state) {
        super(currentValue.getAnnotatedString(), currentValue.m4846getSelectiond9O1mEE(), layoutResultProxy != null ? layoutResultProxy.getValue() : null, offsetMapping, state, null);
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m4841copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), m803getSelectiond9O1mEE(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        if (TextRange.m4631getCollapsedimpl(m803getSelectiond9O1mEE())) {
        ...
        return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m4635getMinimpl(m803getSelectiond9O1mEE()), TextRange.m4635getMinimpl(m803getSelectiond9O1mEE()))});
    }
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r10, int r11) {
        ...
        L1c:
            ...
            long r2 = r2.m4846getSelectiond9O1mEE()
            int r2 = androidx.compose.ui.text.TextRange.m4632getEndimpl(r2)
            ...
            float r3 = r2.getLeft()
            float r4 = r2.getTop()
            long r5 = r0.m2401getSizeNHjbRc()
            float r5 = androidx.compose.ui.geometry.Size.m2434getHeightimpl(r5)
            float r6 = (float) r11
            float r5 = r5 * r6
            float r4 = r4 + r5
            ...
            int r6 = r6.m4609getOffsetForPositionk4lQ0M(r7)
