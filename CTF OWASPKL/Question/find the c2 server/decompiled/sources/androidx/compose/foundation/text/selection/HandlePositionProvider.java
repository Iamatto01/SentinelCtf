...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo805calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[this.handleReferencePoint.ordinal()]) {
            case 1:
                return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m5240getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m5241getYimpl(this.offset));
            case 2:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5240getXimpl(this.offset)) - IntSize.m5282getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m5241getYimpl(this.offset));
            case 3:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5240getXimpl(this.offset)) - (IntSize.m5282getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m5241getYimpl(this.offset));
            default:
