...
public final class AndroidCursorHandle_androidKt {
    private static final float CursorHandleHeight = Dp.m5122constructorimpl(25);
    private static final float CursorHandleWidth;
    private static final float Sqrt2 = 1.4142135f;

    static {
        float arg0$iv = CursorHandleHeight;
        CursorHandleWidth = Dp.m5122constructorimpl(Dp.m5122constructorimpl(arg0$iv * 2.0f) / 2.4142137f);
    }
    ...
    public static final void m691CursorHandleULxng0E(final long handlePosition, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty2 & 731) != 146 || !$composer2.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m800HandlePopupULxng0E(handlePosition, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda($composer2, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
            ...
            public final void invoke(Composer composer, int i) {
                AndroidCursorHandle_androidKt.m691CursorHandleULxng0E(handlePosition, modifier, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer $composer, final int $changed) {
        ...
        if (($dirty & 11) != 2 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m459sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final Modifier drawCursorHandle(Modifier $this$drawCursorHandle) {
        ...
        return ComposedModifierKt.composed$default($this$drawCursorHandle, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-2126899193, $changed, -1, "androidx.compose.foundation.text.drawCursorHandle.<anonymous> (AndroidCursorHandle.android.kt:62)");
                }
                ...
                Object key1$iv = Color.m2596boximpl(handleColor);
                $composer.startReplaceableGroup(1157296644);
                ComposerKt.sourceInformation($composer, "CC(remember)P(1):Composables.kt#9igjgp");
                boolean invalid$iv$iv = $composer.changed(key1$iv);
                Object it$iv$iv = $composer.rememberedValue();
                if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                    value$iv$iv = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        /* JADX INFO: Access modifiers changed from: package-private */
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            final float radius = Size.m2437getWidthimpl(drawWithCache.m2280getSizeNHjbRc()) / 2.0f;
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    $this$invoke_u24lambda_u240.mo3077rotateUv8p0NA(45.0f, Offset.Companion.m2384getZeroF1C5BW0());
                                    DrawScope.m3131drawImagegbVJVH8$default($this$withTransform$iv, imageBitmap2, 0L, 0.0f, null, colorFilter2, 0, 46, null);
