...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.Companion.m4813getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.Companion.m4839getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.Companion.m4785getDefaulteUduSuo() : i3, null);
    }

    /* renamed from: getCapitalization-IUNYP9k  reason: not valid java name */
    public final int m721getCapitalizationIUNYP9k() {
    ...
    public final int m723getKeyboardTypePjHm6EE() {
        return this.keyboardType;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m722getImeActioneUduSuo() {
    ...
    public static /* synthetic */ KeyboardOptions m719copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m720copy3m2b7yw(i, z, i2, i3);
    }

    /* renamed from: copy-3m2b7yw  reason: not valid java name */
    public final KeyboardOptions m720copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof KeyboardOptions) && KeyboardCapitalization.m4804equalsimpl0(this.capitalization, ((KeyboardOptions) other).capitalization) && this.autoCorrect == ((KeyboardOptions) other).autoCorrect && KeyboardType.m4819equalsimpl0(this.keyboardType, ((KeyboardOptions) other).keyboardType) && ImeAction.m4773equalsimpl0(this.imeAction, ((KeyboardOptions) other).imeAction);
    }

    public int hashCode() {
        int result = KeyboardCapitalization.m4805hashCodeimpl(this.capitalization);
        return (((((result * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4820hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4774hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m4806toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4821toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4775toStringimpl(this.imeAction)) + ')';
    }
}
