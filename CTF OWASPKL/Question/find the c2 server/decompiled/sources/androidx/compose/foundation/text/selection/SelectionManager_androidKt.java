...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m859isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo716mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
