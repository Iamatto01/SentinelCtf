...
public final class TextFieldCursorKt {
    ...
    private static final float DefaultCursorThickness = Dp.m5122constructorimpl(2);
        ...
        return enabled ? ComposedModifierKt.composed$default($this$cursor, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (brush instanceof SolidColor) {
                    long $this$isUnspecified$iv = ((SolidColor) brush).m2931getValue0d7_KjU();
                    if ($this$isUnspecified$iv == Color.Companion.m2642getUnspecified0d7_KjU()) {
                        z = false;
                    }
                }
                boolean isBrushSpecified = z;
                if (state.getHasFocus() && TextRange.m4631getCollapsedimpl(value.m4846getSelectiond9O1mEE()) && isBrushSpecified) {
                    EffectsKt.LaunchedEffect(value.getAnnotatedString(), TextRange.m4625boximpl(value.m4846getSelectiond9O1mEE()), new AnonymousClass1(cursorAlpha, null), $composer, 512);
                    ...
                    companion = DrawModifierKt.drawWithContent(composed, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1.2
                        ...
                        public final void invoke2(ContentDrawScope drawWithContent) {
                            ...
                            if (!(cursorAlphaValue == 0.0f)) {
                                int transformedOffset = offsetMapping2.originalToTransformed(TextRange.m4637getStartimpl(textFieldValue.m4846getSelectiond9O1mEE()));
                                ...
                                float cursorWidth = drawWithContent.mo301toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                                float f = 2;
                                float cursorX = RangesKt.coerceAtMost(cursorRect.getLeft() + (cursorWidth / f), Size.m2437getWidthimpl(drawWithContent.mo3146getSizeNHjbRc()) - (cursorWidth / f));
                                DrawScope.m3132drawLine1RTmtNc$default(drawWithContent, brush2, OffsetKt.Offset(cursorX, cursorRect.getTop()), OffsetKt.Offset(cursorX, cursorRect.getBottom()), cursorWidth, 0, null, cursorAlphaValue, null, 0, 432, null);
                            }
                        }
                    });
                } else {
                    ...
                    */
                    public final java.lang.Object invokeSuspend(java.lang.Object r12) {
                        ...
                        L52:
                            ...
                            return r1
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1.AnonymousClass1.C00231.invokeSuspend(java.lang.Object):java.lang.Object");
                    }
                }
