...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m715cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m3867equalsimpl0(KeyEvent_androidKt.m3875getTypeZmokQxo(cancelsTextSelection), KeyEventType.Companion.m3872getKeyUpCS__XNY());
    }
