...
public final class PressInteractionKt {
    public static final State<Boolean> collectIsPressedAsState(InteractionSource $this$collectIsPressedAsState, Composer $composer, int $changed) {
        ...
        if (invalid$iv$iv || it$iv$iv2 == Composer.Companion.getEmpty()) {
            Object value$iv$iv3 = (Function2) new PressInteractionKt$collectIsPressedAsState$1$1($this$collectIsPressedAsState, isPressed, null);
        ...
        $composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect($this$collectIsPressedAsState, (Function2) value$iv$iv2, $composer, ($changed & 14) | 64);
        if (ComposerKt.isTraceInProgress()) {
