...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.Companion.m2384getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo756onStartk4lQ0M(long startPoint) {
                ...
                if (!((state$foundation_release2 == null || (layoutResult3 = state$foundation_release2.getLayoutResult()) == null || !layoutResult3.m793isPositionOnTextk4lQ0M(startPoint)) ? false : true) && (state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release()) != null && (layoutResult2 = state$foundation_release.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                    int offset = textFieldSelectionManager.getOffsetMapping$foundation_release().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult2, layoutResult2.getLineForVerticalPosition(Offset.m2369getYimpl(startPoint)), false, 2, null));
                    HapticFeedback hapticFeedBack = textFieldSelectionManager.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo3252performHapticFeedbackCdsT49E(HapticFeedbackType.Companion.m3261getTextHandleMove5zf0vsI());
                    }
                    newValue = textFieldSelectionManager.m871createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(offset, offset));
                ...
                if (state$foundation_release3 != null && (layoutResult = state$foundation_release3.getLayoutResult()) != null) {
                    ...
                    int offset2 = TextLayoutResultProxy.m790getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), offset2, offset2, false, SelectionAdjustment.Companion.getWord());
                ...
                textFieldSelectionManager3.m873setCurrentDragPosition_kEHs6E(Offset.m2357boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.Companion.m2384getZeroF1C5BW0();
            }
            ...
            public void mo755onDragk4lQ0M(long delta) {
                ...
                Integer num;
                long j4;
                int m792getOffsetForPosition3MmeM6k;
                if (TextFieldSelectionManager.this.getValue$foundation_release().getText().length() == 0) {
                    return;
                }
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = textFieldSelectionManager.dragTotalDistance;
                textFieldSelectionManager.dragTotalDistance = Offset.m2373plusMKHz9U(j, delta);
                ...
                if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null) {
                    ...
                    textFieldSelectionManager2.m873setCurrentDragPosition_kEHs6E(Offset.m2357boximpl(Offset.m2373plusMKHz9U(j2, j3)));
                    num = textFieldSelectionManager2.dragBeginOffsetInText;
                    if (num != null) {
                        m792getOffsetForPosition3MmeM6k = num.intValue();
                    } else {
                        j4 = textFieldSelectionManager2.dragBeginPosition;
                        m792getOffsetForPosition3MmeM6k = layoutResult.m792getOffsetForPosition3MmeM6k(j4, false);
                    }
                    int startOffset = m792getOffsetForPosition3MmeM6k;
                    Offset m876getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m876getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m876getCurrentDragPosition_m7T9E);
                    int endOffset = layoutResult.m792getOffsetForPosition3MmeM6k(m876getCurrentDragPosition_m7T9E.m2378unboximpl(), false);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), startOffset, endOffset, false, SelectionAdjustment.Companion.getWord());
                }
                TextFieldState state$foundation_release2 = TextFieldSelectionManager.this.getState$foundation_release();
            ...
            public void onStop() {
                ...
                TextFieldSelectionManager.this.m873setCurrentDragPosition_kEHs6E(null);
                TextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo758onExtendk4lQ0M(long downPosition) {
                ...
                if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                    int startOffset = textFieldSelectionManager.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4637getStartimpl(textFieldSelectionManager.getValue$foundation_release().m4846getSelectiond9O1mEE()));
                    int clickOffset = TextLayoutResultProxy.m790getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null);
            ...
            public boolean mo759onExtendDragk4lQ0M(long dragPosition) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                int startOffset = textFieldSelectionManager.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4637getStartimpl(textFieldSelectionManager.getValue$foundation_release().m4846getSelectiond9O1mEE()));
                int dragOffset = layoutResult.m792getOffsetForPosition3MmeM6k(dragPosition, false);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), startOffset, dragOffset, false, SelectionAdjustment.Companion.getNone());
                return true;
            }
            ...
            public boolean mo760onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                    textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m790getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null));
                    j = textFieldSelectionManager.dragBeginPosition;
                    int clickOffset = TextLayoutResultProxy.m790getOffsetForPosition3MmeM6k$default(layoutResult, j, false, 2, null);
    ...
    public final void m873setCurrentDragPosition_kEHs6E(Offset offset) {
        MutableState $this$setValue$iv = this.currentDragPosition$delegate;
        $this$setValue$iv.setValue(offset);
    }

    /* renamed from: getCurrentDragPosition-_m7T9-E  reason: not valid java name */
    public final Offset m876getCurrentDragPosition_m7T9E() {
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo754onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.m873setCurrentDragPosition_kEHs6E(Offset.m2357boximpl(SelectionHandlesKt.m825getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m878getHandlePositiontuRUvjQ$foundation_release(isStartHandle))));
            }
            ...
            public void mo756onStartk4lQ0M(long startPoint) {
                long j;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m825getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m878getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j = textFieldSelectionManager2.dragBeginPosition;
                textFieldSelectionManager2.m873setCurrentDragPosition_kEHs6E(Offset.m2357boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.Companion.m2384getZeroF1C5BW0();
                TextFieldSelectionManager.this.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
                TextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release == null) {
            ...
            public void mo755onDragk4lQ0M(long delta) {
                ...
                if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null && (layoutResult2 = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset m876getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m876getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m876getCurrentDragPosition_m7T9E);
                        startOffset = layoutResult2.m4609getOffsetForPositionk4lQ0M(m876getCurrentDragPosition_m7T9E.m2378unboximpl());
                    } else {
                        startOffset = textFieldSelectionManager2.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4637getStartimpl(textFieldSelectionManager2.getValue$foundation_release().m4846getSelectiond9O1mEE()));
                    }
                    if (z) {
                        endOffset = textFieldSelectionManager2.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4632getEndimpl(textFieldSelectionManager2.getValue$foundation_release().m4846getSelectiond9O1mEE()));
                    } else {
                        Offset m876getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m876getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m876getCurrentDragPosition_m7T9E2);
                        endOffset = layoutResult2.m4609getOffsetForPositionk4lQ0M(m876getCurrentDragPosition_m7T9E2.m2378unboximpl());
                    }
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo754onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.m873setCurrentDragPosition_kEHs6E(Offset.m2357boximpl(SelectionHandlesKt.m825getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m878getHandlePositiontuRUvjQ$foundation_release(true))));
            }
            ...
            public void mo756onStartk4lQ0M(long startPoint) {
                long j;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m825getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m878getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j = textFieldSelectionManager2.dragBeginPosition;
                textFieldSelectionManager2.m873setCurrentDragPosition_kEHs6E(Offset.m2357boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.Companion.m2384getZeroF1C5BW0();
            ...
            public void mo755onDragk4lQ0M(long delta) {
                ...
                long j2;
                long j3;
                TextFieldValue m871createTextFieldValueFDrldGo;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = textFieldSelectionManager.dragTotalDistance;
                textFieldSelectionManager.dragTotalDistance = Offset.m2373plusMKHz9U(j, delta);
                TextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null && (layoutResult2 = layoutResult.getValue()) != null) {
                    ...
                    Offset m876getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m876getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m876getCurrentDragPosition_m7T9E);
                    int offset = offsetMapping$foundation_release.transformedToOriginal(layoutResult2.m4609getOffsetForPositionk4lQ0M(m876getCurrentDragPosition_m7T9E.m2378unboximpl()));
                    long newSelection = TextRangeKt.TextRange(offset, offset);
                    if (TextRange.m4630equalsimpl0(newSelection, textFieldSelectionManager2.getValue$foundation_release().m4846getSelectiond9O1mEE())) {
                        return;
                    }
                    ...
                    m871createTextFieldValueFDrldGo = textFieldSelectionManager2.m871createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), newSelection);
                    onValueChange$foundation_release.invoke(m871createTextFieldValueFDrldGo);
                }
            }
    ...
    public static /* synthetic */ void m872deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m875deselect_kEHs6E$foundation_release(offset);
    }

    /* renamed from: deselect-_kEHs6E$foundation_release  reason: not valid java name */
    public final void m875deselect_kEHs6E$foundation_release(Offset position) {
        HandleState selectionMode;
        int newCursorOffset;
        if (!TextRange.m4631getCollapsedimpl(getValue$foundation_release().m4846getSelectiond9O1mEE())) {
            TextFieldState textFieldState = this.state;
            ...
            if (position != null && layoutResult != null) {
                newCursorOffset = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m790getOffsetForPosition3MmeM6k$default(layoutResult, position.m2378unboximpl(), false, 2, null));
            } else {
                newCursorOffset = TextRange.m4634getMaximpl(getValue$foundation_release().m4846getSelectiond9O1mEE());
            }
            TextFieldValue newValue = TextFieldValue.m4841copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(newCursorOffset), (TextRange) null, 5, (Object) null);
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        ...
        if (cancelSelection) {
            int newCursorOffset = TextRange.m4634getMaximpl(getValue$foundation_release().m4846getSelectiond9O1mEE());
            TextFieldValue newValue = m871createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
            this.onValueChange.invoke(newValue);
            setHandleState(HandleState.None);
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        int newCursorOffset = TextRange.m4635getMinimpl(getValue$foundation_release().m4846getSelectiond9O1mEE()) + text.length();
        TextFieldValue newValue = m871createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
        this.onValueChange.invoke(newValue);
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int newCursorOffset = TextRange.m4635getMinimpl(getValue$foundation_release().m4846getSelectiond9O1mEE());
        TextFieldValue newValue = m871createTextFieldValueFDrldGo(newText, TextRangeKt.TextRange(newCursorOffset, newCursorOffset));
        this.onValueChange.invoke(newValue);
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue newValue = m871createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(newValue);
        this.oldValue = TextFieldValue.m4841copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, newValue.m4846getSelectiond9O1mEE(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final long m878getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        long m4846getSelectiond9O1mEE = getValue$foundation_release().m4846getSelectiond9O1mEE();
        int offset = isStartHandle ? TextRange.m4637getStartimpl(m4846getSelectiond9O1mEE) : TextRange.m4632getEndimpl(m4846getSelectiond9O1mEE);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(offset), isStartHandle, TextRange.m4636getReversedimpl(getValue$foundation_release().m4846getSelectiond9O1mEE()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release  reason: not valid java name */
    public final long m877getCursorPositiontuRUvjQ$foundation_release(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        int offset = this.offsetMapping.originalToTransformed(TextRange.m4637getStartimpl(getValue$foundation_release().m4846getSelectiond9O1mEE()));
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        ...
        float x = cursorRect.getLeft() + (density.mo301toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2);
    ...
    */
    public final void showSelectionToolbar$foundation_release() {
        /*
            ...
            long r1 = r1.m4846getSelectiond9O1mEE()
            boolean r1 = androidx.compose.ui.text.TextRange.m4631getCollapsedimpl(r1)
            r2 = 0
            if (r1 != 0) goto L1e
            if (r0 != 0) goto L1e
        ...
        L1f:
            androidx.compose.ui.text.input.TextFieldValue r1 = r9.getValue$foundation_release()
            long r3 = r1.m4846getSelectiond9O1mEE()
            boolean r1 = androidx.compose.ui.text.TextRange.m4631getCollapsedimpl(r3)
            if (r1 != 0) goto L3f
        ...
        L60:
            androidx.compose.ui.text.input.TextFieldValue r1 = r9.getValue$foundation_release()
            long r3 = r1.m4846getSelectiond9O1mEE()
            int r1 = androidx.compose.ui.text.TextRange.m4633getLengthimpl(r3)
    ...
    public final void m874contextMenuOpenAdjustmentk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        TextFieldState textFieldState = this.state;
        if (textFieldState != null && (layoutResult = textFieldState.getLayoutResult()) != null) {
            int offset = TextLayoutResultProxy.m790getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
            if (!TextRange.m4628containsimpl(getValue$foundation_release().m4846getSelectiond9O1mEE(), offset)) {
    ...
    private final Rect getContentRect() {
        ...
        if (it != null) {
            if (!(!it.isLayoutResultStale())) {
                it = null;
            }
            if (it != null) {
                int transformedStart = this.offsetMapping.originalToTransformed(TextRange.m4637getStartimpl(getValue$foundation_release().m4846getSelectiond9O1mEE()));
                int transformedEnd = this.offsetMapping.originalToTransformed(TextRange.m4632getEndimpl(getValue$foundation_release().m4846getSelectiond9O1mEE()));
                TextFieldState textFieldState = this.state;
                if (textFieldState != null && (layoutCoordinates4 = textFieldState.getLayoutCoordinates()) != null) {
                    startOffset = layoutCoordinates4.mo4132localToRootMKHz9U(m878getHandlePositiontuRUvjQ$foundation_release(true));
                } else {
                    startOffset = Offset.Companion.m2384getZeroF1C5BW0();
                }
                TextFieldState textFieldState2 = this.state;
                if (textFieldState2 != null && (layoutCoordinates3 = textFieldState2.getLayoutCoordinates()) != null) {
                    endOffset = layoutCoordinates3.mo4132localToRootMKHz9U(m878getHandlePositiontuRUvjQ$foundation_release(false));
                } else {
                    endOffset = Offset.Companion.m2384getZeroF1C5BW0();
                }
                ...
                if (textFieldState3 != null && (layoutCoordinates2 = textFieldState3.getLayoutCoordinates()) != null) {
                    ...
                    startTop = Offset.m2369getYimpl(layoutCoordinates2.mo4132localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(transformedStart)) == null) ? 0.0f : cursorRect2.getTop())));
                } else {
                    startTop = 0.0f;
                }
                ...
                if (textFieldState4 != null && (layoutCoordinates = textFieldState4.getLayoutCoordinates()) != null) {
                    ...
                    endTop = Offset.m2369getYimpl(layoutCoordinates.mo4132localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(transformedEnd)) == null) ? 0.0f : cursorRect.getTop())));
                }
                float left = Math.min(Offset.m2368getXimpl(startOffset), Offset.m2368getXimpl(endOffset));
                float right = Math.max(Offset.m2368getXimpl(startOffset), Offset.m2368getXimpl(endOffset));
                float top = Math.min(startTop, endTop);
                float bottom = Math.max(Offset.m2369getYimpl(startOffset), Offset.m2369getYimpl(endOffset)) + (Dp.m5122constructorimpl(25) * it.getTextDelegate().getDensity().getDensity());
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResultProxy layoutResult;
        long transformedSelection = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m4637getStartimpl(value.m4846getSelectiond9O1mEE())), this.offsetMapping.originalToTransformed(TextRange.m4632getEndimpl(value.m4846getSelectiond9O1mEE())));
        TextFieldState textFieldState = this.state;
        long newTransformedSelection = TextFieldSelectionDelegateKt.m868getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m4631getCollapsedimpl(transformedSelection) ? null : TextRange.m4625boximpl(transformedSelection), isStartHandle, adjustment);
        long originalSelection = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m4637getStartimpl(newTransformedSelection)), this.offsetMapping.transformedToOriginal(TextRange.m4632getEndimpl(newTransformedSelection)));
        if (TextRange.m4630equalsimpl0(originalSelection, value.m4846getSelectiond9O1mEE())) {
            return;
        }
        ...
        TextFieldValue newValue = m871createTextFieldValueFDrldGo(value.getAnnotatedString(), originalSelection);
        this.onValueChange.invoke(newValue);
        TextFieldState textFieldState2 = this.state;
        if (textFieldState2 != null) {
    ...
    public final TextFieldValue m871createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
