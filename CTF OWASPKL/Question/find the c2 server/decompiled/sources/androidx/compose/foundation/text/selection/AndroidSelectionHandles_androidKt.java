...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void m801SelectionHandle8fL75g(final long position, final boolean isStartHandle, final ResolvedTextDirection direction, final boolean handlesCrossed, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            m800HandlePopupULxng0E(position, handleReferencePoint, ComposableLambdaKt.composableLambda($composer3, 732099485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1
                ...
                public final void invoke(Composer $composer4, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer4.getSkipping()) {
                        ...
                        if (function2 == null) {
                            ...
                            Object key2$iv = Offset.m2357boximpl(position);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$2
            ...
            public final void invoke(Composer composer, int i) {
                AndroidSelectionHandles_androidKt.m801SelectionHandle8fL75g(position, isStartHandle, direction, handlesCrossed, modifier, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
            }
        });
    }
    ...
    public static final void DefaultSelectionHandle(final Modifier modifier, final boolean isStartHandle, final ResolvedTextDirection direction, final boolean handlesCrossed, Composer $composer, final int $changed) {
        ...
        if (($dirty & 5851) != 1170 || !$composer2.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m459sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), isStartHandle, direction, handlesCrossed), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final Modifier drawSelectionHandle(Modifier $this$drawSelectionHandle, final boolean isStartHandle, final ResolvedTextDirection direction, final boolean handlesCrossed) {
        ...
        return ComposedModifierKt.composed$default($this$drawSelectionHandle, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1
            ...
            public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1538687176, $changed, -1, "androidx.compose.foundation.text.selection.drawSelectionHandle.<anonymous> (AndroidSelectionHandles.android.kt:112)");
                }
                ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object consume = $composer.consume(TextSelectionColorsKt.getLocalTextSelectionColors());
                ComposerKt.sourceInformationMarkerEnd($composer);
                final long handleColor = ((TextSelectionColors) consume).m884getHandleColor0d7_KjU();
                Modifier.Companion companion = Modifier.Companion;
                Object[] keys$iv = {Color.m2596boximpl(handleColor), Boolean.valueOf(isStartHandle), direction, Boolean.valueOf(handlesCrossed)};
                final boolean z = isStartHandle;
                ...
                if (invalid$iv || value$iv$iv == Composer.Companion.getEmpty()) {
                    value$iv$iv = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            float radius = Size.m2437getWidthimpl(drawWithCache.m2280getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap handleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, radius);
                            final ColorFilter colorFilter = ColorFilter.Companion.m2647tintxETnrds$default(ColorFilter.Companion, handleColor, 0, 2, null);
                            final boolean z3 = z;
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    if (isLeft) {
                                        ...
                                        long pivot$iv = $this$scale_u2dFgt4K4Q_u24default$iv.mo3145getCenterF1C5BW0();
                                        ...
                                        $this$scale_Fgt4K4Q_u24lambda_u242$iv.mo3078scale0AR0LA0(-1.0f, 1.0f, pivot$iv);
                                        DrawScope.m3131drawImagegbVJVH8$default($this$scale_u2dFgt4K4Q_u24default$iv, imageBitmap, 0L, 0.0f, null, colorFilter2, 0, 46, null);
                                        $this$withTransform_u24lambda_u246$iv$iv.getCanvas().restore();
                                        $this$withTransform_u24lambda_u246$iv$iv.mo3072setSizeuvyYCjk(previousSize$iv$iv);
                                        return;
                                    }
                                    DrawScope.m3131drawImagegbVJVH8$default(onDrawWithContent, handleImage, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                }
                            });
                        }
                    };
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope $this$createHandleImage, float radius) {
        ...
        if (imageBitmap2 == null || canvas2 == null || edge > imageBitmap2.getWidth() || edge > imageBitmap2.getHeight()) {
            ImageBitmap imageBitmap3 = ImageBitmapKt.m2827ImageBitmapx__hDU$default(edge, edge, ImageBitmapConfig.Companion.m2821getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        $this$draw_yzxVdVo_u24lambda_u240$iv.m3070setSizeuvyYCjk(size$iv);
        canvas.save();
        CanvasDrawScope $this$createHandleImage_u24lambda_u240 = this_$iv;
        DrawScope.m3141drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u240, Color.Companion.m2632getBlack0d7_KjU(), 0L, $this$createHandleImage_u24lambda_u240.mo3146getSizeNHjbRc(), 0.0f, null, null, BlendMode.Companion.m2523getClear0nO6VwU(), 58, null);
        DrawScope.m3141drawRectnJ9OG0$default($this$createHandleImage_u24lambda_u240, ColorKt.Color(4278190080L), Offset.Companion.m2384getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(radius, radius), 0.0f, null, null, 0, 120, null);
        DrawScope.m3128drawCircleVaOC9Bg$default($this$createHandleImage_u24lambda_u240, ColorKt.Color(4278190080L), radius, OffsetKt.Offset(radius, radius), 0.0f, null, null, 0, 120, null);
        canvas.restore();
