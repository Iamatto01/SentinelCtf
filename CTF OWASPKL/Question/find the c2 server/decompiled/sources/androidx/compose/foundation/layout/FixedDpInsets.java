...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo295roundToPx0680j_4(this.leftDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo295roundToPx0680j_4(this.topDp);
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo295roundToPx0680j_4(this.rightDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo295roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m5133toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m5133toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m5133toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m5133toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof FixedDpInsets) {
            return Dp.m5127equalsimpl0(this.leftDp, ((FixedDpInsets) other).leftDp) && Dp.m5127equalsimpl0(this.topDp, ((FixedDpInsets) other).topDp) && Dp.m5127equalsimpl0(this.rightDp, ((FixedDpInsets) other).rightDp) && Dp.m5127equalsimpl0(this.bottomDp, ((FixedDpInsets) other).bottomDp);
        }
        return false;
    }

    public int hashCode() {
        int result = Dp.m5128hashCodeimpl(this.leftDp);
        return (((((result * 31) + Dp.m5128hashCodeimpl(this.topDp)) * 31) + Dp.m5128hashCodeimpl(this.rightDp)) * 31) + Dp.m5128hashCodeimpl(this.bottomDp);
    }
}
