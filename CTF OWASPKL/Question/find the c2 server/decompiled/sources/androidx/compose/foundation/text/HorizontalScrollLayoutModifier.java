...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public final HorizontalScrollLayoutModifier copy(TextFieldScrollerPosition scrollerPosition, int i, TransformedText transformedText, Function0<TextLayoutResultProxy> textLayoutResultProvider) {
        Intrinsics.checkNotNullParameter(scrollerPosition, "scrollerPosition");
        Intrinsics.checkNotNullParameter(transformedText, "transformedText");
        Intrinsics.checkNotNullParameter(textLayoutResultProvider, "textLayoutResultProvider");
        return new HorizontalScrollLayoutModifier(scrollerPosition, i, transformedText, textLayoutResultProvider);
    }
    ...
    public MeasureResult mo24measure3p2s80s(final MeasureScope measure, Measurable measurable, long constraints) {
        ...
        int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m5077getMaxHeightimpl(constraints));
        if (maxIntrinsicWidth >= Constraints.m5078getMaxWidthimpl(constraints)) {
            m5068copyZbe2FdA = Constraints.m5068copyZbe2FdA(constraints, (r12 & 1) != 0 ? Constraints.m5080getMinWidthimpl(constraints) : 0, (r12 & 2) != 0 ? Constraints.m5078getMaxWidthimpl(constraints) : Integer.MAX_VALUE, (r12 & 4) != 0 ? Constraints.m5079getMinHeightimpl(constraints) : 0, (r12 & 8) != 0 ? Constraints.m5077getMaxHeightimpl(constraints) : 0);
        } else {
            m5068copyZbe2FdA = constraints;
        }
        long childConstraints = m5068copyZbe2FdA;
        final Placeable placeable = measurable.mo4125measureBRTryo0(childConstraints);
        final int width = Math.min(placeable.getWidth(), Constraints.m5078getMaxWidthimpl(constraints));
