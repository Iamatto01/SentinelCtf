...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(Context context, OverscrollConfiguration overscrollConfig) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            it.setColor(ColorKt.m2660toArgb8_81llA(this.overscrollConfig.m214getGlowColor0d7_KjU()));
        }
        this.redrawSignal = SnapshotStateKt.mutableStateOf(Unit.INSTANCE, SnapshotStateKt.neverEqualPolicy());
        this.invalidationEnabled = true;
        this.containerSize = Size.Companion.m2446getZeroNHjbRc();
        Function1<IntSize, Unit> function1 = new Function1<IntSize, Unit>() { // from class: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect$onNewSize$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                m147invokeozmzZPI(intSize.m5286unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-ozmzZPI  reason: not valid java name */
            public final void m147invokeozmzZPI(long size2) {
                long j;
                ...
                long m5292toSizeozmzZPI = IntSizeKt.m5292toSizeozmzZPI(size2);
                j = AndroidEdgeEffectOverscrollEffect.this.containerSize;
                boolean differentSize = !Size.m2433equalsimpl0(m5292toSizeozmzZPI, j);
                AndroidEdgeEffectOverscrollEffect.this.containerSize = IntSizeKt.m5292toSizeozmzZPI(size2);
                if (differentSize) {
                    edgeEffect = AndroidEdgeEffectOverscrollEffect.this.topEffect;
                    edgeEffect.setSize(IntSize.m5282getWidthimpl(size2), IntSize.m5281getHeightimpl(size2));
                    edgeEffect2 = AndroidEdgeEffectOverscrollEffect.this.bottomEffect;
                    edgeEffect2.setSize(IntSize.m5282getWidthimpl(size2), IntSize.m5281getHeightimpl(size2));
                    edgeEffect3 = AndroidEdgeEffectOverscrollEffect.this.leftEffect;
                    edgeEffect3.setSize(IntSize.m5281getHeightimpl(size2), IntSize.m5282getWidthimpl(size2));
                    edgeEffect4 = AndroidEdgeEffectOverscrollEffect.this.rightEffect;
                    edgeEffect4.setSize(IntSize.m5281getHeightimpl(size2), IntSize.m5282getWidthimpl(size2));
                    edgeEffect5 = AndroidEdgeEffectOverscrollEffect.this.topEffectNegation;
                    edgeEffect5.setSize(IntSize.m5282getWidthimpl(size2), IntSize.m5281getHeightimpl(size2));
                    edgeEffect6 = AndroidEdgeEffectOverscrollEffect.this.bottomEffectNegation;
                    edgeEffect6.setSize(IntSize.m5282getWidthimpl(size2), IntSize.m5281getHeightimpl(size2));
                    edgeEffect7 = AndroidEdgeEffectOverscrollEffect.this.leftEffectNegation;
                    edgeEffect7.setSize(IntSize.m5281getHeightimpl(size2), IntSize.m5282getWidthimpl(size2));
                    edgeEffect8 = AndroidEdgeEffectOverscrollEffect.this.rightEffectNegation;
                    edgeEffect8.setSize(IntSize.m5281getHeightimpl(size2), IntSize.m5282getWidthimpl(size2));
                }
                if (differentSize) {
    ...
    public long mo146applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        float consumedPixelsY;
        boolean appliedHorizontalOverscroll;
        boolean appliedVerticalOverscroll;
        Intrinsics.checkNotNullParameter(performScroll, "performScroll");
        if (Size.m2439isEmptyimpl(this.containerSize)) {
            return performScroll.invoke(Offset.m2357boximpl(delta)).m2378unboximpl();
        }
        ...
        long pointer = offset != null ? offset.m2378unboximpl() : SizeKt.m2447getCenteruvyYCjk(this.containerSize);
        float consumedPixelsX = 0.0f;
        if (Offset.m2369getYimpl(delta) == 0.0f) {
            consumedPixelsY = 0.0f;
        } else {
            if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f)) {
                consumedPixelsY = m143pullTop0a9Yr6o(delta, pointer);
                if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f) {
                    this.topEffect.onRelease();
                }
            } else {
                if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) == 0.0f)) {
                    consumedPixelsY = m140pullBottom0a9Yr6o(delta, pointer);
                    if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) == 0.0f) {
        ...
        if (!(Offset.m2368getXimpl(delta) == 0.0f)) {
            if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f)) {
                float m141pullLeft0a9Yr6o = m141pullLeft0a9Yr6o(delta, pointer);
                if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f) {
                    this.leftEffect.onRelease();
                }
                consumedPixelsX = m141pullLeft0a9Yr6o;
            } else {
                if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
                    float m142pullRight0a9Yr6o = m142pullRight0a9Yr6o(delta, pointer);
                    if (EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f) {
                        this.rightEffect.onRelease();
                    }
                    consumedPixelsX = m142pullRight0a9Yr6o;
                }
            }
        }
        long consumedOffset = OffsetKt.Offset(consumedPixelsX, consumedPixelsY);
        if (!Offset.m2365equalsimpl0(consumedOffset, Offset.Companion.m2384getZeroF1C5BW0())) {
            invalidateOverscroll();
        }
        long leftForDelta = Offset.m2372minusMKHz9U(delta, consumedOffset);
        long consumedByDelta = performScroll.invoke(Offset.m2357boximpl(leftForDelta)).m2378unboximpl();
        long leftForOverscroll = Offset.m2372minusMKHz9U(leftForDelta, consumedByDelta);
        boolean needsInvalidation = false;
        if (NestedScrollSource.m3901equalsimpl0(source, NestedScrollSource.Companion.m3906getDragWNlRxjI())) {
            if (Offset.m2368getXimpl(leftForOverscroll) > 0.5f) {
                m141pullLeft0a9Yr6o(leftForOverscroll, pointer);
                appliedHorizontalOverscroll = true;
            } else if (Offset.m2368getXimpl(leftForOverscroll) < -0.5f) {
                m142pullRight0a9Yr6o(leftForOverscroll, pointer);
                appliedHorizontalOverscroll = true;
            } else {
                appliedHorizontalOverscroll = false;
            }
            if (Offset.m2369getYimpl(leftForOverscroll) > 0.5f) {
                m143pullTop0a9Yr6o(leftForOverscroll, pointer);
                appliedVerticalOverscroll = true;
            } else if (Offset.m2369getYimpl(leftForOverscroll) < -0.5f) {
                m140pullBottom0a9Yr6o(leftForOverscroll, pointer);
                appliedVerticalOverscroll = true;
            } else {
        ...
        boolean appliedHorizontalOverscroll2 = m144releaseOppositeOverscrollk4lQ0M(delta);
        boolean needsInvalidation2 = appliedHorizontalOverscroll2 || needsInvalidation;
        if (needsInvalidation2) {
            invalidateOverscroll();
        }
        return Offset.m2373plusMKHz9U(consumedOffset, consumedByDelta);
    }
    ...
    */
    public java.lang.Object mo145applyToFlingBMRW4eQ(long r10, kotlin.jvm.functions.Function2<? super androidx.compose.ui.unit.Velocity, ? super kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity>, ? extends java.lang.Object> r12, kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        /*
            Method dump skipped, instructions count: 458
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.AndroidEdgeEffectOverscrollEffect.mo145applyToFlingBMRW4eQ(long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final boolean stopOverscrollAnimation() {
        ...
        long fakeDisplacement = SizeKt.m2447getCenteruvyYCjk(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f)) {
            m141pullLeft0a9Yr6o(Offset.Companion.m2384getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
            m142pullRight0a9Yr6o(Offset.Companion.m2384getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f)) {
            m143pullTop0a9Yr6o(Offset.Companion.m2384getZeroF1C5BW0(), fakeDisplacement);
            stopped = true;
        }
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) == 0.0f)) {
            m140pullBottom0a9Yr6o(Offset.Companion.m2384getZeroF1C5BW0(), fakeDisplacement);
            return true;
        }
        return stopped;
    }
    ...
    private final boolean drawLeft(DrawScope $this$drawLeft, EdgeEffect left, android.graphics.Canvas canvas) {
        ...
        canvas.translate(-Size.m2434getHeightimpl(this.containerSize), $this$drawLeft.mo301toPx0680j_4(this.overscrollConfig.getDrawPadding().mo395calculateLeftPaddingu2uoSUM($this$drawLeft.getLayoutDirection())));
    ...
    private final boolean drawTop(DrawScope $this$drawTop, EdgeEffect top, android.graphics.Canvas canvas) {
        int restore = canvas.save();
        canvas.translate(0.0f, $this$drawTop.mo301toPx0680j_4(this.overscrollConfig.getDrawPadding().mo397calculateTopPaddingD9Ej5fM()));
    ...
    private final boolean drawRight(DrawScope $this$drawRight, EdgeEffect right, android.graphics.Canvas canvas) {
        int restore = canvas.save();
        int width = MathKt.roundToInt(Size.m2437getWidthimpl(this.containerSize));
        float rightPadding = this.overscrollConfig.getDrawPadding().mo396calculateRightPaddingu2uoSUM($this$drawRight.getLayoutDirection());
        canvas.rotate(90.0f);
        canvas.translate(0.0f, (-width) + $this$drawRight.mo301toPx0680j_4(rightPadding));
    ...
    private final boolean drawBottom(DrawScope $this$drawBottom, EdgeEffect bottom, android.graphics.Canvas canvas) {
        ...
        float bottomPadding = $this$drawBottom.mo301toPx0680j_4(this.overscrollConfig.getDrawPadding().mo394calculateBottomPaddingD9Ej5fM());
        canvas.translate(-Size.m2437getWidthimpl(this.containerSize), (-Size.m2434getHeightimpl(this.containerSize)) + bottomPadding);
    ...
    private final boolean m144releaseOppositeOverscrollk4lQ0M(long delta) {
        boolean needsInvalidation = false;
        if (!this.leftEffect.isFinished() && Offset.m2368getXimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.leftEffect, Offset.m2368getXimpl(delta));
            needsInvalidation = this.leftEffect.isFinished();
        }
        boolean needsInvalidation2 = false;
        if (!this.rightEffect.isFinished() && Offset.m2368getXimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.rightEffect, Offset.m2368getXimpl(delta));
            needsInvalidation = needsInvalidation || this.rightEffect.isFinished();
        }
        if (!this.topEffect.isFinished() && Offset.m2369getYimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.topEffect, Offset.m2369getYimpl(delta));
            needsInvalidation = needsInvalidation || this.topEffect.isFinished();
        }
        if (!this.bottomEffect.isFinished() && Offset.m2369getYimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.bottomEffect, Offset.m2369getYimpl(delta));
    ...
    private final float m143pullTop0a9Yr6o(long scroll, long displacement) {
        float displacementX = Offset.m2368getXimpl(displacement) / Size.m2437getWidthimpl(this.containerSize);
        float pullY = Offset.m2369getYimpl(scroll) / Size.m2434getHeightimpl(this.containerSize);
        float consumed = EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.topEffect, pullY, displacementX) * Size.m2434getHeightimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.topEffect) == 0.0f)) {
            return Offset.m2369getYimpl(scroll);
        }
        return consumed;
    }

    /* renamed from: pullBottom-0a9Yr6o  reason: not valid java name */
    private final float m140pullBottom0a9Yr6o(long scroll, long displacement) {
        float displacementX = Offset.m2368getXimpl(displacement) / Size.m2437getWidthimpl(this.containerSize);
        float pullY = Offset.m2369getYimpl(scroll) / Size.m2434getHeightimpl(this.containerSize);
        float consumed = (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.bottomEffect, -pullY, 1 - displacementX)) * Size.m2434getHeightimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.bottomEffect) == 0.0f)) {
            return Offset.m2369getYimpl(scroll);
        }
        return consumed;
    ...
    private final float m141pullLeft0a9Yr6o(long scroll, long displacement) {
        float displacementY = Offset.m2369getYimpl(displacement) / Size.m2434getHeightimpl(this.containerSize);
        float pullX = Offset.m2368getXimpl(scroll) / Size.m2437getWidthimpl(this.containerSize);
        float consumed = EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.leftEffect, pullX, 1 - displacementY) * Size.m2437getWidthimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.leftEffect) == 0.0f)) {
            return Offset.m2368getXimpl(scroll);
        }
        return consumed;
    }

    /* renamed from: pullRight-0a9Yr6o  reason: not valid java name */
    private final float m142pullRight0a9Yr6o(long scroll, long displacement) {
        float displacementY = Offset.m2369getYimpl(displacement) / Size.m2434getHeightimpl(this.containerSize);
        float pullX = Offset.m2368getXimpl(scroll) / Size.m2437getWidthimpl(this.containerSize);
        float consumed = (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(this.rightEffect, -pullX, displacementY)) * Size.m2437getWidthimpl(this.containerSize);
        if (!(EdgeEffectCompat.INSTANCE.getDistanceCompat(this.rightEffect) == 0.0f)) {
            return Offset.m2368getXimpl(scroll);
        }
        return consumed;
