...
public final class MagnifierKt$magnifier$4 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer $composer, int $changed) {
        ...
        if (it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2357boximpl(Offset.Companion.m2383getUnspecifiedF1C5BW0()), null, 2, null);
        ...
        if (it$iv$iv2 == Composer.Companion.getEmpty()) {
            value$iv$iv2 = SnapshotStateKt.derivedStateOf(new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$sourceCenterInRoot$2$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m2357boximpl(m197invokeF1C5BW0());
                }
                ...
                public final long m197invokeF1C5BW0() {
                    ...
                    long sourceCenterOffset = ((Offset) invoke$lambda$3.invoke(Density.this)).m2378unboximpl();
                    if (OffsetKt.m2387isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.invoke$lambda$1(anchorPositionInRoot$delegate)) && OffsetKt.m2387isSpecifiedk4lQ0M(sourceCenterOffset)) {
                        return Offset.m2373plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(anchorPositionInRoot$delegate), sourceCenterOffset);
                    }
        ...
        if (it$iv$iv3 == Composer.Companion.getEmpty()) {
            value$iv$iv3 = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$isMagnifierShown$2$1
                ...
                public final Boolean invoke() {
                    return Boolean.valueOf(OffsetKt.m2387isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.invoke$lambda$8(sourceCenterInRoot$delegate)));
                }
            });
        ...
        Float valueOf = Float.valueOf(zoomEffectKey);
        ...
        if (invalid$iv$iv || it$iv$iv5 == Composer.Companion.getEmpty()) {
            Object value$iv$iv7 = (Function1) new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$2$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
        ...
        if (invalid$iv$iv2 || it$iv$iv6 == Composer.Companion.getEmpty()) {
            Object value$iv$iv8 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    ...
                    semantics.set(magnifierPositionInRoot, new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1.1
                        ...
                        @Override // kotlin.jvm.functions.Function0
                        public /* bridge */ /* synthetic */ Offset invoke() {
                            return Offset.m2357boximpl(m196invokeF1C5BW0());
                        }
    ...
    public static final long invoke$lambda$1(MutableState<Offset> mutableState) {
        ...
        return $this$getValue$iv.getValue().m2378unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void invoke$lambda$2(MutableState<Offset> mutableState, long value) {
        mutableState.setValue(Offset.m2357boximpl(value));
    }
    ...
    public static final long invoke$lambda$8(State<Offset> state) {
        Object thisObj$iv = state.getValue();
        return ((Offset) thisObj$iv).m2378unboximpl();
    }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    long newSize = magnifier2.mo215getSizeYbymL2g();
                    ...
                    if (invoke$lambda$6 != null) {
                        invoke$lambda$6.invoke(DpSize.m5208boximpl($this$invokeSuspend_u24lambda_u241_u24lambda_u240.mo299toDpSizekrfVVM(IntSizeKt.m5292toSizeozmzZPI(newSize))));
                    }
                    previousSize.element = newSize;
                    FlowKt.launchIn(FlowKt.onEach(this.$onNeedsUpdate, new C00031(magnifier2, null)), $this$LaunchedEffect);
                    try {
                        ...
                        if (FlowKt.collect(SnapshotStateKt.snapshotFlow(new Function0<Unit>() { // from class: androidx.compose.foundation.MagnifierKt.magnifier.4.1.2
                            ...
                            public final void invoke2() {
                                long m2383getUnspecifiedF1C5BW0;
                                if (MagnifierKt$magnifier$4.invoke$lambda$10(state)) {
                                    ...
                                    long it = ((Offset) invoke).m2378unboximpl();
                                    if (OffsetKt.m2387isSpecifiedk4lQ0M(it)) {
                                        m2383getUnspecifiedF1C5BW0 = Offset.m2373plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(mutableState2), it);
                                    } else {
                                        m2383getUnspecifiedF1C5BW0 = Offset.Companion.m2383getUnspecifiedF1C5BW0();
                                    }
                                    platformMagnifier.mo216updateWko1d7g(invoke$lambda$8, m2383getUnspecifiedF1C5BW0, MagnifierKt$magnifier$4.invoke$lambda$5(state4));
                                    long size = PlatformMagnifier.this.mo215getSizeYbymL2g();
                                    ...
                                    if (!IntSize.m5280equalsimpl0(size, longRef.element)) {
                                        longRef.element = size;
                                        Function1 invoke$lambda$62 = MagnifierKt$magnifier$4.invoke$lambda$6(state6);
                                        if (invoke$lambda$62 != null) {
                                            invoke$lambda$62.invoke(DpSize.m5208boximpl($this$invoke_u24lambda_u242_u24lambda_u241.mo299toDpSizekrfVVM(IntSizeKt.m5292toSizeozmzZPI(size))));
                                            return;
                                        }
                                        return;
                                    }
