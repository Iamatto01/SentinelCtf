...
public interface PaddingValues {
    ...
    float mo395calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM */
    float mo396calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM */
    float mo397calculateTopPaddingD9Ej5fM();
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m423getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m424getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m425getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m426getTopD9Ej5fM$annotations() {
        }
        ...
        public /* synthetic */ Absolute(float f, float f2, float f3, float f4, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? Dp.m5122constructorimpl(0) : f, (i & 2) != 0 ? Dp.m5122constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m5122constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m5122constructorimpl(0) : f4, null);
        }

        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateLeftPadding-u2uoSUM */
        public float mo395calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateTopPadding-D9Ej5fM */
        public float mo397calculateTopPaddingD9Ej5fM() {
            return this.top;
        }

        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateRightPadding-u2uoSUM */
        public float mo396calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return this.right;
        }
        ...
        @Override // androidx.compose.foundation.layout.PaddingValues
        /* renamed from: calculateBottomPadding-D9Ej5fM */
        public float mo394calculateBottomPaddingD9Ej5fM() {
            return this.bottom;
        }

        public boolean equals(Object other) {
            return (other instanceof Absolute) && Dp.m5127equalsimpl0(this.left, ((Absolute) other).left) && Dp.m5127equalsimpl0(this.top, ((Absolute) other).top) && Dp.m5127equalsimpl0(this.right, ((Absolute) other).right) && Dp.m5127equalsimpl0(this.bottom, ((Absolute) other).bottom);
        }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m5133toStringimpl(this.left)) + ", top=" + ((Object) Dp.m5133toStringimpl(this.top)) + ", right=" + ((Object) Dp.m5133toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m5133toStringimpl(this.bottom)) + ')';
        }
    }
}
