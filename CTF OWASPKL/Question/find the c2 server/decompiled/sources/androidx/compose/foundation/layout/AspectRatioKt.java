...
public final class AspectRatioKt {
    ...
    public static final Modifier aspectRatio(Modifier $this$aspectRatio, final float ratio, final boolean matchHeightConstraintsFirst) {
        ...
        return $this$aspectRatio.then(new AspectRatioModifier(ratio, matchHeightConstraintsFirst, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.AspectRatioKt$aspectRatio$$inlined$debugInspectorInfo$1
