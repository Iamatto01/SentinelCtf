...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent $this$calculateRotation) {
        ...
        while (index$iv < size2) {
            ...
            if (!change.getPressed() || !change.getPreviousPressed()) {
                ...
                long currentPosition = change.m4007getPositionF1C5BW0();
                long previousPosition2 = change.m4008getPreviousPositionF1C5BW0();
                long previousOffset = Offset.m2372minusMKHz9U(previousPosition2, previousCentroid);
                previousPosition = currentCentroid2;
                currentCentroid = previousCentroid;
                pointerCount = pointerCount2;
                long currentOffset = Offset.m2372minusMKHz9U(currentPosition, previousPosition);
                float previousAngle = m326anglek4lQ0M(previousOffset);
                float currentAngle = m326anglek4lQ0M(currentOffset);
                float angleDiff = currentAngle - previousAngle;
                float weight = Offset.m2366getDistanceimpl(Offset.m2373plusMKHz9U(currentOffset, previousOffset)) / 2.0f;
                if (angleDiff > 180.0f) {
                    f = angleDiff - 360.0f;
                } else {
    ...
    private static final float m326anglek4lQ0M(long $this$angle_u2dk_u2d4lQ0M) {
        if (Offset.m2368getXimpl($this$angle_u2dk_u2d4lQ0M) == 0.0f) {
            if (Offset.m2369getYimpl($this$angle_u2dk_u2d4lQ0M) == 0.0f) {
                return 0.0f;
            }
        }
        return ((-((float) Math.atan2(Offset.m2368getXimpl($this$angle_u2dk_u2d4lQ0M), Offset.m2369getYimpl($this$angle_u2dk_u2d4lQ0M)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent $this$calculatePan) {
        ...
        if (Offset.m2365equalsimpl0(currentCentroid, Offset.Companion.m2383getUnspecifiedF1C5BW0())) {
            return Offset.Companion.m2384getZeroF1C5BW0();
        }
        long previousCentroid = calculateCentroid($this$calculatePan, false);
        return Offset.m2372minusMKHz9U(currentCentroid, previousCentroid);
    }
    ...
    public static final float calculateCentroidSize(PointerEvent $this$calculateCentroidSize, boolean useCurrent) {
        ...
        if (Offset.m2365equalsimpl0(centroid, Offset.Companion.m2383getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            PointerInputChange change = (PointerInputChange) item$iv;
            if (change.getPressed() && change.getPreviousPressed()) {
                long position = useCurrent ? change.m4007getPositionF1C5BW0() : change.m4008getPreviousPositionF1C5BW0();
                distanceToCentroid += Offset.m2366getDistanceimpl(Offset.m2372minusMKHz9U(position, centroid));
                distanceWeight++;
            }
        }
    ...
    public static final long calculateCentroid(PointerEvent $this$calculateCentroid, boolean useCurrent) {
        ...
        long centroid = Offset.Companion.m2384getZeroF1C5BW0();
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            if (change.getPressed() && change.getPreviousPressed()) {
                long position = useCurrent ? change.m4007getPositionF1C5BW0() : change.m4008getPreviousPositionF1C5BW0();
                centroid = Offset.m2373plusMKHz9U(centroid, position);
                centroidWeight++;
            }
        }
        if (centroidWeight == 0) {
        ...
        return Offset.m2363divtuRUvjQ(centroid, centroidWeight);
    }
}
