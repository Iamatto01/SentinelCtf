...
public final class InfiniteTransition {
    ...
    private final boolean getRefreshChildNeeded() {
        State $this$getValue$iv = this.refreshChildNeeded$delegate;
        return ((Boolean) $this$getValue$iv.getValue()).booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void setRefreshChildNeeded(boolean z) {
        MutableState $this$setValue$iv = this.refreshChildNeeded$delegate;
    ...
    public final void run$animation_core_release(Composer $composer, final int $changed) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.animation.core.InfiniteTransition$run$2
            ...
            public final void invoke(Composer composer, int i) {
                InfiniteTransition.this.run$animation_core_release(composer, $changed | 1);
            }
        });
    }
