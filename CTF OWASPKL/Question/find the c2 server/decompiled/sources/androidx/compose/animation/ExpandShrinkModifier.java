...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m58sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        long preEnterSize = it != null ? it.getSize().invoke(IntSize.m5274boximpl(fullSize)).m5286unboximpl() : fullSize;
        ChangeSize it2 = this.shrink.getValue();
        long postExitSize = it2 != null ? it2.getSize().invoke(IntSize.m5274boximpl(fullSize)).m5286unboximpl() : fullSize;
    ...
    public final long m59targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        if (this.currentAlignment != null && this.alignment.getValue() != null && !Intrinsics.areEqual(this.currentAlignment, this.alignment.getValue())) {
            switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
                case 1:
                    return IntOffset.Companion.m5250getZeronOccac();
                case 2:
                    return IntOffset.Companion.m5250getZeronOccac();
                case 3:
                    ChangeSize it = this.shrink.getValue();
                    if (it != null) {
                        long endSize = it.getSize().invoke(IntSize.m5274boximpl(fullSize)).m5286unboximpl();
                        Alignment value = this.alignment.getValue();
                        Intrinsics.checkNotNull(value);
                        long targetOffset = value.mo2264alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                        Alignment alignment = this.currentAlignment;
                        Intrinsics.checkNotNull(alignment);
                        long currentOffset = alignment.mo2264alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                        return IntOffsetKt.IntOffset(IntOffset.m5240getXimpl(targetOffset) - IntOffset.m5240getXimpl(currentOffset), IntOffset.m5241getYimpl(targetOffset) - IntOffset.m5241getYimpl(currentOffset));
                    }
                    return IntOffset.Companion.m5250getZeronOccac();
                default:
                    throw new NoWhenBranchMatchedException();
    ...
    public MeasureResult mo24measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
        ...
        long currentSize = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m5274boximpl(m60invokeYEO4UFw(enterExitState));
            }
        ...
        final long offsetDelta = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m5231boximpl(m61invokeBjo55l4(enterExitState));
            }
        ...
        }).getValue().m5249unboximpl();
        Alignment alignment = this.currentAlignment;
        final long offset = alignment != null ? alignment.mo2264alignKFBX0sM(measuredSize, currentSize, LayoutDirection.Ltr) : IntOffset.Companion.m5250getZeronOccac();
        return MeasureScope.layout$default(measure, IntSize.m5282getWidthimpl(currentSize), IntSize.m5281getHeightimpl(currentSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, Placeable.this, IntOffset.m5240getXimpl(offset) + IntOffset.m5240getXimpl(offsetDelta), IntOffset.m5241getYimpl(offset) + IntOffset.m5241getYimpl(offsetDelta), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
