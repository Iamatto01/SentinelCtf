...
public final class ContentTransform {
    ...
    public ContentTransform(EnterTransition targetContentEnter, ExitTransition initialContentExit, float targetContentZIndex, SizeTransform sizeTransform) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Float.valueOf(targetContentZIndex), null, 2, null);
    ...
    public final float getTargetContentZIndex() {
        State $this$getValue$iv = this.targetContentZIndex$delegate;
        return ((Number) $this$getValue$iv.getValue()).floatValue();
    }

    public final void setTargetContentZIndex(float f) {
        MutableState $this$setValue$iv = this.targetContentZIndex$delegate;
