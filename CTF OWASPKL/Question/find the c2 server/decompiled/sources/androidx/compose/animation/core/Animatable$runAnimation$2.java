...
public final class Animatable$runAnimation$2<T, V> extends SuspendLambda implements Function1<Continuation<? super AnimationResult<T, V>>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        Animatable$runAnimation$2 animatable$runAnimation$2 = this;
        try {
            switch (animatable$runAnimation$2.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    animatable$runAnimation$2 = this;
                    animatable$runAnimation$2.this$0.getInternalState$animation_core_release().setVelocityVector$animation_core_release((V) ((AnimationVector) animatable$runAnimation$2.this$0.getTypeConverter().getConvertToVector().invoke(animatable$runAnimation$2.$initialVelocity)));
                    ...
                    endState = AnimationStateKt.copy$default((AnimationState) animatable$runAnimation$2.this$0.getInternalState$animation_core_release(), (Object) null, (AnimationVector) null, 0L, Long.MIN_VALUE, false, 23, (Object) null);
                    ...
                    if (SuspendAnimationKt.animate(endState, animation, j, new Function1<AnimationScope<T, V>, Unit>() { // from class: androidx.compose.animation.core.Animatable$runAnimation$2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(1);
                        ...
                        public final void invoke(AnimationScope<T, V> animate) {
                            ...
                            clamped = animatable.clampToBounds(animate.getValue());
                            if (!Intrinsics.areEqual(clamped, animate.getValue())) {
