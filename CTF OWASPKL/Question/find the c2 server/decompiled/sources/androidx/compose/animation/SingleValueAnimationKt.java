...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m68animateColorAsStateeuL9pac(long targetValue, AnimationSpec<Color> animationSpec, String label, Function1<? super Color, Unit> function1, Composer $composer, int $changed, int i) {
        ...
        Object key1$iv = Color.m2610getColorSpaceimpl(targetValue);
        $composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation($composer, "C(remember)P(1):Composables.kt#9igjgp");
        boolean invalid$iv$iv = $composer.changed(key1$iv);
        Object it$iv$iv = $composer.rememberedValue();
        if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
            value$iv$iv = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(Color.m2610getColorSpaceimpl(targetValue));
        ...
        State<Color> animateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m2596boximpl(targetValue), converter, animationSpec2, null, label2, finishedListener, $composer, ($changed & 14) | 576 | (($changed << 6) & 57344) | (458752 & ($changed << 6)), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Animatable<Color, AnimationVector4D> m66Animatable8_81llA(long initialValue) {
        return new Animatable<>(Color.m2596boximpl(initialValue), ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(Color.m2610getColorSpaceimpl(initialValue)), null, null, 12, null);
    }
}
