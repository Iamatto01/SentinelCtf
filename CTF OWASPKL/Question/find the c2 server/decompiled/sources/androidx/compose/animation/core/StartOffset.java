...
public final class StartOffset {
    ...
    public static boolean m112equalsimpl(long j, Object obj) {
        return (obj instanceof StartOffset) && j == ((StartOffset) obj).m118unboximpl();
    }
    ...
    public final /* synthetic */ long m118unboximpl() {
        return this.value;
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m109constructorimpl(int offsetMillis, int offsetType) {
        return m110constructorimpl(offsetMillis * offsetType);
    }
    ...
    public static /* synthetic */ long m111constructorimpl$default(int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i3 & 2) != 0) {
            i2 = StartOffsetType.Companion.m126getDelayEo1U57Q();
        }
        return m109constructorimpl(i, i2);
    }

    /* renamed from: getOffsetMillis-impl  reason: not valid java name */
    public static final int m114getOffsetMillisimpl(long arg0) {
        return Math.abs((int) arg0);
    }

    /* renamed from: getOffsetType-Eo1U57Q  reason: not valid java name */
    public static final int m115getOffsetTypeEo1U57Q(long arg0) {
        boolean z = arg0 > 0;
        if (z) {
            return StartOffsetType.Companion.m127getFastForwardEo1U57Q();
        }
        if (z) {
            throw new NoWhenBranchMatchedException();
        }
        return StartOffsetType.Companion.m126getDelayEo1U57Q();
    }
}
