...
public final class AnimatedContentScope<S> implements Transition.Segment<S> {
    ...
    public AnimatedContentScope(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5274boximpl(IntSize.Companion.m5287getZeroYbymL2g()), null, 2, null);
    ...
    public static final class SlideDirection {
        ...
        public static boolean m28equalsimpl(int i, Object obj) {
            return (obj instanceof SlideDirection) && i == ((SlideDirection) obj).m32unboximpl();
        }
        ...
        public static String m31toStringimpl(int arg0) {
            return m29equalsimpl0(arg0, Left) ? "Left" : m29equalsimpl0(arg0, Right) ? "Right" : m29equalsimpl0(arg0, Up) ? "Up" : m29equalsimpl0(arg0, Down) ? "Down" : m29equalsimpl0(arg0, Start) ? "Start" : m29equalsimpl0(arg0, End) ? "End" : "Invalid";
        }
    }
    ...
    public static /* synthetic */ EnterTransition m18slideIntoContainerHTTW7Ok$default(AnimatedContentScope animatedContentScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5231boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, null);
        }
        if ((i2 & 4) != 0) {
    ...
    public final EnterTransition m22slideIntoContainerHTTW7Ok(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(initialOffset, "initialOffset");
        return m16isLeft9jb1Dl8(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$2
            ...
            public final Integer invoke(int it) {
                ...
                int m5282getWidthimpl = IntSize.m5282getWidthimpl(m15getCurrentSizeYbymL2g);
                ...
                return function1.invoke(Integer.valueOf(m5282getWidthimpl - IntOffset.m5240getXimpl(m14calculateOffsetemnUabE)));
            }
        }) : m17isRight9jb1Dl8(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final Integer invoke(int it) {
                ...
                return function1.invoke(Integer.valueOf((-IntOffset.m5240getXimpl(m14calculateOffsetemnUabE)) - it));
            }
        }) : SlideDirection.m29equalsimpl0(towards, SlideDirection.Companion.m38getUpaUPqQNE()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m15getCurrentSizeYbymL2g = this.m15getCurrentSizeYbymL2g();
                int m5281getHeightimpl = IntSize.m5281getHeightimpl(m15getCurrentSizeYbymL2g);
                AnimatedContentScope<S> animatedContentScope = this;
                long IntSize = IntSizeKt.IntSize(it, it);
                m15getCurrentSizeYbymL2g2 = this.m15getCurrentSizeYbymL2g();
                m14calculateOffsetemnUabE = animatedContentScope.m14calculateOffsetemnUabE(IntSize, m15getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5281getHeightimpl - IntOffset.m5241getYimpl(m14calculateOffsetemnUabE)));
            }
        }) : SlideDirection.m29equalsimpl0(towards, SlideDirection.Companion.m33getDownaUPqQNE()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentScope$slideIntoContainer$5
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final Integer invoke(int it) {
                ...
                m15getCurrentSizeYbymL2g = this.m15getCurrentSizeYbymL2g();
                m14calculateOffsetemnUabE = animatedContentScope.m14calculateOffsetemnUabE(IntSize, m15getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m5241getYimpl(m14calculateOffsetemnUabE)) - it));
            }
        }) : EnterTransition.Companion.getNone();
    }

    /* renamed from: isLeft-9jb1Dl8  reason: not valid java name */
    private final boolean m16isLeft9jb1Dl8(int $this$isLeft) {
        return SlideDirection.m29equalsimpl0($this$isLeft, SlideDirection.Companion.m35getLeftaUPqQNE()) || (SlideDirection.m29equalsimpl0($this$isLeft, SlideDirection.Companion.m37getStartaUPqQNE()) && this.layoutDirection == LayoutDirection.Ltr) || (SlideDirection.m29equalsimpl0($this$isLeft, SlideDirection.Companion.m34getEndaUPqQNE()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-9jb1Dl8  reason: not valid java name */
    private final boolean m17isRight9jb1Dl8(int $this$isRight) {
        return SlideDirection.m29equalsimpl0($this$isRight, SlideDirection.Companion.m36getRightaUPqQNE()) || (SlideDirection.m29equalsimpl0($this$isRight, SlideDirection.Companion.m37getStartaUPqQNE()) && this.layoutDirection == LayoutDirection.Rtl) || (SlideDirection.m29equalsimpl0($this$isRight, SlideDirection.Companion.m34getEndaUPqQNE()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE  reason: not valid java name */
    public final long m14calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.mo2264alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }
    ...
    public final ExitTransition m23slideOutOfContainerHTTW7Ok(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(targetOffset, "targetOffset");
        return m16isLeft9jb1Dl8(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$2
            ...
            public final Integer invoke(int it) {
                ...
                long targetSize = state != null ? ((IntSize) state.getValue()).m5286unboximpl() : IntSize.Companion.m5287getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m14calculateOffsetemnUabE = this.this$0.m14calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5240getXimpl(m14calculateOffsetemnUabE)) - it));
            }
        }) : m17isRight9jb1Dl8(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$3
            final /* synthetic */ AnimatedContentScope<S> this$0;
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m14calculateOffsetemnUabE = this.this$0.m14calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5240getXimpl(m14calculateOffsetemnUabE)) + IntSize.m5282getWidthimpl(targetSize)));
            }
        }) : SlideDirection.m29equalsimpl0(towards, SlideDirection.Companion.m38getUpaUPqQNE()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$4
            final /* synthetic */ AnimatedContentScope<S> this$0;
        ...
        }) : SlideDirection.m29equalsimpl0(towards, SlideDirection.Companion.m33getDownaUPqQNE()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentScope$slideOutOfContainer$5
            final /* synthetic */ AnimatedContentScope<S> this$0;
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m14calculateOffsetemnUabE = this.this$0.m14calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m5241getYimpl(m14calculateOffsetemnUabE)) + IntSize.m5281getHeightimpl(targetSize)));
            }
    ...
    public final long m20getMeasuredSizeYbymL2g$animation_release() {
        ...
        return ((IntSize) $this$getValue$iv.getValue()).m5286unboximpl();
    }
    ...
    public final void m21setMeasuredSizeozmzZPI$animation_release(long j) {
        ...
        $this$setValue$iv.setValue(IntSize.m5274boximpl(j));
    }
    ...
    public final long m15getCurrentSizeYbymL2g() {
        ...
        return state != null ? state.getValue().m5286unboximpl() : m20getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    public final Modifier createSizeAnimationModifier$animation_release(ContentTransform contentTransform, Composer $composer, int $changed) {
        ...
        MutableState shouldAnimateSize$delegate = (MutableState) value$iv$iv2;
        ...
        if (createSizeAnimationModifier$lambda$2(shouldAnimateSize$delegate)) {
            Transition.DeferredAnimation sizeAnimation = androidx.compose.animation.core.TransitionKt.createDeferredAnimation(this.transition, VectorConvertersKt.getVectorConverter(IntSize.Companion), null, $composer, 64, 2);
            $composer.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation($composer, "C(remember)P(1):Composables.kt#9igjgp");
            ...
            if (invalid$iv$iv2 || it$iv$iv2 == Composer.Companion.getEmpty()) {
                ...
                value$iv$iv3 = ((sizeTransform2 == null || sizeTransform2.getClip()) ? false : false ? Modifier.Companion : ClipKt.clipToBounds(Modifier.Companion)).then(new SizeModifier(this, sizeAnimation, sizeTransform));
                $composer.updateRememberedValue(value$iv$iv3);
            } else {
                value$iv$iv3 = it$iv$iv2;
            }
            $composer.endReplaceableGroup();
            companion = (Modifier) value$iv$iv3;
        } else {
    ...
    public final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo24measure3p2s80s(MeasureScope measure, Measurable measurable, long constraints) {
            ...
            final Placeable placeable = measurable.mo4125measureBRTryo0(constraints);
            ...
            State size = deferredAnimation.animate(new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentScope$SizeModifier$measure$size$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    ...
                    long initial = state != null ? state.getValue().m5286unboximpl() : IntSize.Companion.m5287getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentScope.getTargetSizeMap$animation_release().get(animate.getTargetState());
                    long target = state2 != null ? state2.getValue().m5286unboximpl() : IntSize.Companion.m5287getZeroYbymL2g();
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object p1) {
                    return IntSize.m5274boximpl(m25invokeYEO4UFw(p1));
                }

                /* renamed from: invoke-YEO4UFw  reason: not valid java name */
                public final long m25invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentScope2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().m5286unboximpl() : IntSize.Companion.m5287getZeroYbymL2g();
                }
            }));
            this.this$0.setAnimatedSize$animation_release(size);
            final long offset = this.this$0.getContentAlignment$animation_release().mo2264alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), size.getValue().m5286unboximpl(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measure, IntSize.m5282getWidthimpl(size.getValue().m5286unboximpl()), IntSize.m5281getHeightimpl(size.getValue().m5286unboximpl()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentScope$SizeModifier$measure$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m4173place70tqf50$default(layout, Placeable.this, offset, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
