...
public final class Transition<S> {
    ...
    public final long getPlayTimeNanos() {
        State $this$getValue$iv = this.playTimeNanos$delegate;
        return ((Number) $this$getValue$iv.getValue()).longValue();
    }

    public final void setPlayTimeNanos(long j) {
        MutableState $this$setValue$iv = this.playTimeNanos$delegate;
        $this$setValue$iv.setValue(Long.valueOf(j));
    }

    private final long getStartTimeNanos() {
        State $this$getValue$iv = this.startTimeNanos$delegate;
        return ((Number) $this$getValue$iv.getValue()).longValue();
    }

    private final void setStartTimeNanos(long j) {
        MutableState $this$setValue$iv = this.startTimeNanos$delegate;
        $this$setValue$iv.setValue(Long.valueOf(j));
    }
    ...
    public final void seek(S s, S s2, long playTimeNanos) {
        ...
        for (Transition element$iv : $this$forEach$iv) {
            Transition it = element$iv;
        ...
        for (TransitionAnimationState element$iv2 : $this$forEach$iv2) {
            element$iv2.seekTo$animation_core_release(playTimeNanos);
        }
    ...
    public final void updateTarget$animation_core_release(final S s, Composer $composer, final int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-583974681, $changed, -1, "androidx.compose.animation.core.Transition.updateTarget (Transition.kt:399)");
            }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>(this) { // from class: androidx.compose.animation.core.Transition$updateTarget$2
            ...
            public final void invoke(Composer composer, int i) {
                this.$tmp0_rcvr.updateTarget$animation_core_release(s, composer, $changed | 1);
            }
        });
    }
    ...
    public final void animateTo$animation_core_release(final S s, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(animateTo)426@16622L25,430@16892L655,430@16871L676:Transition.kt#pdpnli");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
            $dirty |= $composer2.changed(s) ? 4 : 2;
        }
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1493585151, $dirty, -1, "androidx.compose.animation.core.Transition.animateTo (Transition.kt:424)");
            }
            if (!isSeeking()) {
                ...
                if (!Intrinsics.areEqual(s, getCurrentState()) || isRunning() || getUpdateChildrenNeeded$animation_core_release()) {
                    ...
                    if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                        value$iv$iv = (Function2) new Transition$animateTo$1$1(this, null);
                        $composer2.updateRememberedValue(value$iv$iv);
                    } else {
                        value$iv$iv = it$iv$iv;
                    }
                    $composer2.endReplaceableGroup();
                    EffectsKt.LaunchedEffect(this, (Function2) value$iv$iv, $composer2, (($dirty >> 3) & 14) | 64);
                }
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>(this) { // from class: androidx.compose.animation.core.Transition$animateTo$2
            ...
            public final void invoke(Composer composer, int i2) {
                this.$tmp0_rcvr.animateTo$animation_core_release(s, composer, $changed | 1);
            }
        });
    }
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        private final long getOffsetTimeNanos() {
            State $this$getValue$iv = this.offsetTimeNanos$delegate;
            return ((Number) $this$getValue$iv.getValue()).longValue();
        }

        private final void setOffsetTimeNanos(long j) {
            MutableState $this$setValue$iv = this.offsetTimeNanos$delegate;
            $this$setValue$iv.setValue(Long.valueOf(j));
        }

        private final boolean getNeedsReset() {
            State $this$getValue$iv = this.needsReset$delegate;
            return ((Boolean) $this$getValue$iv.getValue()).booleanValue();
        }

        private final void setNeedsReset(boolean z) {
            MutableState $this$setValue$iv = this.needsReset$delegate;
            $this$setValue$iv.setValue(Boolean.valueOf(z));
        }
