    ...
    */
    ...
    public static final void AnimatedVisibility(final boolean visible, Modifier modifier, final EnterTransition enter, final ExitTransition exit, final boolean initiallyVisible, final Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            AnimatedVisibility((MutableTransitionState) value$iv$iv, modifier2, enter, exit, (String) null, ComposableLambdaKt.composableLambda($composer2, 1996320812, true, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibility$16
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibility$17
            ...
            public final void invoke(Composer composer, int i3) {
                AnimatedVisibilityKt.AnimatedVisibility(visible, modifier3, enter, exit, initiallyVisible, content, composer, $changed | 1, i);
            }
        });
    }
    ...
    public static final <T> void AnimatedEnterExitImpl(final Transition<T> transition, final Function1<? super T, Boolean> function1, final Modifier modifier, final EnterTransition enter, final ExitTransition exit, final Function3<? super AnimatedVisibilityScope, ? super Composer, ? super Integer, Unit> function3, Composer $composer, final int $changed) {
        ...
        if ((374491 & $dirty2) != 74898 || !$composer2.getSkipping()) {
            ...
            if (function1.invoke(transition.getTargetState()).booleanValue() || ((Boolean) isAnimationVisible.getValue()).booleanValue() || transition.isSeeking()) {
                ...
                ComposerKt.sourceInformation($composer2, "CC(createChildTransition)785@31111L36,786@31171L74,787@31268L39,788@31319L63:Transition.kt#pdpnli");
                ...
                if (invalid$iv$iv$iv || it$iv$iv$iv == Composer.Companion.getEmpty()) {
                    ...
                    $composer2.updateRememberedValue(currentState);
                } else {
                    currentState = it$iv$iv$iv;
                }
                $composer2.endReplaceableGroup();
                Object it = transition.isSeeking() ? transition.getCurrentState() : currentState;
                ...
                if (invalid$iv$iv2 || it$iv$iv2 == Composer.Companion.getEmpty()) {
                    value$iv$iv2 = (Function2) new AnimatedVisibilityKt$AnimatedEnterExitImpl$1$1(childTransition, isAnimationVisible, null);
                    $composer2.updateRememberedValue(value$iv$iv2);
                } else {
                    value$iv$iv2 = it$iv$iv2;
                }
                $composer2.endReplaceableGroup();
                EffectsKt.LaunchedEffect(childTransition, (Function2) value$iv$iv2, $composer2, 64);
                ...
                if (childTransition.getCurrentState() == EnterExitState.Visible || childTransition.getTargetState() == EnterExitState.Visible) {
                    ...
                    if (invalid$iv$iv$iv2 || it$iv$iv$iv2 == Composer.Companion.getEmpty()) {
                        value$iv$iv$iv = new AnimatedVisibilityScopeImpl(childTransition);
                        $composer2.updateRememberedValue(value$iv$iv$iv);
                    } else {
                        value$iv$iv$iv = it$iv$iv$iv2;
                    }
                    $composer2.endReplaceableGroup();
                    AnimatedVisibilityScopeImpl scope$iv = (AnimatedVisibilityScopeImpl) value$iv$iv$iv;
                    ...
                    if (it$iv$iv$iv3 == Composer.Companion.getEmpty()) {
                        value$iv$iv$iv2 = new AnimatedEnterExitMeasurePolicy(scope$iv);
                        $composer2.updateRememberedValue(value$iv$iv$iv2);
                    } else {
                        value$iv$iv$iv2 = it$iv$iv$iv3;
                    }
                    $composer2.endReplaceableGroup();
