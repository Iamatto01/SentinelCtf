...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m76targetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long preEnter = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.Companion.m5250getZeronOccac() : slideOffset2.invoke(IntSize.m5274boximpl(fullSize)).m5249unboximpl();
        Slide value2 = this.slideOut.getValue();
        long postExit = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.Companion.m5250getZeronOccac() : slideOffset.invoke(IntSize.m5274boximpl(fullSize)).m5249unboximpl();
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                State slideOffset = lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m5231boximpl(m77invokeBjo55l4(enterExitState));
                    }
                ...
                Placeable.PlacementScope.m4176placeWithLayeraW9wM$default(layout, placeable, slideOffset.getValue().m5249unboximpl(), 0.0f, null, 6, null);
            }
        }, 4, null);
    }
}
