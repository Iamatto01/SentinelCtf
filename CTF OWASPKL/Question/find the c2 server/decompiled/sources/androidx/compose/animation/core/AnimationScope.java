...
public final class AnimationScope<T, V extends AnimationVector> {
    ...
    public AnimationScope(T t, TwoWayConverter<T, V> typeConverter, V initialVelocityVector, long lastFrameTimeNanos, T t2, long startTimeNanos, boolean isRunning, Function0<Unit> onCancel) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Boolean.valueOf(isRunning), null, 2, null);
