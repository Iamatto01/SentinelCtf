...
public final class SuspendAnimationKt {
    public static /* synthetic */ Object animate$default(float f, float f2, float f3, AnimationSpec animationSpec, Function2 function2, Continuation continuation, int i, Object obj) {
        ...
        return animate(f, f2, f4, springSpec, function2, continuation);
    }
    ...
    public static /* synthetic */ Object animate$default(TwoWayConverter twoWayConverter, Object obj, Object obj2, Object obj3, AnimationSpec animationSpec, Function2 function2, Continuation continuation, int i, Object obj4) {
        ...
        return animate(twoWayConverter, obj, obj2, obj5, springSpec, function2, continuation);
    }
    ...
    public static final <T, V extends AnimationVector> Object animate(final TwoWayConverter<T, V> twoWayConverter, T t, T t2, T t3, AnimationSpec<T> animationSpec, final Function2<? super T, ? super T, Unit> function2, Continuation<? super Unit> continuation) {
        V invoke;
        V initialVelocityVector = (t3 == null || (invoke = twoWayConverter.getConvertToVector().invoke(t3)) == null) ? AnimationVectorsKt.newInstance(twoWayConverter.getConvertToVector().invoke(t)) : invoke;
    ...
    /* JADX WARN: Removed duplicated region for block: B:131:0x0128 A[Catch: CancellationException -> 0x0159, TRY_LEAVE, TryCatch #5 {CancellationException -> 0x0159, blocks: (B:129:0x011b, B:131:0x0128), top: B:165:0x011b }] */
    /* JADX WARN: Removed duplicated region for block: B:146:0x0171  */
    /* JADX WARN: Removed duplicated region for block: B:154:0x018c  */
    /* JADX WARN: Removed duplicated region for block: B:170:0x0156 A[SYNTHETIC] */
    ...
    */
    ...
    public static /* synthetic */ Object animate$default(AnimationState animationState, Animation animation, long j, Function1 function1, Continuation continuation, int i, Object obj) {
        long j2;
        SuspendAnimationKt$animate$5 suspendAnimationKt$animate$5;
        if ((i & 2) == 0) {
            j2 = j;
        } else {
            j2 = Long.MIN_VALUE;
        ...
        if ((i & 4) == 0) {
            suspendAnimationKt$animate$5 = function1;
        } else {
            suspendAnimationKt$animate$5 = new Function1<AnimationScope<T, V>, Unit>() { // from class: androidx.compose.animation.core.SuspendAnimationKt$animate$5
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(Object p1) {
                    invoke((AnimationScope) ((AnimationScope) p1));
                    return Unit.INSTANCE;
        ...
        return animate(animationState, animation, j2, suspendAnimationKt$animate$5, continuation);
    }
