...
public final class WithLifecycleStateKt {
    ...
    public static final <R> Object withStateAtLeast(LifecycleOwner $this$withStateAtLeast, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        if (!dispatchNeeded$iv$iv) {
            if ($this$withStateAtLeast$iv.getCurrentState() == Lifecycle.State.DESTROYED) {
                throw new LifecycleDestroyedException();
            }
            if ($this$withStateAtLeast$iv.getCurrentState().compareTo(state) >= 0) {
                return function0.invoke();
            }
        }
    ...
    public static final <R> Object withCreated(LifecycleOwner $this$withCreated, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        if (!dispatchNeeded$iv) {
            ...
            if ($this$withStateAtLeastUnchecked$iv.getCurrentState().compareTo(state$iv) >= 0) {
                return function0.invoke();
            }
        }
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.Companion.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        m5433constructorimpl = Result.m5433constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.Companion;
                        m5433constructorimpl = Result.m5433constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(m5433constructorimpl);
                } else if (event == Lifecycle.Event.ON_DESTROY) {
                    $this$suspendWithStateAtLeastUnchecked.removeObserver(this);
                    Result.Companion companion3 = Result.Companion;
                    co.resumeWith(Result.m5433constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (dispatchNeeded) {
            lifecycleDispatcher.mo6986dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$1
        ...
        co.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2
            ...
            public final void invoke2(Throwable it) {
                if (CoroutineDispatcher.this.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    ...
                    CoroutineDispatcher.this.mo6986dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2.1
                        @Override // java.lang.Runnable
                        public final void run() {
