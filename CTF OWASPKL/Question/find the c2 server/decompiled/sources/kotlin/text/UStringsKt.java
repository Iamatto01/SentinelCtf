...
public final class UStringsKt {
    ...
    public static final String m6745toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m6747toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m6746toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m6744toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m5501unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m5764unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m5580unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m5659unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m5580unboximpl = uIntOrNull.m5580unboximpl();
            if (Integer.compareUnsigned(m5580unboximpl, UInt.m5528constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m5445boximpl(UByte.m5451constructorimpl((byte) m5580unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m5580unboximpl = uIntOrNull.m5580unboximpl();
            if (Integer.compareUnsigned(m5580unboximpl, UInt.m5528constructorimpl(SupportMenu.USER_MASK)) > 0) {
                return null;
            }
            return UShort.m5708boximpl(UShort.m5714constructorimpl((short) m5580unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m5528constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m5528constructorimpl(result * uradix);
            result = UInt.m5528constructorimpl(UInt.m5528constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m5522boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m5607constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m5607constructorimpl(result * uradix);
            result = ULong.m5607constructorimpl(ULong.m5607constructorimpl(UInt.m5528constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m5601boximpl(result);
    }
}
