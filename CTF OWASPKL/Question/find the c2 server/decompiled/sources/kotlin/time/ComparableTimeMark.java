...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo6749minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo6750minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo6751plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m6754minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo6751plusLRDsOJo(Duration.m6811unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m6758compareToLRDsOJo($this.mo6750minusUwyO8pc(other), Duration.Companion.m6861getZEROUwyO8pc());
        }
    }
}
