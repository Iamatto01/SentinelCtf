...
public interface TimeMark {
    ...
    TimeMark mo6749minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6751plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m6896plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m6895minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo6751plusLRDsOJo(Duration.m6811unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m6792isNegativeimpl($this.mo6748elapsedNowUwyO8pc());
        }
