...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m6898boximpl(m6892markNowz9LOYto());
    }
    ...
    public long m6892markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m6901constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m6891elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    /* renamed from: differenceBetween-fRLX17w  reason: not valid java name */
    public final long m6890differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m6889adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m6901constructorimpl(LongSaturatedMathKt.m6887saturatingAddpTJri5U(timeMark, duration));
    }
}
