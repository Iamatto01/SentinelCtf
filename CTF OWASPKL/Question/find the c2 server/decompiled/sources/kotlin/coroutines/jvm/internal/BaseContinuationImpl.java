    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                m5433constructorimpl = Result.m5433constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.Companion;
            m5433constructorimpl = Result.m5433constructorimpl(outcome);
            Object outcome2 = m5433constructorimpl;
