...
public final class UMathKt {
    ...
    private static final int m6657minJ1ME1BU(int a, int b) {
        return UComparisonsKt.m6639minOfJ1ME1BU(a, b);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m6658mineb3DHEI(long a, long b) {
        return UComparisonsKt.m6647minOfeb3DHEI(a, b);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m6655maxJ1ME1BU(int a, int b) {
        return UComparisonsKt.m6627maxOfJ1ME1BU(a, b);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m6656maxeb3DHEI(long a, long b) {
        return UComparisonsKt.m6635maxOfeb3DHEI(a, b);
    }
}
