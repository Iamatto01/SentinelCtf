        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m6003contentEqualskV0jMPg(((UByteArray) t).m5518unboximpl(), ((UByteArray) t2).m5518unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m6000contentEqualsFGO6Aew(((UShortArray) t).m5781unboximpl(), ((UShortArray) t2).m5781unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m6001contentEqualsKJPZfPQ(((UIntArray) t).m5597unboximpl(), ((UIntArray) t2).m5597unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m6005contentEqualslec5QzE(((ULongArray) t).m5676unboximpl(), ((ULongArray) t2).m5676unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m6017contentToString2csIQuQ(uByteArray != null ? uByteArray.m5518unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m6021contentToStringd6D3K8(uShortArray != null ? uShortArray.m5781unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m6020contentToStringXUkPCBk(uIntArray != null ? uIntArray.m5597unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m6023contentToStringuLth9ew(uLongArray != null ? uLongArray.m5676unboximpl() : null));
            } else {
