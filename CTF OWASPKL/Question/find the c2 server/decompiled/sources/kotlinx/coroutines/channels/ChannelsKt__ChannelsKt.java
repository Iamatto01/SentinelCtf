...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object $this$onSuccess_u2dWpGqRn0$iv = sendChannel.mo6940trySendJP2dKIU(e);
        if ($this$onSuccess_u2dWpGqRn0$iv instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m6957unboximpl();
        }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m6955isSuccessimpl(sendChannel.mo6940trySendJP2dKIU(e))) {
