...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5433constructorimpl = Result.m5433constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m5433constructorimpl = Result.m5433constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m5439isFailureimpl(m5433constructorimpl)) {
                m5433constructorimpl = null;
            }
            return (E) m5433constructorimpl;
        }
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        if (newInstance != null) {
                            ...
                            it.initCause(e);
                            m5433constructorimpl = Result.m5433constructorimpl(it);
                            if (Result.m5439isFailureimpl(m5433constructorimpl)) {
                                m5433constructorimpl = null;
                            }
                            return (Throwable) m5433constructorimpl;
                        }
            ...
            case 1:
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        if (newInstance != null) {
                            m5433constructorimpl = Result.m5433constructorimpl((Throwable) newInstance);
                            if (Result.m5439isFailureimpl(m5433constructorimpl)) {
                                m5433constructorimpl = null;
                            }
                            return (Throwable) m5433constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m5433constructorimpl = Result.m5433constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    m5433constructorimpl = Result.m5433constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        Integer m5433constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m5433constructorimpl = Result.m5433constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5433constructorimpl = Result.m5433constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5439isFailureimpl(m5433constructorimpl)) {
            m5433constructorimpl = valueOf;
        }
        return ((Number) m5433constructorimpl).intValue();
    }
