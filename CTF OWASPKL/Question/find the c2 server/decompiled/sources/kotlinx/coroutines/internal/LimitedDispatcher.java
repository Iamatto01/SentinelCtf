...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo6987scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.mo6987scheduleResumeAfterDelay(j, cancellableContinuation);
    }
        ...
        while (true) {
            ...
            if (task != null) {
                ...
                if (fairnessCounter >= 16 && this.dispatcher.isDispatchNeeded(this)) {
                    this.dispatcher.mo6986dispatch(this, this);
                    return;
                }
            } else {
