...
final class FlowKt__DelayKt$debounceInternal$1$3$2 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m6968invokeWpGqRn0(channelResult.m6957unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m6968invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$3$2) create(ChannelResult.m6945boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ?? m6957unboximpl = ((ChannelResult) this.L$0).m6957unboximpl();
                Ref.ObjectRef<Object> objectRef2 = this.$lastValue;
                if (!(m6957unboximpl instanceof ChannelResult.Failed)) {
                    objectRef2.element = m6957unboximpl;
                }
                objectRef = this.$lastValue;
                FlowCollector<T> flowCollector = this.$downstream;
                if (m6957unboximpl instanceof ChannelResult.Failed) {
                    Throwable it = ChannelResult.m6949exceptionOrNullimpl(m6957unboximpl);
                    if (it != null) {
                        throw it;
                    }
