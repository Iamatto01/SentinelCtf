...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f106default;
    ...
    static {
        ...
        f106default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }
    ...
    public void execute(Runnable command) {
        mo6986dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo6986dispatch(CoroutineContext context, Runnable block) {
        f106default.mo6986dispatch(context, block);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext context, Runnable block) {
        f106default.dispatchYield(context, block);
    }
