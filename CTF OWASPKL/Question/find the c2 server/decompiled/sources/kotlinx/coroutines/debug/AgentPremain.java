...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m5433constructorimpl = Result.m5433constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m5433constructorimpl = Result.m5433constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m5439isFailureimpl(m5433constructorimpl) ? null : m5433constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m6962installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m6962installSignalHandler$lambda1(Signal it) {
