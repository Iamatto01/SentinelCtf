...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo6987scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> cancellableContinuation) {
        Executor executor = getExecutor();
        ...
        if (future != null) {
            ...
            DefaultExecutor.INSTANCE.mo6987scheduleResumeAfterDelay(timeMillis, cancellableContinuation);
        }
    }
