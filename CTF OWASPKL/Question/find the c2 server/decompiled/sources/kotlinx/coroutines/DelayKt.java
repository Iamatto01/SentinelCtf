    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo6987scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m6922delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m6923toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m6923toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m6758compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m6861getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6777getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1L);
        }
        return 0L;
    }
}
